  ...
  create(context) {
    return {
      TSNonNullExpression(node) {
        ...
        const nonNullOperator = (0, util_1.nullThrows)(
          context.sourceCode.getTokenAfter(
            node.expression,
            util_1.isNonNullAssertionPunctuator,
          ),
          util_1.NullThrowsReasons.MissingToken("!", "expression"),
        );
            ...
            if (node.parent.computed) {
              ...
              suggest.push({
                ...
                fix(fixer) {
                  // x!.y?.z
                  //   ^ punctuator
                  const punctuator = (0, util_1.nullThrows)(
