...
exports.default = (0, util_1.createRule)({
  ...
  create(
    ...
    function getSwitchMetadata(node) {
      ...
      const discriminantType = (0, util_1.getConstrainedTypeAtLocation)(
        services,
        node.discriminant,
      );
      ...
      for (const switchCase of node.cases) {
        ...
        const caseType = (0, util_1.getConstrainedTypeAtLocation)(
          services,
          switchCase.test,
        );
    ...
    function fixSwitch(
      fixer,
      node,
      missingBranchTypes, // null means default branch
      symbolName,
    ) {
      const lastCase =
      ...
      const openingBrace = (0, util_1.nullThrows)(
        context.sourceCode.getTokenAfter(
          node.discriminant,
          util_1.isOpeningBraceToken,
        ),
        util_1.NullThrowsReasons.MissingToken("{", "discriminant"),
      );
      const closingBrace = (0, util_1.nullThrows)(
        context.sourceCode.getTokenAfter(
          node.discriminant,
