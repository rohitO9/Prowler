  ...
  create(context) {
    ...
    function parseArrayFilterExpressions(expression) {
      if (expression.type === utils_1.AST_NODE_TYPES.SequenceExpression) {
        ...
        const lastExpression = (0, util_1.nullThrows)(
      ...
      if (
        expression.type === utils_1.AST_NODE_TYPES.CallExpression &&
        !expression.optional
      ) {
        ...
        if (callee.type === utils_1.AST_NODE_TYPES.MemberExpression) {
          ...
          if (isStaticMemberAccessOfValue(callee, "filter", globalScope)) {
            ...
            const filteredObjectType = (0, util_1.getConstrainedTypeAtLocation)(
              services,
              callee.object,
            );
    ...
    function getObjectIfArrayAtZeroExpression(node) {
      ...
      if (
        ...
        const atArgument = (0, util_1.getStaticValue)(
          node.arguments[0],
          globalScope,
        );
...
function isStaticMemberAccessOfValue(memberExpression, value, scope) {
  ...
  // x['memberName'] cases.
  const staticValueResult = (0, util_1.getStaticValue)(
