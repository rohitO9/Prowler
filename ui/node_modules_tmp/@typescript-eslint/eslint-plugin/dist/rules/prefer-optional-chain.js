    ...
    return {
      ...
      'LogicalExpression[operator="||"], LogicalExpression[operator="??"]'(
        ...
        const isRightNodeAnEmptyObjectLiteral =
          rightNode.type === utils_1.AST_NODE_TYPES.ObjectExpression &&
        ...
        function isLeftSideLowerPrecedence() {
          ...
          const leftPrecedence = (0, util_1.getOperatorPrecedence)(
            leftTsNode.kind,
            operator,
          );
      ...
      'LogicalExpression[operator!="??"]'(node) {
        ...
        const { operands, newlySeenLogicals } = (0,
        gatherLogicalOperands_1.gatherLogicalOperands)(
          node,
          parserServices,
          context.sourceCode,
          options,
