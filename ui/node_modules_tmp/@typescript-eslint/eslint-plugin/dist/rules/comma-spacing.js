  ...
  create(context, [{ before: spaceBefore, after: spaceAfter }]) {
    ...
    function validateCommaSpacing(commaToken, prevToken, nextToken) {
      ...
      if (
        spaceAfter &&
        nextToken &&
        ((0, util_1.isClosingBraceToken)(nextToken) ||
          (0, util_1.isClosingBracketToken)(nextToken))
      ) {
        return;
      }
      if (
        !spaceAfter &&
        nextToken &&
        nextToken.type === utils_1.AST_TOKEN_TYPES.Line
      ) {
        return;
      }
      if (
        ...
        tokensAndComments.forEach((token, i) => {
          ...
          validateCommaSpacing(
            ...
            (0, util_1.isCommaToken)(prevToken) || ignoredTokens.has(token)
              ? null
              : prevToken,
            (nextToken && (0, util_1.isCommaToken)(nextToken)) ||
