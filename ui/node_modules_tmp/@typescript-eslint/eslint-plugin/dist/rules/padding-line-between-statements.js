...
function isBlockLikeStatement(node, sourceCode) {
  ...
  const belongingNode =
    lastToken && (0, util_1.isClosingBraceToken)(lastToken)
...
const StatementTypes = {
  ...
  continue: newKeywordTester(
    utils_1.AST_NODE_TYPES.ContinueStatement,
    "continue",
  ),
  debugger: newKeywordTester(
...
exports.default = (0, util_1.createRule)({
  ...
  create(context) {
    ...
    function match(node, type) {
      ...
      while (
        innerStatementNode.type === utils_1.AST_NODE_TYPES.LabeledStatement
      ) {
