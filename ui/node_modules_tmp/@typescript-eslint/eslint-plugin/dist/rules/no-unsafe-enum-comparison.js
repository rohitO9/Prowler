...
exports.default = (0, util_1.createRule)({
  ...
  create(context) {
    ...
    function isMismatchedComparison(leftType, rightType) {
      ...
      const rightEnumTypes = new Set(
        (0, shared_1.getEnumTypes)(typeChecker, rightType),
      );
            ...
            suggest: [
              {
                ...
                fix(fixer) {
                  ...
                  // ```
                  const leftEnumKey = (0, shared_1.getEnumKeyForLiteral)(
                    (0, shared_1.getEnumLiterals)(leftType),
                    (0, util_1.getStaticValue)(node.right)?.value,
                  );
                  if (leftEnumKey) {
                  ...
                  // ```
                  const rightEnumKey = (0, shared_1.getEnumKeyForLiteral)(
                    (0, shared_1.getEnumLiterals)(rightType),
                    (0, util_1.getStaticValue)(node.left)?.value,
                  );
                  if (rightEnumKey) {
