...
exports.default = (0, util_1.createRule)({
  ...
  create(context, [{ ignoreParameters, ignoreProperties }]) {
    ...
    function hasUnaryPrefix(init, ...operators) {
      return (
        init.type === utils_1.AST_NODE_TYPES.UnaryExpression &&
    ...
    function isInferrable(annotation, init) {
      switch (annotation.type) {
        ...
        case utils_1.AST_NODE_TYPES.TSNullKeyword:
          return (
            init.type === utils_1.AST_NODE_TYPES.Literal && init.value == null
          );
    ...
    function reportInferrableType(node, typeNode, initNode) {
      ...
      const type =
        typeNode.typeAnnotation.type === utils_1.AST_NODE_TYPES.TSTypeReference
