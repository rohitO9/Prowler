...
exports.default = (0, util_1.createRule)({
  ...
  create(context) {
    function createFixer(member) {
      if (
        member.property.type === utils_1.AST_NODE_TYPES.Literal &&
    ...
    function getTokenRange(property) {
      return [
        (0, util_1.nullThrows)(
          ...
          util_1.NullThrowsReasons.MissingToken("token before", "property"),
        ).range[0],
        (0, util_1.nullThrows)(
          context.sourceCode.getTokenAfter(property),
          util_1.NullThrowsReasons.MissingToken("token after", "property"),
        ).range[1],
      ];
    }
  },
