...
const class_methods_use_this_1 = __importDefault(
  require("./class-methods-use-this"),
);
const comma_dangle_1 = __importDefault(require("./comma-dangle"));
const comma_spacing_1 = __importDefault(require("./comma-spacing"));
const consistent_generic_constructors_1 = __importDefault(
  require("./consistent-generic-constructors"),
);
...
const lines_around_comment_1 = __importDefault(
  require("./lines-around-comment"),
);
...
const no_duplicate_enum_values_1 = __importDefault(
  require("./no-duplicate-enum-values"),
);
const no_duplicate_type_constituents_1 = __importDefault(
  require("./no-duplicate-type-constituents"),
);
...
const no_empty_object_type_1 = __importDefault(
  require("./no-empty-object-type"),
);
...
const no_import_type_side_effects_1 = __importDefault(
  require("./no-import-type-side-effects"),
);
...
const no_redundant_type_constituents_1 = __importDefault(
  require("./no-redundant-type-constituents"),
);
...
const no_unnecessary_template_expression_1 = __importDefault(
  require("./no-unnecessary-template-expression"),
);
...
const no_unsafe_declaration_merging_1 = __importDefault(
  require("./no-unsafe-declaration-merging"),
);
const no_unsafe_enum_comparison_1 = __importDefault(
  require("./no-unsafe-enum-comparison"),
);
...
const no_unsafe_unary_minus_1 = __importDefault(
  require("./no-unsafe-unary-minus"),
);
...
const no_useless_empty_export_1 = __importDefault(
  require("./no-useless-empty-export"),
);
const no_useless_template_literals_1 = __importDefault(
  require("./no-useless-template-literals"),
);
...
const parameter_properties_1 = __importDefault(
  require("./parameter-properties"),
);
const prefer_as_const_1 = __importDefault(require("./prefer-as-const"));
const prefer_destructuring_1 = __importDefault(
  require("./prefer-destructuring"),
);
...
const prefer_promise_reject_errors_1 = __importDefault(
...
const sort_type_constituents_1 = __importDefault(
  require("./sort-type-constituents"),
);
...
const use_unknown_in_catch_callback_variable_1 = __importDefault(
  require("./use-unknown-in-catch-callback-variable"),
);
exports.default = {
  ...
  "no-unnecessary-template-expression":
    no_unnecessary_template_expression_1.default,
  ...
  "use-unknown-in-catch-callback-variable":
    use_unknown_in_catch_callback_variable_1.default,
};
