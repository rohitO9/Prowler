...
const disable_type_checked_1 = __importDefault(
  require("./configs/disable-type-checked"),
);
const eslint_recommended_1 = __importDefault(
  require("./configs/eslint-recommended"),
);
const recommended_1 = __importDefault(require("./configs/recommended"));
const recommended_type_checked_1 = __importDefault(
  require("./configs/recommended-type-checked"),
);
const recommended_type_checked_only_1 = __importDefault(
  require("./configs/recommended-type-checked-only"),
);
const strict_1 = __importDefault(require("./configs/strict"));
const strict_type_checked_1 = __importDefault(
  require("./configs/strict-type-checked"),
);
const strict_type_checked_only_1 = __importDefault(
  require("./configs/strict-type-checked-only"),
);
const stylistic_1 = __importDefault(require("./configs/stylistic"));
const stylistic_type_checked_1 = __importDefault(
  require("./configs/stylistic-type-checked"),
);
const stylistic_type_checked_only_1 = __importDefault(
  require("./configs/stylistic-type-checked-only"),
);
