...
exports.readonlynessOptionsDefaults = exports.readonlynessOptionsSchema =
  void 0;
...
function isTypeReadonlyArrayOrTuple(program, type, options, seenTypes) {
  ...
  if (checker.isArrayType(type)) {
    const symbol = utils_1.ESLintUtils.nullThrows(
      type.getSymbol(),
...
function isTypeReadonlyObject(program, type, options, seenTypes) {
  ...
  if (properties.length) {
    ...
    for (const property of properties) {
      const propertyType = utils_1.ESLintUtils.nullThrows(
...
function isTypeReadonlyRecurser(program, type, options, seenTypes) {
  ...
  if (
    options.allow?.some((specifier) =>
      (0, TypeOrValueSpecifier_1.typeMatchesSpecifier)(
        type,
        specifier,
        program,
      ),
  ...
  /* istanbul ignore else */ if (
    isReadonlyObject !== 1 /* Readonlyness.UnknownType */
  ) {
    return isReadonlyObject;
  }
...
function isTypeReadonly(
  program,
  type,
  options = exports.readonlynessOptionsDefaults,
) {
  return (
