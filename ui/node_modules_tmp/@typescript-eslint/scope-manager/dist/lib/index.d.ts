declare const lib: {
  ...
  readonly "dom.iterable": Record<
    string,
    import("..").ImplicitLibVariableOptions
  >;
  readonly "dom.asynciterable": Record<
    string,
    import("..").ImplicitLibVariableOptions
  >;
  ...
  readonly "webworker.iterable": Record<
    ...
    import("..").ImplicitLibVariableOptions
  >;
  readonly "webworker.asynciterable": Record<
    string,
    import("..").ImplicitLibVariableOptions
  >;
  ...
  readonly "esnext.decorators": Record<
    ...
    import("..").ImplicitLibVariableOptions
  >;
  readonly "esnext.object": Record<
    string,
    import("..").ImplicitLibVariableOptions
  >;
  readonly "esnext.regexp": Record<
    string,
    import("..").ImplicitLibVariableOptions
  >;
