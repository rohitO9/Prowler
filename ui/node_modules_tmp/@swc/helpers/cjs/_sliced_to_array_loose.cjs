...
exports._ = exports._sliced_to_array_loose = _sliced_to_array_loose;
function _sliced_to_array_loose(arr, i) {
  return (
    _array_with_holes._(arr) ||
    _iterable_to_array_limit_loose._(arr, i) ||
    _unsupported_iterable_to_array._(arr, i) ||
    _non_iterable_rest._()
  );
}
