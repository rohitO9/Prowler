...
exports._ = exports._to_consumable_array = _to_consumable_array;
function _to_consumable_array(arr) {
  return (
    _array_without_holes._(arr) ||
    _iterable_to_array._(arr) ||
    _unsupported_iterable_to_array._(arr) ||
    _non_iterable_spread._()
  );
}
