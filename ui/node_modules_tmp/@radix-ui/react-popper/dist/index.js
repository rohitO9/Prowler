...
import_react_context.createContextScope)(POPPER_NAME);
...
var PopperContent = React.forwardRef((props, forwardedRef) => {
  ...
  const { refs, floatingStyles, placement, isPositioned, middlewareData } = (0,
  import_react_dom.useFloating)({
    ...
    middleware: [
      ...
      avoidCollisions &&
        (0, import_react_dom.shift)({
          ...
          crossAxis: false,
          limiter:
            sticky === "partial" ? (0, import_react_dom.limitShift)() : void 0,
          ...detectOverflowOptions,
        }),
      avoidCollisions &&
        (0, import_react_dom.flip)({ ...detectOverflowOptions }),
      ...
      arrow &&
        (0, import_react_dom.arrow)({ element: arrow, padding: arrowPadding }),
      transformOrigin({ arrowWidth, arrowHeight }),
      hideWhenDetached &&
        (0, import_react_dom.hide)({
  ...
  const handlePlaced = (0, import_react_use_callback_ref.useCallbackRef)(
    onPlaced,
  );
