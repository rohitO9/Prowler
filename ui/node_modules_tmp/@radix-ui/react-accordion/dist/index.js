...
import_react_collection.createCollection)(ACCORDION_NAME);
var [createAccordionContext, createAccordionScope] = (0,
import_react_context.createContextScope)(ACCORDION_NAME, [
  createCollectionScope,
  import_react_collapsible.createCollapsibleScope,
]);
var useCollapsibleScope = (0,
import_react_collapsible.createCollapsibleScope)();
var Accordion = import_react.default.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection.Provider, {
    ...
    children:
      type === "multiple"
        ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionImplMultiple, {
            ...multipleProps,
            ref: forwardedRef,
          })
...
var [AccordionValueProvider, useAccordionValueContext] =
  createAccordionContext(ACCORDION_NAME);
var [AccordionCollapsibleProvider, useAccordionCollapsibleContext] =
...
var AccordionImplMultiple = import_react.default.forwardRef(
  (props, forwardedRef) => {
    const {
      value: valueProp,
      defaultValue,
...
var [AccordionImplProvider, useAccordionContext] =
  createAccordionContext(ACCORDION_NAME);
var AccordionImpl = import_react.default.forwardRef((props, forwardedRef) => {
  ...
  const handleKeyDown = (0, import_primitive.composeEventHandlers)(
    props.onKeyDown,
    (event) => {
...
var [AccordionItemProvider, useAccordionItemContext] =
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection.ItemSlot, {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        {
          "aria-disabled":
            (itemContext.open && !collapsibleContext.collapsible) || void 0,
          "data-orientation": accordionContext.orientation,
