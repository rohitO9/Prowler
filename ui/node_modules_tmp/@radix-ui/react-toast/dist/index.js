...
import_react_collection.createCollection)("Toast");
var [createToastContext, createToastScope] = (0,
import_react_context.createContextScope)("Toast", [createCollectionScope]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DismissableLayer.Branch, {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection.Slot, {
        scope: __scopeToast,
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          import_react_primitive.Primitive.ol,
          { tabIndex: -1, ...viewportProps, ref: composedRefs },
        ),
      }),
      hasToasts &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FocusProxy, {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_react_presence.Presence,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToastImpl, {
        ...
        onPause: (0, import_react_use_callback_ref.useCallbackRef)(
          props.onPause,
        ),
        onResume: (0, import_react_use_callback_ref.useCallbackRef)(
          props.onResume,
        ),
        onSwipeStart: (0, import_primitive.composeEventHandlers)(
          props.onSwipeStart,
          (event) => {
            event.currentTarget.setAttribute("data-swipe", "start");
          },
        ),
        onSwipeMove: (0, import_primitive.composeEventHandlers)(
          props.onSwipeMove,
          (event) => {
        ...
        onSwipeCancel: (0, import_primitive.composeEventHandlers)(
          props.onSwipeCancel,
          (event) => {
        ...
        onSwipeEnd: (0, import_primitive.composeEventHandlers)(
          props.onSwipeEnd,
          (event) => {
            const { x, y } = event.detail.delta;
...
var [ToastInteractiveProvider, useToastInteractiveContext] = createToastContext(
  TOAST_NAME,
  {
    onClose() {},
  },
                ...
                DismissableLayer.Root,
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    import_react_primitive.Primitive.li,
                    {
                      ...
                      onPointerDown: (0, import_primitive.composeEventHandlers)(
                        props.onPointerDown,
                        (event) => {
                      ...
                      onPointerUp: (0, import_primitive.composeEventHandlers)(
                        props.onPointerUp,
                        (event) => {
...
var ToastAnnounce = (props) => {
  ...
  return isAnnounced
    ? null
    : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react_portal.Portal, {
        asChild: true,
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          import_react_visually_hidden.VisuallyHidden,
          {
...
var ToastDescription = React.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_react_primitive.Primitive.div,
    { ...descriptionProps, ref: forwardedRef },
  );
});
