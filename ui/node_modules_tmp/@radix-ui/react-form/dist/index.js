...
var [createFormContext, createFormScope] = (0,
import_react_context.createContextScope)("Form");
var FORM_NAME = "Form";
var [ValidationProvider, useValidationContext] = createFormContext(FORM_NAME);
var [AriaDescriptionProvider, useAriaDescriptionContext] =
...
var Form = React.forwardRef((props, forwardedRef) => {
  ...
  const composedFormRef = (0, import_react_compose_refs.useComposedRefs)(
    forwardedRef,
    formRef,
  );
  ...
  const handleFieldCustomMatcherAdd = React.useCallback(
    (fieldName, matcherEntry) => {
  ...
  const handleFieldCustomMatcherRemove = React.useCallback(
    (fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
  ...
  const handleFieldCustomErrorsChange = React.useCallback(
  ...
  const getFieldDescription = React.useCallback(
    (fieldName) =>
      Array.from(messageIdsMap[fieldName] ?? []).join(" ") || void 0,
    [messageIdsMap],
  );
      ...
      AriaDescriptionProvider,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          import_react_primitive.Primitive.form,
          {
            ...rootProps,
            ref: composedFormRef,
            onInvalid: (0, import_primitive.composeEventHandlers)(
              props.onInvalid,
              (event) => {
            ...
            onSubmit: (0, import_primitive.composeEventHandlers)(
              props.onSubmit,
              onClearServerErrors,
              {
            ...
            onReset: (0, import_primitive.composeEventHandlers)(
              props.onReset,
              onClearServerErrors,
            ),
          },
...
var FormControl = React.forwardRef((props, forwardedRef) => {
  ...
  const customMatcherEntries =
    validationContext.getFieldCustomMatcherEntries(name);
  const {
  ...
  const updateControlValidity = React.useCallback(
    async (control) => {
      ...
      if (!hasSyncCustomErrors && ayncCustomMatcherEntries.length > 0) {
        ...
        const hasAsyncCustomErrors = Object.values(asyncCustomErrorsById).some(
          Boolean,
        );
        const hasCustomError2 = hasAsyncCustomErrors;
        control.setCustomValidity(
          hasCustomError2 ? DEFAULT_INVALID_MESSAGE : "",
        );
        const controlValidity2 = validityStateToObject(control.validity);
        onFieldValidityChange(name, controlValidity2);
...
var FormCustomMessage = React.forwardRef((props, forwardedRef) => {
  ...
  const { onFieldCustomMatcherEntryAdd, onFieldCustomMatcherEntryRemove } =
    validationContext;
  React.useEffect(() => {
  ...
  const matches =
    forceMatch ||
    (validity && !hasBuiltInError(validity) && hasMatchingCustomError);
  if (matches) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormMessageImpl, {
      id,
      ref: composedRef,
...
var FormMessageImpl = React.forwardRef((props, forwardedRef) => {
  ...
  const _id = (0, import_react_id.useId)();
  const id = idProp ?? _id;
  const { onFieldMessageIdAdd, onFieldMessageIdRemove } =
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ...
    { id, ...messageProps, ref: forwardedRef },
  );
});
