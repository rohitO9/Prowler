...
var [createToggleGroupContext, createToggleGroupScope] = (0,
import_react_context.createContextScope)(TOGGLE_GROUP_NAME, [
...
var ToggleGroup = import_react.default.forwardRef((props, forwardedRef) => {
  ...
  if (type === "multiple") {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ...
      { ...multipleProps, ref: forwardedRef },
    );
  }
  throw new Error(`Missing prop \`type\` expected on \`${TOGGLE_GROUP_NAME}\``);
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
var [ToggleGroupValueProvider, useToggleGroupValueContext] =
  createToggleGroupContext(TOGGLE_GROUP_NAME);
var ToggleGroupImplSingle = import_react.default.forwardRef(
  (props, forwardedRef) => {
    const {
      value: valueProp,
      defaultValue,
...
var ToggleGroupImplMultiple = import_react.default.forwardRef(
  (props, forwardedRef) => {
    const {
      value: valueProp,
      defaultValue,
...
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
var [ToggleGroupContext, useToggleGroupContext] =
  createToggleGroupContext(TOGGLE_GROUP_NAME);
var ToggleGroupImpl = import_react.default.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToggleGroupContext, {
    ...
    children: rovingFocus
      ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RovingFocusGroup.Root, {
          asChild: true,
...
var ToggleGroupItem = import_react.default.forwardRef((props, forwardedRef) => {
  ...
  return context.rovingFocus
    ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RovingFocusGroup.Item, {
        asChild: true,
        ...rovingFocusGroupScope,
        focusable: !disabled,
        active: pressed,
