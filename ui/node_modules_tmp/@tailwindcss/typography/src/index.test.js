...
test('variants', async () => {
  ...
  return run(config).then((result) => {
    expect(result.css).toMatchFormattedCss(css`
      ...
      .hover\:prose-lg:hover
        :where(.hover\:prose-lg:hover > ul > li):not(
          :where([class~='not-prose'], [class~='not-prose'] *)
        ) {
        color: blue;
      }
...
test('custom class name', async () => {
  ...
  return run(config).then((result) => {
    expect(result.css).toMatchFormattedCss(css`
      ...
      .markdown :where(h4 strong):not(:where([class~='not-markdown'], [class~='not-markdown'] *)) {
        font-weight: 700;
      }
      .markdown :where(figure > *):not(:where([class~='not-markdown'], [class~='not-markdown'] *)) {
        margin: 0;
      }
      .markdown
...
it('does not modify selectors with differing pseudo elements', () => {
  ...
  return run(config).then((result) => {
    expect(result.css).toIncludeCss(css`
      .prose
        :where(ol li::before, ul li::after):not(
          :where([class~='not-prose'], [class~='not-prose'] *)
        ) {
        color: red;
      }
...
it('lifts only the common, trailing pseudo elements from selectors', () => {
  ...
  return run(config).then((result) => {
    expect(result.css).toIncludeCss(css`
      .prose
        :where(ol li::scroll-thumb, ul li::scroll-track):not(
          :where([class~='not-prose'], [class~='not-prose'] *)
        )::before {
        color: red;
      }
...
it('ignores common non-trailing pseudo-elements in selectors', () => {
  ...
  return run(config).then((result) => {
    expect(result.css).toIncludeCss(css`
      .prose
        :where(ol li::before::scroll-thumb, ul li::before::scroll-track):not(
          :where([class~='not-prose'], [class~='not-prose'] *)
        ) {
        color: red;
      }
