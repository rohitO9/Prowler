...
interface TableSelectAllCheckboxProps<T = object>
  extends HTMLNextUIProps<"th"> {
  /**
   * The table column.
   */
  node: GridNode<T>;
...
declare const TableSelectAllCheckbox: _nextui_org_system.InternalForwardRefRenderFunction<
  "th",
  TableSelectAllCheckboxProps<object>,
  never
>;
