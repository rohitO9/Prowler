...
var TableCheckboxCell = (0, import_system.forwardRef)((props, ref) => {
  ...
  const { gridCellProps } = (0, import_table.useTableCell)(
    { node },
    state,
    domRef,
  );
  const { isFocusVisible, focusProps } = (0, import_focus.useFocusRing)();
  const { checkboxProps } = (0, import_table.useTableSelectionCheckbox)(
    { key: (node == null ? void 0 : node.parentKey) || node.key },
    state,
  );
  const tdStyles = (0, import_shared_utils.clsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
    ...
    children: isSingleSelectionMode
      ...
      : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_checkbox.Checkbox, {
          color,
          disableAnimation,
