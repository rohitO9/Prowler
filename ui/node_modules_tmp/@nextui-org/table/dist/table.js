...
function useTable(originalProps) {
  ...
  const [props, variantProps] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.table.variantKeys,
  );
  const {
    ref,
    as,
    ...
    removeWrapper = false,
    disableAnimation = (_a =
      globalContext == null ? void 0 : globalContext.disableAnimation) != null
      ? _a
      : false,
    selectionMode = "none",
  ...
  const { gridProps } = (0, import_table2.useTable)(
    { ...originalProps, layout: layoutNode },
    state,
    domRef,
  );
  ...
  const values = (0, import_react2.useMemo)(() => {
    ...
    return {
      ...
      checkboxesProps,
      isHeaderSticky:
        (_a2 = originalProps == null ? void 0 : originalProps.isHeaderSticky) !=
        null
          ? _a2
          : false,
      selectionMode,
...
var TableRowGroup = (0, import_system2.forwardRef)((props, ref) => {
  ...
  const theadStyles = (0, import_shared_utils2.clsx)(
    classNames == null ? void 0 : classNames.thead,
    className,
  );
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
    ...
    className:
      (_a = slots.thead) == null
        ? void 0
        : _a.call(slots, { class: theadStyles }),
...
var TableHeaderRow = (0, import_system3.forwardRef)((props, ref) => {
  ...
  const { rowProps } = (0, import_table4.useTableHeaderRow)(
    { node },
    state,
    domRef,
  );
  const trStyles = (0, import_shared_utils3.clsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Component, {
    ...
    className:
      (_b = slots.tr) == null ? void 0 : _b.call(slots, { class: trStyles }),
    children,
  });
});
...
var TableColumnHeader = (0, import_system4.forwardRef)((props, ref) => {
  var _a, _b, _c, _d, _e;
  const { as, className, state, node, slots, classNames, ...otherProps } =
    props;
  const Component = as || "th";
  const shouldFilterDOMProps = typeof Component === "string";
  const domRef = (0, import_react_utils4.useDOMRef)(ref);
  const { columnHeaderProps } = (0, import_table5.useTableColumnHeader)(
    { node },
    state,
    domRef,
  );
  const thStyles = (0, import_shared_utils4.clsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Component, {
    ...
    className:
      (_b = slots.th) == null
        ? void 0
        : _b.call(slots, { align, class: thStyles }),
    children: [
      hideHeader
      ...
      allowsSorting &&
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          import_shared_icons.ChevronDownIcon,
          {
            "aria-hidden": "true",
            className:
              (_c = slots.sortIcon) == null
                ? void 0
                : _c.call(slots, {
                    class: classNames == null ? void 0 : classNames.sortIcon,
                  }),
            "data-direction":
              (_d = state.sortDescriptor) == null ? void 0 : _d.direction,
            "data-visible": (0, import_shared_utils4.dataAttr)(
              ((_e = state.sortDescriptor) == null ? void 0 : _e.column) ===
                node.key,
            ),
            strokeWidth: 3,
          },
...
var TableSelectAllCheckbox = (0, import_system5.forwardRef)((props, ref) => {
  ...
  const { columnHeaderProps } = (0, import_table6.useTableColumnHeader)(
    { node },
    state,
    domRef,
  );
  ...
  const thStyles = (0, import_shared_utils5.clsx)(
    classNames == null ? void 0 : classNames.th,
    className,
    (_a = node.props) == null ? void 0 : _a.className,
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, {
    ...
    className:
      (_b = slots.th) == null ? void 0 : _b.call(slots, { class: thStyles }),
    children: isSingleSelectionMode
      ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          import_visually_hidden2.VisuallyHidden,
          { children: checkboxProps["aria-label"] },
        )
      : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_checkbox.Checkbox, {
          color,
          disableAnimation,
...
var TableRow = (0, import_system6.forwardRef)((props, ref) => {
  ...
  const trStyles = (0, import_shared_utils6.clsx)(
    classNames == null ? void 0 : classNames.tr,
    className,
    (_a = node.props) == null ? void 0 : _a.className,
  );
  ...
  const { isFirst, isLast, isMiddle, isOdd } = (0,
  import_react3.useMemo)(() => {
    ...
    const isOdd2 = (node == null ? void 0 : node.index)
      ? (node.index + 1) % 2 === 0
      : false;
    return {
      isFirst: isFirst2,
...
var TableCell = (0, import_system7.forwardRef)((props, ref) => {
  ...
  const { gridCellProps } = (0, import_table8.useTableCell)(
    { node },
    state,
    domRef,
  );
  const tdStyles = (0, import_shared_utils7.clsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Component, {
    ...
    className:
      (_c = slots.td) == null
        ? void 0
        : _c.call(slots, { align: columnProps.align, class: tdStyles }),
    children: cell,
  });
});
...
var TableCheckboxCell = (0, import_system8.forwardRef)((props, ref) => {
  ...
  const { gridCellProps } = (0, import_table9.useTableCell)(
    { node },
    state,
    domRef,
  );
  const { isFocusVisible, focusProps } = (0, import_focus5.useFocusRing)();
  const { checkboxProps } = (0, import_table9.useTableSelectionCheckbox)(
    { key: (node == null ? void 0 : node.parentKey) || node.key },
    state,
  );
  const tdStyles = (0, import_shared_utils8.clsx)(
    classNames == null ? void 0 : classNames.td,
    className,
    (_a = node.props) == null ? void 0 : _a.className,
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Component, {
    ...
    className:
      (_b = slots.td) == null ? void 0 : _b.call(slots, { class: tdStyles }),
    children: isSingleSelectionMode
      ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          import_visually_hidden3.VisuallyHidden,
          { children: checkboxProps["aria-label"] },
        )
      : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
...
var TableBody = (0, import_system9.forwardRef)((props, ref) => {
  ...
  const tbodyStyles = (0, import_shared_utils9.clsx)(
    classNames == null ? void 0 : classNames.tbody,
    className,
  );
  const bodyProps = collection == null ? void 0 : collection.body.props;
  const isLoading =
    (bodyProps == null ? void 0 : bodyProps.isLoading) ||
    (bodyProps == null ? void 0 : bodyProps.loadingState) === "loading" ||
    (bodyProps == null ? void 0 : bodyProps.loadingState) === "loadingMore";
  ...
  if (collection.size === 0 && bodyProps.emptyContent) {
    emptyContent = /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("tr", {
      role: "row",
      children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", {
        className:
          slots == null
            ? void 0
            : slots.emptyWrapper({
  ...
  if (isLoading && bodyProps.loadingContent) {
    loadingContent = /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("tr", {
      role: "row",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", {
          className:
            slots == null
              ? void 0
              : slots.loadingWrapper({
                  class:
                    classNames == null ? void 0 : classNames.loadingWrapper,
                }),
          colSpan: collection.columnCount,
          role: "gridcell",
          ...
          ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", {
              className:
                slots == null
                  ...
                  : slots.emptyWrapper({
                      class:
                        classNames == null ? void 0 : classNames.emptyWrapper,
                    }),
            })
          : null,
      ],
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(Component, {
    ...
    className:
      (_a = slots.tbody) == null
        ? void 0
        : _a.call(slots, { class: tbodyStyles }),
...
var Table = (0, import_system10.forwardRef)((props, ref) => {
  ...
  const Wrapper = (0, import_react6.useCallback)(
    ({ children }) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(BaseComponent, {
        ...getWrapperProps(),
        children,
      });
    },
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Wrapper, {
        children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
          import_jsx_runtime9.Fragment,
          {
            children: [
              topContentPlacement === "inside" && topContent,
              /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(Component, {
                ...getTableProps(),
                children: [
                            ...
                            table_header_row_default,
                            {
                              ...
                              children: [...headerRow.childNodes].map(
                                (column) => {
                                  ...
                                  return (
                                    (_a =
                                      column == null ? void 0 : column.props) ==
                                    null
                                      ? void 0
                                      : _a.isSelectionCell
                                  )
                                    ? /* @__PURE__ */ (0,
                                      import_jsx_runtime9.jsx)(
                                        table_select_all_checkbox_default,
                                        {
                                          checkboxesProps:
                                            values.checkboxesProps,
                                          classNames: values.classNames,
                                          color: values.color,
                                          disableAnimation:
