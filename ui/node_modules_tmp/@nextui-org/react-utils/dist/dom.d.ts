...
declare function getUserAgentBrowser(
  navigator: Navigator,
):
  | "Chrome for iOS"
  | "Edge"
...
declare function getUserAgentOS(
  navigator: Navigator,
): "Android" | "iOS" | "Windows" | "Mac" | "Chrome OS" | "Firefox OS" | null;
type UserAgentOS = NonNullable<ReturnType<typeof getUserAgentOS>>;
declare function detectDeviceType(
  navigator: Navigator,
...
declare function createDOMRef<T extends HTMLElement = HTMLElement>(
  ref: RefObject<T>,
): DOMRefValue<T>;
declare function createFocusableRef<T extends HTMLElement = HTMLElement>(
  domRef: RefObject<T>,
  focusableRef?: RefObject<HTMLElement>,
): FocusableRefValue<T>;
declare function useDOMRef<T extends HTMLElement = HTMLElement>(
  ref?: RefObject<T | null> | Ref<T | null>,
): RefObject<T>;
declare function useFocusableRef<T extends HTMLElement = HTMLElement>(
  ref: FocusableRef<T>,
  focusableRef?: RefObject<HTMLElement>,
): RefObject<T>;
