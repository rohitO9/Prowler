...
function useBreadcrumbItem(originalProps) {
  const [props, variantProps] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.breadcrumbItem.variantKeys,
  );
  const {
    ref,
    as,
  ...
  const isCurrent = !!(originalProps == null
    ? void 0
    : originalProps.isCurrent);
  const isDisabled = originalProps == null ? void 0 : originalProps.isDisabled;
  const Component =
    (originalProps == null ? void 0 : originalProps.href) && !isCurrent
      ? "a"
      : "span";
  ...
  const slots = (0, import_react.useMemo)(
    () =>
      (0, import_theme.breadcrumbItem)({
        ...
        isCurrent,
        underline:
          (originalProps == null ? void 0 : originalProps.underline) !==
            void 0 && !isCurrent
            ? originalProps == null
              ? void 0
              : originalProps.underline
            : "none",
        className,
      }),
    [(0, import_shared_utils.objectToDeps)(variantProps), isCurrent, className],
  );
...
var Breadcrumbs = (0, import_system2.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(WrapperComponent, {
    ...getBaseProps(),
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component, {
        ...getItemProps(),
...
function useBreadcrumbs(originalProps) {
  ...
  const disableAnimation =
    (_b =
      ...
      ? _b
      : false;
  const [props, variantProps] = (0, import_system3.mapPropsVariants)(
    originalProps,
    import_theme2.breadcrumbs.variantKeys,
  );
  const {
    ref,
    as,
  ...
  const [, children] = (0, import_react_utils2.pickChildren)(
    childrenProp,
...
var Breadcrumbs2 = (0, import_system4.forwardRef)((props, ref) => {
  const {
    ...
    childCount,
    itemProps,
    separator = /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      import_shared_icons.ChevronRightIcon,
      {},
    ),
    maxItems,
    itemsBeforeCollapse,
  ...
  const content = (0, import_react4.useMemo)(() => {
        ...
        : children.map((child, i) => {
            ...
            return (0, import_react4.cloneElement)(child, {
              ...
              onPress: (0, import_utils3.chain)(
                (_a = child.props) == null ? void 0 : _a.onPress,
                () => (onAction == null ? void 0 : onAction(itemKey)),
              ),
            });
          });
    ...
    const ellipsisIcon = /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    ...
    const ellipsisItem =
      typeof renderEllipsis === "function"
        ? renderEllipsis({
            ...
            itemsBeforeCollapse,
            itemsAfterCollapse,
            separator: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", {
              ...getSeparatorProps(),
              children: separator,
            }),
          })
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Component, {
    ...getBaseProps(),
    children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ol", {
      ...getListProps(),
      children: content,
    }),
  });
