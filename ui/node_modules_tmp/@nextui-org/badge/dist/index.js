...
function useBadge(originalProps) {
  ...
  const [props, variantProps] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.badge.variantKeys,
  );
  ...
  const isOneChar = (0, import_react.useMemo)(() => {
    var _a2;
    return (
      ((_a2 = String(content)) == null ? void 0 : _a2.length) === 1 ||
  ...
  const slots = (0, import_react.useMemo)(
    () =>
      (0, import_theme.badge)({
        ...variantProps,
        showOutline: !!(originalProps == null
          ? void 0
          : originalProps.disableOutline)
          ? !(originalProps == null ? void 0 : originalProps.disableOutline)
          : originalProps == null
            ? void 0
...
var Badge = (0, import_system2.forwardRef)((props, ref) => {
  const { Component, children, content, slots, classNames, getBadgeProps } =
    useBadge({
      ...props,
    });
