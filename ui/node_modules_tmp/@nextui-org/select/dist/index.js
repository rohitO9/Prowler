...
function useSelect(originalProps) {
  ...
  const [props, variantProps] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.select.variantKeys,
  );
    ...
    scrollShadowProps: (0, import_utils.mergeProps)(
      {
        ref: scrollShadowRef,
        isEnabled:
          (_c = originalProps.showScrollIndicators) != null ? _c : true,
        hideScrollBar: true,
        offset: 15,
      },
      scrollShadowProps,
  ...
  (0, import_use_safe_layout_effect.useSafeLayoutEffect)(() => {
    ...
    state.setSelectedKeys(
      /* @__PURE__ */ new Set([...state.selectedKeys, domRef.current.value]),
    );
  }, [domRef.current]);
  const {
    labelProps,
  ...
  const isInvalid =
    originalProps.isInvalid || validationState === "invalid" || isAriaInvalid;
  const { isPressed, buttonProps } = (0, import_use_aria_button.useAriaButton)(
    triggerProps,
    triggerRef,
  );
  const { focusProps, isFocused, isFocusVisible } = (0,
  ...
  const shouldLabelBeOutside =
    ...
    (labelPlacement === "outside" &&
      (hasPlaceholder || !!originalProps.isMultiline));
  const shouldLabelBeInside = labelPlacement === "inside";
  const isOutsideLeft = labelPlacement === "outside-left";
  const isFilled =
    state.isOpen ||
    hasPlaceholder ||
    !!((_d = state.selectedItems) == null ? void 0 : _d.length) ||
    !!startContent ||
    !!endContent ||
  ...
  (0, import_react.useEffect)(() => {
    if (state.isOpen && popoverRef.current && listBoxRef.current) {
      ...
      if (selectedItem && scrollShadow && selectedItem.parentElement) {
        let scrollShadowRect =
          scrollShadow == null ? void 0 : scrollShadow.getBoundingClientRect();
  ...
  const getPopoverProps = (0, import_react.useCallback)(
    (props2 = {}) => {
      var _a2, _b2;
      const popoverProps2 = (0, import_utils.mergeProps)(
      ...
      return {
        ...
        offset:
          state.selectedItems && state.selectedItems.length > 0
            ? state.selectedItems.length * 1e-8 +
              (((_a2 = slotsProps.popoverProps) == null
                ? void 0
                : _a2.offset) || 0)
            : (_b2 = slotsProps.popoverProps) == null
              ? void 0
              : _b2.offset,
        shouldCloseOnInteractOutside: (
          popoverProps2 == null
            ? void 0
            : popoverProps2.shouldCloseOnInteractOutside
        )
          ? popoverProps2.shouldCloseOnInteractOutside
          : (element) =>
                ...
                [...state.collection.getKeys()].map((key) => {
                  ...
                  if ((item == null ? void 0 : item.type) === "item") {
                    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      "option",
                      { value: item.key, children: item.textValue },
                      item.key,
                    );
                  }
                }),
...
function Select(props, ref) {
  const {
    ...
    isLoading,
    triggerRef,
    selectorIcon = /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
  ...
  const labelContent = label
    ...
    : null;
  const clonedIcon = (0, import_react2.cloneElement)(
    selectorIcon,
    getSelectorIconProps(),
  );
        ...
        ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_popover.FreeSoloPopover,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                import_scroll_shadow.ScrollShadow,
                {
                  ...getListboxWrapperProps(),
                  children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", {
    ...getBaseProps(),
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(HiddenSelect, {
        ...getHiddenSelectProps(),
      }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", {
        ...getMainWrapperProps(),
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Component, {
            ...getTriggerProps(),
            children: [
              !isOutsideLeft ? labelContent : null,
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", {
