...
interface Props<T extends DateValue>
  ...
  classNames?: SlotsToClasses<DateRangePickerSlots> &
    DateInputProps<T>["classNames"];
}
type UseDateRangePickerProps<T extends DateValue> = Props<T> &
  AriaDateRangePickerProps<T>;
declare function useDateRangePicker<T extends DateValue>({
  as,
  ...
  getStartDateInputProps: (
    props?: DOMAttributes,
  ) => DateRangePickerFieldProps<_react_types_datepicker.DateValue>;
