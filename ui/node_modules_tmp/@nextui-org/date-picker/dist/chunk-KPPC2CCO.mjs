"use client";
import { AnimatePresence } from "./chunk-QQ5UXTVS.mjs";
import { date_range_picker_field_default } from "./chunk-73TKHF55.mjs";
import { useDateRangePicker } from "./chunk-CNP6KVM5.mjs";
...
function DateRangePicker(props, ref) {
  ...
  const selectorContent = isValidElement(selectorIcon)
    ...
    : /* @__PURE__ */ jsx(CalendarBoldIcon, { ...getSelectorIconProps() });
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [
      /* @__PURE__ */ jsxs(DateInputGroup, {
        ...
        children: [
          /* @__PURE__ */ jsx(date_range_picker_field_default, {
            ...getStartDateInputProps(),
          }),
          /* @__PURE__ */ jsx("span", {
            ...getSeparatorProps(),
      ...
      disableAnimation
        ? popoverContent
        : /* @__PURE__ */ jsx(AnimatePresence, { children: popoverContent }),
    ],
  });
}
...
export { date_range_picker_default };
