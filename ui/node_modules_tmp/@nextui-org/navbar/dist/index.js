...
function useNavbar(originalProps) {
  ...
  const [props, variantProps] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.navbar.variantKeys,
  );
  const {
    ref,
    as,
  ...
  (0, import_utils.useResizeObserver)({
    ...
    onResize: () => {
      var _a2;
      const currentWidth =
        (_a2 = domRef.current) == null ? void 0 : _a2.offsetWidth;
  ...
  (0, import_react.useEffect)(() => {
    ...
    updateWidth();
    navHeight.current =
      ((_a2 = domRef.current) == null ? void 0 : _a2.offsetHeight) || 0;
  }, []);
...
var NavbarMenu = (0, import_system2.forwardRef)((props, ref) => {
  ...
  const { slots, isMenuOpen, height, disableAnimation, classNames } =
    useNavbarContext();
  const styles = (0, import_shared_utils2.clsx)(
    classNames == null ? void 0 : classNames.menu,
    className,
  );
  ...
  const contents = disableAnimation
    ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuWrapper, {
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
          ref: domRef,
          className:
            (_a = slots.menu) == null
              ? void 0
              : _a.call(slots, { class: styles }),
    ...
    : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        import_framer_motion.AnimatePresence,
        {
          ...
          children: isMenuOpen
            ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                import_framer_motion.LazyMotion,
                {
                      ...
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                        import_framer_motion.m.ul,
                        {
                          ...
                          className:
                            (_b = slots.menu) == null
                              ? void 0
                              : _b.call(slots, { class: styles }),
                          "data-open": (0, import_shared_utils2.dataAttr)(
                            isMenuOpen,
                          ),
                          exit: "exit",
                          initial: "exit",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_overlays.Overlay, {
    portalContainer,
    children: contents,
  });
});
...
var Navbar = (0, import_system3.forwardRef)((props, ref) => {
  ...
  const [childrenWithoutMenu, menu] = (0, import_react_utils4.pickChildren)(
    children,
    navbar_menu_default,
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(NavbarProvider, {
    value: context,
    children: context.shouldHideOnScroll
      ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          import_framer_motion2.LazyMotion,
          {
            features: import_framer_motion2.domAnimation,
...
var NavbarBrand = (0, import_system4.forwardRef)((props, ref) => {
  ...
  const styles = (0, import_shared_utils3.clsx)(
    classNames == null ? void 0 : classNames.brand,
    className,
  );
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Component, {
    ref: domRef,
    className:
      (_a = slots.brand) == null ? void 0 : _a.call(slots, { class: styles }),
    ...otherProps,
    children,
  });
});
...
var NavbarContent = (0, import_system5.forwardRef)((props, ref) => {
  ...
  const { slots, classNames } = useNavbarContext();
  const styles = (0, import_shared_utils4.clsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, {
    ref: domRef,
    className:
      (_a = slots.content) == null ? void 0 : _a.call(slots, { class: styles }),
...
var NavbarItem = (0, import_system6.forwardRef)((props, ref) => {
  ...
  const { slots, classNames } = useNavbarContext();
  const styles = (0, import_shared_utils5.clsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Component, {
    ref: domRef,
    className:
      (_a = slots.item) == null ? void 0 : _a.call(slots, { class: styles }),
...
var NavbarMenuToggle = (0, import_system7.forwardRef)((props, ref) => {
  ...
  import_use_aria_toggle_button.useAriaToggleButton)(props, state, domRef);
  const { isFocusVisible, focusProps } = (0, import_focus.useFocusRing)({
    autoFocus,
  });
  const { isHovered, hoverProps } = (0, import_interactions.useHover)({});
  const toggleStyles = (0, import_shared_utils6.clsx)(
    classNames == null ? void 0 : classNames.toggle,
    className,
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(Component, {
    ref: domRef,
    className:
      (_a = slots.toggle) == null
        ? void 0
        : _a.call(slots, { class: toggleStyles }),
...
var NavbarMenuItem = (0, import_system8.forwardRef)((props, ref) => {
  ...
  const styles = (0, import_shared_utils7.clsx)(
    classNames == null ? void 0 : classNames.menuItem,
    className,
  );
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("li", {
    ref: domRef,
    className:
      (_a = slots.menuItem) == null
        ? void 0
        : _a.call(slots, { class: styles }),
