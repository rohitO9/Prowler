...
function useAccordion(props) {
  ...
  const children = (0, import_react2.useMemo)(() => {
    ...
    import_react.default.Children.map(childrenProp, (child) => {
      ...
      if (
        ...
        typeof ((_a2 = child.props) == null ? void 0 : _a2.children) !==
          "string"
      ) {
  ...
  const treeProps = {
    ...
    disallowEmptySelection,
    defaultSelectedKeys:
      defaultSelectedKeys != null ? defaultSelectedKeys : defaultExpandedKeys,
    onSelectionChange,
    ...commonProps,
    ...expandableProps,
  };
  ...
  const { accordionProps } = (0,
  import_use_aria_accordion.useReactAriaAccordion)(
    {
      ...commonProps,
      ...expandableProps,
    },
...
function useAccordionItem(props) {
  ...
  const { buttonProps: buttonCompleteProps, regionProps } = (0,
  import_use_aria_accordion2.useReactAriaAccordionItem)(
    { item, isDisabled },
    { ...state, focusedKey },
    domRef,
  );
  ...
  const { isFocused, isFocusVisible, focusProps } = (0,
...
var AccordionItem = (0, import_system3.forwardRef)((props, ref) => {
  ...
  const content = (0, import_react4.useMemo)(() => {
    ...
    const transitionVariants = {
      exit: {
        ...import_framer_utils.TRANSITION_VARIANTS.collapse.exit,
        overflowY: "hidden",
      },
      enter: {
        ...import_framer_utils.TRANSITION_VARIANTS.collapse.enter,
        overflowY: "unset",
      },
    };
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component, {
    ...getBaseProps(),
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadingComponent, {
        ...getHeadingProps(),
