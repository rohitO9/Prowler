...
interface ListboxSectionProps<T extends object = object>
  extends ListboxSectionBaseProps {
  item: Node<T>;
  state: ListState<T>;
  /**
 ...
 * @internal
 */
declare const ListboxSection: _nextui_org_system.InternalForwardRefRenderFunction<
  "li",
