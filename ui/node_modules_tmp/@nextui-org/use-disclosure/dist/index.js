...
function useDisclosure(props = {}) {
  ...
  const onOpenPropCallbackRef = (0, import_use_callback_ref.useCallbackRef)(
    onOpenProp,
  );
  const onClosePropCallbackRef = (0, import_use_callback_ref.useCallbackRef)(
    onCloseProp,
  );
  const [isOpen, setIsOpen] = (0, import_utils2.useControlledState)(
    isOpenProp,
    defaultOpen || false,
    onChange,
  );
