...
declare function useSliderThumb(props: UseSliderThumbProps): {
  ...
  getThumbProps: PropGetter<
    ...
    _nextui_org_system.DOMAttributes<_nextui_org_system.DOMElement>
  >;
...
declare const SliderThumb: _nextui_org_system.InternalForwardRefRenderFunction<
  "div",
  SliderThumbProps,
  never
>;
...
type UseSliderProps = Omit<Props, keyof ValueBase<SliderValue>> &
  AriaSliderProps &
  SliderVariantProps;
declare function useSlider(originalProps: UseSliderProps): {
  ...
  getBaseProps: PropGetter<
    Record<string, unknown>,
    DOMAttributes<_nextui_org_system.DOMElement>
  >;
...
export {
  ...
  UseSliderProps as U,
  SliderStepMark as a,
  SliderRenderThumbProps as b,
  UseSliderThumbProps as c,
  useSliderThumb as d,
  UseSliderThumbReturn as e,
  SliderThumb as f,
  SliderThumbProps as g,
  UseSliderReturn as h,
  useSlider as u,
};
