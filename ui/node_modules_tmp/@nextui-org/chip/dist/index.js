...
function useChip(originalProps) {
  ...
  const isOneChar = (0, import_react.useMemo)(
    () =>
      ...
      (children == null ? void 0 : children.length) === 1,
    [children],
  );
  const hasStartContent = (0, import_react.useMemo)(
    () => !!avatar || !!startContent,
    [avatar, startContent],
  );
  const hasEndContent = (0, import_react.useMemo)(
  ...
  const getContentClone = (content) =>
    (0, import_react.isValidElement)(content)
      ? (0, import_react.cloneElement)(content, {
