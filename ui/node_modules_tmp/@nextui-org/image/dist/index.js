...
function useImage(originalProps) {
  ...
  const [props, variantProps] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.image.variantKeys,
  );
  const {
    ref,
    as,
  ...
  const getImgProps = (props2 = {}) => {
    const imgStyles = (0, import_shared_utils.clsx)(
      baseStyles,
...
var Image = (0, import_system2.forwardRef)((props, ref) => {
  ...
  const img = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
    ref: domRef,
    ...getImgProps(),
  });
  if (removeWrapper) {
  ...
  const zoomed = /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
