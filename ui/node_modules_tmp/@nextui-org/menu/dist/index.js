...
function useMenu(props) {
  ...
  const { menuProps } = (0, import_use_aria_menu.useAriaMenu)(
    { ...otherProps, ...userMenuProps },
    state,
    domRef,
  );
  const slots = (0, import_react.useMemo)(
    () => (0, import_theme.menu)({ className }),
    [className],
  );
...
var import_use_aria_menu2 = require("@nextui-org/use-aria-menu");
...
function useMenuItem(originalProps) {
  ...
  const [props, variantProps] = (0, import_system2.mapPropsVariants)(
    originalProps,
    import_theme2.menuItem.variantKeys,
  );
  const {
    as,
    item,
  ...
  const Component =
    as || ((otherProps == null ? void 0 : otherProps.href) ? "a" : "li");
  const shouldFilterDOMProps = typeof Component === "string";
  ...
  } = (0, import_use_aria_menu2.useAriaMenuItem)(
    {
      key,
      onClose,
      isDisabled,
  ...
  const getItemProps = (props2 = {}) => ({
    ...
    "data-hover": (0, import_shared_utils2.dataAttr)(
      isMobile ? isHovered || isPressed : isHovered,
    ),
...
var MenuItem = (0, import_system3.forwardRef)((props, _) => {
  const {
    Component,
    slots,
    classNames,
  ...
  const selectedContent = (0, import_react3.useMemo)(() => {
    const defaultIcon = /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      MenuSelectedIcon,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Component, {
    ...
    children: [
      ...
      shortcut &&
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("kbd", {
          ...getKeyboardShortcutProps(),
          children: shortcut,
        }),
      isSelectable &&
...
var MenuSection = (0, import_system4.forwardRef)(
  (
    {
      item,
      state,
    ...
    const dividerStyles = (0, import_shared_utils3.clsx)(
      classNames == null ? void 0 : classNames.divider,
      dividerProps == null ? void 0 : dividerProps.className,
    );
    const { itemProps, headingProps, groupProps } = (0,
    import_menu.useMenuSection)({
...
function Menu(props, ref) {
      ...
      [...state.collection].map((item) => {
        ...
        if (item.type === "section") {
          return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            ...
            { ...itemProps, itemClasses },
            item.key,
          );
        }
        let menuItem2 = /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          menu_item_default,
          { ...itemProps, classNames: itemClasses },
          item.key,
        );
        if (item.wrapper) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", {
    ...getBaseProps(),
    children: [topContent, content, bottomContent],
  });
}
var menu_default = (0, import_system5.forwardRef)(Menu);
