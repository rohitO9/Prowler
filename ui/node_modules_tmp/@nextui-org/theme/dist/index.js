...
var tv = (options, config) => {
  ...
  return (0, import_tailwind_variants.tv)(options, {
    ...config,
    twMerge:
      (_a = config == null ? void 0 : config.twMerge) != null ? _a : true,
    twMergeConfig: {
      ...(config == null ? void 0 : config.twMergeConfig),
      theme: {
        ...((_b = config == null ? void 0 : config.twMergeConfig) == null
          ? void 0
          : _b.theme),
        ...twMergeConfig.theme,
      },
      classGroups: {
        ...((_c = config == null ? void 0 : config.twMergeConfig) == null
          ? void 0
          : _c.classGroups),
...
var input = tv({
  ...
  compoundVariants: [
    ...
    },
    {
      variant: ["flat", "faded"],
      class: {
        inputWrapper: [...groupDataFocusVisibleClasses],
      },
    },
    {
      isInvalid: true,
...
var select = tv({
  ...
  compoundVariants: [
    ...
    },
    {
      variant: ["flat", "faded"],
      class: {
        trigger: [...dataFocusVisibleClasses],
      },
    },
    {
      isInvalid: true,
...
var calendar = tv({
  slots: {
    ...
    gridHeaderCell:
      "flex w-8 justify-center items-center font-medium text-small",
    gridBody: "",
    ...
    helperWrapper:
      "px-4 pb-2 max-w-[270px] flex justify-start flex-wrap items-center",
...
var dateInput = tv({
  ...
  variants: {
    ...
    color: {
      default: {
        segment:
          "focus:bg-default-400/50 data-[editable=true]:focus:text-default-foreground",
      },
      primary: {
        segment:
          "focus:bg-primary-400/50 data-[editable=true]:focus:text-primary",
      },
      secondary: {
        segment:
          "focus:bg-secondary-400/50 data-[editable=true]:focus:text-secondary",
      },
      success: {
        segment:
...
var dateRangePicker = tv({
  ...
  slots: {
    ...
    timeInputWrapper:
      "flex flex-col group-data-[has-multiple-months=true]:flex-row",
...
var resolveConfig = (themes = {}, defaultTheme, prefix) => {
  ...
  for (const [themeName, { extend, layout, colors: colors2 }] of Object.entries(
    themes,
  )) {
    ...
    const flatLayout = layout
      ? (0, import_lodash4.default)(layout, (value, key) =>
          (0, import_lodash5.default)(key),
        )
      : {};
    ...
    for (const [colorName, colorValue] of Object.entries(flatColors)) {
      ...
      try {
        const parsedColor =
          ...
          (0, import_color.default)(colorValue).hsl().round(2).array();
...
var nextui = (config = {}) => {
  ...
  const userLightColors = (0, import_lodash.default)(
    themeObject,
    "light.colors",
    {},
  );
  const userDarkColors = (0, import_lodash.default)(
    themeObject,
    "dark.colors",
    {},
  );
  const defaultLayoutObj =
    userLayout && typeof userLayout === "object"
      ? (0, import_deepmerge.default)(defaultLayout, userLayout)
      : defaultLayout;
  const baseLayouts = {
    light: {
      ...defaultLayoutObj,
  ...
  let otherThemes =
    (0, import_lodash2.default)(themeObject, ["light", "dark"]) || {};
  (0, import_lodash3.default)(
    otherThemes,
    ({ extend, colors: colors2, layout }, themeName) => {
      const baseTheme =
        extend && isBaseTheme(extend) ? extend : defaultExtendTheme;
      if (colors2 && typeof colors2 === "object") {
        otherThemes[themeName].colors = (0, import_deepmerge.default)(
  ...
  const light2 = {
    layout: (0, import_deepmerge.default)(
      baseLayouts.light,
      (0, import_lodash.default)(themeObject, "light.layout", {}),
    ),
    colors: (0, import_deepmerge.default)(
  ...
  const dark = {
    layout: (0, import_deepmerge.default)(
      baseLayouts.dark,
      (0, import_lodash.default)(themeObject, "dark.layout", {}),
    ),
