...
var [AvatarGroupProvider, useAvatarGroupContext] = (0,
...
function useAvatarGroup(props = {}) {
  ...
  const clones = childrenWithinMax.map((child, index) => {
    ...
    return (0, import_react.cloneElement)(
      child,
      (0, import_shared_utils.compact)(childProps),
    );
  });
...
function useAvatar(originalProps = {}) {
  ...
  const {
    ...
    alt = name || "avatar",
    imgRef: imgRefProp,
    color = (_a = groupContext == null ? void 0 : groupContext.color) != null
      ? _a
      : "default",
    radius = (_b = groupContext == null ? void 0 : groupContext.radius) != null
      ? _b
      : "full",
    size = (_c = groupContext == null ? void 0 : groupContext.size) != null
      ? _c
      : "md",
    isBordered = (_d =
      groupContext == null ? void 0 : groupContext.isBordered) != null
      ? _d
      : false,
    isDisabled = (_e =
  ...
  const slots = (0, import_react2.useMemo)(() => {
    ...
    return (0, import_theme2.avatar)({
      ...
      disableAnimation,
      isInGridGroup:
        (_a2 = groupContext == null ? void 0 : groupContext.isGrid) != null
          ? _a2
          : false,
    });
  }, [
  ...
  const getImageProps = (0, import_react2.useCallback)(
    (props = {}) => ({
      ...
      ...(0, import_utils.mergeProps)(
        imgProps,
        props,
        (0, import_react_utils4.filterDOMProps)(
          { disableAnimation },
          {
...
var Avatar = (0, import_system2.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Component, {
    ...
    children: [
      src &&
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ImgComponent, {
          ...getImageProps(),
          alt,
        }),
      fallback,
...
var AvatarGroup = (0, import_system3.forwardRef)((props, ref) => {
  const {
    ...
    getAvatarGroupProps,
    renderCount = (count) =>
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(avatar_default, {
        ...getAvatarGroupCountProps(),
        name: `+${count}`,
      }),
  } = useAvatarGroup({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Component, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      ...
      {
        value: context,
        children: [clones, remainingCount > 0 && renderCount(remainingCount)],
      },
    ),
  });
});
