...
function useProgress(originalProps) {
  ...
  const [props, variantProps] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.progress.variantKeys,
  );
  const {
    ref,
    as,
  ...
  const percentage = (0, import_react.useMemo)(
    () =>
      isIndeterminate || !selfMounted
        ? void 0
        : (0, import_shared_utils.clampPercentage)(
...
function useCircularProgress(originalProps) {
  ...
  const [props, variantProps] = (0, import_system3.mapPropsVariants)(
    originalProps,
    import_theme2.circularProgress.variantKeys,
  );
  const {
    ref,
    as,
  ...
  const isIndeterminate =
    ((_a = originalProps.isIndeterminate) != null ? _a : true) &&
    value === void 0;
  const disableAnimation =
    (_c =
  ...
  const percentage = (0, import_react2.useMemo)(() => {
    ...
    return value
      ? (0, import_shared_utils2.clampPercentage)(
