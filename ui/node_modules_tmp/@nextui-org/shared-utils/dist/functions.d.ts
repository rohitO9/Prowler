...
declare function callAllHandlers<T extends (event: any) => void>(
  ...fns: (T | undefined)[]
): (event: Args<T>[0]) => void;
declare function callAll<T extends AnyFunction>(
  ...fns: (T | undefined)[]
): (arg: Args<T>[0]) => void;
declare function extractProperty<
