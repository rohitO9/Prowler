...
function usePagination(props) {
  ...
  const [activePage, setActivePage] = (0, import_react.useState)(
    page || initialPage,
  );
  ...
  const next = () =>
    isRTL ? setPage(activePage - 1) : setPage(activePage + 1);
  const previous = () =>
    isRTL ? setPage(activePage + 1) : setPage(activePage - 1);
  ...
  const formatRange = (0, import_react.useCallback)(
    (range2) => {
      if (showControls) {
        return isRTL
          ? ["next" /* NEXT */, ...range2, "prev" /* PREV */]
          : ["prev" /* PREV */, ...range2, "next" /* NEXT */];
      }
      return range2;
    },
    [isRTL, showControls],
