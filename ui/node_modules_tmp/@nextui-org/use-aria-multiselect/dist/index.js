...
function useMultiSelect(props, state, ref) {
  ...
  const collator = (0, import_i18n.useCollator)({
    usage: "search",
    sensitivity: "base",
  });
  const delegate = (0, import_react.useMemo)(
    () =>
      new import_selection.ListKeyboardDelegate(
        state.collection,
        state.disabledKeys,
        null,
        collator,
  ...
  const { labelProps, fieldProps, descriptionProps, errorMessageProps } = (0,
  import_label.useField)({
    ...props,
  ...
  const triggerProps = (0, import_utils.mergeProps)(
    typeSelectProps,
    menuTriggerProps,
    fieldProps,
  );
  ...
  return {
    ...
    triggerProps: (0, import_utils.mergeProps)(domProps, {
      ...triggerProps,
      onKeyDown: (0, import_utils.chain)(
      ...
      "aria-labelledby": [
        valueId,
        domProps["aria-label"] !== void 0
          ? domProps["aria-labelledby"] !== void 0
