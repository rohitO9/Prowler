...
type UseAutocompleteProps<T> = Props<T> &
  Omit<
    InputProps,
    "children" | "value" | "isClearable" | "defaultValue" | "classNames"
  > &
  ComboBoxProps<T> &
  AsyncLoadable &
  AutocompleteVariantProps;
declare function useAutocomplete<T extends object>(
  originalProps: UseAutocompleteProps<T>,
): {
