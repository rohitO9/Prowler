...
function useAutocomplete(originalProps) {
  ...
  const [props, variantProps] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.autocomplete.variantKeys,
  );
  const disableAnimation =
    (_b =
      ...
      : false;
  const isClearable =
    originalProps.disableClearable !== void 0
  ...
  let state = (0, import_combobox.useComboBoxState)({
    ...
    defaultFilter:
      defaultFilter && typeof defaultFilter === "function"
        ? defaultFilter
        : contains,
    ...
    scrollShadowProps: (0, import_utils.mergeProps)(
      {
        ref: scrollShadowRef,
        isEnabled:
          (_d = showScrollIndicators && state.collection.size > 5) != null
            ? _d
            : true,
        hideScrollBar: true,
        offset: 15,
  ...
  const isOpen = (
    (_e = slotsProps.listboxProps) == null ? void 0 : _e.hideEmptyContent
  )
    ...
    return {
      ...
      className: slots.selectorButton({
        class: (0, import_shared_utils.clsx)(
          classNames == null ? void 0 : classNames.selectorButton,
          (_a2 = slotsProps.selectorButtonProps) == null
            ? void 0
            : _a2.className,
        ),
      }),
  ...
  const getClearButtonProps = () => {
    ...
    return {
      ...
      onPress: (e) => {
        var _a3, _b3;
        (_b3 =
          (_a3 = slotsProps.clearButtonProps) == null ? void 0 : _a3.onPress) ==
        null
          ? void 0
          : _b3.call(_a3, e);
      ...
      "data-visible":
        !!state.selectedItem ||
        ((_a2 = state.inputValue) == null ? void 0 : _a2.length) > 0,
      className: slots.clearButton({
        class: (0, import_shared_utils.clsx)(
          classNames == null ? void 0 : classNames.clearButton,
          (_b2 = slotsProps.clearButtonProps) == null ? void 0 : _b2.className,
        ),
      }),
    };
  };
  const getInputProps = () => ({
    ...
    onClick: (0, import_utils.chain)(
      slotsProps.inputProps.onClick,
      otherProps.onClick,
    ),
  });
  ...
  const getEndContentWrapperProps = (props2 = {}) => ({
    className: slots.endContentWrapper({
      class: (0, import_shared_utils.clsx)(
        classNames == null ? void 0 : classNames.endContentWrapper,
        props2 == null ? void 0 : props2.className,
      ),
    }),
...
function Autocomplete(props, ref) {
  const {
    ...
    isOpen,
    disableAnimation,
    selectorIcon = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_shared_icons.ChevronDownIcon,
      {},
    ),
    clearIcon = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_shared_icons.CloseIcon,
      {},
    ),
    endContent,
    getBaseProps,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component, {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_input.Input, {
        ...getInputProps(),
        endContent: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...getEndContentWrapperProps(),
          children: [
            endContent ||
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                import_button.Button,
                { ...getClearButtonProps(), children: clearIcon },
              ),
