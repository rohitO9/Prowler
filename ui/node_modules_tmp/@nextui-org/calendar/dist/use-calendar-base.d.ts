...
type NextUIBaseProps = Omit<
  HTMLNextUIProps<"div">,
  keyof CalendarPropsBase | "onChange"
>;
...
type UseCalendarBasePropsComplete = Props &
  CalendarVariantProps &
  CalendarPropsBase;
...
declare function useCalendarBase(originalProps: UseCalendarBasePropsComplete): {
  ...
  otherProps:
    | {
        ...
        disableAnimation?: boolean | undefined;
        isDateUnavailable?:
          | ((date: _react_types_calendar.DateValue) => boolean)
          | undefined;
...
export {
  ...
  UseCalendarBasePropsComplete,
  UseCalendarBaseReturn,
  useCalendarBase,
};
