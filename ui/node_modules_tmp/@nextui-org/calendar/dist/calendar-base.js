...
function useVisualElement(Component2, visualState, props, createVisualElement) {
  ...
  const wantsHandoff = (0, import_react6.useRef)(
...
function useCreateMotionContext(props) {
  const { initial, animate } = getCurrentTreeVariants(
    props,
    (0, import_react8.useContext)(MotionContext),
  );
...
function createMotionComponent({
  ...
  function MotionComponent(props, externalRef) {
    ...
    if (!isStatic && isBrowser) {
      ...
      const initialLayoutGroupConfig = (0, import_react11.useContext)(
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component2, props, ref, { latestValues }, isStatic) => {
    ...
    const renderedChildren = (0, import_react14.useMemo)(
...
function useForceUpdate() {
  ...
  import_react18.useState)(0);
  const forceRender = (0, import_react18.useCallback)(() => {
    isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  const deferredForceRender = (0, import_react18.useCallback)(
...
function onlyElements(children) {
  ...
  import_react22.Children.forEach(children, (child) => {
    if ((0, import_react22.isValidElement)(child)) filtered.push(child);
  });
  return filtered;
}
var AnimatePresence = ({
  ...
  const forceRender =
    (0, import_react22.useContext)(LayoutGroupContext).forceRender ||
    useForceUpdate()[0];
  const isMounted = useIsMounted();
  const filteredChildren = onlyElements(children);
  let childrenToRender = filteredChildren;
  const exitingChildren = (0, import_react22.useRef)(
    /* @__PURE__ */ new Map(),
  ).current;
  const presentChildren = (0, import_react22.useRef)(childrenToRender);
  const allChildren = (0, import_react22.useRef)(
    /* @__PURE__ */ new Map(),
  ).current;
  ...
  return React4.createElement(
    ...
    exitingChildren.size
      ? childrenToRender
      : childrenToRender.map((child) =>
          (0, import_react22.cloneElement)(child),
        ),
  );
};
...
function CalendarCell(originalProps) {
  ...
  const {
  ...
  } = (0, import_calendar.useCalendarCell)(
    {
      ...props,
      isDisabled:
        !(0, import_date.isSameMonth)(props.date, currentMonth) ||
        isPickerVisible,
    },
    state,
    ref,
  ...
  const isSelectionStart =
    isSelected &&
    highlightedRange &&
    (0, import_date.isSameDay)(props.date, highlightedRange.start);
  const isSelectionEnd =
    isSelected &&
    highlightedRange &&
    (0, import_date.isSameDay)(props.date, highlightedRange.end);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("td", {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", {
      ...
      "data-disabled": (0, import_shared_utils.dataAttr)(
        isDisabled && !isInvalid,
      ),
      "data-focus-visible": (0, import_shared_utils.dataAttr)(
        isFocused && isFocusVisible,
      ),
      "data-hover": (0, import_shared_utils.dataAttr)(isHovered),
      "data-invalid": (0, import_shared_utils.dataAttr)(isInvalid),
      "data-outside-month": (0, import_shared_utils.dataAttr)(
        !(0, import_date.isSameMonth)(props.date, currentMonth),
      ),
      "data-pressed": (0, import_shared_utils.dataAttr)(
        isPressed && !state.isReadOnly,
      ),
      "data-range-end": (0, import_shared_utils.dataAttr)(isRangeEnd),
      "data-range-selection": (0, import_shared_utils.dataAttr)(
      ...
      "data-selection-start": (0, import_shared_utils.dataAttr)(
        isSelectionStart,
      ),
      "data-today": (0, import_shared_utils.dataAttr)(
        (0, import_date.isToday)(props.date, state.timeZone),
      ),
...
import_react_utils.createContext)({
...
function CalendarMonth(props) {
  ...
  import_calendar2.useCalendarGrid)(
    {
      ...props,
      weekdayStyle,
...
var CalendarPickerItem = (0, import_react27.forwardRef)(
...
function useCalendarPicker(props) {
  ...
  const highlightRef = (0, import_react28.useRef)(null);
  const yearsListRef = (0, import_react28.useRef)(null);
  const monthsListRef = (0, import_react28.useRef)(null);
  const monthsItemsRef = (0, import_react28.useRef)();
  const yearsItemsRef = (0, import_react28.useRef)();
  ...
  const handleListScroll = (0, import_react28.useCallback)(
    (e, highlightEl, list) => {
  ...
  const onPickerItemPressed = (0, import_react28.useCallback)(
    (e, list) => {
  ...
  const onPickerItemKeyDown = (0, import_react28.useCallback)(
    (e, value, list) => {
      var _a2;
      const map = getItemsRefMap(
        list === "months" ? monthsItemsRef : yearsItemsRef,
...
function CalendarPicker(props) {
  ...
  const EmptyItem = (0, import_react29.useCallback)(
    (props2) =>
  ...
  const PickerItemWrapper = (0, import_react29.useCallback)(
    ({ children }) =>
...
function CalendarBase(props) {
  ...
  const [direction, setDirection] = (0, import_react31.useState)(0);
  ...
  for (let i = 0; i < visibleMonths; i++) {
          ...
          children: [
            i === 0 &&
              /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
                ...
                {
                  ...prevButtonProps,
                  onPress: (0, import_utils15.chain)(
    ...
    import_react32.createElement)(CalendarMonth, {
      ...props,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(Component2, {
    ...(0, import_utils15.mergeProps)(calendarProps, otherProps),
    ref,
    children: [
      topContent,
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
