...
var [ButtonGroupProvider, useButtonGroupContext] = (0,
...
function useButton(props) {
  ...
  const {
    ...
    fullWidth = (_a = groupContext == null ? void 0 : groupContext.fullWidth) !=
    null
      ? _a
      : false,
    radius = groupContext == null ? void 0 : groupContext.radius,
    size = (_b = groupContext == null ? void 0 : groupContext.size) != null
      ? _b
      : "md",
    color = (_c = groupContext == null ? void 0 : groupContext.color) != null
      ? _c
      : "default",
    variant = (_d = groupContext == null ? void 0 : groupContext.variant) !=
    null
      ? _d
      : "solid",
    disableAnimation = (_f =
      ...
      ? _f
      : false,
    isDisabled: isDisabledProp = (_g =
      groupContext == null ? void 0 : groupContext.isDisabled) != null
      ? _g
      : false,
    isIconOnly = (_h =
      groupContext == null ? void 0 : groupContext.isIconOnly) != null
      ? _h
      : false,
  ...
  const disableRipple =
    (_i =
      disableRippleProp ||
      (globalContext == null ? void 0 : globalContext.disableRipple)) != null
      ? _i
      : disableAnimation;
  ...
  const getIconClone = (icon) =>
    (0, import_react2.isValidElement)(icon)
...
var Button = (0, import_system2.forwardRef)((props, ref) => {
  const {
    ...
    styles,
    spinnerSize,
    spinner = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_spinner.Spinner,
      { color: "current", size: spinnerSize },
    ),
    spinnerPlacement,
    startContent,
    endContent,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component, {
    ...
    children: [
      ...
      endContent,
      !disableRipple &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ripple2.Ripple, {
          ...getRippleProps(),
        }),
    ],
  });
...
function useButtonGroup(originalProps) {
  ...
  const [props, variantProps] = (0, import_system3.mapPropsVariants)(
    originalProps,
    import_theme2.buttonGroup.variantKeys,
  );
  const {
    ref,
    as,
