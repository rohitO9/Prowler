...
function useCheckbox(props = {}) {
  ...
  const {
    ...
    size = (_a = groupContext == null ? void 0 : groupContext.size) != null
      ? _a
      : "md",
    color = (_b = groupContext == null ? void 0 : groupContext.color) != null
      ? _b
      : "primary",
    radius = groupContext == null ? void 0 : groupContext.radius,
    lineThrough = (_c =
      groupContext == null ? void 0 : groupContext.lineThrough) != null
      ? _c
      : false,
    isDisabled: isDisabledProp = (_d =
      groupContext == null ? void 0 : groupContext.isDisabled) != null
      ? _d
      : false,
    disableAnimation = (_f =
      (_e = groupContext == null ? void 0 : groupContext.disableAnimation) !=
      null
        ? _e
        : globalContext == null
          ? void 0
    ...
    isInvalid = validationState
      ...
      : (_g = groupContext == null ? void 0 : groupContext.isInvalid) != null
        ? _g
        : false,
    isIndeterminate = false,
    validationBehavior = (_h =
      groupContext == null ? void 0 : groupContext.validationBehavior) != null
      ? _h
      : "aria",
    defaultSelected,
    classNames,
  ...
  const pressed = isInteractionDisabled
    ? false
    : isPressed || isPressedKeyboard;
...
function CheckboxIcon(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BaseIcon, {
    ...otherProps,
  });
}
...
var Checkbox = (0, import_system2.forwardRef)((props, ref) => {
  ...
  const clonedIcon =
    typeof icon === "function"
      ? icon(getIconProps())
      : (0, import_react3.cloneElement)(icon, getIconProps());
...
function useCheckboxGroup(props) {
  ...
  const checkboxGroupProps = (0, import_react4.useMemo)(() => {
    return {
      ...
      value,
      name,
      "aria-label": (0, import_shared_utils2.safeAriaLabel)(
        otherProps["aria-label"],
        label,
      ),
      defaultValue,
  ...
  const groupState = (0, import_checkbox3.useCheckboxGroupState)(
    checkboxGroupProps,
  );
  const {
    labelProps,
...
var CheckboxGroup = (0, import_system4.forwardRef)((props, ref) => {
  ...
  const errorMessageContent = (0, import_react5.useMemo)(
    () => errorMessage,
    [isInvalid],
  );
