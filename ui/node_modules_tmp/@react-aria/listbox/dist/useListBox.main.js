...
$parcel$export(
  module.exports,
  "useListBox",
  () => $a3ce5bb3074610af$export$50eacbbf140a3141,
);
/*
...
function $a3ce5bb3074610af$export$50eacbbf140a3141(props, state, ref) {
  ...
  let linkBehavior =
    props.linkBehavior ||
    (selectionBehavior === "replace" ? "action" : "override");
  ...
  let { listProps: listProps } = (0,
  $eCULP$reactariaselection.useSelectableList)({
    ...props,
    ref: ref,
  ...
  $eCULP$reactariainteractions.useFocusWithin)({
  ...
  return {
    ...
    listBoxProps: (0, $eCULP$reactariautils.mergeProps)(
      domProps,
      focusWithinProps,
