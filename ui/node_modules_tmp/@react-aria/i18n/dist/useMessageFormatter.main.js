...
$parcel$export(
  module.exports,
  "useMessageFormatter",
  () => $c376aa482226bf60$export$ec23bf898b1eed85,
);
/*
...
function $c376aa482226bf60$var$getCachedDictionary(strings) {
  ...
  if (!dictionary) {
    dictionary = new (0, $8WbGG$internationalizedmessage.MessageDictionary)(
      strings,
    );
...
function $c376aa482226bf60$export$ec23bf898b1eed85(strings) {
  ...
  let dictionary = (0, $8WbGG$react.useMemo)(
    () => $c376aa482226bf60$var$getCachedDictionary(strings),
    [strings],
  );
  let formatter = (0, $8WbGG$react.useMemo)(
    () =>
      new (0, $8WbGG$internationalizedmessage.MessageFormatter)(
        locale,
        dictionary,
      ),
    [locale, dictionary],
  );
  return (0, $8WbGG$react.useCallback)(
