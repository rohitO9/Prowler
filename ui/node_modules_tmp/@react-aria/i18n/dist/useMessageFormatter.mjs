...
import {
  MessageDictionary as $eZWU1$MessageDictionary,
  MessageFormatter as $eZWU1$MessageFormatter,
} from "@internationalized/message";
import {
  useMemo as $eZWU1$useMemo,
  useCallback as $eZWU1$useCallback,
} from "react";
...
function $321bc95feeb923dd$export$ec23bf898b1eed85(strings) {
  ...
  let dictionary = (0, $eZWU1$useMemo)(
    () => $321bc95feeb923dd$var$getCachedDictionary(strings),
    [strings],
  );
  let formatter = (0, $eZWU1$useMemo)(
    () => new (0, $eZWU1$MessageFormatter)(locale, dictionary),
    [locale, dictionary],
  );
  return (0, $eZWU1$useCallback)(
