...
$parcel$export(
  module.exports,
  "useHasTabbableChild",
  () => $259c6413a286f2e6$export$eac1895992b9f3d6,
);
/*
...
function $259c6413a286f2e6$export$eac1895992b9f3d6(ref, options) {
  ...
  let [hasTabbableChild, setHasTabbableChild] = (0, $6RLDH$react.useState)(
    false,
  );
  (0, $6RLDH$reactariautils.useLayoutEffect)(() => {
    if (
      ...
      let update = () => {
        if (ref.current) {
          let walker = (0, $a7a032acae3ddda9$exports.getFocusableTreeWalker)(
            ref.current,
            {
              tabbable: true,
            },
