import {
  getOwnerDocument as $jlOai$getOwnerDocument,
  runAfterTransition as $jlOai$runAfterTransition,
  focusWithoutScrolling as $jlOai$focusWithoutScrolling,
  ...
  if ((0, $jlOai$getInteractionModality)() === "virtual") {
    ...
    (0, $jlOai$runAfterTransition)(() => {
      ...
      if (
        ...
        (0, $jlOai$focusWithoutScrolling)(element);
    });
