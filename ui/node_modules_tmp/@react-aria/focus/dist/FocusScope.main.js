...
$parcel$export(
  module.exports,
  "FocusScope",
  () => $a7a032acae3ddda9$export$20e40289641fbbb6,
);
$parcel$export(
  module.exports,
  "useFocusManager",
  () => $a7a032acae3ddda9$export$10c5169755ce7bd7,
);
$parcel$export(
  module.exports,
  "getFocusableTreeWalker",
  () => $a7a032acae3ddda9$export$2d6ec8fc375ceafa,
);
$parcel$export(
  module.exports,
  "isFocusable",
  () => $a7a032acae3ddda9$export$4c063cf1350e6fed,
);
$parcel$export(
  module.exports,
  "isElementInChildOfActiveScope",
  () => $a7a032acae3ddda9$export$1258395f99bf9cbf,
);
$parcel$export(
  module.exports,
  "createFocusManager",
  () => $a7a032acae3ddda9$export$c5251b9e124bf29,
);
/*
...
const $a7a032acae3ddda9$var$FocusContext = /*#__PURE__*/ (0,
$parcel$interopDefault($euGna$react)).createContext(null);
const $a7a032acae3ddda9$var$RESTORE_FOCUS_EVENT =
...
function $a7a032acae3ddda9$export$20e40289641fbbb6(props) {
  ...
  let { parentNode: parentNode } =
    (0, $euGna$react.useContext)($a7a032acae3ddda9$var$FocusContext) || {};
  // Create a tree node here so we can add children to it even before it is added to the tree.
  let node = (0, $euGna$react.useMemo)(
    () =>
      new $a7a032acae3ddda9$var$TreeNode({
        scopeRef: scopeRef,
      }),
    [scopeRef],
  );
  (0, $euGna$reactariautils.useLayoutEffect)(() => {
    ...
    if (
      $a7a032acae3ddda9$export$d06fae2ee68b101e.getTreeNode(parent.scopeRef) &&
      $a7a032acae3ddda9$var$activeScope &&
      !$a7a032acae3ddda9$var$isAncestorScope(
        $a7a032acae3ddda9$var$activeScope,
        parent.scopeRef,
      )
    ) {
      let activeNode = $a7a032acae3ddda9$export$d06fae2ee68b101e.getTreeNode(
        $a7a032acae3ddda9$var$activeScope,
      );
  ...
  (0, $euGna$reactariautils.useLayoutEffect)(() => {
    ...
    let node =
      (_startRef_current = startRef.current) === null ||
      _startRef_current === void 0
        ? void 0
    ...
    while (node && node !== endRef.current) {
      ...
      node.addEventListener(
        $a7a032acae3ddda9$var$RESTORE_FOCUS_EVENT,
        stopPropagation,
      );
  ...
  (0, $euGna$react.useEffect)(() => {
    const activeElement = (0, $euGna$reactariautils.getOwnerDocument)(
      scopeRef.current ? scopeRef.current[0] : undefined,
    ).activeElement;
    let scope = null;
    if (
      $a7a032acae3ddda9$var$isElementInScope(activeElement, scopeRef.current)
    ) {
      // We need to traverse the focusScope tree and find the bottom most scope that
      // contains the active element and set that as the activeScope.
      for (let node of $a7a032acae3ddda9$export$d06fae2ee68b101e.traverse())
        if (
          node.scopeRef &&
  ...
  (0, $euGna$reactariautils.useLayoutEffect)(() => {
    return () => {
      ...
      let parentScope =
        (_focusScopeTree_getTreeNode_parent_scopeRef =
          (_focusScopeTree_getTreeNode =
            $a7a032acae3ddda9$export$d06fae2ee68b101e.getTreeNode(scopeRef)) ===
            null || _focusScopeTree_getTreeNode === void 0
            ? void 0
            : (_focusScopeTree_getTreeNode_parent =
                  _focusScopeTree_getTreeNode.parent) === null ||
                _focusScopeTree_getTreeNode_parent === void 0
              ? void 0
              : _focusScopeTree_getTreeNode_parent.scopeRef) !== null &&
        _focusScopeTree_getTreeNode_parent_scopeRef !== void 0
          ? _focusScopeTree_getTreeNode_parent_scopeRef
          : null;
      if (
        (scopeRef === $a7a032acae3ddda9$var$activeScope ||
          $a7a032acae3ddda9$var$isAncestorScope(
            scopeRef,
            $a7a032acae3ddda9$var$activeScope,
          )) &&
        (!parentScope ||
          $a7a032acae3ddda9$export$d06fae2ee68b101e.getTreeNode(parentScope))
      )
        $a7a032acae3ddda9$var$activeScope = parentScope;
      $a7a032acae3ddda9$export$d06fae2ee68b101e.removeTreeNode(scopeRef);
    };
  }, [scopeRef]);
  let focusManager = (0, $euGna$react.useMemo)(
    () => $a7a032acae3ddda9$var$createFocusManagerForScope(scopeRef),
    [],
  );
  ...
  return /*#__PURE__*/ (0, $parcel$interopDefault($euGna$react)).createElement(
    $a7a032acae3ddda9$var$FocusContext.Provider,
    {
      value: value,
    },
    /*#__PURE__*/ (0, $parcel$interopDefault($euGna$react)).createElement(
      "span",
      {
...
function $a7a032acae3ddda9$export$10c5169755ce7bd7() {
  var _useContext;
  return (_useContext = (0, $euGna$react.useContext)(
    $a7a032acae3ddda9$var$FocusContext,
  )) === null || _useContext === void 0
    ? void 0
    : _useContext.focusManager;
}
function $a7a032acae3ddda9$var$createFocusManagerForScope(scopeRef) {
  return {
    focusNext(opts = {}) {
      ...
      let node =
        from ||
        (0, $euGna$reactariautils.getOwnerDocument)(scope[0]).activeElement;
      ...
      walker.currentNode = $a7a032acae3ddda9$var$isElementInScope(node, scope)
        ? node
        : sentinel;
...
const $a7a032acae3ddda9$var$FOCUSABLE_ELEMENT_SELECTOR =
  $a7a032acae3ddda9$var$focusableElements.join(":not([hidden]),") +
  ",[tabindex]:not([disabled]):not([hidden])";
$a7a032acae3ddda9$var$focusableElements.push(
  '[tabindex]:not([tabindex="-1"]):not([disabled])',
);
const $a7a032acae3ddda9$var$TABBABLE_ELEMENT_SELECTOR =
  $a7a032acae3ddda9$var$focusableElements.join(
...
function $a7a032acae3ddda9$var$shouldContainFocus(scopeRef) {
  let scope = $a7a032acae3ddda9$export$d06fae2ee68b101e.getTreeNode(
    $a7a032acae3ddda9$var$activeScope,
  );
...
function $a7a032acae3ddda9$var$useFocusContainment(scopeRef, contain) {
  ...
  (0, $euGna$reactariautils.useLayoutEffect)(() => {
    ...
    const ownerDocument = (0, $euGna$reactariautils.getOwnerDocument)(
      scope ? scope[0] : undefined,
    );
    ...
    let onKeyDown = (e) => {
      if (
        ...
        e.ctrlKey ||
        e.metaKey ||
        !$a7a032acae3ddda9$var$shouldContainFocus(scopeRef) ||
        e.isComposing
      )
        return;
      ...
      if (
        !scope ||
        !$a7a032acae3ddda9$var$isElementInScope(focusedElement, scope)
      )
        return;
      let scopeRoot = $a7a032acae3ddda9$var$getScopeRoot(scope);
      let walker = $a7a032acae3ddda9$export$2d6ec8fc375ceafa(
    ...
    let onFocus = (e) => {
      ...
      if (
        ...
        $a7a032acae3ddda9$var$isElementInScope(e.target, scopeRef.current)
      ) {
        $a7a032acae3ddda9$var$activeScope = scopeRef;
        focusedNode.current = e.target;
      } else if (
        $a7a032acae3ddda9$var$shouldContainFocus(scopeRef) &&
        !$a7a032acae3ddda9$var$isElementInChildScope(e.target, scopeRef)
      ) {
        ...
        if (focusedNode.current) focusedNode.current.focus();
          ...
          $a7a032acae3ddda9$var$activeScope &&
          $a7a032acae3ddda9$var$activeScope.current
        )
          $a7a032acae3ddda9$var$focusFirstInScope(
            $a7a032acae3ddda9$var$activeScope.current,
          );
      ...
      raf.current = requestAnimationFrame(() => {
        ...
        if (
          ...
          if (ownerDocument.body.contains(e.target)) {
            ...
            focusedNode.current = e.target;
            (_focusedNode_current = focusedNode.current) === null ||
            _focusedNode_current === void 0
              ? void 0
              : _focusedNode_current.focus();
...
function $a7a032acae3ddda9$var$isElementInChildScope(element, scope = null) {
  ...
  for (let {
    scopeRef: s,
  } of $a7a032acae3ddda9$export$d06fae2ee68b101e.traverse(
    $a7a032acae3ddda9$export$d06fae2ee68b101e.getTreeNode(scope),
  )) {
...
function $a7a032acae3ddda9$export$1258395f99bf9cbf(element) {
  return $a7a032acae3ddda9$var$isElementInChildScope(
    element,
    $a7a032acae3ddda9$var$activeScope,
  );
}
function $a7a032acae3ddda9$var$isAncestorScope(ancestor, scope) {
  ...
  let parent =
    (_focusScopeTree_getTreeNode =
      $a7a032acae3ddda9$export$d06fae2ee68b101e.getTreeNode(scope)) === null ||
...
function $a7a032acae3ddda9$var$getFirstInScope(scope, tabbable = true) {
  ...
  if (tabbable && !nextNode) {
    ...
    walker = $a7a032acae3ddda9$export$2d6ec8fc375ceafa(
      scopeRoot,
      {
        tabbable: false,
      },
...
function $a7a032acae3ddda9$var$focusFirstInScope(scope, tabbable = true) {
  $a7a032acae3ddda9$var$focusElement(
    $a7a032acae3ddda9$var$getFirstInScope(scope, tabbable),
  );
}
function $a7a032acae3ddda9$var$useAutoFocus(scopeRef, autoFocus) {
  const autoFocusRef = (0, $parcel$interopDefault($euGna$react)).useRef(
    autoFocus,
  );
  (0, $euGna$react.useEffect)(() => {
...
function $a7a032acae3ddda9$var$useActiveScopeTracker(
  scopeRef,
  restore,
  contain,
) {
...
function $a7a032acae3ddda9$var$shouldRestoreFocus(scopeRef) {
  ...
  return (
    (scope === null || scope === void 0 ? void 0 : scope.scopeRef) === scopeRef
  );
}
function $a7a032acae3ddda9$var$useRestoreFocus(
  scopeRef,
  restoreFocus,
  contain,
) {
  ...
  const nodeToRestoreRef = (0, $euGna$react.useRef)(
    typeof document !== "undefined"
      ? (0, $euGna$reactariautils.getOwnerDocument)(
          scopeRef.current ? scopeRef.current[0] : undefined,
        ).activeElement
      : null,
  );
  ...
  (0, $euGna$reactariautils.useLayoutEffect)(() => {
    ...
    let onKeyDown = (e) => {
      ...
      if (
        ...
        !$a7a032acae3ddda9$var$shouldRestoreFocus(scopeRef)
      )
        return;
      let treeNode =
        $a7a032acae3ddda9$export$d06fae2ee68b101e.getTreeNode(scopeRef);
      ...
      if (
        !nodeToRestore ||
        !ownerDocument.body.contains(nodeToRestore) ||
        nodeToRestore === ownerDocument.body
      ) {
      ...
      if (
        ...
        while (
          $a7a032acae3ddda9$var$isElementInChildScope(nextElement, scopeRef)
        );
        e.preventDefault();
        e.stopPropagation();
        if (nextElement) $a7a032acae3ddda9$var$focusElement(nextElement, true);
  ...
  (0, $euGna$reactariautils.useLayoutEffect)(() => {
    ...
    treeNode.nodeToRestore =
      (_nodeToRestoreRef_current = nodeToRestoreRef.current) !== null &&
      _nodeToRestoreRef_current !== void 0
        ...
        requestAnimationFrame(() => {
          ...
          if (ownerDocument.activeElement === ownerDocument.body) {
            ...
            while (treeNode) {
              if (
                treeNode.nodeToRestore &&
                treeNode.nodeToRestore.isConnected
              ) {
                $a7a032acae3ddda9$var$restoreFocusToElement(
                  treeNode.nodeToRestore,
                );
                return;
              }
            ...
            while (treeNode) {
              if (
                ...
                $a7a032acae3ddda9$export$d06fae2ee68b101e.getTreeNode(
                  treeNode.scopeRef,
                )
              ) {
                let node = $a7a032acae3ddda9$var$getFirstInScope(
                  treeNode.scopeRef.current,
                  true,
                );
...
function $a7a032acae3ddda9$var$restoreFocusToElement(node) {
  ...
  if (
    node.dispatchEvent(
      new CustomEvent($a7a032acae3ddda9$var$RESTORE_FOCUS_EVENT, {
        bubbles: true,
        cancelable: true,
      }),
    )
...
function $a7a032acae3ddda9$export$2d6ec8fc375ceafa(root, opts, scope) {
  let selector = (opts === null || opts === void 0 ? void 0 : opts.tabbable)
    ? $a7a032acae3ddda9$var$TABBABLE_ELEMENT_SELECTOR
    : $a7a032acae3ddda9$var$FOCUSABLE_ELEMENT_SELECTOR;
  let walker = (0, $euGna$reactariautils.getOwnerDocument)(
    root,
    ...
    acceptNode(node) {
      ...
      if (
        ...
        (0, $d5156037ad898a4d$exports.isElementVisible)(node) &&
        (!scope || $a7a032acae3ddda9$var$isElementInScope(node, scope)) &&
        (!(opts === null || opts === void 0 ? void 0 : opts.accept) ||
          opts.accept(node))
      )
...
function $a7a032acae3ddda9$export$c5251b9e124bf29(ref, defaultOptions = {}) {
  return {
    focusNext(opts = {}) {
      ...
      let {
        from: from,
        tabbable: tabbable = defaultOptions.tabbable,
        wrap: wrap = defaultOptions.wrap,
        accept: accept = defaultOptions.accept,
      } = opts;
      let node =
        from || (0, $euGna$reactariautils.getOwnerDocument)(root).activeElement;
    ...
    focusPrevious(opts = defaultOptions) {
      ...
      if (previousNode) $a7a032acae3ddda9$var$focusElement(previousNode, true);
      return previousNode !== null && previousNode !== void 0
        ? previousNode
        : null;
    },
...
class $a7a032acae3ddda9$var$Tree {
  ...
  addTreeNode(scopeRef, parent, nodeToRestore) {
    let parentNode = this.fastMap.get(
      parent !== null && parent !== void 0 ? parent : null,
    );
  ...
  *traverse(node = this.root) {
    ...
    if (node.children.size > 0)
      for (let child of node.children) yield* this.traverse(child);
  }
  clone() {
    var _node_parent;
    ...
    for (let node of this.traverse())
      newTree.addTreeNode(
        node.scopeRef,
        (_node_parent_scopeRef =
          (_node_parent = node.parent) === null || _node_parent === void 0
            ? void 0
            : _node_parent.scopeRef) !== null &&
          _node_parent_scopeRef !== void 0
          ? _node_parent_scopeRef
          : null,
        node.nodeToRestore,
      );
...
let $a7a032acae3ddda9$export$d06fae2ee68b101e =
  new $a7a032acae3ddda9$var$Tree();
