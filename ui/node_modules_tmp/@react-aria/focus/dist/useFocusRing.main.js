...
$parcel$export(
  module.exports,
  "useFocusRing",
  () => $581a96d6eb128c1b$export$4e328f61c538687f,
);
...
function $581a96d6eb128c1b$export$4e328f61c538687f(props = {}) {
  ...
  let state = (0, $7eRoM$react.useRef)({
    isFocused: false,
    isFocusVisible:
      autoFocus || (0, $7eRoM$reactariainteractions.isFocusVisible)(),
  });
  let [isFocused, setFocused] = (0, $7eRoM$react.useState)(false);
  let [isFocusVisibleState, setFocusVisible] = (0, $7eRoM$react.useState)(
    () => state.current.isFocused && state.current.isFocusVisible,
  );
  let updateState = (0, $7eRoM$react.useCallback)(
    () =>
      setFocusVisible(state.current.isFocused && state.current.isFocusVisible),
    [],
  );
  let onFocusChange = (0, $7eRoM$react.useCallback)(
    (isFocused) => {
  ...
  (0, $7eRoM$reactariainteractions.useFocusVisibleListener)(
    (isFocusVisible) => {
  ...
  $7eRoM$reactariainteractions.useFocusWithin)({
    isDisabled: !within,
