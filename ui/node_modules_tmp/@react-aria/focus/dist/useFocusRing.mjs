import {
  isFocusVisible as $isWE5$isFocusVisible,
  useFocusVisibleListener as $isWE5$useFocusVisibleListener,
  useFocus as $isWE5$useFocus,
  useFocusWithin as $isWE5$useFocusWithin,
} from "@react-aria/interactions";
import {
  useRef as $isWE5$useRef,
  useState as $isWE5$useState,
  useCallback as $isWE5$useCallback,
} from "react";
...
function $f7dceffc5ad7768b$export$4e328f61c538687f(props = {}) {
  ...
  let [isFocusVisibleState, setFocusVisible] = (0, $isWE5$useState)(
    () => state.current.isFocused && state.current.isFocusVisible,
  );
  let updateState = (0, $isWE5$useCallback)(
    () =>
      setFocusVisible(state.current.isFocused && state.current.isFocusVisible),
    [],
  );
  let onFocusChange = (0, $isWE5$useCallback)(
    (isFocused) => {
  ...
  (0, $isWE5$useFocusVisibleListener)(
    (isFocusVisible) => {
