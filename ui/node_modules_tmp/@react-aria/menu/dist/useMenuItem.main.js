...
$parcel$export(
  module.exports,
  "useMenuItem",
  () => $38191ed02615ec07$export$9d32628fc2aea7da,
);
/*
...
function $38191ed02615ec07$export$9d32628fc2aea7da(props, state, ref) {
  ...
  if (isVirtualized) {
    ariaProps["aria-posinset"] =
      item === null || item === void 0 ? void 0 : item.index;
    ariaProps["aria-setsize"] = (0,
    $byVdR$reactstatelycollections.getItemCount)(state.collection);
  }
  let onPressStart = (e) => {
    if (e.pointerType === "keyboard") performAction(e);
    pressStartProp === null || pressStartProp === void 0
      ? void 0
      : pressStartProp(e);
  };
  let onPressUp = (e) => {
    if (e.pointerType !== "keyboard") {
      ...
      if (
        !isTrigger &&
        onClose &&
        (closeOnSelect !== null && closeOnSelect !== void 0
          ? closeOnSelect
  ...
  let { itemProps: itemProps, isFocused: isFocused } = (0,
  $byVdR$reactariaselection.useSelectableItem)({
  ...
  $byVdR$reactariainteractions.usePress)({
  ...
  let { hoverProps: hoverProps } = (0, $byVdR$reactariainteractions.useHover)({
    ...
    onHoverStart(e) {
      ...
      hoverStartProp === null || hoverStartProp === void 0
        ? void 0
        : hoverStartProp(e);
    },
    onHoverChange: onHoverChange,
  ...
  $byVdR$reactariainteractions.useKeyboard)({
    onKeyDown: (e) => {
  ...
  return {
    menuItemProps: {
      ...ariaProps,
      ...(0, $byVdR$reactariautils.mergeProps)(
        domProps,
        linkProps,
        isTrigger
          ? {
