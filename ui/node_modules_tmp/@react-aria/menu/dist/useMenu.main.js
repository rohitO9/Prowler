...
$parcel$export(
  module.exports,
  "menuData",
  () => $a3815f0132802737$export$6f49b4016bfc8d56,
);
$parcel$export(
  module.exports,
  "useMenu",
  () => $a3815f0132802737$export$38eaa17faae8f579,
);
/*
...
function $a3815f0132802737$export$38eaa17faae8f579(props, state, ref) {
  let {
    shouldFocusWrap: shouldFocusWrap = true,
    onKeyDown: onKeyDown,
    onKeyUp: onKeyUp,
    ...otherProps
  } = props;
  ...
  $6CumN$reactariaselection.useSelectableList)({
    ...otherProps,
    ref: ref,
  ...
  return {
    menuProps: (0, $6CumN$reactariautils.mergeProps)(
      domProps,
      {
        onKeyDown: onKeyDown,
        onKeyUp: onKeyUp,
