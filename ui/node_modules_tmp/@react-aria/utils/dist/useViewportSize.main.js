...
$parcel$export(
  module.exports,
  "useViewportSize",
  () => $8b24bab62f5c65ad$export$d699905dd57c73ca,
);
/*
...
// @ts-ignore
let $8b24bab62f5c65ad$var$visualViewport =
...
function $8b24bab62f5c65ad$export$d699905dd57c73ca() {
  ...
  let [size, setSize] = (0, $4gIVO$react.useState)(() =>
    isSSR
      ? {
          width: 0,
          height: 0,
  ...
  (0, $4gIVO$react.useEffect)(() => {
    ...
    return () => {
      if (!$8b24bab62f5c65ad$var$visualViewport)
        ...
        $8b24bab62f5c65ad$var$visualViewport.removeEventListener(
          "resize",
          onResize,
        );
    };
...
function $8b24bab62f5c65ad$var$getViewportSize() {
  return {
    width:
      ($8b24bab62f5c65ad$var$visualViewport &&
        ($8b24bab62f5c65ad$var$visualViewport === null ||
        $8b24bab62f5c65ad$var$visualViewport === void 0
          ? void 0
          : $8b24bab62f5c65ad$var$visualViewport.width)) ||
      window.innerWidth,
    height:
      ($8b24bab62f5c65ad$var$visualViewport &&
        ($8b24bab62f5c65ad$var$visualViewport === null ||
        $8b24bab62f5c65ad$var$visualViewport === void 0
          ? void 0
          : $8b24bab62f5c65ad$var$visualViewport.height)) ||
      window.innerHeight,
  };
}
