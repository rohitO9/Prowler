...
$parcel$export(
  module.exports,
  "useTextField",
  () => $9076f978e02df845$export$712718f7aec83d5,
);
/*
...
function $9076f978e02df845$export$712718f7aec83d5(props, ref) {
  ...
  let [value, setValue] = (0, $4Z7CR$reactstatelyutils.useControlledState)(
    props.value,
    props.defaultValue || "",
    props.onChange,
  );
  let { focusableProps: focusableProps } = (0,
  $4Z7CR$reactariafocus.useFocusable)(props, ref);
  ...
  } = (0, $4Z7CR$reactarialabel.useField)({
    ...props,
    isInvalid: isInvalid,
  ...
  (0, $4Z7CR$react.useEffect)(() => {
    ...
    if (
      ...
      (0, $4Z7CR$reactariautils.getOwnerWindow)(ref.current).HTMLTextAreaElement
    ) {
  ...
  return {
    labelProps: labelProps,
    inputProps: (0, $4Z7CR$reactariautils.mergeProps)(
      domProps,
