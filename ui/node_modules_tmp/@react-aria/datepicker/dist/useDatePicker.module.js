...
import {
  useId as $4lVjK$useId,
  useDescription as $4lVjK$useDescription,
  filterDOMProps as $4lVjK$filterDOMProps,
  mergeProps as $4lVjK$mergeProps,
...
import {
  useLocalizedStringFormatter as $4lVjK$useLocalizedStringFormatter,
  useLocale as $4lVjK$useLocale,
...
function $6057a3d2a53a12fd$export$42df105a73306d51(props, state, ref) {
  ...
  let stringFormatter = (0, $4lVjK$useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($4lVjK$intlStringsmodulejs)),
  ...
  let focusManager = (0, $4lVjK$useMemo)(
    () => (0, $4lVjK$createFocusManager)(ref),
    [ref],
  );
