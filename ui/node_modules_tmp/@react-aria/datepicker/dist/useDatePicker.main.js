...
$parcel$export(
  module.exports,
  "useDatePicker",
  () => $e90ae7c26a69c6b1$export$42df105a73306d51,
);
/*
...
function $e90ae7c26a69c6b1$export$42df105a73306d51(props, state, ref) {
  ...
  let stringFormatter = (0, $bxHoL$reactariai18n.useLocalizedStringFormatter)(
  ...
  } = (0, $bxHoL$reactarialabel.useField)({
    ...props,
  ...
  let description = date
    ? stringFormatter.format("selectedDateDescription", {
        date: date,
      })
    : "";
  ...
  let focusManager = (0, $bxHoL$react.useMemo)(
    () => (0, $bxHoL$reactariafocus.createFocusManager)(ref),
    [ref],
  );
  let { focusWithinProps: focusWithinProps } = (0,
  $bxHoL$reactariainteractions.useFocusWithin)({
    ...props,
  ...
  return {
    groupProps: (0, $bxHoL$reactariautils.mergeProps)(
      domProps,
      groupProps,
      fieldProps,
      descProps,
