...
$parcel$export(
  module.exports,
  "useDatePickerGroup",
  () => $715562ad3b4cced4$export$4a931266a3838b86,
);

function $715562ad3b4cced4$export$4a931266a3838b86(
  state,
  ref,
  disableArrowNavigation,
) {
  let { direction: direction } = (0, $19S5E$reactariai18n.useLocale)();
  let focusManager = (0, $19S5E$react.useMemo)(
    () => (0, $19S5E$reactariafocus.createFocusManager)(ref),
    [ref],
  );
  ...
  let focusLast = () => {
    ...
    let target =
      (_window_event = window.event) === null || _window_event === void 0
        ? void 0
        : _window_event.target;
    let walker = (0, $19S5E$reactariafocus.getFocusableTreeWalker)(
      ref.current,
      {
        tabbable: true,
      },
