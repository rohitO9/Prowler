import {
  focusManagerSymbol as $16f0b7bb276bc17e$export$7b3062cd49e80452,
  roleSymbol as $16f0b7bb276bc17e$export$300019f83c56d282,
} from "./useDateField.module.js";
...
import {
  DEFAULT_VALIDATION_RESULT as $eIQ1H$DEFAULT_VALIDATION_RESULT,
  privateValidationStateProp as $eIQ1H$privateValidationStateProp,
  mergeValidation as $eIQ1H$mergeValidation,
} from "@react-stately/form";
import {
  useDescription as $eIQ1H$useDescription,
  useId as $eIQ1H$useId,
  filterDOMProps as $eIQ1H$filterDOMProps,
  mergeProps as $eIQ1H$mergeProps,
...
import {
  useLocalizedStringFormatter as $eIQ1H$useLocalizedStringFormatter,
  useLocale as $eIQ1H$useLocale,
...
function $887cac91b7cc8801$export$12fd5f0e9f4bb192(props, state, ref) {
  ...
  let stringFormatter = (0, $eIQ1H$useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($eIQ1H$intlStringsmodulejs)),
  ...
  let ariaDescribedBy =
    [descProps["aria-describedby"], fieldProps["aria-describedby"]]
      .filter(Boolean)
      .join(" ") || undefined;
  let focusManager = (0, $eIQ1H$useMemo)(
    () =>
      (0, $eIQ1H$createFocusManager)(ref, {
  ...
  let startFieldValidation = (0, $eIQ1H$useRef)(
    (0, $eIQ1H$DEFAULT_VALIDATION_RESULT),
  );
  let endFieldValidation = (0, $eIQ1H$useRef)(
    (0, $eIQ1H$DEFAULT_VALIDATION_RESULT),
  );
  return {
    groupProps: (0, $eIQ1H$mergeProps)(
      domProps,
      groupProps,
      fieldProps,
      descProps,
      ...
      [(0, $eIQ1H$privateValidationStateProp)]: {
        ...
        updateValidation(e) {
          ...
          state.updateValidation(
            (0, $eIQ1H$mergeValidation)(e, endFieldValidation.current),
          );
        },
    ...
    endFieldProps: {
      ...
      ...commonFieldProps,
      value:
        (_state_value1 = state.value) === null || _state_value1 === void 0
          ? void 0
          : _state_value1.end,
      ...
      [(0, $eIQ1H$privateValidationStateProp)]: {
        ...
        updateValidation(e) {
          ...
          state.updateValidation(
            (0, $eIQ1H$mergeValidation)(startFieldValidation.current, e),
          );
        },
        resetValidation: state.resetValidation,
        commitValidation: state.commitValidation,
