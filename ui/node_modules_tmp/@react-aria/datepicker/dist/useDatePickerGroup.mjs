import {
  createFocusManager as $7CEvq$createFocusManager,
  getFocusableTreeWalker as $7CEvq$getFocusableTreeWalker,
...
function $3dfb0f96be0d6a08$export$4a931266a3838b86(
  state,
  ref,
  disableArrowNavigation,
) {
  let { direction: direction } = (0, $7CEvq$useLocale)();
  let focusManager = (0, $7CEvq$useMemo)(
    () => (0, $7CEvq$createFocusManager)(ref),
    [ref],
  );
