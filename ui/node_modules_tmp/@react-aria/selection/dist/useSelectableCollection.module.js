import {
  isCtrlKeyPressed as $feb5ffebff200149$export$16792effe837dba3,
  isNonContiguousSelectionModifier as $feb5ffebff200149$export$d3e3bd3e26688c04,
...
import {
  getFocusableTreeWalker as $3H3GQ$getFocusableTreeWalker,
  focusSafely as $3H3GQ$focusSafely,
} from "@react-aria/focus";
import {
  useRouter as $3H3GQ$useRouter,
  focusWithoutScrolling as $3H3GQ$focusWithoutScrolling,
  useEvent as $3H3GQ$useEvent,
  scrollIntoViewport as $3H3GQ$scrollIntoViewport,
  scrollIntoView as $3H3GQ$scrollIntoView,
  mergeProps as $3H3GQ$mergeProps,
...
function $ae20dd8cbca75726$export$d6daf82dcd84e87c(options) {
  let {
    ...
    linkBehavior: linkBehavior = "action",
  } = options;
    ...
    const navigateToKey = (key, childFocus) => {
      if (key != null) {
        if (
          ...
          selectOnFocus &&
          !(0, $feb5ffebff200149$export$d3e3bd3e26688c04)(e)
        ) {
          // Set focused key and re-render synchronously to bring item into view if needed.
          (0, $3H3GQ$flushSync)(() => {
            manager.setFocusedKey(key, childFocus);
          });
          let item = scrollRef.current.querySelector(
            `[data-key="${CSS.escape(key.toString())}"]`,
          );
      ...
      case "Home":
        if (delegate.getFirstKey) {
          ...
          let firstKey = delegate.getFirstKey(
            manager.focusedKey,
            (0, $feb5ffebff200149$export$16792effe837dba3)(e),
          );
        ...
        if (!allowsTabNavigation) {
          ...
          if (e.shiftKey) ref.current.focus();
            ...
            if (next && !next.contains(document.activeElement))
              (0, $3H3GQ$focusWithoutScrolling)(next);
          }
          break;
        }
    }
  ...
  let onFocus = (e) => {
    ...
    if (!isVirtualized && manager.focusedKey != null) {
      ...
      let element = scrollRef.current.querySelector(
        `[data-key="${CSS.escape(manager.focusedKey.toString())}"]`,
      );
      if (element) {
        // This prevents a flash of focus on the first/last element in the collection, or the collection itself.
        if (!element.contains(document.activeElement))
          (0, $3H3GQ$focusWithoutScrolling)(element);
        let modality = (0, $3H3GQ$getInteractionModality)();
        if (modality === "keyboard")
          (0, $3H3GQ$scrollIntoViewport)(element, {
  ...
  (0, $3H3GQ$useEffect)(() => {
    if (autoFocusRef.current) {
      ...
      if (focusedKey == null && !shouldUseVirtualFocus)
        (0, $3H3GQ$focusSafely)(ref.current);
    }
  ...
  let { typeSelectProps: typeSelectProps } = (0,
  $fb3050f43d946246$export$e32c88dfddc6e1d8)({
    keyboardDelegate: delegate,
    selectionManager: manager,
  });
  if (!disallowTypeAhead)
    handlers = (0, $3H3GQ$mergeProps)(typeSelectProps, handlers);
