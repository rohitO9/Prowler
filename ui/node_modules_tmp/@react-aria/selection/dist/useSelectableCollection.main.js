...
$parcel$export(
  ...
  () => $b6837c2f80a3c32f$export$d6daf82dcd84e87c,
);
/*
...
function $b6837c2f80a3c32f$export$d6daf82dcd84e87c(options) {
    ...
    const navigateToKey = (key, childFocus) => {
      if (key != null) {
        if (
          ...
          selectOnFocus &&
          !(0, $ee0bdf4faa47f2a8$exports.isNonContiguousSelectionModifier)(e)
        ) {
      ...
      case "Home":
        if (delegate.getFirstKey) {
          ...
          let firstKey = delegate.getFirstKey(
            manager.focusedKey,
            (0, $ee0bdf4faa47f2a8$exports.isCtrlKeyPressed)(e),
          );
      ...
      case "Tab":
        if (!allowsTabNavigation) {
          ...
          if (e.shiftKey) ref.current.focus();
            ...
            let walker = (0, $bT8Bh$reactariafocus.getFocusableTreeWalker)(
              ref.current,
              {
                tabbable: true,
              },
            ...
            if (next && !next.contains(document.activeElement))
              (0, $bT8Bh$reactariautils.focusWithoutScrolling)(next);
          }
          break;
        }
    }
  ...
  (0, $bT8Bh$reactariautils.useEvent)(
    scrollRef,
    "scroll",
    isVirtualized
      ? null
    ...
    if (!isVirtualized && manager.focusedKey != null) {
      ...
      if (element) {
        ...
        if (!element.contains(document.activeElement))
          (0, $bT8Bh$reactariautils.focusWithoutScrolling)(element);
        let modality = (0,
        $bT8Bh$reactariainteractions.getInteractionModality)();
        if (modality === "keyboard")
          (0, $bT8Bh$reactariautils.scrollIntoViewport)(element, {
  ...
  (0, $bT8Bh$react.useEffect)(() => {
    if (autoFocusRef.current) {
      ...
      if (focusedKey == null && !shouldUseVirtualFocus)
        (0, $bT8Bh$reactariafocus.focusSafely)(ref.current);
    }
  ...
  $a1189052f36475e8$exports.useTypeSelect)({
    keyboardDelegate: delegate,
    selectionManager: manager,
  });
  if (!disallowTypeAhead)
    handlers = (0, $bT8Bh$reactariautils.mergeProps)(typeSelectProps, handlers);
