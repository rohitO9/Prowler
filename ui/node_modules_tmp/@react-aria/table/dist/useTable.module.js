...
import {
  useId as $dDeJM$useId,
  useDescription as $dDeJM$useDescription,
  useUpdateEffect as $dDeJM$useUpdateEffect,
  mergeProps as $dDeJM$mergeProps,
} from "@react-aria/utils";
import { useMemo as $dDeJM$useMemo } from "react";
import { tableNestedRows as $dDeJM$tableNestedRows } from "@react-stately/flags";
import {
  useCollator as $dDeJM$useCollator,
  useLocale as $dDeJM$useLocale,
  useLocalizedStringFormatter as $dDeJM$useLocalizedStringFormatter,
...
function $6e31608fbba75bab$export$25bceaac3c7e4dc7(props, state, ref) {
  ...
  let delegate = (0, $dDeJM$useMemo)(
    () =>
      keyboardDelegate ||
      new (0, $0ba3c81c7f1caedd$export$da43f8f5cb04028d)({
  ...
  if ((0, $dDeJM$tableNestedRows)() && "expandedKeys" in state)
    gridProps.role = "treegrid";
  let { column: column, direction: sortDirection } = state.sortDescriptor || {};
  let stringFormatter = (0, $dDeJM$useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($dDeJM$intlStringsmodulejs)),
    "@react-aria/table",
  );
  let sortDescription = (0, $dDeJM$useMemo)(() => {
    var _state_collection_columns_find;
    let columnName =
      (_state_collection_columns_find = state.collection.columns.find(
        (c) => c.key === column,
      )) === null || _state_collection_columns_find === void 0
        ? void 0
        : _state_collection_columns_find.textValue;
    return sortDirection && column
      ? stringFormatter.format(`${sortDirection}Sort`, {
