...
$parcel$export(
  module.exports,
  "useTable",
  () => $25d14c0f8fad722e$export$25bceaac3c7e4dc7,
);
/*
...
function $25d14c0f8fad722e$export$25bceaac3c7e4dc7(props, state, ref) {
  ...
  let delegate = (0, $aZ1Oy$react.useMemo)(
    () =>
      keyboardDelegate ||
      new (0, $a911ff492b884835$exports.TableKeyboardDelegate)({
  ...
  if (
    (0, $aZ1Oy$reactstatelyflags.tableNestedRows)() &&
    "expandedKeys" in state
  )
    gridProps.role = "treegrid";
  let { column: column, direction: sortDirection } = state.sortDescriptor || {};
  let stringFormatter = (0, $aZ1Oy$reactariai18n.useLocalizedStringFormatter)(
  ...
  let descriptionProps = (0, $aZ1Oy$reactariautils.useDescription)(
    sortDescription,
  );
  // Only announce after initial render, tabbing to the table will tell you the initial sort info already
  (0, $aZ1Oy$reactariautils.useUpdateEffect)(() => {
    (0, $aZ1Oy$reactarialiveannouncer.announce)(
      sortDescription,
      "assertive",
      500,
    );
  ...
  return {
    gridProps: (0, $aZ1Oy$reactariautils.mergeProps)(
      gridProps,
      descriptionProps,
      {
