...
$parcel$export(
  ...
  () => $16d645f9e2153641$export$52994e973806c219,
);
/*
...
function $16d645f9e2153641$export$52994e973806c219(props, state, ref) {
  ...
  const stringFormatter = (0, $gDW2h$reactariai18n.useLocalizedStringFormatter)(
  ...
  $gDW2h$reactariainteractions.useKeyboard)({
    onKeyDown: (e) => {
      if (editModeEnabled) {
        if (
          e.key === "Escape" ||
  ...
  let onKeyDown = (0, $gDW2h$react.useCallback)(
    (e) => {
  ...
  $gDW2h$reactariavisuallyhidden.useVisuallyHidden)();
  return {
    resizerProps: (0, $gDW2h$reactariautils.mergeProps)(
      keyboardProps,
      {
        ...moveProps,
        onKeyDown: onKeyDown,
    ...
    inputProps: (0, $gDW2h$reactariautils.mergeProps)(
      visuallyHiddenProps,
      {
        id: id,
        onBlur: () => {
