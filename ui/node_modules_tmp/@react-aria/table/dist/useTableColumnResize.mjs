...
import {
  useRef as $d9Rqy$useRef,
  useCallback as $d9Rqy$useCallback,
  useEffect as $d9Rqy$useEffect,
} from "react";
import { focusSafely as $d9Rqy$focusSafely } from "@react-aria/focus";
import {
  useId as $d9Rqy$useId,
  useEffectEvent as $d9Rqy$useEffectEvent,
  useDescription as $d9Rqy$useDescription,
  mergeProps as $d9Rqy$mergeProps,
} from "@react-aria/utils";
import {
  useKeyboard as $d9Rqy$useKeyboard,
  useMove as $d9Rqy$useMove,
  useInteractionModality as $d9Rqy$useInteractionModality,
  usePress as $d9Rqy$usePress,
} from "@react-aria/interactions";
import {
  useLocalizedStringFormatter as $d9Rqy$useLocalizedStringFormatter,
  useLocale as $d9Rqy$useLocale,
...
function $e91ef4e5004e3774$export$52994e973806c219(props, state, ref) {
  ...
  const stringFormatter = (0, $d9Rqy$useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($d9Rqy$intlStringsmodulejs)),
    "@react-aria/table",
  );
  ...
  let startResize = (0, $d9Rqy$useEffectEvent)((item) => {
    if (!isResizingRef.current) {
      lastSize.current = state.updateResizedColumns(
        item.key,
        state.getColumnWidth(item.key),
      );
      state.startResize(item.key);
      state.tableState.setKeyboardNavigationDisabled(true);
      onResizeStart === null || onResizeStart === void 0
        ? void 0
    ...
    if (isResizingRef.current) {
      ...
      if (
        (triggerRef === null || triggerRef === void 0
          ? void 0
          : triggerRef.current) &&
        !wasFocusedOnResizeStart.current
      )
  ...
  let onKeyDown = (0, $d9Rqy$useCallback)(
    (e) => {
  ...
  let { visuallyHiddenProps: visuallyHiddenProps } = (0,
  $d9Rqy$useVisuallyHidden)();
  return {
    resizerProps: (0, $d9Rqy$mergeProps)(
      keyboardProps,
      {
        ...moveProps,
        onKeyDown: onKeyDown,
