...
import {
  useId as $eV0xE$useId,
  filterDOMProps as $eV0xE$filterDOMProps,
  mergeProps as $eV0xE$mergeProps,
} from "@react-aria/utils";
import {
  useMemo as $eV0xE$useMemo,
  useCallback as $eV0xE$useCallback,
} from "react";
import {
  useCollator as $eV0xE$useCollator,
  useLocale as $eV0xE$useLocale,
...
function $83c6e2eafa584c67$export$f6b86a04e5d66d90(props, state, ref) {
  ...
  let delegate = (0, $eV0xE$useMemo)(
    () =>
      keyboardDelegate ||
      new (0, $d1c300d9c497e402$export$de9feff04fda126e)({
  ...
  let onFocus = (0, $eV0xE$useCallback)(
    (e) => {
  ...
  let gridProps = (0, $eV0xE$mergeProps)(
    domProps,
    {
      role: "grid",
      id: id,
