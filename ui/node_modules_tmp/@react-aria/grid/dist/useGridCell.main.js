...
$parcel$export(
  module.exports,
  "useGridCell",
  () => $cf2021be63b01ef4$export$c7e10bfc0c59f67c,
);
/*
...
function $cf2021be63b01ef4$export$c7e10bfc0c59f67c(props, state, ref) {
  ...
  let {
    ...
    actions: { onCellAction: onCellAction },
  } = (0, $8ee34951196858d0$exports.gridMap).get(state);
  ...
  let focus = () => {
    if (ref.current) {
      let treeWalker = (0, $9yLAi$reactariafocus.getFocusableTreeWalker)(
        ref.current,
      );
      if (focusMode === "child") {
        ...
        let focusable =
          state.selectionManager.childFocusStrategy === "last"
            ? $cf2021be63b01ef4$var$last(treeWalker)
  ...
  let { itemProps: itemProps, isPressed: isPressed } = (0,
  $9yLAi$reactariaselection.useSelectableItem)({
  ...
  let onKeyDownCapture = (e) => {
    ...
    switch (e.key) {
      case "ArrowLeft": {
        ...
        let focusable =
          direction === "rtl" ? walker.nextNode() : walker.previousNode();
        ...
        if (focusable) {
          ...
          (0, $9yLAi$reactariautils.scrollIntoViewport)(focusable, {
            containingElement: (0, $9yLAi$reactariautils.getScrollParent)(
              ref.current,
            ),
          });
        } else {
          ...
          let prev =
            (_keyboardDelegate_getKeyLeftOf = keyboardDelegate.getKeyLeftOf) ===
              null || _keyboardDelegate_getKeyLeftOf === void 0
              ? void 0
              : _keyboardDelegate_getKeyLeftOf.call(keyboardDelegate, node.key);
          if (prev !== node.key) {
            ...
            (_ref_current_parentElement = ref.current.parentElement) === null ||
            _ref_current_parentElement === void 0
              ? void 0
              : _ref_current_parentElement.dispatchEvent(
          ...
          if (focusMode === "cell" && direction === "rtl") {
            ...
            focusable =
              direction === "rtl"
                ? walker.firstChild()
                : $cf2021be63b01ef4$var$last(walker);
            if (focusable) {
              (0, $9yLAi$reactariafocus.focusSafely)(focusable);
              (0, $9yLAi$reactariautils.scrollIntoViewport)(focusable, {
                containingElement: (0, $9yLAi$reactariautils.getScrollParent)(
      ...
      case "ArrowRight": {
        let focusable =
          direction === "rtl" ? walker.previousNode() : walker.nextNode();
        if (focusMode === "child" && focusable === ref.current)
          focusable = null;
        e.preventDefault();
        e.stopPropagation();
        if (focusable) {
          ...
          let next =
            (_keyboardDelegate_getKeyRightOf =
              keyboardDelegate.getKeyRightOf) === null ||
            _keyboardDelegate_getKeyRightOf === void 0
              ? void 0
              : _keyboardDelegate_getKeyRightOf.call(
                  keyboardDelegate,
                  node.key,
                );
          if (next !== node.key) {
            ...
            (_ref_current_parentElement1 = ref.current.parentElement) ===
              null || _ref_current_parentElement1 === void 0
              ? void 0
              : _ref_current_parentElement1.dispatchEvent(
                  new KeyboardEvent(e.nativeEvent.type, e.nativeEvent),
                );
            break;
          }
      ...
      case "ArrowDown":
        ...
        if (!e.altKey && ref.current.contains(e.target)) {
          ...
          e.stopPropagation();
          e.preventDefault();
          (_ref_current_parentElement2 = ref.current.parentElement) === null ||
          _ref_current_parentElement2 === void 0
            ? void 0
            : _ref_current_parentElement2.dispatchEvent(
                new KeyboardEvent(e.nativeEvent.type, e.nativeEvent),
              );
        }
        break;
  ...
  let onFocus = (e) => {
    ...
    if (e.target !== ref.current) {
      ...
      if (!(0, $9yLAi$reactariainteractions.isFocusVisible)())
  ...
  var _node_colIndex;
  if (isVirtualized)
    gridCellProps["aria-colindex"] =
      ((_node_colIndex = node.colIndex) !== null && _node_colIndex !== void 0
        ? _node_colIndex
        : node.index) + 1; // aria-colindex is 1-based
