module.exports = {
  deselectedItem: (args) =>
    `\u{672A}\u{9078}\u{53D6}\u{300C}${args.item}\u{300D}\u{3002}`,
  ...
  selectedCount: (args, formatter) =>
    `${formatter.plural(args.count, {
      ...
      one: () =>
        `\u{5DF2}\u{9078}\u{53D6} ${formatter.number(args.count)} \u{500B}\u{9805}\u{76EE}`,
      other: () =>
        `\u{5DF2}\u{9078}\u{53D6} ${formatter.number(args.count)} \u{500B}\u{9805}\u{76EE}`,
    })}\u{3002}`,
  selectedItem: (args) =>
    `\u{5DF2}\u{9078}\u{53D6}\u{300C}${args.item}\u{300D}\u{3002}`,
};
