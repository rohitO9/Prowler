...
$682989befd4f478d$exports = {
  deselectedItem: (args) =>
    `${args.item} \u{63A}\u{64A}\u{631} \u{627}\u{644}\u{645}\u{62D}\u{62F}\u{62F}`,
  ...
  selectedCount: (args, formatter) =>
    `${formatter.plural(args.count, {
      ...
      one: () =>
        `${formatter.number(args.count)} \u{639}\u{646}\u{635}\u{631} \u{645}\u{62D}\u{62F}\u{62F}`,
      other: () =>
        `${formatter.number(args.count)} \u{639}\u{646}\u{635}\u{631} \u{645}\u{62D}\u{62F}\u{62F}`,
    })}.`,
  selectedItem: (args) =>
    `${args.item} \u{627}\u{644}\u{645}\u{62D}\u{62F}\u{62F}`,
};
