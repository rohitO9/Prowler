...
$parcel$export(
  module.exports,
  "useGrid",
  () => $11d770dfabe45077$export$f6b86a04e5d66d90,
);
/*
...
function $11d770dfabe45077$export$f6b86a04e5d66d90(props, state, ref) {
  ...
  let delegate = (0, $lBaOG$react.useMemo)(
    () =>
      keyboardDelegate ||
      new (0, $3187c0e19200cb16$exports.GridKeyboardDelegate)({
  ...
  $lBaOG$reactariaselection.useSelectableCollection)({
    ref: ref,
  ...
  let descriptionProps = (0,
  $340f2fcd0ef9ce8d$exports.useHighlightSelectionDescription)({
    selectionManager: manager,
  ...
  let onFocus = (0, $lBaOG$react.useCallback)(
    (e) => {
  ...
  let gridProps = (0, $lBaOG$reactariautils.mergeProps)(
    domProps,
    {
      role: "grid",
      id: id,
