...
$parcel$export(
  module.exports,
  "useCalendarBase",
  () => $02ef492a56b91cb2$export$d652b3ea2d672d5b,
);
/*
...
function $02ef492a56b91cb2$export$d652b3ea2d672d5b(props, state) {
  let stringFormatter = (0, $dPWPO$reactariai18n.useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($bd6dc95a3c5ee5cd$exports)),
    "@react-aria/calendar",
  );
  let domProps = (0, $dPWPO$reactariautils.filterDOMProps)(props);
  let title = (0, $df1d8e967e73ec8e$exports.useVisibleRangeDescription)(
    state.visibleRange.start,
    state.visibleRange.end,
    state.timeZone,
    false,
  );
  let visibleRangeDescription = (0,
  $df1d8e967e73ec8e$exports.useVisibleRangeDescription)(
    state.visibleRange.start,
    state.visibleRange.end,
    state.timeZone,
    true,
  ...
  (0, $dPWPO$reactariautils.useUpdateEffect)(() => {
    ...
    if (!state.isFocused)
      (0, $dPWPO$reactarialiveannouncer.announce)(visibleRangeDescription);
  }, [visibleRangeDescription]);
  // Announce when the selected value changes
  let selectedDateDescription = (0,
  $df1d8e967e73ec8e$exports.useSelectedDateDescription)(state);
  (0, $dPWPO$reactariautils.useUpdateEffect)(() => {
    if (selectedDateDescription)
      (0, $dPWPO$reactarialiveannouncer.announce)(
