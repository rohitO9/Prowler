...
import {
  startOfWeek as $NQfxu$startOfWeek,
  today as $NQfxu$today,
} from "@internationalized/date";
import { useMemo as $NQfxu$useMemo } from "react";
import {
  useLabels as $NQfxu$useLabels,
  mergeProps as $NQfxu$mergeProps,
} from "@react-aria/utils";
import {
  useLocale as $NQfxu$useLocale,
  useDateFormatter as $NQfxu$useDateFormatter,
...
function $e3031d1f8c9d64eb$export$cb95147730a423f5(props, state) {
  let {
    startDate: startDate = state.visibleRange.start,
    endDate: endDate = state.visibleRange.end,
  } = props;
  ...
  let { ariaLabel: ariaLabel, ariaLabelledBy: ariaLabelledBy } = (0,
  ...
  let weekDays = (0, $NQfxu$useMemo)(() => {
    let weekStart = (0, $NQfxu$startOfWeek)(
      (0, $NQfxu$today)(state.timeZone),
      locale,
    );
