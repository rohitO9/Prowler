...
$parcel$export(
  module.exports,
  "hookData",
  () => $df1d8e967e73ec8e$export$653eddfc964b0f8a,
);
$parcel$export(
  module.exports,
  "getEraFormat",
  () => $df1d8e967e73ec8e$export$134cbb7fb09a9522,
);
$parcel$export(
  module.exports,
  "useSelectedDateDescription",
  () => $df1d8e967e73ec8e$export$b6df97c887c38e1a,
);
$parcel$export(
  module.exports,
  "useVisibleRangeDescription",
  () => $df1d8e967e73ec8e$export$31afe65d91ef6e8,
);
/*
...
function $df1d8e967e73ec8e$export$b6df97c887c38e1a(state) {
  let stringFormatter = (0, $idq92$reactariai18n.useLocalizedStringFormatter)(
  ...
  let dateFormatter = (0, $idq92$reactariai18n.useDateFormatter)({
    ...
    day: "numeric",
    era:
      $df1d8e967e73ec8e$export$134cbb7fb09a9522(start) ||
      $df1d8e967e73ec8e$export$134cbb7fb09a9522(end),
  ...
  return (0, $idq92$react.useMemo)(() => {
    ...
    if (!anchorDate && start && end) {
      ...
      if ((0, $idq92$internationalizeddate.isSameDay)(start, end)) {
        ...
        let dateRange = $df1d8e967e73ec8e$var$formatRange(
          dateFormatter,
          stringFormatter,
          start,
          end,
...
function $df1d8e967e73ec8e$export$31afe65d91ef6e8(
  startDate,
  endDate,
  timeZone,
  isAria,
  ...
  let era =
    $df1d8e967e73ec8e$export$134cbb7fb09a9522(startDate) ||
    $df1d8e967e73ec8e$export$134cbb7fb09a9522(endDate);
  ...
  return (0, $idq92$react.useMemo)(() => {
    ...
    if (
      (0, $idq92$internationalizeddate.isSameDay)(
        startDate,
        (0, $idq92$internationalizeddate.startOfMonth)(startDate),
      )
    ) {
      if (
        (0, $idq92$internationalizeddate.isSameDay)(
          endDate,
          (0, $idq92$internationalizeddate.endOfMonth)(startDate),
        )
      )
        ...
        (0, $idq92$internationalizeddate.isSameDay)(
          endDate,
          (0, $idq92$internationalizeddate.endOfMonth)(endDate),
        )
      )
        return isAria
          ? $df1d8e967e73ec8e$var$formatRange(
              monthFormatter,
              stringFormatter,
              startDate,
              endDate,
...
function $df1d8e967e73ec8e$var$formatRange(
  dateFormatter,
  stringFormatter,
  start,
  end,
