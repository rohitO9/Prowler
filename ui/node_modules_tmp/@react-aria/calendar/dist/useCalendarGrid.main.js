...
$parcel$export(
  module.exports,
  "useCalendarGrid",
  () => $a07388a797d86b95$export$cb95147730a423f5,
);
/*
...
function $a07388a797d86b95$export$cb95147730a423f5(props, state) {
  ...
  $df1d8e967e73ec8e$exports.hookData).get(state);
  ...
  let weekDays = (0, $iASLq$react.useMemo)(() => {
    let weekStart = (0, $iASLq$internationalizeddate.startOfWeek)(
      (0, $iASLq$internationalizeddate.today)(state.timeZone),
      locale,
    );
