...
import {
  clearAnnouncer as $5rwhf$clearAnnouncer,
  announce as $5rwhf$announce,
} from "@react-aria/live-announcer";
import { useRef as $5rwhf$useRef, useEffect as $5rwhf$useEffect } from "react";
import {
  useEffectEvent as $5rwhf$useEffectEvent,
  useGlobalListeners as $5rwhf$useGlobalListeners,
...
function $d2e8511e6f209edf$export$e908e06f4b8e3402(props) {
  ...
  const stringFormatter = (0, $5rwhf$useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($5rwhf$intlStringsmodulejs)),
  ...
  let onKeyDown = (e) => {
    ...
    switch (e.key) {
      case "PageUp":
        if (onIncrementPage) {
          e.preventDefault();
          onIncrementPage === null || onIncrementPage === void 0
            ? void 0
            : onIncrementPage();
          break;
        }
      ...
      case "Up":
        if (onIncrement) {
          e.preventDefault();
          onIncrement === null || onIncrement === void 0
            ? void 0
            : onIncrement();
        }
        break;
      case "PageDown":
        if (onDecrementPage) {
          e.preventDefault();
          onDecrementPage === null || onDecrementPage === void 0
            ? void 0
            : onDecrementPage();
          break;
        }
      ...
      case "Down":
        if (onDecrement) {
          e.preventDefault();
          onDecrement === null || onDecrement === void 0
            ? void 0
            : onDecrement();
        }
        break;
      case "Home":
        if (onDecrementToMin) {
          e.preventDefault();
          onDecrementToMin === null || onDecrementToMin === void 0
            ? void 0
            : onDecrementToMin();
        }
        break;
      case "End":
        if (onIncrementToMax) {
          e.preventDefault();
          onIncrementToMax === null || onIncrementToMax === void 0
            ? void 0
            : onIncrementToMax();
        }
        break;
  ...
  const onIncrementPressStart = (0, $5rwhf$useEffectEvent)(
    (initialStepDelay) => {
      clearAsync();
  ...
  const onDecrementPressStart = (0, $5rwhf$useEffectEvent)(
    (initialStepDelay) => {
      clearAsync();
