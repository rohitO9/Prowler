...
function $f7e14e656343df57$export$16a4697467175487(target) {
  if ((0, $20aJV$reactariautils.isIOS)()) {
    if ($f7e14e656343df57$var$state === "default") {
      const documentObject = (0, $20aJV$reactariautils.getOwnerDocument)(
        target,
      );
    ...
    $f7e14e656343df57$var$modifiedElementMap.set(
      target,
  ...
  if ((0, $20aJV$reactariautils.isIOS)()) {
    ...
    if (target && $f7e14e656343df57$var$modifiedElementMap.has(target)) {
      let targetOldUserSelect =
        $f7e14e656343df57$var$modifiedElementMap.get(target);
