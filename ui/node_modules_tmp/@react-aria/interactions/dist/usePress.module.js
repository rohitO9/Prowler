import {
  disableTextSelection as $14c0b72509d70225$export$16a4697467175487,
  restoreTextSelection as $14c0b72509d70225$export$b0d6fa1ab32e3295,
} from "./textSelection.module.js";
...
import {
  mergeProps as $7mdmh$mergeProps,
  useSyncRef as $7mdmh$useSyncRef,
  useGlobalListeners as $7mdmh$useGlobalListeners,
  useEffectEvent as $7mdmh$useEffectEvent,
  getOwnerDocument as $7mdmh$getOwnerDocument,
  chain as $7mdmh$chain,
  isMac as $7mdmh$isMac,
  openLink as $7mdmh$openLink,
  isVirtualClick as $7mdmh$isVirtualClick,
  focusWithoutScrolling as $7mdmh$focusWithoutScrolling,
  isVirtualPointerEvent as $7mdmh$isVirtualPointerEvent,
  getOwnerWindow as $7mdmh$getOwnerWindow,
} from "@react-aria/utils";
import {
  useContext as $7mdmh$useContext,
  useState as $7mdmh$useState,
  useRef as $7mdmh$useRef,
  useMemo as $7mdmh$useMemo,
  useEffect as $7mdmh$useEffect,
} from "react";
...
function $f6c31cce2adf654f$var$usePressResponderContext(props) {
  ...
  let context = (0, $7mdmh$useContext)(
    (0, $ae1eeba8b9eafd08$export$5165eccb35aaadb5),
  );
  if (context) {
...
class $f6c31cce2adf654f$var$PressEvent {
  ...
  constructor(type, pointerType, originalEvent, state) {
    ...
    let currentTarget =
      (_state_target =
        state === null || state === void 0 ? void 0 : state.target) !== null &&
      _state_target !== void 0
        ? _state_target
        : originalEvent.currentTarget;
    const rect =
      currentTarget === null || currentTarget === void 0
        ? void 0
...
function $f6c31cce2adf654f$export$45712eceda6fad21(props) {
  ...
  let triggerPressStart = (0, $7mdmh$useEffectEvent)(
  ...
  let triggerPressEnd = (0, $7mdmh$useEffectEvent)(
  ...
  let triggerPressUp = (0, $7mdmh$useEffectEvent)(
    (originalEvent, pointerType) => {
      let state = ref.current;
  ...
  let pressProps = (0, $7mdmh$useMemo)(() => {
    ...
    let pressProps = {
      onKeyDown(e) {
        if (
          ...
          if (
            $f6c31cce2adf654f$var$shouldPreventDefaultKeyboard(e.target, e.key)
          )
            e.preventDefault();
          ...
          if (!state.isPressed && !e.repeat) {
            ...
            let pressUp = (e) => {
              if (
                $f6c31cce2adf654f$var$isValidKeyboardEvent(e, originalTarget) &&
                !e.repeat &&
                originalTarget.contains(e.target) &&
                state.target
              )
                triggerPressUp(
                  $f6c31cce2adf654f$var$createEvent(state.target, e),
            ...
            addGlobalListener(
              (0, $7mdmh$getOwnerDocument)(e.currentTarget),
              "keyup",
              (0, $7mdmh$chain)(pressUp, onKeyUp),
              true,
            );
          }
          ...
          if (e.metaKey && (0, $7mdmh$isMac)())
            (_state_metaKeyEvents = state.metaKeyEvents) === null ||
            _state_metaKeyEvents === void 0
              ? void 0
              : _state_metaKeyEvents.set(e.key, e.nativeEvent);
        ...
        if (
          ...
          if (
            ...
            (state.pointerType === "virtual" ||
              (0, $7mdmh$isVirtualClick)(e.nativeEvent))
          ) {
            // Ensure the element receives focus (VoiceOver on iOS does not do this)
            if (!isDisabled && !preventFocusOnPress)
              (0, $7mdmh$focusWithoutScrolling)(e.currentTarget);
    ...
    let onKeyUp = (e) => {
      ...
      if (
        state.isPressed &&
        state.target &&
        $f6c31cce2adf654f$var$isValidKeyboardEvent(e, state.target)
      ) {
        ...
        if (
          ...
          state.target.contains(target) &&
          !e[$f6c31cce2adf654f$var$LINK_CLICKED]
        ) {
        ...
        state.isPressed = false;
        (_state_metaKeyEvents1 = state.metaKeyEvents) === null ||
        _state_metaKeyEvents1 === void 0
          ? void 0
          : _state_metaKeyEvents1.delete(e.key);
      } else if (
        e.key === "Meta" &&
        ((_state_metaKeyEvents = state.metaKeyEvents) === null ||
        _state_metaKeyEvents === void 0
          ? void 0
          : _state_metaKeyEvents.size)
      ) {
        var _state_target;
        ...
        for (let event of events.values())
          (_state_target = state.target) === null || _state_target === void 0
            ? void 0
            : _state_target.dispatchEvent(new KeyboardEvent("keyup", event));
      }
    };
    if (typeof PointerEvent !== "undefined") {
      ...
      pressProps.onPointerUp = (e) => {
        ...
        if (
          e.button === 0 &&
          $f6c31cce2adf654f$var$isOverTarget(e, e.currentTarget)
        )
      ...
      let onPointerMove = (e) => {
        ...
        if (
          state.target &&
          $f6c31cce2adf654f$var$isOverTarget(e, state.target)
        ) {
          if (!state.isOverTarget && state.pointerType != null) {
            state.isOverTarget = true;
            triggerPressStart(
      ...
      pressProps.onTouchStart = (e) => {
        ...
        let shouldStopPropagation = triggerPressStart(
          $f6c31cce2adf654f$var$createTouchEvent(state.target, e),
          state.pointerType,
        );
        if (shouldStopPropagation) e.stopPropagation();
        addGlobalListener(
          (0, $7mdmh$getOwnerWindow)(e.currentTarget),
          "scroll",
          onScroll,
          true,
        );
      ...
      pressProps.onTouchMove = (e) => {
        ...
        let touch = $f6c31cce2adf654f$var$getTouchById(
          e.nativeEvent,
        ...
        if (
          touch &&
          $f6c31cce2adf654f$var$isOverTarget(touch, e.currentTarget)
        ) {
          if (!state.isOverTarget && state.pointerType != null) {
            state.isOverTarget = true;
    ...
    return () => {
      ...
      if (!allowTextSelectionOnPress)
        ...
        (0, $14c0b72509d70225$export$b0d6fa1ab32e3295)(
          (_ref_current_target = ref.current.target) !== null &&
            _ref_current_target !== void 0
            ? _ref_current_target
            : undefined,
        );
    };
...
function $f6c31cce2adf654f$var$isValidKeyboardEvent(event, currentTarget) {
  ...
  return (
    ...
    !(
      (element instanceof
        (0, $7mdmh$getOwnerWindow)(element).HTMLInputElement &&
        !$f6c31cce2adf654f$var$isValidInputKey(element, key)) ||
      element instanceof
        (0, $7mdmh$getOwnerWindow)(element).HTMLTextAreaElement ||
      element.isContentEditable
    ) && // Links should only trigger with Enter key
    !(
      (role === "link" ||
        (!role && $f6c31cce2adf654f$var$isHTMLAnchorLink(element))) &&
      key !== "Enter"
    )
  );
}
