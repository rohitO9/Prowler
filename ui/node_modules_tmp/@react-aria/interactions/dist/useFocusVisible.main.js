...
$parcel$export(
  module.exports,
  "isFocusVisible",
  () => $e77252a287ef94ab$export$b9b3dfddab17db27,
);
$parcel$export(
  module.exports,
  "getInteractionModality",
  () => $e77252a287ef94ab$export$630ff653c5ada6a9,
);
$parcel$export(
  module.exports,
  "setInteractionModality",
  () => $e77252a287ef94ab$export$8397ddfc504fdb9a,
);
$parcel$export(
  module.exports,
  "useInteractionModality",
  () => $e77252a287ef94ab$export$98e20ec92f614cfe,
);
$parcel$export(
  module.exports,
  "useFocusVisible",
  () => $e77252a287ef94ab$export$ffd9e5021c1fb2d6,
);
$parcel$export(
  module.exports,
 ...
 */ function $e77252a287ef94ab$var$isValidKey(e) {
  ...
  return !(
    e.metaKey ||
    (!(0, $cR3F8$reactariautils.isMac)() && e.altKey) ||
    e.ctrlKey ||
    e.key === "Control" ||
    e.key === "Shift" ||
    e.key === "Meta"
...
function $e77252a287ef94ab$var$handleFocusEvent(e) {
  ...
  if (
    !$e77252a287ef94ab$var$hasEventBeforeFocus &&
    !$e77252a287ef94ab$var$hasBlurredWindowRecently
  ) {
    $e77252a287ef94ab$var$currentModality = "virtual";
 ...
 */ function $e77252a287ef94ab$var$setupGlobalFocusEvents(element) {
  if (
    ...
    $e77252a287ef94ab$export$d90243b58daecda7.get(
      (0, $cR3F8$reactariautils.getOwnerWindow)(element),
    )
  )
    return;
  ...
  documentObject.addEventListener(
    "keydown",
    $e77252a287ef94ab$var$handleKeyboardEvent,
    true,
  );
  documentObject.addEventListener(
    "keyup",
  ...
  documentObject.addEventListener(
    "click",
    $e77252a287ef94ab$var$handleClickEvent,
    true,
  );
  ...
  windowObject.addEventListener(
    "focus",
    $e77252a287ef94ab$var$handleFocusEvent,
    true,
  );
  windowObject.addEventListener(
    "blur",
    $e77252a287ef94ab$var$handleWindowBlur,
    false,
  );
  if (typeof PointerEvent !== "undefined") {
    documentObject.addEventListener(
      "pointerdown",
      $e77252a287ef94ab$var$handlePointerEvent,
      true,
    );
    documentObject.addEventListener(
      "pointermove",
...
const $e77252a287ef94ab$var$tearDownWindowFocusTracking = (
  element,
  loadListener,
) => {
  const windowObject = (0, $cR3F8$reactariautils.getOwnerWindow)(element);
  ...
  windowObject.HTMLElement.prototype.focus =
    $e77252a287ef94ab$export$d90243b58daecda7.get(windowObject).focus;
...
function $e77252a287ef94ab$export$2f1888112f558a7d(element) {
  ...
  return () =>
    $e77252a287ef94ab$var$tearDownWindowFocusTracking(element, loadListener);
}
...
function $e77252a287ef94ab$export$98e20ec92f614cfe() {
  ...
  let [modality, setModality] = (0, $cR3F8$react.useState)(
 ...
 */ function $e77252a287ef94ab$var$isKeyboardFocusEvent(
  isTextInput,
  modality,
  e,
) {
  ...
  const IHTMLInputElement =
    typeof window !== "undefined"
      ? (0, $cR3F8$reactariautils.getOwnerWindow)(
  ...
  isTextInput =
    ...
    ((e === null || e === void 0 ? void 0 : e.target) instanceof
      IHTMLInputElement &&
      !$e77252a287ef94ab$var$nonTextInputTypes.has(
        e === null || e === void 0
          ? void 0
  ...
  return !(
    ...
    !$e77252a287ef94ab$var$FOCUS_VISIBLE_INPUT_KEYS[e.key]
  );
}
function $e77252a287ef94ab$export$ffd9e5021c1fb2d6(props = {}) {
  let { isTextInput: isTextInput, autoFocus: autoFocus } = props;
  let [isFocusVisibleState, setFocusVisible] = (0, $cR3F8$react.useState)(
    autoFocus || $e77252a287ef94ab$export$b9b3dfddab17db27(),
  );
  $e77252a287ef94ab$export$ec71b4b83ac08ec3(
    (isFocusVisible) => {
...
function $e77252a287ef94ab$export$ec71b4b83ac08ec3(fn, deps, opts) {
  ...
  (0, $cR3F8$react.useEffect)(() => {
    let handler = (modality, e) => {
      if (
        !$e77252a287ef94ab$var$isKeyboardFocusEvent(
