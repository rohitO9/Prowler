...
$parcel$export(
  module.exports,
  "useFocus",
  () => $5cb73d0ce355b0dc$export$f8168d8dd8fd66e6,
);
/*
...
function $5cb73d0ce355b0dc$export$f8168d8dd8fd66e6(props) {
  ...
  const onBlur = (0, $hrHul$react.useCallback)(
    (e) => {
  ...
  const onSyntheticFocus = (0, $625cf83917e112ad$exports.useSyntheticBlurEvent)(
    onBlur,
  );
  const onFocus = (0, $hrHul$react.useCallback)(
    (e) => {
      // Double check that document.activeElement actually matches e.target in case a previously chained
      // focus handler already moved focus somewhere else.
      const ownerDocument = (0, $hrHul$reactariautils.getOwnerDocument)(
        e.target,
      );
      if (
