...
$parcel$export(
  module.exports,
  "Pressable",
  () => $e1dbec26039c051d$export$27c701ed9e449e99,
);
/*
...
const $e1dbec26039c051d$export$27c701ed9e449e99 = /*#__PURE__*/ (0,
$parcel$interopDefault($ev4bP$react)).forwardRef(
  ({ children: children, ...props }, ref) => {
    ...
    let child = (0, $parcel$interopDefault($ev4bP$react)).Children.only(
      children,
    );
    return /*#__PURE__*/ (0, $parcel$interopDefault($ev4bP$react)).cloneElement(
      child, // @ts-ignore
      {
        ref: ref,
