...
function getDelta(
  ...
  let boundaryEndEdge =
    boundarySize + boundaryDimensions.scroll[AXIS[axis]] - padding;
  let startEdgeOffset =
    offset -
    containerScroll +
...
function computePosition(
  ...
  if (placement === axis) {
    ...
    const containerHeight = isContainerPositioned
      ...
      : boundaryDimensions[TOTAL_SIZE[size]];
...
function getMaxHeight(
  ...
  const containerHeight = isContainerPositioned
    ...
    : boundaryDimensions[TOTAL_SIZE.height];
...
function getOffset(node: Element): Offset {
  ...
  let { scrollTop, scrollLeft, clientTop, clientLeft } =
    document.documentElement;
  return {
