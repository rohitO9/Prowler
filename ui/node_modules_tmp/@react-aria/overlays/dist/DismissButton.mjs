...
function $86ea4cb521eb2e37$export$2317d149ed6f78c4(props) {
  ...
  let stringFormatter = (0, $iYaQO$useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($iYaQO$intlStringsmodulejs)),
    "@react-aria/overlays",
  );
  let labels = (0, $iYaQO$useLabels)(
    otherProps,
  ...
  return /*#__PURE__*/ (0, $iYaQO$react).createElement(
    (0, $iYaQO$VisuallyHidden),
    null,
    /*#__PURE__*/ (0, $iYaQO$react).createElement("button", {
      ...labels,
      tabIndex: -1,
      onClick: onClick,
      style: {
