...
$parcel$export(
  module.exports,
  "ModalProvider",
  () => $0775ea8ea6a0565e$export$178405afcd8c5eb,
);
$parcel$export(
  module.exports,
  "useModalProvider",
  () => $0775ea8ea6a0565e$export$d9aaed4c3ece1bc0,
);
$parcel$export(
  module.exports,
  "OverlayProvider",
  () => $0775ea8ea6a0565e$export$bf688221f59024e5,
);
$parcel$export(
  module.exports,
  "OverlayContainer",
  () => $0775ea8ea6a0565e$export$b47c3594eab58386,
);
$parcel$export(
  module.exports,
  "useModal",
  () => $0775ea8ea6a0565e$export$33ffd74ebf07f060,
);
/*
...
const $0775ea8ea6a0565e$var$Context = /*#__PURE__*/ (0,
$parcel$interopDefault($btuAB$react)).createContext(null);
function $0775ea8ea6a0565e$export$178405afcd8c5eb(props) {
  ...
  return /*#__PURE__*/ (0, $parcel$interopDefault($btuAB$react)).createElement(
    $0775ea8ea6a0565e$var$Context.Provider,
    {
      value: context,
    },
    children,
...
function $0775ea8ea6a0565e$export$bf688221f59024e5(props) {
  return /*#__PURE__*/ (0, $parcel$interopDefault($btuAB$react)).createElement(
    $0775ea8ea6a0565e$export$178405afcd8c5eb,
    null,
    /*#__PURE__*/ (0, $parcel$interopDefault($btuAB$react)).createElement(
      $0775ea8ea6a0565e$var$OverlayContainerDOM,
      props,
    ),
  );
}
function $0775ea8ea6a0565e$export$b47c3594eab58386(props) {
  ...
  let {
    portalContainer: portalContainer = isSSR ? null : document.body,
    ...rest
  } = props;
  (0, $parcel$interopDefault($btuAB$react)).useEffect(() => {
    if (
      portalContainer === null || portalContainer === void 0
        ? void 0
        : portalContainer.closest("[data-overlay-container]")
    )
      throw new Error(
  ...
  let contents = /*#__PURE__*/ (0,
  $parcel$interopDefault($btuAB$react)).createElement(
    $0775ea8ea6a0565e$export$bf688221f59024e5,
    rest,
  );
  return /*#__PURE__*/ (0,
  $parcel$interopDefault($btuAB$reactdom)).createPortal(
    contents,
    portalContainer,
  );
}
function $0775ea8ea6a0565e$export$33ffd74ebf07f060(options) {
  ...
  return {
    modalProps: {
      "data-ismodal": !(options === null || options === void 0
        ? void 0
        : options.isDisabled),
    },
  };
