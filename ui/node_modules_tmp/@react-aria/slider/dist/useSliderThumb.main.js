...
$parcel$export(
  module.exports,
  "useSliderThumb",
  () => $5eb806b626475377$export$8d15029008292ae,
);
...
function $5eb806b626475377$export$8d15029008292ae(opts, state) {
  ...
  } = (0, $cqSUd$reactariautils.useGlobalListeners)();
  ...
  const focusInput = (0, $cqSUd$react.useCallback)(() => {
    if (inputRef.current)
      (0, $cqSUd$reactariautils.focusWithoutScrolling)(inputRef.current);
  }, [inputRef]);
  ...
  let { keyboardProps: keyboardProps } = (0,
  $cqSUd$reactariainteractions.useKeyboard)({
    onKeyDown(e) {
      let {
  ...
  const { focusableProps: focusableProps } = (0,
  $cqSUd$reactariafocus.useFocusable)(
    (0, $cqSUd$reactariautils.mergeProps)(opts, {
  ...
  let interactions = !isDisabled
    ? (0, $cqSUd$reactariautils.mergeProps)(keyboardProps, moveProps, {
        onMouseDown: (e) => {
  ...
  return {
    inputProps: (0, $cqSUd$reactariautils.mergeProps)(
      focusableProps,
      fieldProps,
      {
        type: "range",
