...
$parcel$export(
  module.exports,
  "useTab",
  () => $4eeea1c984cc0628$export$fdf4756d5b8ef90a,
);
/*
...
function $4eeea1c984cc0628$export$fdf4756d5b8ef90a(props, state, ref) {
  ...
  $dX61C$reactariaselection.useSelectableItem)({
  ...
  let tabPanelId = (0, $a217ebca77471970$exports.generateId)(
    state,
    key,
    "tabpanel",
  );
  ...
  let domProps = (0, $dX61C$reactariautils.filterDOMProps)(
  ...
  delete domProps.id;
  let linkProps = (0, $dX61C$reactariautils.useLinkProps)(
    item === null || item === void 0 ? void 0 : item.props,
  );
  return {
    tabProps: (0, $dX61C$reactariautils.mergeProps)(
      domProps,
      linkProps,
      itemProps,
      {
