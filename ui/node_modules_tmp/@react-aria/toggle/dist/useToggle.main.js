...
$parcel$export(
  module.exports,
  "useToggle",
  () => $ee1b638d33c90dcc$export$cbe85ee05b554577,
);
/*
...
function $ee1b638d33c90dcc$export$cbe85ee05b554577(props, state, ref) {
  ...
  $2jyrz$reactariainteractions.usePress)({
  ...
  $2jyrz$reactariafocus.useFocusable)(props, ref);
  let interactions = (0, $2jyrz$reactariautils.mergeProps)(
    pressProps,
    focusableProps,
  );
  ...
  (0, $2jyrz$reactariautils.useFormReset)(
    ref,
    state.isSelected,
    state.setSelected,
  );
