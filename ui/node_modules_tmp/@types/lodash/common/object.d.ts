...
declare module "../index" {
  ...
  interface Object<T> {
    ...
    get<TPath extends string>(
      path: TPath,
    ): string extends TPath ? any : GetFieldType<T, TPath>;
    /**
     * @see _.get
     */
  ...
  interface Object<T> {
    ...
    pickBy<S extends T[keyof T]>(
      ...
      NumericDictionary<unknown> extends T
        ? NumericDictionary<S>
        : Dictionary<S>
    >;
    /**
  ...
  interface LoDashImplicitWrapper<TValue> {
    ...
    toPairs(): Collection<
      [
        string,
        TValue extends Dictionary<infer U>
          ? U
          : TValue extends NumericDictionary<infer V>
            ? V
            : any,
      ]
    >;
