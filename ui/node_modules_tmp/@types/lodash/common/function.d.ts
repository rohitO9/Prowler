...
declare module "../index" {
  ...
  interface Function<T extends (...args: any) => any> {
    ...
    debounce(
      ...
      ? Function<DebouncedFuncLeading<T>>
      : never;
    debounce(
      wait?: number,
      options?: DebounceSettings,
  ...
  interface FunctionChain<T extends (...args: any) => any> {
    ...
    debounce(
      ...
      ? FunctionChain<DebouncedFuncLeading<T>>
      : never;
    debounce(
      wait?: number,
      options?: DebounceSettings,
    ): T extends (...args: any[]) => any
      ? FunctionChain<DebouncedFunc<T>>
      : never;
  }
  interface LoDashStatic {
    /**
  ...
  interface Function<T extends (...args: any) => any> {
    ...
    partial<T1, T2, T4>(
      ...
      T extends Function4<T1, T2, infer T3, T4, infer R>
        ? Function1<T3, R>
        : any
    >;
    /**
    ...
    partial<T1, T3, T4>(
      ...
      T extends Function4<T1, infer T2, T3, T4, infer R>
        ? Function1<T2, R>
        : any
    >;
    /**
    ...
    partial<T2, T3, T4>(
      ...
      T extends Function4<infer T1, T2, T3, T4, infer R>
        ? Function1<T1, R>
        : any
    >;
    /**
    ...
    partial<T1, T2>(
      ...
      T extends (t1: T1, t2: T2, ...ts: infer TS) => infer R
        ? (...ts: TS) => R
        : any
    >;
    /**
    ...
    partial<T1>(
      ...
      T extends (t1: T1, ...ts: infer TS) => infer R ? (...ts: TS) => R : any
    >;
    /**
     * @see _.partial
     */
  ...
  interface Function<T extends (...args: any) => any> {
    ...
    partialRight<T1>(
      ...
      T extends Function2<T1, infer T2, infer R> ? Function1<T2, R> : any
    >;
    /**
     * @see _.partialRight
     */
    ...
    partialRight<T1>(
      ...
      T extends Function3<T1, infer T2, infer T3, infer R>
        ? Function2<T2, T3, R>
        : any
    >;
    /**
    ...
    partialRight<T1, T2>(
      ...
      T extends Function3<T1, T2, infer T3, infer R> ? Function1<T3, R> : any
    >;
    /**
     * @see _.partialRight
     */
    ...
    partialRight<T1, T3>(
      ...
      T extends Function3<T1, infer T2, T3, infer R> ? Function1<T2, R> : any
    >;
    /**
     * @see _.partialRight
     */
    partialRight<T2, T3>(
      ...
      T extends Function3<infer T1, T2, T3, infer R> ? Function1<T1, R> : any
    >;
    /**
     * @see _.partialRight
     */
    ...
    partialRight<T1, T2, T3>(
      ...
      T extends Function4<T1, T2, T3, infer T4, infer R>
        ? Function1<T4, R>
        : any
    >;
    /**
    ...
    partialRight<TS extends any[]>(
      ...ts: TS
    ): Function<T extends (...args: TS) => infer R ? () => R : any>;
    /**
     * @see _.partialRight
     */
