...
export function fcumsum(
  values: Iterable<Numeric | undefined | null>,
): Float64Array;
/**
 * Returns a full precision cumulative sum of the given values.
 * Although slower, d3.fcumsum can replace d3.cumsum when greater precision is needed. Uses d3.Adder.
 ...
 */
export function permute<T, K extends keyof T>(
  source: T,
  keys: Iterable<K>,
): Array<T[K]>;
...
export interface Bin<Datum, Value extends number | Date | undefined>
  extends Array<Datum> {
  x0: Value | undefined;
  x1: Value | undefined;
}
...
export interface HistogramGeneratorDate<Datum, Value extends Date | undefined>
  ...
  domain(
    domain: [Date, Date] | ((values: ArrayLike<Value>) => [Date, Date]),
  ): this;
   ...
   */
  thresholds(
    thresholds: ArrayLike<Value> | ThresholdDateArrayGenerator<Value>,
  ): this;
}
...
> extends HistogramCommon<Datum, Value> {
  ...
  // tslint:disable-next-line:unified-signatures
  thresholds(
    thresholds: ArrayLike<Value> | ThresholdNumberArrayGenerator<Value>,
  ): this;
}
...
export function histogram<
  Datum,
  Value extends number | undefined,
>(): HistogramGeneratorNumber<Datum, Value>;
...
export function histogram<
  Datum,
  Value extends Date | undefined,
>(): HistogramGeneratorDate<Datum, Value>;
