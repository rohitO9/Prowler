...
function wrapWordsToLines(text, maxLineLength, indentOrLinePrefix) {
  ...
  for (const line of lines) {
    if (line.length + linePrefixLength <= maxLineLength) {
      ...
      const lineAdditionalPrefix =
        ((_a = line.match(/^\s*/)) === null || _a === void 0
          ? void 0
          : _a[0]) || "";
      ...
      while ((currentWhitespaceMatch = whitespaceRegexp.exec(line)) !== null) {
        if (
          ...
          previousBreakRanOver =
            whitespaceToSplitAt.index - currentLineStartIndex > maxLineLength;
          currentLineStartIndex =
            whitespaceToSplitAt.index + whitespaceToSplitAt[0].length;
        } else {
      ...
      if (currentLineStartIndex < line.length) {
        wrappedLines.push(
          linePrefix +
            lineAdditionalPrefix +
            line.substring(currentLineStartIndex),
        );
      }
    }
  }
