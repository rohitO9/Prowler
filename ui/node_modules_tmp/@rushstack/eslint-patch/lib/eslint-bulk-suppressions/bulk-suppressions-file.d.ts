...
export declare function getSuppressionsConfigForEslintrcFolderPath(
  eslintrcFolderPath: string,
): IBulkSuppressionsConfig;
export declare function getAllBulkSuppressionsConfigsByEslintrcFolderPath(): [
  string,
  IBulkSuppressionsConfig,
][];
export declare function writeSuppressionsJsonToFile(
  eslintrcFolderPath: string,
  suppressionsConfig: IBulkSuppressionsConfig,
): void;
export declare function deleteBulkSuppressionsFileInEslintrcFolder(
  eslintrcFolderPath: string,
): void;
export declare function serializeSuppression({
  file,
  scopeId,
  rule,
}: ISuppression): string;
