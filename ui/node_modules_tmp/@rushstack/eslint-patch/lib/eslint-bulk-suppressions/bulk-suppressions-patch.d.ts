...
export declare function requireFromPathToLinterJS(
  importPath: string,
): import("eslint").Linter;
export declare function patchClass<T, U extends T>(
  originalClass: new () => T,
  patchedClass: new () => U,
): void;
/**
 ...
 */
export declare function extendVerifyFunction(
