...
const eslintBulkDetectEnvVarValue =
  process.env[constants_1.ESLINT_BULK_DETECT_ENV_VAR_NAME];
if (
  eslintBulkDetectEnvVarValue === "true" ||
  eslintBulkDetectEnvVarValue === "1"
) {
  (0, path_utils_1.findAndConsoleLogPatchPathCli)();
  process.exit(0);
}
const pathToLinterJS = (0, path_utils_1.getPathToLinterJS)();
process.env[constants_1.ESLINT_BULK_PATCH_PATH_ENV_VAR_NAME] = require.resolve(
  "./bulk-suppressions-patch",
);
const pathToGeneratedPatch = (0, path_utils_1.ensurePathToGeneratedPatch)();
(0, generate_patched_file_1.generatePatchedLinterJsFileIfDoesNotExist)(
  pathToLinterJS,
  pathToGeneratedPatch,
);
const { Linter: LinterPatch } = require(pathToGeneratedPatch);
LinterPatch.prototype.verify = (0,
bulk_suppressions_patch_1.extendVerifyFunction)(LinterPatch.prototype.verify);
