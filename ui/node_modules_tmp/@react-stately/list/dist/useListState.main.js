...
$parcel$export(
  module.exports,
  "useListState",
  () => $5450691d3629f6ea$export$2f645645f7bca764,
);
/*
...
function $5450691d3629f6ea$export$2f645645f7bca764(props) {
  ...
  $5RsKl$reactstatelyselection.useMultipleSelectionState)(props);
  let disabledKeys = (0, $5RsKl$react.useMemo)(
    () => (props.disabledKeys ? new Set(props.disabledKeys) : new Set()),
    [props.disabledKeys],
  );
  let factory = (0, $5RsKl$react.useCallback)(
    (nodes) =>
      filter
        ? new (0, $c9aa5a224613c979$exports.ListCollection)(filter(nodes))
        : new (0, $c9aa5a224613c979$exports.ListCollection)(nodes),
    [filter],
  );
  ...
  let collection = (0, $5RsKl$reactstatelycollections.useCollection)(
    props,
    factory,
    context,
  );
  let selectionManager = (0, $5RsKl$react.useMemo)(
    () =>
      new (0, $5RsKl$reactstatelyselection.SelectionManager)(
        collection,
        selectionState,
      ),
