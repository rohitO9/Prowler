...
import {
  useMultipleSelectionState as $d5vlZ$useMultipleSelectionState,
  SelectionManager as $d5vlZ$SelectionManager,
} from "@react-stately/selection";
import {
  useMemo as $d5vlZ$useMemo,
  useCallback as $d5vlZ$useCallback,
  useRef as $d5vlZ$useRef,
  useEffect as $d5vlZ$useEffect,
} from "react";
...
function $e72dd72e1c76a225$export$2f645645f7bca764(props) {
  ...
  let disabledKeys = (0, $d5vlZ$useMemo)(
    () => (props.disabledKeys ? new Set(props.disabledKeys) : new Set()),
    [props.disabledKeys],
  );
  let factory = (0, $d5vlZ$useCallback)(
    (nodes) =>
      filter
        ? new (0, $a02d57049d202695$export$d085fb9e920b5ca7)(filter(nodes))
        : new (0, $a02d57049d202695$export$d085fb9e920b5ca7)(nodes),
    [filter],
  );
  ...
  let selectionManager = (0, $d5vlZ$useMemo)(
    () => new (0, $d5vlZ$SelectionManager)(collection, selectionState),
