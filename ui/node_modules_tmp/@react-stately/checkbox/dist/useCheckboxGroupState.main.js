...
$parcel$export(
  ...
  () => $943f4c622056df75$export$daff6da51032a415,
);
/*
...
function $943f4c622056df75$export$daff6da51032a415(props = {}) {
  let [selectedValues, setValue] = (0,
  $6SsBH$reactstatelyutils.useControlledState)(
    props.value,
    props.defaultValue || [],
    props.onChange,
  );
  ...
  const state = {
    ...
    setInvalid(value, v) {
      ...
      validation.updateValidation(
        (0, $6SsBH$reactstatelyform.mergeValidation)(...s.values()),
      );
    },
    validationState:
      (_props_validationState = props.validationState) !== null &&
      _props_validationState !== void 0
        ? _props_validationState
        : isInvalid
          ? "invalid"
          : null,
    isInvalid: isInvalid,
