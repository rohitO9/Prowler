...
import {
  useSingleSelectListState as $49BJP$useSingleSelectListState,
  ListCollection as $49BJP$ListCollection,
} from "@react-stately/list";
import {
  useState as $49BJP$useState,
  useMemo as $49BJP$useMemo,
  useRef as $49BJP$useRef,
  useCallback as $49BJP$useCallback,
  useEffect as $49BJP$useEffect,
} from "react";
...
function $a9e7382a7d111cb5$export$b453a3bfd4a5fa9e(props) {
  ...
  let [inputValue, setInputValue] = (0, $49BJP$useControlledState)(
    props.inputValue,
    (_ref =
  ...
  let filteredCollection = (0, $49BJP$useMemo)(
    () =>
      ...
      props.items != null || !defaultFilter
        ? collection
        : $a9e7382a7d111cb5$var$filterCollection(
            collection,
            inputValue,
            defaultFilter,
          ),
  ...
  let [lastCollection, setLastCollection] = (0, $49BJP$useState)(
    filteredCollection,
  );
  ...
  let toggleMenu = (0, $49BJP$useCallback)(
    (focusStrategy = null) => {
  ...
  let resetInputValue = () => {
    ...
    let itemText =
      (_collection_getItem_textValue =
        ...
        _collection_getItem === void 0
          ? void 0
          : _collection_getItem.textValue) !== null &&
      _collection_getItem_textValue !== void 0
        ? _collection_getItem_textValue
        : "";
  ...
  let lastSelectedKey = (0, $49BJP$useRef)(
    (_ref1 =
      (_props_selectedKey = props.selectedKey) !== null &&
      _props_selectedKey !== void 0
        ? _props_selectedKey
  ...
  let lastSelectedKeyText = (0, $49BJP$useRef)(
    (_collection_getItem_textValue =
      ...
      _collection_getItem1 === void 0
        ? void 0
        : _collection_getItem1.textValue) !== null &&
      _collection_getItem_textValue !== void 0
      ? _collection_getItem_textValue
      : "",
  );
...
function $a9e7382a7d111cb5$var$filterCollection(
  collection,
  inputValue,
  filter,
) {
  return new (0, $49BJP$ListCollection)(
    $a9e7382a7d111cb5$var$filterNodes(
      collection,
      collection,
      inputValue,
      filter,
...
function $a9e7382a7d111cb5$var$filterNodes(
  collection,
  nodes,
  inputValue,
  filter,
  ...
  for (let node of nodes) {
    if (node.type === "section" && node.hasChildNodes) {
      let filtered = $a9e7382a7d111cb5$var$filterNodes(
        collection,
        (0, $49BJP$getChildNodes)(node, collection),
        inputValue,
        filter,
      );
