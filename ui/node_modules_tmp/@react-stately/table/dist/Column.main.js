...
$parcel$export(
  module.exports,
  "Column",
  () => $714483d9f6ca4c55$export$816b5d811295e6bc,
);
/*
...
$714483d9f6ca4c55$var$Column.getCollectionNode = function* getCollectionNode(
  props,
  context,
) {
  ...
  let fullNodes = yield {
    ...
    hasChildNodes:
      !!childColumns ||
      (title &&
        (0, $parcel$interopDefault($kykIu$react)).Children.count(children) > 0),
    rendered: rendered,
    textValue: textValue,
    props: props,
    *childNodes() {
      if (childColumns)
        ...
        let childColumns = [];
        (0, $parcel$interopDefault($kykIu$react)).Children.forEach(
          children,
          (child) => {
            childColumns.push({
              type: "column",
