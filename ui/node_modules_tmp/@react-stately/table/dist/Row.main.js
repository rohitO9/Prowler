...
$parcel$export(
  module.exports,
  "Row",
  () => $9ec6912e32cc0d81$export$b59bdbef9ce70de2,
);
/*
...
$9ec6912e32cc0d81$var$Row.getCollectionNode = function* getCollectionNode(
  props,
  context,
) {
  let {
    ...
    *childNodes() {
      ...
      if (typeof children === "function") {
        ...
        if (UNSTABLE_childItems)
          ...
          for (let child of UNSTABLE_childItems) // Note: in order to reuse the render function of TableBody for our child rows, we just need to yield a type and a value here. CollectionBuilder will then look up
            yield {
              type: "item",
              value: child,
            };
        ...
        let cells = [];
        let childRows = [];
        (0, $parcel$interopDefault($7Z9ig$react)).Children.forEach(
          children,
          (node) => {
