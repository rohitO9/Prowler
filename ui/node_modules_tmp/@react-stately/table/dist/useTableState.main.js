...
$parcel$export(
  module.exports,
  "useTableState",
  () => $e3f7784147dde23d$export$907bcc6c48325fd6,
);
/*
...
function $e3f7784147dde23d$export$907bcc6c48325fd6(props) {
  let [isKeyboardNavigationDisabled, setKeyboardNavigationDisabled] = (0,
  $hkaUn$react.useState)(false);
  let {
  ...
  let collection = (0, $hkaUn$reactstatelycollections.useCollection)(
    props,
    (0, $hkaUn$react.useCallback)(
      (nodes) =>
        new (0, $7f5a58334d8866a5$exports.TableCollection)(
          nodes,
          null,
          context,
        ),
  ...
  let { disabledKeys: disabledKeys, selectionManager: selectionManager } = (0,
  $hkaUn$reactstatelygrid.useGridState)({
    ...props,
  ...
  return {
    ...
    sort(columnKey, direction) {
      ...
      props.onSortChange({
        column: columnKey,
        direction:
          direction !== null && direction !== void 0
            ? direction
            : ((_props_sortDescriptor = props.sortDescriptor) === null ||
                _props_sortDescriptor === void 0
                  ? void 0
                  : _props_sortDescriptor.column) === columnKey
              ? $e3f7784147dde23d$var$OPPOSITE_SORT_DIRECTION[
