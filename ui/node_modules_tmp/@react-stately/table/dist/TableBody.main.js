...
$parcel$export(
  module.exports,
  "TableBody",
  () => $6ec527db6a3a5692$export$76ccd210b9029917,
);
/*
...
$6ec527db6a3a5692$var$TableBody.getCollectionNode = function* getCollectionNode(
  props,
) {
  ...
  yield {
    ...
    *childNodes() {
      if (typeof children === "function") {
        ...
        let items = [];
        (0, $parcel$interopDefault($ablJS$react)).Children.forEach(
          children,
          (item) => {
            items.push({
              type: "item",
