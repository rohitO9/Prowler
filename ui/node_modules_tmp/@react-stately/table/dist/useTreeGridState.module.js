...
function $ee65a0057fd99531$export$34dfa8a1622185a4(props) {
  ...
  if (!(0, $2Mvwf$tableNestedRows)())
    throw new Error(
      "Feature flag for table nested rows must be enabled to use useTreeGridState.",
    );
  let [expandedKeys, setExpandedKeys] = (0, $2Mvwf$useControlledState)(
    propExpandedKeys
      ? $ee65a0057fd99531$var$convertExpanded(propExpandedKeys)
      : undefined,
    propDefaultExpandedKeys
      ? $ee65a0057fd99531$var$convertExpanded(propDefaultExpandedKeys)
      : new Set(),
  ...
  let builder = (0, $2Mvwf$useMemo)(
    () => new (0, $2Mvwf$CollectionBuilder)(),
    [],
  );
  let nodes = (0, $2Mvwf$useMemo)(
    () =>
      builder.build(
        {
          children: children,
  ...
  let onToggle = (key) => {
    setExpandedKeys(
      $ee65a0057fd99531$var$toggleKey(expandedKeys, key, treeGridCollection),
    );
  };
  let collection = (0, $2Mvwf$useMemo)(() => {
    return new (0, $788781baa30117fa$export$596e1b2e2cf93690)(
