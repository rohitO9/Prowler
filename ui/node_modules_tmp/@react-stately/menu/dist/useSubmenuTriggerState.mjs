import {
  useState as $7exkJ$useState,
  useMemo as $7exkJ$useMemo,
  useCallback as $7exkJ$useCallback,
} from "react";
...
function $e5614764aa47eb35$export$cfc51cf86138bf98(props, state) {
  ...
  let [submenuLevel] = (0, $7exkJ$useState)(
    expandedKeysStack === null || expandedKeysStack === void 0
      ? void 0
      : expandedKeysStack.length,
  );
  let isOpen = (0, $7exkJ$useMemo)(
  ...
  let toggle = (0, $7exkJ$useCallback)(
    (focusStrategy = null) => {
      setFocusStrategy(focusStrategy);
      if (isOpen) close();
