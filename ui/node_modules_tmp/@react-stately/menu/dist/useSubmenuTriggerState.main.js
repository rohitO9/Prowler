...
$parcel$export(
  ...
  () => $38ab7fb105c54ad2$export$cfc51cf86138bf98,
);
/*
...
function $38ab7fb105c54ad2$export$cfc51cf86138bf98(props, state) {
  ...
  let [submenuLevel] = (0, $9cbje$react.useState)(
    expandedKeysStack === null || expandedKeysStack === void 0
      ? void 0
      : expandedKeysStack.length,
  );
  let isOpen = (0, $9cbje$react.useMemo)(
  ...
  let open = (0, $9cbje$react.useCallback)(
    (focusStrategy = null) => {
  ...
  let toggle = (0, $9cbje$react.useCallback)(
    (focusStrategy = null) => {
      setFocusStrategy(focusStrategy);
      if (isOpen) close();
