...
import {
  useState as $3Fik3$useState,
  useMemo as $3Fik3$useMemo,
  useEffect as $3Fik3$useEffect,
  useCallback as $3Fik3$useCallback,
} from "react";
...
function $fc0b13b484ac1194$export$1505db82fe357e65(opts) {
  ...
  let [contentSize, setContentSize] = (0, $3Fik3$useState)(
    new (0, $ee1bfa90a957fb8a$export$cb6da89c6af1a8ec)(),
  );
  let [isAnimating, setAnimating] = (0, $3Fik3$useState)(false);
  let [isScrolling, setScrolling] = (0, $3Fik3$useState)(false);
  let virtualizer = (0, $3Fik3$useMemo)(
    () => new (0, $38b9490c1cca8fc4$export$89be5a243e59c4b2)(),
    [],
  );
  ...
  let setVisibleRect = (0, $3Fik3$useCallback)(
    (rect) => {
      virtualizer.visibleRect = rect;
    },
    [virtualizer],
