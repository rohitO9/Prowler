...
$parcel$export(
  module.exports,
  "useSliderState",
  () => $e86753598efd0f02$export$e5fda3247f5d67f9,
);
/*
...
function $e86753598efd0f02$export$e5fda3247f5d67f9(props) {
  const {
    ...
    minValue: minValue = $e86753598efd0f02$var$DEFAULT_MIN_VALUE,
    maxValue: maxValue = $e86753598efd0f02$var$DEFAULT_MAX_VALUE,
    numberFormatter: formatter,
    step: step = $e86753598efd0f02$var$DEFAULT_STEP_VALUE,
    orientation: orientation = "horizontal",
  } = props;
  // Page step should be at least equal to step and always a multiple of the step.
  let pageSize = (0, $1NNdE$react.useMemo)(() => {
    let calcPageSize = (maxValue - minValue) / 10;
    calcPageSize = (0, $1NNdE$reactstatelyutils.snapValueToStep)(
      calcPageSize,
      0,
      calcPageSize + step,
      step,
  ...
  let restrictValues = (0, $1NNdE$react.useCallback)(
    (values) =>
      values === null || values === void 0
        ...
        : values.map((val, idx) => {
            ...
            return (0, $1NNdE$reactstatelyutils.snapValueToStep)(
              val,
              min,
              max,
              step,
  ...
  let value = (0, $1NNdE$react.useMemo)(
    () => restrictValues($e86753598efd0f02$var$convertValue(props.value)),
    [props.value],
  );
  let defaultValue = (0, $1NNdE$react.useMemo)(() => {
    var _convertValue;
    return restrictValues(
      (_convertValue = $e86753598efd0f02$var$convertValue(
        props.defaultValue,
      )) !== null && _convertValue !== void 0
        ? _convertValue
        : [minValue],
    );
  }, [props.defaultValue, minValue]);
  let onChange = $e86753598efd0f02$var$createOnChange(
    props.value,
    props.defaultValue,
    props.onChange,
  );
  let onChangeEnd = $e86753598efd0f02$var$createOnChange(
    props.value,
    props.defaultValue,
    props.onChangeEnd,
  );
  const [values, setValuesState] = (0,
  $1NNdE$reactstatelyutils.useControlledState)(value, defaultValue, onChange);
  const [isDraggings, setDraggingsState] = (0, $1NNdE$react.useState)(
    new Array(values.length).fill(false),
  );
  const isEditablesRef = (0, $1NNdE$react.useRef)(
  ...
  function updateValue(index, value) {
    ...
    value = (0, $1NNdE$reactstatelyutils.snapValueToStep)(
      value,
      thisMin,
      thisMax,
      step,
    );
    let newValues = $e86753598efd0f02$var$replaceIndex(
      valuesRef.current,
      index,
      value,
    );
  ...
  function updateDragging(index, dragging) {
    ...
    isDraggingsRef.current = $e86753598efd0f02$var$replaceIndex(
  ...
  function getPercentValue(percent) {
    ...
    return (0, $1NNdE$reactstatelyutils.clamp)(
      getRoundedValue(val),
      minValue,
      maxValue,
    );
  ...
  function incrementThumb(index, stepSize = 1) {
    ...
    updateValue(
      index,
      (0, $1NNdE$reactstatelyutils.snapValueToStep)(
        values[index] + s,
        minValue,
        maxValue,
        step,
