import {
  snapValueToStep as $BT4Uh$snapValueToStep,
  useControlledState as $BT4Uh$useControlledState,
  clamp as $BT4Uh$clamp,
} from "@react-stately/utils";
import {
  useMemo as $BT4Uh$useMemo,
  useCallback as $BT4Uh$useCallback,
  useState as $BT4Uh$useState,
  useRef as $BT4Uh$useRef,
} from "react";
...
function $28f99e3e86e6ec45$export$e5fda3247f5d67f9(props) {
  const {
    ...
    minValue: minValue = $28f99e3e86e6ec45$var$DEFAULT_MIN_VALUE,
    maxValue: maxValue = $28f99e3e86e6ec45$var$DEFAULT_MAX_VALUE,
    numberFormatter: formatter,
    step: step = $28f99e3e86e6ec45$var$DEFAULT_STEP_VALUE,
    orientation: orientation = "horizontal",
  } = props;
  // Page step should be at least equal to step and always a multiple of the step.
  let pageSize = (0, $BT4Uh$useMemo)(() => {
    let calcPageSize = (maxValue - minValue) / 10;
    calcPageSize = (0, $BT4Uh$snapValueToStep)(
      calcPageSize,
      0,
      calcPageSize + step,
      step,
  ...
  let restrictValues = (0, $BT4Uh$useCallback)(
    (values) =>
  ...
  let value = (0, $BT4Uh$useMemo)(
    () => restrictValues($28f99e3e86e6ec45$var$convertValue(props.value)),
    [props.value],
  );
  let defaultValue = (0, $BT4Uh$useMemo)(() => {
    var _convertValue;
    return restrictValues(
      (_convertValue = $28f99e3e86e6ec45$var$convertValue(
        props.defaultValue,
  ...
  let onChange = $28f99e3e86e6ec45$var$createOnChange(
    props.value,
    props.defaultValue,
    props.onChange,
  );
  let onChangeEnd = $28f99e3e86e6ec45$var$createOnChange(
    props.value,
    props.defaultValue,
    props.onChangeEnd,
  );
  const [values, setValuesState] = (0, $BT4Uh$useControlledState)(
    value,
    defaultValue,
    onChange,
  );
  const [isDraggings, setDraggingsState] = (0, $BT4Uh$useState)(
    new Array(values.length).fill(false),
  );
  const isEditablesRef = (0, $BT4Uh$useRef)(
  ...
  function updateValue(index, value) {
    ...
    let newValues = $28f99e3e86e6ec45$var$replaceIndex(
      valuesRef.current,
      index,
      value,
    );
  ...
  function updateDragging(index, dragging) {
    ...
    isDraggingsRef.current = $28f99e3e86e6ec45$var$replaceIndex(
  ...
  function incrementThumb(index, stepSize = 1) {
    ...
    updateValue(
      index,
      (0, $BT4Uh$snapValueToStep)(values[index] + s, minValue, maxValue, step),
    );
  }
