...
import {
  toCalendarDate as $d0gbl$toCalendarDate,
  maxDate as $d0gbl$maxDate,
  minDate as $d0gbl$minDate,
  isEqualDay as $d0gbl$isEqualDay,
  toCalendar as $d0gbl$toCalendar,
  GregorianCalendar as $d0gbl$GregorianCalendar,
} from "@internationalized/date";
import { useControlledState as $d0gbl$useControlledState } from "@react-stately/utils";
import {
  useState as $d0gbl$useState,
  useRef as $d0gbl$useRef,
  useMemo as $d0gbl$useMemo,
} from "react";
...
function $9a36b6ba2fb1a7c5$export$9a987164d97ecc90(props) {
  ...
  let [value, setValue] = (0, $d0gbl$useControlledState)(
    valueProp,
    defaultValue || null,
    onChange,
  );
  ...
  if (value && value.start && value.end) {
    let start = (0, $f62d864046160412$export$f4a51ff076cc9a09)(
      (0, $d0gbl$toCalendarDate)(value.start),
      visibleDuration,
      locale,
      minValue,
      maxValue,
  ...
  let min = (0, $d0gbl$useMemo)(
    () =>
      (0, $d0gbl$maxDate)(
        minValue,
        availableRange === null || availableRange === void 0
          ? void 0
          : availableRange.start,
      ),
    [minValue, availableRange],
  );
  let max = (0, $d0gbl$useMemo)(
    () =>
      (0, $d0gbl$minDate)(
        maxValue,
        availableRange === null || availableRange === void 0
  ...
  let [lastVisibleRange, setLastVisibleRange] = (0, $d0gbl$useState)(
  ...
  if (
    ...
    !(0, $d0gbl$isEqualDay)(calendar.visibleRange.end, lastVisibleRange.end)
  ) {
  ...
  let highlightedRange = anchorDate
    ? $9a36b6ba2fb1a7c5$var$makeRange(anchorDate, calendar.focusedDate)
    : value && $9a36b6ba2fb1a7c5$var$makeRange(value.start, value.end);
  let selectDate = (date) => {
    if (props.isReadOnly) return;
    date = (0, $f62d864046160412$export$4f5203c0d889109e)(date, min, max);
    date = (0, $f62d864046160412$export$a1d3911297b952d7)(
      date,
      calendar.visibleRange.start,
    ...
    if (!anchorDate) setAnchorDate(date);
      ...
      setValue({
        start: $9a36b6ba2fb1a7c5$var$convertValue(
          range.start,
          value === null || value === void 0 ? void 0 : value.start,
        ),
        end: $9a36b6ba2fb1a7c5$var$convertValue(
          range.end,
  ...
  return {
    ...
    isInvalid(date) {
      ...
      return (
        ...
        (0, $f62d864046160412$export$eac50920cf2fd59a)(
          date,
          (_availableRangeRef_current = availableRangeRef.current) === null ||
            _availableRangeRef_current === void 0
            ? void 0
            : _availableRangeRef_current.start,
          (_availableRangeRef_current1 = availableRangeRef.current) === null ||
            _availableRangeRef_current1 === void 0
            ? void 0
            : _availableRangeRef_current1.end,
        )
      );
    },
...
function $9a36b6ba2fb1a7c5$var$convertValue(newValue, oldValue) {
  ...
  newValue = (0, $d0gbl$toCalendar)(
    newValue,
    (oldValue === null || oldValue === void 0 ? void 0 : oldValue.calendar) ||
      new (0, $d0gbl$GregorianCalendar)(),
  );
