...
$parcel$export(
  module.exports,
  "useRadioGroupState",
  () => $307db30b5687e2e8$export$bca9d026f8e704eb,
);
/*
...
function $307db30b5687e2e8$export$bca9d026f8e704eb(props) {
  ...
  let name = (0, $cVa5U$react.useMemo)(
    () =>
      props.name ||
      `radio-group-${$307db30b5687e2e8$var$instance}-${++$307db30b5687e2e8$var$i}`,
    [props.name],
  );
  var _props_defaultValue;
  let [selectedValue, setSelected] = (0,
  $cVa5U$reactstatelyutils.useControlledState)(
    props.value,
    (_props_defaultValue = props.defaultValue) !== null &&
      _props_defaultValue !== void 0
      ? _props_defaultValue
      : null,
    props.onChange,
  );
  let [lastFocusedValue, setLastFocusedValue] = (0, $cVa5U$react.useState)(
    null,
  );
