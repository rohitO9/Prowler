...
$parcel$export(
  module.exports,
  "useGridState",
  () => $38009b28e45912ea$export$4007ac09ff9c68ed,
);
...
function $38009b28e45912ea$export$4007ac09ff9c68ed(props) {
  ...
  let selectionState =
    props.UNSAFE_selectionState ||
    (0, $5Cus8$reactstatelyselection.useMultipleSelectionState)(props);
  let disabledKeys = (0, $5Cus8$react.useMemo)(
  ...
  selectionState.setFocusedKey = (key, child) => {
    ...
    if (focusMode === "cell" && key != null) {
      ...
      if ((item === null || item === void 0 ? void 0 : item.type) === "item") {
        ...
        let children = (0, $5Cus8$reactstatelycollections.getChildNodes)(
          item,
          collection,
        );
        ...
        if (child === "last")
          key =
            (_getLastItem_key =
              (_getLastItem = (0, $5Cus8$reactstatelycollections.getLastItem)(
                children,
          ...
          key =
            (_getFirstItem_key =
              (_getFirstItem = (0, $5Cus8$reactstatelycollections.getFirstItem)(
                children,
  ...
  let selectionManager = (0, $5Cus8$react.useMemo)(
    () =>
      new (0, $5Cus8$reactstatelyselection.SelectionManager)(
        collection,
        selectionState,
      ),
    ...
    if (
      ...
      if (newRow) {
        const childNodes = newRow.hasChildNodes
          ? [
              ...(0, $5Cus8$reactstatelycollections.getChildNodes)(
                newRow,
                collection,
              ),
            ]
