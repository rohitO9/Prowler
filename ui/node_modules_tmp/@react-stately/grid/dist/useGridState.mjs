import {
  getChildNodes as $7nPCv$getChildNodes,
  getLastItem as $7nPCv$getLastItem,
  getFirstItem as $7nPCv$getFirstItem,
} from "@react-stately/collections";
import {
  useMultipleSelectionState as $7nPCv$useMultipleSelectionState,
  SelectionManager as $7nPCv$SelectionManager,
} from "@react-stately/selection";
import {
  useMemo as $7nPCv$useMemo,
  useRef as $7nPCv$useRef,
  useEffect as $7nPCv$useEffect,
} from "react";
...
function $62967d126f3aa823$export$4007ac09ff9c68ed(props) {
  ...
  let selectionState =
    props.UNSAFE_selectionState || (0, $7nPCv$useMultipleSelectionState)(props);
  let disabledKeys = (0, $7nPCv$useMemo)(
    ...
    if (focusMode === "cell" && key != null) {
      ...
      if ((item === null || item === void 0 ? void 0 : item.type) === "item") {
        ...
        if (child === "last")
          key =
            (_getLastItem_key =
              (_getLastItem = (0, $7nPCv$getLastItem)(children)) === null ||
              _getLastItem === void 0
                ? void 0
          ...
          key =
            (_getFirstItem_key =
              (_getFirstItem = (0, $7nPCv$getFirstItem)(children)) === null ||
  ...
  let selectionManager = (0, $7nPCv$useMemo)(
    () => new (0, $7nPCv$SelectionManager)(collection, selectionState),
  ...
  (0, $7nPCv$useEffect)(() => {
    if (
      ...
      const parentNode =
        (node === null || node === void 0 ? void 0 : node.parentKey) != null &&
        (node.type === "cell" ||
          node.type === "rowheader" ||
          node.type === "column")
      ...
      while (index >= 0) {
        if (
          !selectionManager.isDisabled(rows[index].key) &&
