...
$parcel$export(
  ...
  () => $3391baedd777a697$export$4d40659c25ecb50b,
);
/*
...
function $3391baedd777a697$export$4d40659c25ecb50b(props = {}) {
  let {
    delay: delay = $3391baedd777a697$var$TOOLTIP_DELAY,
    closeDelay: closeDelay = $3391baedd777a697$var$TOOLTIP_COOLDOWN,
  } = props;
  let {
    isOpen: isOpen,
    open: open,
    close: close,
  } = (0, $w0mn6$reactstatelyoverlays.useOverlayTriggerState)(props);
  let id = (0, $w0mn6$react.useMemo)(
    () => `${++$3391baedd777a697$var$tooltipId}`,
    [],
  );
  ...
  let warmupTooltip = () => {
    ...
    if (
      !isOpen &&
      !$3391baedd777a697$var$globalWarmUpTimeout &&
      !$3391baedd777a697$var$globalWarmedUp
    )
