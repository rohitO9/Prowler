...
$parcel$export(
  module.exports,
  "useTreeState",
  () => $38effb299000faaf$export$728d6ba534403756,
);
/*
...
function $38effb299000faaf$export$728d6ba534403756(props) {
  ...
  $abPLV$reactstatelyutils.useControlledState)(
    props.expandedKeys ? new Set(props.expandedKeys) : undefined,
    props.defaultExpandedKeys ? new Set(props.defaultExpandedKeys) : new Set(),
    onExpandedChange,
  );
  let selectionState = (0,
  $abPLV$reactstatelyselection.useMultipleSelectionState)(props);
  let disabledKeys = (0, $abPLV$react.useMemo)(
    () => (props.disabledKeys ? new Set(props.disabledKeys) : new Set()),
    [props.disabledKeys],
  );
  let tree = (0, $abPLV$reactstatelycollections.useCollection)(
    props,
    (0, $abPLV$react.useCallback)(
      (nodes) =>
        new (0, $fae56b53b03726ff$exports.TreeCollection)(nodes, {
  ...
  return {
    ...
    selectionManager: new (0, $abPLV$reactstatelyselection.SelectionManager)(
      tree,
      selectionState,
    ),
  };
