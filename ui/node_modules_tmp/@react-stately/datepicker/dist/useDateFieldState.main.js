...
$parcel$export(
  module.exports,
  "useDateFieldState",
  () => $596a1f0f523d6752$export$60e84778edff6d26,
);
/*
...
function $596a1f0f523d6752$export$60e84778edff6d26(props) {
  ...
  $50d5d6a623389320$exports.useDefaultProps)(v, props.granularity);
  ...
  let defaultFormatter = (0, $iqS8N$react.useMemo)(
    () => new (0, $iqS8N$internationalizeddate.DateFormatter)(locale),
    [locale],
  );
  let calendar = (0, $iqS8N$react.useMemo)(
    () => createCalendar(defaultFormatter.resolvedOptions().calendar),
    [createCalendar, defaultFormatter],
  );
  let [value, setDate] = (0, $iqS8N$reactstatelyutils.useControlledState)(
    props.value,
    props.defaultValue,
    props.onChange,
  );
  let calendarValue = (0, $iqS8N$react.useMemo)(
    () => (0, $50d5d6a623389320$exports.convertValue)(value, calendar),
    [value, calendar],
  );
  ...
  let [placeholderDate, setPlaceholderDate] = (0, $iqS8N$react.useState)(() =>
    (0, $50d5d6a623389320$exports.createPlaceholderDate)(
  ...
  let opts = (0, $iqS8N$react.useMemo)(
    () => (0, $50d5d6a623389320$exports.getFormatOptions)({}, formatOpts),
    [formatOpts],
  );
  let dateFormatter = (0, $iqS8N$react.useMemo)(
    () => new (0, $iqS8N$internationalizeddate.DateFormatter)(locale, opts),
    [locale, opts],
  );
  let resolvedOptions = (0, $iqS8N$react.useMemo)(
    () => dateFormatter.resolvedOptions(),
    [dateFormatter],
  );
  // Determine how many editable segments there are for validation purposes.
  // The result is cached for performance.
  let allSegments = (0, $iqS8N$react.useMemo)(
    () =>
      dateFormatter
        .formatToParts(new Date())
        .filter((seg) => $596a1f0f523d6752$var$EDITABLE_SEGMENTS[seg.type])
        .reduce((p, seg) => ((p[seg.type] = true), p), {}),
    [dateFormatter],
  );
  let [validSegments, setValidSegments] = (0, $iqS8N$react.useState)(() =>
    ...
    if (calendar.identifier !== lastCalendarIdentifier.current) {
      ...
      setPlaceholderDate((placeholder) =>
        Object.keys(validSegments).length > 0
          ? (0, $iqS8N$internationalizeddate.toCalendar)(placeholder, calendar)
          : (0, $50d5d6a623389320$exports.createPlaceholderDate)(
              props.placeholderValue,
              granularity,
              calendar,
  ...
  let setValue = (newValue) => {
    ...
    if (newValue == null) {
      ...
      newValue = (0, $iqS8N$internationalizeddate.toCalendar)(
        newValue,
        (v === null || v === void 0 ? void 0 : v.calendar) ||
          new (0, $iqS8N$internationalizeddate.GregorianCalendar)(),
      );
      setDate(newValue);
  ...
  let segments = (0, $iqS8N$react.useMemo)(
    () =>
      dateFormatter.formatToParts(dateValue).map((segment) => {
        ...
        if (segment.type === "era" && calendar.getEras().length === 1)
          isEditable = false;
        let isPlaceholder =
          $596a1f0f523d6752$var$EDITABLE_SEGMENTS[segment.type] &&
          !validSegments[segment.type];
        let placeholder = $596a1f0f523d6752$var$EDITABLE_SEGMENTS[segment.type]
          ? (0, $e1e8ada727fae1a1$exports.getPlaceholder)(
              segment.type,
              segment.value,
              locale,
            )
        ...
        return {
          type:
            $596a1f0f523d6752$var$TYPE_MAPPING[segment.type] || segment.type,
          text: isPlaceholder ? placeholder : segment.value,
          ...$596a1f0f523d6752$var$getSegmentLimits(
            displayValue,
            segment.type,
            resolvedOptions,
          ),
  ...
  let adjustSegment = (type, amount) => {
    if (!validSegments[type]) {
      ...
      setValue(
        $596a1f0f523d6752$var$addSegment(
          displayValue,
          type,
          amount,
          resolvedOptions,
  ...
  let builtinValidation = (0, $iqS8N$react.useMemo)(
    () =>
      (0, $50d5d6a623389320$exports.getValidationResult)(
        value,
        minValue,
        maxValue,
        isDateUnavailable,
  ...
  return {
    ...
    setSegment(part, v) {
      markValid(part);
      setValue(
        $596a1f0f523d6752$var$setSegment(
          displayValue,
          part,
          v,
          resolvedOptions,
    ...
    clearSegment(part) {
      ...
      let placeholder = (0, $50d5d6a623389320$exports.createPlaceholderDate)(
        props.placeholderValue,
        granularity,
        calendar,
        defaultTimeZone,
    ...
    formatValue(fieldOptions) {
      ...
      let formatOptions = (0, $50d5d6a623389320$exports.getFormatOptions)(
        fieldOptions,
        formatOpts,
      );
      let formatter = new (0, $iqS8N$internationalizeddate.DateFormatter)(
        locale,
        formatOptions,
      );
