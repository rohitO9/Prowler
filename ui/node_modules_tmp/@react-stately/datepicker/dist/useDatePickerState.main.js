...
$parcel$export(
  module.exports,
  "useDatePickerState",
  () => $aaab7a647e17e1fd$export$87194bb378cc3ac2,
);
/*
...
function $aaab7a647e17e1fd$export$87194bb378cc3ac2(props) {
  let overlayState = (0, $g6L8e$reactstatelyoverlays.useOverlayTriggerState)(
    props,
  );
  let [value, setValue] = (0, $g6L8e$reactstatelyutils.useControlledState)(
    props.value,
  ...
  let builtinValidation = (0, $g6L8e$react.useMemo)(
    () =>
  ...
  let commitValue = (date, time) => {
    setValue(
      "timeZone" in time
        ? time.set((0, $g6L8e$internationalizeddate.toCalendarDate)(date))
        : (0, $g6L8e$internationalizeddate.toCalendarDateTime)(date, time),
    );
  ...
  return {
    ...
    formatValue(locale, fieldOptions) {
      ...
      let formatter = new (0, $g6L8e$internationalizeddate.DateFormatter)(
        locale,
        formatOptions,
      );
