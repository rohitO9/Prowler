...
$parcel$export(
  ...
  () => $7072d26f58deb33b$export$e50a61c1de9f574,
);
/*
...
function $7072d26f58deb33b$export$e50a61c1de9f574(props) {
  ...
  let overlayState = (0, $9LYIl$reactstatelyoverlays.useOverlayTriggerState)(
    props,
  );
  let [controlledValue, setControlledValue] = (0,
  $9LYIl$reactstatelyutils.useControlledState)(
    props.value,
    props.defaultValue || null,
    props.onChange,
  );
  let [placeholderValue, setPlaceholderValue] = (0, $9LYIl$react.useState)(
    () =>
      controlledValue || {
        start: null,
        end: null,
    ...
    setValue({
      start:
        "timeZone" in timeRange.start
          ? timeRange.start.set(
              (0, $9LYIl$internationalizeddate.toCalendarDate)(dateRange.start),
            )
          : (0, $9LYIl$internationalizeddate.toCalendarDateTime)(
              dateRange.start,
              timeRange.start,
            ),
      end:
        "timeZone" in timeRange.end
          ? timeRange.end.set(
              (0, $9LYIl$internationalizeddate.toCalendarDate)(dateRange.end),
            )
          : (0, $9LYIl$internationalizeddate.toCalendarDateTime)(
              dateRange.end,
              timeRange.end,
        ...
        commitValue(range, {
          start:
            (timeRange === null || timeRange === void 0
              ? void 0
              : timeRange.start) ||
            (0, $50d5d6a623389320$exports.getPlaceholderTime)(
              props.placeholderValue,
            ),
          end:
            (timeRange === null || timeRange === void 0
  ...
  let builtinValidation = (0, $9LYIl$react.useMemo)(
    () =>
      (0, $50d5d6a623389320$exports.getRangeValidationResult)(
        value,
        minValue,
        maxValue,
        isDateUnavailable,
  ...
  return {
    ...
    formatValue(locale, fieldOptions) {
      ...
      let startOptions = (0, $50d5d6a623389320$exports.getFormatOptions)(
        fieldOptions,
        {
      ...
      let startFormatter = new (0, $9LYIl$internationalizeddate.DateFormatter)(
        locale,
        startOptions,
      );
      let endFormatter;
      if (
        ...
        let endOptions = (0, $50d5d6a623389320$exports.getFormatOptions)(
          fieldOptions,
          {
        ...
        endFormatter = new (0, $9LYIl$internationalizeddate.DateFormatter)(
          locale,
          endOptions,
        );
      }
