...
$parcel$export(
  module.exports,
  "NumberParser",
  () => $d68f3f4c684426c6$export$cd11ab140839f11d,
);
/*
...
class $d68f3f4c684426c6$export$cd11ab140839f11d {
   ...
   */ parse(value) {
    return $d68f3f4c684426c6$var$getNumberParserImpl(
      this.locale,
      this.options,
      value,
    ).parse(value);
...
function $d68f3f4c684426c6$var$getNumberParserImpl(locale, options, value) {
  ...
  let defaultParser = $d68f3f4c684426c6$var$getCachedNumberParser(
    locale,
    options,
  );
  ...
  if (!locale.includes("-nu-") && !defaultParser.isValidPartialNumber(value)) {
    for (let numberingSystem of $d68f3f4c684426c6$var$NUMBERING_SYSTEMS)
      if (numberingSystem !== defaultParser.options.numberingSystem) {
        let parser = $d68f3f4c684426c6$var$getCachedNumberParser(
          locale +
...
class $d68f3f4c684426c6$var$NumberParserImpl {
  parse(value) {
    ...
    if (this.symbols.group)
      ...
      fullySanitizedValue = $d68f3f4c684426c6$var$replaceAll(
        fullySanitizedValue,
        this.symbols.group,
        "",
      );
    ...
    if (this.options.style === "percent") {
      ...
      return new $d68f3f4c684426c6$export$cd11ab140839f11d(
        this.locale,
        options,
      ).parse(
        new (0, $0c1d5654b62fc485$exports.NumberFormatter)(
          this.locale,
          options,
        ).format(newValue),
      );
    ...
    if (
      ...
      $d68f3f4c684426c6$var$CURRENCY_SIGN_REGEX.test(value)
    )
      newValue = -1 * newValue;
    return newValue;
  }
  sanitize(value) {
    ...
    if (this.options.numberingSystem === "arab") {
      ...
      if (this.symbols.group)
        value = $d68f3f4c684426c6$var$replaceAll(
          value,
          ".",
          this.symbols.group,
        );
  ...
  constructor(locale, options = {}) {
    ...
    this.symbols = $d68f3f4c684426c6$var$getSymbols(
      locale,
      this.formatter,
      this.options,
      options,
...
function $d68f3f4c684426c6$var$getSymbols(
  locale,
  formatter,
  intlOptions,
  originalOptions,
  ...
  let minusSign =
    (_allParts_find_value =
      (_allParts_find = allParts.find((p) => p.type === "minusSign")) ===
        null || _allParts_find === void 0
        ? void 0
        : _allParts_find.value) !== null && _allParts_find_value !== void 0
      ? _allParts_find_value
      : "-";
  let plusSign =
    (_posAllParts_find = posAllParts.find((p) => p.type === "plusSign")) ===
  ...
  let decimal =
    (_decimalParts_find = decimalParts.find((p) => p.type === "decimal")) ===
      null || _decimalParts_find === void 0
      ? void 0
      : _decimalParts_find.value;
  let group =
    (_allParts_find1 = allParts.find((p) => p.type === "group")) === null ||
    _allParts_find1 === void 0
      ? void 0
      : _allParts_find1.value;
  // this set is also for a regex, it's all literals that might be in the string we want to eventually parse that
  // don't contribute to the numerical value
  let allPartsLiterals = allParts
    .filter((p) => !$d68f3f4c684426c6$var$nonLiteralParts.has(p.type))
