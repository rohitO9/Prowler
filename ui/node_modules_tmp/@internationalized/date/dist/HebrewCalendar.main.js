...
$parcel$export(
  module.exports,
  "HebrewCalendar",
  () => $0f5324ee3bdd9396$export$ca405048b8fb5af,
);
/*
...
const $0f5324ee3bdd9396$var$MONTH_FRACT =
  12 * $0f5324ee3bdd9396$var$HOUR_PARTS + 793;
const $0f5324ee3bdd9396$var$MONTH_PARTS =
  $0f5324ee3bdd9396$var$MONTH_DAYS * $0f5324ee3bdd9396$var$DAY_PARTS +
  $0f5324ee3bdd9396$var$MONTH_FRACT;
...
function $0f5324ee3bdd9396$var$startOfYear(year) {
  return (
    $0f5324ee3bdd9396$var$hebrewDelay1(year) +
    $0f5324ee3bdd9396$var$hebrewDelay2(year)
  );
}
function $0f5324ee3bdd9396$var$getDaysInYear(year) {
  return (
    $0f5324ee3bdd9396$var$startOfYear(year + 1) -
    $0f5324ee3bdd9396$var$startOfYear(year)
  );
}
...
class $0f5324ee3bdd9396$export$ca405048b8fb5af {
  fromJulianDay(jd) {
    ...
    let m =
      (d * $0f5324ee3bdd9396$var$DAY_PARTS) / $0f5324ee3bdd9396$var$MONTH_PARTS; // Months (approx)
  ...
  balanceYearMonth(date, previousDate) {
    ...
    if (previousDate.year !== date.year) {
      if (
        $0f5324ee3bdd9396$var$isLeapYear(previousDate.year) &&
        !$0f5324ee3bdd9396$var$isLeapYear(date.year) &&
