  ...
  create: function create(context) {
    ...
    return {
      ...
      JSXOpeningElement: function JSXOpeningElement(node) {
        var pathname = convertToCorrectSeparator(context.getFilename());
        var isInAppDir = pathname.includes(
          "".concat(_path.sep, "app").concat(_path.sep),
        );
        ...
        context.report({
          node: node,
          message:
            "`next/script`'s `beforeInteractive` strategy should not be used outside of `pages/_document.js`. See: ".concat(
              url,
            ),
        });
      },
