 ...
 */
export declare function getCompilerOptionsFromTsConfig(
  filePath: string,
...
export declare class KeyValueCache<T, U> {
  ...
  getOrCreate<TCreate extends U = U>(
    key: T,
    createFunc: () => TCreate,
  ): TCreate;
  has(key: T): boolean;
 ...
 */
export declare class PropertyComparer<TValue, TProperty>
  implements Comparer<TValue>
{
   ...
   */
  constructor(
    getProperty: (value: TValue) => TProperty,
    comparer: Comparer<TProperty>,
  );
  /** @inheritdoc */
 ...
 */
export declare class PropertyStoredComparer<TValue, TProperty>
  implements StoredComparer<TValue>
{
  private readonly getProperty;
  private readonly comparer;
  /**
  ...
  constructor(
    getProperty: (value: TValue) => TProperty,
    comparer: StoredComparer<TProperty>,
  );
  /** @inheritdoc */
 ...
 */
export declare function createModuleResolutionHost(
 ...
 */
export type ResolutionHostFactory = (
...
export interface TsSourceFileContainer {
   ...
   */
  getSourceFileFromCacheFromFilePath(
   ...
   * @param opts - Options for adding or getting the file.
   */
  addOrGetSourceFileFromFilePathSync(
    filePath: StandardizedFilePath,
    opts: {
      markInProject: boolean;
      scriptKind: ScriptKind | undefined;
   ...
   * @param dirPath - Path of the directory to check.
   */
  getChildDirectoriesOfDirectory(
...
export declare namespace errors {
   ...
   * @param argName - Argument name.
   */
  function throwIfRangeOutOfRange(
   ...
   */
  function throwNotImplementedForSyntaxKindError(
    kind: ts.SyntaxKind,
    node?: Node,
  ): never;
  /**
   ...
   * @param value - Value to check.
   */
  function throwNotImplementedForNeverValueError(
    value: never,
    sourceNode?: Node,
  ): never;
  /**
...
export declare class FileUtils {
   ...
   */
  static getStandardizedAbsolutePath(
    fileSystem: FileSystemHost,
   ...
   */
  static pathStartsWith(
    fileOrDirPath: string | undefined,
    startsWithPath: string | undefined,
  ): boolean;
   ...
   * @param encoding - File encoding.
   */
  static readFileOrNotExistsSync(
    fileSystem: FileSystemHost,
    filePath: StandardizedFilePath,
    encoding: string,
  ): string | false;
   ...
   */
  static getDescendantDirectories(
...
export declare function matchGlobs(
...
export declare class TransactionalFileSystem {
  ...
  queueMoveDirectory(
    srcPath: StandardizedFilePath,
    destPath: StandardizedFilePath,
  ): void;
  queueCopyDirectory(
    srcPath: StandardizedFilePath,
    destPath: StandardizedFilePath,
  ...
  copyDirectoryImmediately(
    srcDirPath: StandardizedFilePath,
    destDirPath: StandardizedFilePath,
  ): Promise<void>;
  copyDirectoryImmediatelySync(
    srcDirPath: StandardizedFilePath,
    destDirPath: StandardizedFilePath,
  ): void;
  moveDirectoryImmediately(
    srcDirPath: StandardizedFilePath,
    destDirPath: StandardizedFilePath,
  ): Promise<void>;
  moveDirectoryImmediatelySync(
    srcDirPath: StandardizedFilePath,
    destDirPath: StandardizedFilePath,
  ): void;
  ...
  ): Generator<StandardizedFilePath, void, unknown>;
...
export declare function matchFiles(
  this: any,
  path: string,
...
export declare function getFileMatcherPatterns(
  this: any,
  path: string,
  excludes: ReadonlyArray<string>,
  includes: ReadonlyArray<string>,
...
export declare function getEmitModuleResolutionKind(
  this: any,
...
export declare class ArrayUtils {
  ...
  static binaryInsertWithOverwrite<T>(
    items: T[],
    newItem: T,
    comparer: Comparer<T>,
  ): void;
  ...
  static containsSubArray<T>(
    items: ReadonlyArray<T>,
    subArray: ReadonlyArray<T>,
  ): boolean;
}
 ...
 */
export type EventContainerSubscription<EventArgType> = (
  arg: EventArgType,
) => void;
...
export declare function nameof<TObject>(
  obj: TObject,
  key: keyof TObject,
): string;
