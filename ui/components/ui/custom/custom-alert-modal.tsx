...
export const CustomAlertModal: React.FC<CustomAlertModalProps> = ({
  ...
  return (
    <Modal
      ...
      size="5xl"
      classNames={{
        base: "dark:bg-vulneraiq-blue-800 max-w-[90vw] w-full",
    ...
    >
      <ModalContent
        className={`mx-6 ${className ? className : "max-w-[90vw] w-full"} max-h-[90vh] overflow-hidden rounded-2xl shadow-2xl bg-white dark:bg-vulneraiq-blue-800 pt-2 pb-4`}
      >
        {(_onClose) => (
          <>
            <div className="sticky top-0 z-10 bg-white dark:bg-vulneraiq-blue-800">
              <button
