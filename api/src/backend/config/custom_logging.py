...
# Ensure the environment variables are valid and trimmed of extra spaces
LEVEL = env("DJANGO_LOGGING_LEVEL", default="INFO").strip()  
FORMATTER = env("DJANGO_LOGGING_FORMATTER", default="ndjson").strip()
