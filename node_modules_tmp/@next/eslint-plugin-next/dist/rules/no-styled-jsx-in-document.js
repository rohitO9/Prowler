  ...
  create: function create(context) {
    return {
      JSXOpeningElement: function JSXOpeningElement(node) {
        ...
        var _path_parse = _path.parse(document),
          name = _path_parse.name,
          dir = _path_parse.dir;
        if (
          !(
        ...
        if (
          ...
          node.attributes.find(function (attr) {
          ...
          context.report({
            node: node,
            message:
              "`styled-jsx` should not be used in `pages/_document.js`. See: ".concat(
                url,
              ),
          });
        }
