...
var _nodeattributes = /*#__PURE__*/ _interop_require_default(
  require("../utils/node-attributes"),
);
...
module.exports = (0, _definerule.defineRule)({
  ...
  create: function create(context) {
    ...
    var is_Document =
      page.startsWith("".concat(_path.sep, "_document")) ||
      page.startsWith("".concat(_path.posix.sep, "_document"));
    ...
    return {
      ...
      JSXOpeningElement: function JSXOpeningElement(node) {
        ...
        if (isGoogleFont) {
          ...
          var message = is_Document
            ? "Using `<link />` outside of `<Head>` will disable automatic font optimization. ".concat(
                end,
              )
            : "Custom fonts not added in `pages/_document.js` will only load for a single page. ".concat(
                end,
              );
          context.report({
            node: node,
