        ...
        try {
          var _loop = function () {
            ...
            if (
              ...
              if (
                ((_block_declaration = block.declaration) === null ||
                _block_declaration === void 0
                  ? void 0
                  : _block_declaration.type) === "FunctionDeclaration" &&
              ...
              if (
                ...
                var functionDeclaration = node.body.find(function (localBlock) {
                  ...
                  if (
                    ...
                    localBlock.declarations.find(function (declaration) {
                      var _declaration_id;
                      return (
                        ((_declaration_id = declaration.id) === null ||
                        _declaration_id === void 0
                          ? void 0
                          : _declaration_id.type) === "Identifier" &&
                ...
                if (
                  ...
                  functionDeclaration === void 0
                    ? void 0
                    : functionDeclaration.type) === "VariableDeclaration"
                ) {
                  var _varDeclarator_init;
                  var varDeclarator = functionDeclaration.declarations.find(
                  ...
                  if (
                    (varDeclarator === null || varDeclarator === void 0
                      ? void 0
                      : (_varDeclarator_init = varDeclarator.init) === null ||
                          _varDeclarator_init === void 0
                        ? void 0
                        : _varDeclarator_init.type) ===
          ...
          for (
            var _iterator = node.body[Symbol.iterator](), _step;
