    ...
    return {
      ...
      JSXOpeningElement: function JSXOpeningElement(node) {
        ...
        if (
          ...
          src.startsWith("https://polyfill.io/v3/") || // https://community.fastly.com/t/new-options-for-polyfill-io-users/2540
          src.startsWith("https://polyfill-fastly.net/") ||
          src.startsWith("https://polyfill-fastly.io/") || // https://blog.cloudflare.com/polyfill-io-now-available-on-cdnjs-reduce-your-supply-chain-risk
          ...
          if (unwantedFeatures.length > 0) {
            context.report({
              node: node,
              message: "No duplicate polyfills from Polyfill.io are allowed. "
                .concat(unwantedFeatures.join(", "), " ")
                .concat(
                  unwantedFeatures.length > 1 ? "are" : "is",
                  " already shipped with Next.js. See: ",
                )
                .concat(url),
            });
          }
