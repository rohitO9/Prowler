(() => {
  var e = {
    383: (e) => {
      ...
      function expand(e) {
        ...
        for (const n in e.parsed) {
          const r = Object.prototype.hasOwnProperty.call(t, n)
            ? t[n]
            : e.parsed[n];
    ...
    234: (e, t, n) => {
      ...
      function _parseVault(e) {
        ...
        for (let e = 0; e < o; e++) {
          try {
            ...
            s = p.decrypt(o.ciphertext, o.key);
            break;
          } catch (t) {
            if (e + 1 >= o) {
              throw t;
      ...
      function _instructions(e, t) {
        ...
        if (!i) {
          throw new Error(
            `NOT_FOUND_DOTENV_ENVIRONMENT: Cannot locate environment ${s} in your .env.vault file.`,
          );
        }
      ...
      function configDotenv(e) {
        ...
        try {
          const o = p.parse(r.readFileSync(t, { encoding: n }));
          let s = process.env;
          if (e && e.processEnv != null) {
            s = e.processEnv;
          }
  ...
  (() => {
    ...
    function processEnv(e, t, n = console, o = false, i) {
      ...
      for (const o of e) {
        try {
          ...
          if (
            e.parsed &&
            !u.some((e) => e.contents === o.contents && e.path === o.path)
          ) {
            i === null || i === void 0 ? void 0 : i(o.path);
          }
          for (const t of Object.keys(e.parsed || {})) {
            if (typeof _[t] === "undefined" && typeof p[t] === "undefined") {
              _[t] = (l = e.parsed) === null || l === void 0 ? void 0 : l[t];
            }
          }
        } catch (e) {
      ...
      return Object.assign(process.env, _);
    }
    function resetEnv() {
      if (a) {
        replaceProcessEnv(a);
    ...
    function loadEnvConfig(t, n, o = console, s = false, i) {
      ...
      if (l && !s) {
        return { combinedEnv: l, loadedEnvFiles: p };
      }
      replaceProcessEnv(a);
      u = p;
      p = [];
      const c = process.env.NODE_ENV === "test";
      const _ = c ? "test" : n ? "development" : "production";
      const d = [
        `.env.${_}.local`,
        _ !== "test" && `.env.local`,
        `.env.${_}`,
