...
var TableRow = (0, import_system.forwardRef)((props, ref) => {
  ...
  const trStyles = (0, import_shared_utils.clsx)(
...
var TableCell = (0, import_system2.forwardRef)((props, ref) => {
  ...
  const tdStyles = (0, import_shared_utils2.clsx)(
...
var TableCheckboxCell = (0, import_system3.forwardRef)((props, ref) => {
  ...
  const { checkboxProps } = (0, import_table3.useTableSelectionCheckbox)(
    { key: (node == null ? void 0 : node.parentKey) || node.key },
    state,
  );
  const tdStyles = (0, import_shared_utils3.clsx)(
    classNames == null ? void 0 : classNames.td,
    className,
    (_a = node.props) == null ? void 0 : _a.className,
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Component, {
    ...
    children: isSingleSelectionMode
      ...
      : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_checkbox.Checkbox, {
          color,
          disableAnimation,
...
var TableBody = (0, import_system4.forwardRef)((props, ref) => {
  ...
  const tbodyStyles = (0, import_shared_utils4.clsx)(
  ...
  if (collection.size === 0 && bodyProps.emptyContent) {
    emptyContent = /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("tr", {
      role: "row",
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", {
        className:
          slots == null
            ? void 0
            : slots.emptyWrapper({
  ...
  if (isLoading && bodyProps.loadingContent) {
    loadingContent = /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("tr", {
      role: "row",
      children: [
