"use client";
import { table_select_all_checkbox_default } from "./chunk-IZM76DYO.mjs";
import { useTable } from "./chunk-EQH6X4ZB.mjs";
import { table_body_default } from "./chunk-RBQQFBYX.mjs";
import { table_column_header_default } from "./chunk-XPS6TYRF.mjs";
import { table_header_row_default } from "./chunk-N2ZOKY36.mjs";
import { table_row_group_default } from "./chunk-GZVIASP2.mjs";
        ...
        children: /* @__PURE__ */ jsxs(Fragment, {
          children: [
            ...
            /* @__PURE__ */ jsxs(Component, {
              ...getTableProps(),
              children: [
                /* @__PURE__ */ jsxs(table_row_group_default, {
                      ...
                      /* @__PURE__ */ jsx(
                        table_header_row_default,
                        {
                          ...
                          children: [...headerRow.childNodes].map((column) => {
                            var _a;
                            return (
                              (_a = column == null ? void 0 : column.props) ==
                              null
                                ? void 0
                                : _a.isSelectionCell
                            )
                ...
                /* @__PURE__ */ jsx(table_body_default, {
                  checkboxesProps: values.checkboxesProps,
                  classNames: values.classNames,
