...
type UseTableProps<T = object> = Props<T> &
  TableStateProps<T> &
...
declare function useTable<T extends object>(
  originalProps: UseTableProps<T>,
): {
  ...
  children:
    | ((
        ...
        [
          react.ReactElement<
            _react_types_table.TableHeaderProps<T>,
            string | react.JSXElementConstructor<any>
          >,
          react.ReactElement<
            _react_types_table.TableBodyProps<T>,
            string | react.JSXElementConstructor<any>
          >,
        ])
    | undefined;
