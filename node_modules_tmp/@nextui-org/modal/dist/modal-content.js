...
var ModalContent = (0, import_system.forwardRef)((props, _) => {
  ...
  const closeButtonContent = (0, import_react.isValidElement)(closeButton)
    ? (0, import_react.cloneElement)(closeButton, getCloseButtonProps())
  ...
  const contentProps = getDialogProps(
    (0, import_utils.mergeProps)(dialogProps, otherProps),
  );
  const content = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component, {
    ...contentProps,
    onKeyDown: (0, import_utils.chain)(contentProps.onKeyDown, onKeyDown),
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        import_overlays.DismissButton,
        { onDismiss: onClose },
      ),
