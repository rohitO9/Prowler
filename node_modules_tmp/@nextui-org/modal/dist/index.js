...
function useModal(originalProps) {
  ...
  const [props, variantProps] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.modal.variantKeys,
  );
  const {
    ref,
    as,
  ...
  import_use_aria_modal_overlay.useAriaModalOverlay)(
    {
      isDismissable,
      shouldBlockScroll,
  ...
  const { buttonProps: closeButtonProps } = (0,
...
var Modal = (0, import_system2.forwardRef)((props, ref) => {
  ...
  const overlay = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ...
    { portalContainer: context.portalContainer, children },
  );
...
var ModalContent = (0, import_system3.forwardRef)((props, _) => {
  ...
  const closeButtonContent = (0, import_react2.isValidElement)(closeButton)
    ? (0, import_react2.cloneElement)(closeButton, getCloseButtonProps())
  ...
  const contentProps = getDialogProps(
    (0, import_utils2.mergeProps)(dialogProps, otherProps),
  );
  const content = /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Component, {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        import_overlays3.DismissButton,
        { onDismiss: onClose },
      ),
