"use client";
import { HiddenSelect } from "./chunk-B7FBUABT.mjs";
import { useSelect } from "./chunk-MEF3KFM6.mjs";
...
function Select(props, ref) {
  ...
  const labelContent = label
    ? /* @__PURE__ */ jsx("label", { ...getLabelProps(), children: label })
    : null;
      ...
      state.isOpen
        ? /* @__PURE__ */ jsx(FreeSoloPopover, {
            ...
            children: /* @__PURE__ */ jsx(ScrollShadow, {
              ...getListboxWrapperProps(),
              children: /* @__PURE__ */ jsx(Listbox, { ...getListboxProps() }),
            }),
          })
        : null,
    [
