...
function useTabs(originalProps) {
  ...
  const { tabListProps } = (0, import_tabs2.useTabList)(
    otherProps,
    state,
    domRef,
  );
  ...
  const placement =
    (_c = variantProps.placement) != null ? _c : isVertical ? "start" : "top";
  ...
  const getTabListProps = (0, import_react.useCallback)(
    (props2) => ({
      ...
      className: slots.tabList({
        class: (0, import_shared_utils.clsx)(
          classNames == null ? void 0 : classNames.tabList,
          props2 == null ? void 0 : props2.className,
        ),
      }),
...
var Tab = (0, import_system2.forwardRef)((props, ref) => {
  ...
  const {
    ...
    isPressed,
  } = (0, import_tabs3.useTab)(
    { key, isDisabled: isDisabledProp, shouldSelectOnPressUp },
    state,
    domRef,
  );
  ...
  const tabStyles = (0, import_shared_utils2.clsx)(
  ...
  const handleClick = () => {
    ...
    if (
      ...
      !(listRef == null ? void 0 : listRef.current)
    )
      return;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component, {
    ...
    "data-hover-unselected": (0, import_shared_utils2.dataAttr)(
    ...
    className:
      (_a = slots.tab) == null ? void 0 : _a.call(slots, { class: tabStyles }),
...
var TabPanel = (0, import_system3.forwardRef)((props, ref) => {
  ...
  const { focusProps, isFocused, isFocusVisible } = (0,
  import_focus2.useFocusRing)();
  const selectedItem = state.selectedItem;
  const content = state.collection.getItem(tabKey).props.children;
  const tabPanelStyles = (0, import_shared_utils3.clsx)(
    classNames == null ? void 0 : classNames.panel,
    className,
    (_a = selectedItem == null ? void 0 : selectedItem.props) == null
      ? void 0
      : _a.className,
  );
  const isSelected =
    tabKey === (selectedItem == null ? void 0 : selectedItem.key);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Component, {
    ...
    className:
      (_b = slots.panel) == null
        ? void 0
        : _b.call(slots, { class: tabPanelStyles }),
    "data-slot": "panel",
    children: content,
  });
});
...
function Tabs(props, ref) {
  ...
  const layoutGroupEnabled =
    !props.disableAnimation && !props.disableCursorAnimation;
  const tabsProps = {
    state,
  ...
  const tabs2 = [...state.collection].map((item) =>
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      tab_default,
      { item, ...tabsProps, ...item.props },
      item.key,
    ),
  );
  const renderTabs = /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Component, {
            ...getTabListProps(),
            children: layoutGroupEnabled
              ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                  import_framer_motion2.LayoutGroup,
                  { id: layoutId, children: tabs2 },
                )
              : tabs2,
          }),
        }),
