...
function useDateInput(originalProps) {
  ...
  const [props, variantProps] = (0, import_system2.mapPropsVariants)(
    originalProps,
  ...
  const {
    ...
    validationBehavior = (_a =
      globalContext == null ? void 0 : globalContext.validationBehavior) != null
      ? _a
      : "aria",
    ...
    createCalendar: createCalendarProp = (_f =
  ...
  const disableAnimation =
    (_g = originalProps.disableAnimation) != null
      ? _g
      : globalContext == null
        ? void 0
  ...
  const getInnerWrapperProps = (props2) => {
    const innerWrapperProps = (0, import_utils.mergeProps)(
      innerWrapperPropsProp,
      props2,
    );
    return {
      ...innerWrapperProps,
      ...
      className: slots.innerWrapper({
        class: (0, import_theme.cn)(
          ...
          innerWrapperProps == null ? void 0 : innerWrapperProps.className,
        ),
      }),
    };
  };
  ...
  const getBaseGroupProps = () => {
    return {
      ...
      "data-slot": "base",
      "data-required": (0, import_shared_utils.dataAttr)(
        originalProps.isRequired,
      ),
      "data-disabled": (0, import_shared_utils.dataAttr)(
        originalProps.isDisabled,
      ),
      "data-readonly": (0, import_shared_utils.dataAttr)(
        originalProps.isReadOnly,
      ),
      "data-invalid": (0, import_shared_utils.dataAttr)(isInvalid),
      "data-has-start-content": (0, import_shared_utils.dataAttr)(
        !!startContent,
      ),
...
var DateInputGroup = (0, import_system3.forwardRef)((props, ref) => {
  ...
  const errorMessage =
    typeof errorMessageProp === "function"
      ...
      : errorMessageProp ||
        (validationErrors == null ? void 0 : validationErrors.join(" "));
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...wrapperProps,
            children: [startContent, children, endContent],
          }),
...
var DateInputSegment = ({
  ...
  let { segmentProps } = (0, import_datepicker3.useDateSegment)(
    segment,
    state,
    ref,
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", {
    ...
    "data-placeholder": (0, import_shared_utils3.dataAttr)(
...
function useTimeInput(originalProps) {
  ...
  const [props, variantProps] = (0, import_system6.mapPropsVariants)(
    originalProps,
    import_theme2.dateInput.variantKeys,
  );
  const {
    ref,
    as,
  ...
  const disableAnimation =
    (_b = originalProps.disableAnimation) != null
      ? _b
      : globalContext == null
        ? void 0
        : globalContext.disableAnimation;
  ...
  const {
    ...
    errorMessageProps,
    isInvalid,
  } = (0, import_datepicker4.useTimeField)(
    { ...originalProps, label, validationBehavior, inputRef },
    state,
    domRef,
  );
  const baseStyles = (0, import_shared_utils4.clsx)(
    classNames == null ? void 0 : classNames.base,
    className,
  );
  ...
  const getLabelProps = (props2) => {
    return {
      ...
      "data-slot": "label",
      className: slots.label({
        class: (0, import_shared_utils4.clsx)(
          classNames == null ? void 0 : classNames.label,
          props2 == null ? void 0 : props2.className,
        ),
      }),
  ...
  const getBaseGroupProps = () => {
    return {
      ...
      shouldLabelBeOutside,
      "data-slot": "base",
      "data-required": (0, import_shared_utils4.dataAttr)(
        originalProps.isRequired,
      ),
      "data-disabled": (0, import_shared_utils4.dataAttr)(
        originalProps.isDisabled,
      ),
      "data-readonly": (0, import_shared_utils4.dataAttr)(
        originalProps.isReadOnly,
      ),
      "data-invalid": (0, import_shared_utils4.dataAttr)(isInvalid),
      "data-has-start-content": (0, import_shared_utils4.dataAttr)(
        !!startContent,
      ),
...
var time_input_default = (0, import_system7.forwardRef)(TimeInput);
