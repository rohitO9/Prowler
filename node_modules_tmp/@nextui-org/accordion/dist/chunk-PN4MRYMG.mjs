"use client";
import { accordion_item_default } from "./chunk-HYTFRFNK.mjs";
...
var AccordionGroup = forwardRef((props, ref) => {
  ...
  const content = useMemo(() => {
    return [...state.collection].map((item, index) => {
      ...
      return /* @__PURE__ */ jsxs(
        ...
        {
          children: [
            /* @__PURE__ */ jsx(accordion_item_default, {
              item,
            ...
            !item.props.hidden &&
              ...
              /* @__PURE__ */ jsx(Divider, { ...dividerProps }),
          ],
        },
        item.key,
      );
  ...
  return /* @__PURE__ */ jsx(Component, {
    ...
    children: disableAnimation
      ? content
      : /* @__PURE__ */ jsx(LayoutGroup, { children: content }),
  });
});
