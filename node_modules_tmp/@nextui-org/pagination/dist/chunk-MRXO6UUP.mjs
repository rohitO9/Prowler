...
import { pagination_item_default } from "./chunk-5E6ZQJ3X.mjs";
import { usePagination } from "./chunk-AOWPLK3C.mjs";
    ...
    (value, index) => {
      ...
      if (renderItemProp && typeof renderItemProp === "function") {
        ...
        const itemChildren = {
          ...
          [PaginationItemType.NEXT]: /* @__PURE__ */ jsx(ChevronIcon, {
            className: slots.chevronNext({
              class: classNames == null ? void 0 : classNames.chevronNext,
            }),
          }),
          [PaginationItemType.DOTS]: /* @__PURE__ */ jsxs(Fragment, {
            children: [
              ...
              /* @__PURE__ */ jsx(ForwardIcon, {
                className:
                  slots == null
                    ...
                    : slots.forwardIcon({
                        class:
                          classNames == null ? void 0 : classNames.forwardIcon,
                      }),
  ...
  return /* @__PURE__ */ jsx(Component, {
    ...
    children: /* @__PURE__ */ jsxs("ul", {
      ...
      children: [
        !disableCursorAnimation &&
          !disableAnimation &&
          /* @__PURE__ */ jsx(pagination_cursor_default, {
            ...getCursorProps(),
          }),
