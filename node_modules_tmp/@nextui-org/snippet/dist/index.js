...
function useSnippet(originalProps) {
  ...
  const [props, variantProps] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.snippet.variantKeys,
  );
  const {
    ref,
    as,
  ...
  const tooltipProps = {
    ...
    color:
      (_d = originalProps == null ? void 0 : originalProps.color) != null
        ? _d
        : (_c = import_theme.snippet.defaultVariants) == null
          ? void 0
          : _c.color,
  ...
  const onCopy = (0, import_react.useCallback)(() => {
      ...
      children.forEach((child) => {
        ...
        const childString =
          typeof child === "string"
            ? child
            : (_b2 =
                  (_a3 = child == null ? void 0 : child.props) == null
                    ? void 0
                    : _a3.children) == null
              ? void 0
              : _b2.toString();
    ...
    const valueToCopy =
      codeString ||
      stringValue ||
      ((_a2 = preRef.current) == null ? void 0 : _a2.textContent) ||
      "";
    copy(valueToCopy);
...
var Snippet = (0, import_system2.forwardRef)((props, ref) => {
  const {
    ...
    classNames,
    copied,
    copyIcon = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_shared_icons.CopyLinearIcon,
      {},
    ),
    checkIcon = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_shared_icons.CheckLinearIcon,
      {},
    ),
    symbolBefore,
    disableCopy,
  ...
  const contents = (0, import_react2.useMemo)(() => {
    ...
    const clonedCheckIcon =
      checkIcon &&
      (0, import_react2.cloneElement)(checkIcon, {
        className: slots.checkIcon(),
      });
    const clonedCopyIcon =
      copyIcon &&
      (0, import_react2.cloneElement)(copyIcon, {
        className: slots.copyIcon(),
      });
    const copyButton = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      import_button.Button,
      { ...getCopyButtonProps(), children: [clonedCheckIcon, clonedCopyIcon] },
    );
    if (disableTooltip) {
      return copyButton;
    }
