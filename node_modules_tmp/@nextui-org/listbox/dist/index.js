...
function useListbox(props) {
  ...
  const innerState = (0, import_list.useListState)({
    ...props,
    children,
    onSelectionChange,
  });
  const state = propState || innerState;
  const { listBoxProps } = (0, import_listbox.useListBox)(
    { ...props, onAction },
    state,
    domRef,
  );
  const slots = (0, import_react.useMemo)(
    () => (0, import_theme.listbox)({ className }),
    [className],
  );
...
function useListboxItem(originalProps) {
  ...
  const [props, variantProps] = (0, import_system2.mapPropsVariants)(
    originalProps,
    import_theme2.listboxItem.variantKeys,
  );
  const {
    as,
    item,
...
var ListboxItem = (0, import_system3.forwardRef)((props, _) => {
  const {
    Component,
    rendered,
    description,
...
var ListboxSection = (0, import_system4.forwardRef)(
  (
    {
      item,
      state,
    ...
    const slots = (0, import_react4.useMemo)(
      () => (0, import_theme3.listboxSection)(),
      [],
    );
    ...
    import_listbox3.useListBoxSection)({
    ...
    children: [
      ...
      [...state.collection].map((item) => {
        ...
        let listboxItem2 = /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          ...
          {
            ...itemProps,
            classNames: (0, import_utils3.mergeProps)(
              itemClasses,
              (_a = item.props) == null ? void 0 : _a.classNames,
            ),
            shouldHighlightOnFocus,
          },
          item.key,
...
var listbox_default = (0, import_system5.forwardRef)(Listbox);
