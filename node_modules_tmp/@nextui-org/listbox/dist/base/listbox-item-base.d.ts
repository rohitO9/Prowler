...
interface Props<T extends object = {}>
  ...
  selectedIcon?:
    | ReactNode
    | ((props: ListboxItemSelectedIconProps) => ReactNode)
    | null;
  /**
...
type ListboxItemBaseProps<T extends object = {}> = Props<T> &
  ListboxItemVariantProps &
  AriaOptionProps &
  FocusableProps &
  PressEvents;
declare const ListboxItemBase: <T extends object>(
