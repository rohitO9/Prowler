...
} from "./base/listbox-item-base.js";
...
type UseListboxItemProps<T extends object> = Props<T> &
  Omit<HTMLNextUIProps<"li">, keyof Props<T>>;
declare function useListboxItem<T extends object>(
  ...
  selectedIcon:
    | react.ReactNode
    | ((props: ListboxItemSelectedIconProps) => react.ReactNode);
