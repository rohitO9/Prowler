  ...
  const props = Object.keys(originalProps)
    .filter(
      (key) =>
        ...
        (commonKeys == null ? void 0 : commonKeys.includes(key)),
    )
    .reduce((acc, key) => ({ ...acc, [key]: originalProps[key] }), {});
...
var isNextUIEl = (component) => {
  var _a, _b, _c;
  return !!((_c =
    (_b = (_a = component.type) == null ? void 0 : _a.render) == null
      ? void 0
      : _b.displayName) == null
    ? void 0
    : _c.includes("NextUI"));
...
function getClassNamesWithProps({
  ...
  if (!hasSlots) {
    ...
    Object.entries((_c = props.classNames) != null ? _c : {}).forEach(
      ([key, value]) => {
