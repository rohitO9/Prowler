...
var Link = (0, import_system2.forwardRef)((props, ref) => {
  const {
    ...
    children,
    showAnchorIcon,
    anchorIcon = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_shared_icons.LinkIcon,
      { className: import_theme2.linkAnchorClasses },
    ),
    getLinkProps,
  } = useLink({
    ref,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      ...
      { children: [children, showAnchorIcon && anchorIcon] },
    ),
  });
});
