...
function usePopover(originalProps) {
  ...
  const [props, variantProps] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.popover.variantKeys,
  );
  const {
    as,
    ref,
  ...
  const getDialogProps = (props2 = {}) => ({
    ...
    "data-placement": (0, import_aria_utils2.getArrowPlacement)(
      ariaPlacement,
      placementProp,
    ),
  ...
  const placement = (0, import_react3.useMemo)(
    () =>
      (0, import_aria_utils2.getShouldUseAxisPlacement)(
        ariaPlacement,
        placementProp,
      )
  ...
  const onPress = (0, import_react3.useCallback)(
    (e) => {
      ...
      if (
        e.pointerType === "touch" &&
        ((originalProps == null ? void 0 : originalProps.backdrop) === "blur" ||
          (originalProps == null ? void 0 : originalProps.backdrop) ===
            "opaque")
      ) {
...
var [PopoverProvider, usePopoverContext] = (0,
import_react_utils2.createContext)({
  name: "PopoverContext",
  errorMessage:
...
var Popover = (0, import_system2.forwardRef)((props, ref) => {
  ...
  const overlay = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_overlays4.Overlay,
    { portalContainer: context.portalContainer, children: content },
  );
...
var PopoverTrigger = (0, import_system3.forwardRef)((props, _) => {
  ...
  const { onPress, isDisabled, ...restProps } = (0,
  import_react5.useMemo)(() => {
    return getTriggerProps(
      (0, import_utils3.mergeProps)(otherProps, child.props),
      child.ref,
    );
  }, [getTriggerProps, child.props, otherProps, child.ref]);
  const [, triggerChildren] = (0, import_react_utils3.pickChildren)(
    children,
...
var PopoverContent = (0, import_system4.forwardRef)((props, _) => {
  ...
  const { dialogProps: ariaDialogProps, titleProps } = (0,
  import_dialog.useDialog)({}, dialogRef);
      ...
      children: [
        !isNonModal &&
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            import_overlays5.DismissButton,
            { onDismiss: onClose },
          ),
            ...
            import_framer_motion2.LazyMotion,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                import_framer_motion2.m.div,
                {
                  ...
                  initial: "initial",
                  style: {
                    ...(0, import_aria_utils3.getTransformOrigins)(
                      placement === "center" ? "top" : placement,
                    ),
                  },
                  variants:
                    import_framer_utils.TRANSITION_VARIANTS.scaleSpringOpacity,
                  ...motionProps,
                  children: content,
                },
              ),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", {
    ...getPopoverProps(),
    children: [backdropContent, contents],
  });
});
...
var FreeSoloPopoverWrapper = (0, import_system5.forwardRef)(
  (
    ...
    let style = styleProp;
    if (
      transformOrigin.originX !== void 0 ||
      transformOrigin.originY !== void 0
    ) {
      style = {
        ...style,
        transformOrigin,
      ...
      style = {
        ...style,
        ...(0, import_aria_utils4.getTransformOrigins)(
          placement === "center" ? "top" : placement,
        ),
      };
    }
    return disableAnimation
      ...
      : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          import_framer_motion3.LazyMotion,
          {
            features: import_framer_motion3.domAnimation,
            children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              import_framer_motion3.m.div,
              {
                ...
                style,
                variants:
                  import_framer_utils2.TRANSITION_VARIANTS.scaleSpringOpacity,
...
var FreeSoloPopover = (0, import_system5.forwardRef)(
  (
    { children, transformOrigin, disableDialogFocus = false, ...props },
    ref,
  ) => {
    const {
      Component,
    ...
    const { dialogProps: ariaDialogProps, titleProps } = (0,
    import_dialog2.useDialog)({}, dialogRef);
    const dialogProps = getDialogProps({
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
              FreeSoloPopoverWrapper,
              {
                ...
                children: [
                  !isNonModal &&
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                      import_overlays6.DismissButton,
