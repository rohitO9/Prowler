...
function useKbd(originalProps) {
  const [props, variantProps] = (0, import_system_rsc.mapPropsVariants)(
    originalProps,
    import_theme.kbd.variantKeys,
  );
  const { as, children, className, keys, title, classNames, ...otherProps } =
    props;
...
var Kbd = (0, import_system_rsc2.forwardRef)((props, ref) => {
  const { Component, children, slots, classNames, keysToRender, getKbdProps } =
    useKbd({
      ...props,
    });
