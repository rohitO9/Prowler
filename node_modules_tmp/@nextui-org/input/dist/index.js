...
function useInput(originalProps) {
  ...
  const [props, variantProps] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.input.variantKeys,
  );
  const {
    ref,
    as,
  ...
  const innerWrapperRef = (0, import_react_utils.useDOMRef)(
    innerWrapperRefProp,
  );
  ...
  const isFilled =
    !(0, import_shared_utils.isEmpty)(inputValue) || isFilledByDefault;
  ...
  const { isHovered: isLabelHovered, hoverProps: labelHoverProps } = (0,
  import_interactions.useHover)({
    isDisabled: !!(originalProps == null ? void 0 : originalProps.isDisabled),
  });
  const {
    focusProps: clearFocusProps,
    isFocusVisible: isClearButtonFocusVisible,
  } = (0, import_focus.useFocusRing)();
  ...
  const { pressProps: clearPressProps } = (0, import_interactions.usePress)({
    isDisabled:
      ...
      !!(originalProps == null ? void 0 : originalProps.isReadOnly),
    onPress: handleClear,
  });
  const isInvalid =
    validationState === "invalid" || originalProps.isInvalid || isAriaInvalid;
  ...
  const getBaseProps = (0, import_react.useCallback)(
    (props2 = {}) => {
      return {
        ...
        "data-hover": (0, import_shared_utils.dataAttr)(
        ...
        "data-has-value": (0, import_shared_utils.dataAttr)(
          !isPlaceholderShown,
        ),
  ...
  const getInputProps = (0, import_react.useCallback)(
    (props2 = {}) => {
      return {
        ...
        "aria-readonly": (0, import_shared_utils.dataAttr)(
          originalProps.isReadOnly,
        ),
...
var Input = (0, import_system2.forwardRef)((props, ref) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
        ...
        children:
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_shared_icons.CloseFilledIcon,
            {},
          ),
      });
    }
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...getInputWrapperProps(),
            children: [!isOutsideLeft ? labelContent : null, innerWrapper],
          }),
          helperWrapper,
        ],
      });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component, {
    ...getBaseProps(),
    children: [isOutsideLeft ? labelContent : null, mainWrapper],
  });
});
...
var import_react_textarea_autosize = __toESM(
...
var Textarea = (0, import_system3.forwardRef)(
  (
    ...
    const [hasMultipleRows, setIsHasMultipleRows] = (0, import_react3.useState)(
      minRows > 1,
    );
    const [isLimitReached, setIsLimitReached] = (0, import_react3.useState)(
      false,
    );
    const labelContent = label
    ...
    const content = disableAutosize
      ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("textarea", {
          ...inputProps,
          style: (0, import_utils3.mergeProps)(
            inputProps.style,
            style != null ? style : {},
          ),
        })
      : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          import_react_textarea_autosize.default,
          {
            ...inputProps,
            cacheMeasurements,
            "data-hide-scroll": (0, import_shared_utils2.dataAttr)(
              !isLimitReached,
            ),
            maxRows,
            minRows,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Component, {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", {
          ...getInputWrapperProps(),
          "data-has-multiple-rows": (0, import_shared_utils2.dataAttr)(
            hasMultipleRows,
          ),
          children: [shouldLabelBeInside ? labelContent : null, innerWrapper],
        }),
        hasHelper
