...
function useMenuItem(props, state, ref) {
  ...
  let isDisabled =
    (_a = props.isDisabled) != null
      ? _a
      : state.selectionManager.isDisabled(key);
  let isSelected =
    (_b = props.isSelected) != null
      ? _b
  ...
  let performAction = (e) => {
    ...
    if (
      (_a2 = item == null ? void 0 : item.props) == null ? void 0 : _a2.onAction
    ) {
      item.props.onAction();
    }
    if (props.onAction) {
  ...
  let ariaProps = {
    ...
    "aria-describedby":
      [descriptionId, keyboardId].filter(Boolean).join(" ") || void 0,
  ...
  if (isVirtualized) {
    ...
    ariaProps["aria-setsize"] = (0, import_collections.getItemCount)(
      state.collection,
    );
  }
  let onPressStart = (e) => {
