...
interface MenuSectionProps<T extends object = object>
  extends MenuSectionBaseProps {
  item: Node<T>;
  state: TreeState<T>;
  /**
 ...
 * @internal
 */
declare const MenuSection: _nextui_org_system.InternalForwardRefRenderFunction<
  "li",
