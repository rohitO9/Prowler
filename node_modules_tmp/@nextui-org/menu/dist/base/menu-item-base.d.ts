...
interface Props<T extends object = {}>
  ...
  selectedIcon?:
    | ReactNode
    | ((props: MenuItemSelectedIconProps) => ReactNode)
    | null;
  /**
...
type MenuItemBaseProps<T extends object = {}> = Props<T> &
  MenuItemVariantProps &
  AriaMenuItemProps &
  FocusableProps &
  PressEvents;
declare const MenuItemBase: <T extends object>(
  props: MenuItemBaseProps<T>,
) => JSX.Element;
