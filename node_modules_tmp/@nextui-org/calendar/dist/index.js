...
function useCalendarBase(originalProps) {
  ...
  const [props, variantProps2] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.calendar.variantKeys,
  );
  ...
  const gregorianYearOffset = (0, import_shared_utils.getGregorianYearOffset)(
  ...
  const {
    ...
    createCalendar: createCalendarProp = (_a =
      globalContext == null ? void 0 : globalContext.createCalendar) != null
      ? _a
      : null,
    minValue = (_c =
      (_b = globalContext == null ? void 0 : globalContext.defaultDates) == null
        ? void 0
        : _b.minDate) != null
      ? _c
      : new import_date.CalendarDate(
          calendarProp,
          1900 + gregorianYearOffset,
          1,
          1,
        ),
    maxValue = (_e =
      (_d = globalContext == null ? void 0 : globalContext.defaultDates) == null
        ? void 0
        : _d.maxDate) != null
      ? _e
      : new import_date.CalendarDate(
          calendarProp,
          2099 + gregorianYearOffset,
          12,
          31,
        ),
  ...
  const showMonthAndYearPickers =
    ...
    visibleMonths === 1 &&
    !(originalProps == null ? void 0 : originalProps.isRange);
  ...
  const [isHeaderExpanded, setIsHeaderExpanded] = (0,
  import_utils.useControlledState)(
  ...
  const disableAnimation =
    (_g =
      (_f = originalProps.disableAnimation) != null
        ? _f
        : globalContext == null
          ? void 0
          : globalContext.disableAnimation) != null
      ? _g
      : false;
  ...
  const baseProps = {
    "data-slot": "base",
    "data-has-multiple-months": (0, import_shared_utils.dataAttr)(
      hasMultipleMonths,
    ),
    style: {
      "--visible-months":
        typeof visibleMonths === "number" ? `${visibleMonths}` : visibleMonths,
      "--calendar-width":
        typeof calendarWidth === "number"
          ? `${calendarWidth}px`
          : calendarWidth,
    },
  };
...
function useCalendar({
  ...
  const {
    ...
    nextButtonProps,
    errorMessageProps,
  } = (0, import_calendar.useCalendar)(originalProps, state);
  const baseStyles = (0, import_shared_utils2.clsx)(
  ...
  const buttonPickerProps = {
    ...
    onPress: (0, import_utils3.chain)(
      buttonPickerPropsProp == null ? void 0 : buttonPickerPropsProp.onPress,
...
var [CalendarProvider, useCalendarContext] = (0,
import_react_utils3.createContext)({
...
function useVisualElement(Component2, visualState, props, createVisualElement) {
  ...
  const wantsHandoff = (0, import_react8.useRef)(
...
function useCreateMotionContext(props) {
  const { initial, animate } = getCurrentTreeVariants(
    props,
    (0, import_react10.useContext)(MotionContext),
  );
...
function createMotionComponent({
  ...
  function MotionComponent(props, externalRef) {
    ...
    if (!isStatic && isBrowser) {
      ...
      const initialLayoutGroupConfig = (0, import_react13.useContext)(
...
function createMotionProxy(createConfig) {
  function custom(Component2, customMotionComponentConfig = {}) {
    return createMotionComponent(
      createConfig(Component2, customMotionComponentConfig),
    );
  }
...
try {
  loadExternalIsValidProp(
    (init_is_prop_valid_esm(), __toCommonJS(is_prop_valid_esm_exports)).default,
  );
} catch (_a) {}
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component2, props, ref, { latestValues }, isStatic) => {
    const useVisualProps = isSVGComponent(Component2)
      ? useSVGProps
      : useHTMLProps;
    ...
    const renderedChildren = (0, import_react16.useMemo)(
...
function createRenderBatcher(scheduleNextBatch, allowKeepAlive) {
  ...
  const cancel = (process2) =>
    stepsOrder.forEach((key) => steps2[key].cancel(process2));
...
function createDomMotionConfig(
  ...
  const baseConfig = isSVGComponent(Component2)
    ? svgMotionConfig
    : htmlMotionConfig;
  return {
    ...baseConfig,
...
function getKeyframes(value, valueName, target, transition2) {
  ...
  const defaultOrigin =
    transition2.from !== void 0 ? transition2.from : value.get();
  ...
  if (
    ...
    for (let i = 0; i < noneKeyframeIndexes.length; i++) {
      ...
      keyframes2[index2] = getAnimatableNone2(
        valueName,
        animatableTemplateValue,
      );
    }
  ...
  return (onComplete) => {
    ...
    if (
      ...
      return createInstantAnimation(
        instantAnimationState.current ? { ...options, delay: 0 } : options,
      );
    }
    if (
      !transition2.isHandoff &&
      value.owner &&
...
function getOriginFromTransition(key, transition2) {
  ...
  const valueTransition =
    transition2[key] || transition2["default"] || transition2;
...
function animateTarget(
  ...
  let {
    transition: transition2 = visualElement.getDefaultTransition(),
    transitionEnd,
    ...target
  } = visualElement.makeTargetAnimatable(definition);
  const willChange = visualElement.getValue("willChange");
  if (transitionOverride) transition2 = transitionOverride;
  const animations2 = [];
  ...
  for (const key in target) {
    ...
    let canSkip =
      !valueTransition.isHandoff && !hasKeyframesChanged(value, valueTarget);
    if (
...
function animateVariant(visualElement, variant, options = {}) {
  ...
  let { transition: transition2 = visualElement.getDefaultTransition() || {} } =
    resolved || {};
...
var checkAndConvertChangedValueTypes = (
  visualElement,
  target,
  origin = {},
  transitionEnd = {},
...
var VisualElement = class {
  ...
  readValue(key) {
    var _a;
    return this.latestValues[key] !== void 0 || !this.current
  ...
  getBaseTarget(key) {
    ...
    const valueFromInitial =
      typeof initial === "string" || typeof initial === "object"
        ? (_a = resolveVariantFromProps(this.props, initial)) === null ||
          _a === void 0
          ? void 0
          : _a[key]
        : void 0;
...
var DOMVisualElement = class extends VisualElement {
  ...
  makeTargetAnimatableFromInstance(
    { transition: transition2, transitionEnd, ...target },
    { transformValues },
    isMounted,
  ) {
...
var createDomVisualElement = (Component2, options) => {
  return isSVGComponent(Component2)
...
function useForceUpdate() {
  ...
  import_react20.useState)(0);
  const forceRender = (0, import_react20.useCallback)(() => {
    isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  const deferredForceRender = (0, import_react20.useCallback)(
...
var AnimatePresence = ({
  ...
  const forceRender =
    (0, import_react24.useContext)(LayoutGroupContext).forceRender ||
    useForceUpdate()[0];
  const isMounted = useIsMounted();
  const filteredChildren = onlyElements(children);
  let childrenToRender = filteredChildren;
  const exitingChildren = (0, import_react24.useRef)(
    /* @__PURE__ */ new Map(),
  ).current;
  const presentChildren = (0, import_react24.useRef)(childrenToRender);
  const allChildren = (0, import_react24.useRef)(
    /* @__PURE__ */ new Map(),
  ).current;
    ...
    if (!exitingComponent) {
      const onExit = () => {
        ...
        presentChildren.current = filteredChildren.filter((presentChild) => {
          ...
          return (
            presentChildKey === key || leftOverKeys.includes(presentChildKey)
          );
        });
      ...
      exitingComponent = React4.createElement(
        PresenceChild,
        {
          key: getChildKey(child),
          isPresent: false,
  ...
  return React4.createElement(
    ...
    exitingChildren.size
      ? childrenToRender
      : childrenToRender.map((child) =>
          (0, import_react24.cloneElement)(child),
        ),
  );
};
...
function CalendarCell(originalProps) {
  const { state, slots, isPickerVisible, currentMonth, classNames, ...props } =
    originalProps;
  ...
  const {
  ...
  } = (0, import_calendar3.useCalendarCell)(
    {
      ...props,
      isDisabled:
        !(0, import_date3.isSameMonth)(props.date, currentMonth) ||
        isPickerVisible,
    },
    state,
    ref,
  ...
  const isSelectionStart =
    isSelected &&
    highlightedRange &&
    (0, import_date3.isSameDay)(props.date, highlightedRange.start);
  const isSelectionEnd =
    isSelected &&
    highlightedRange &&
    (0, import_date3.isSameDay)(props.date, highlightedRange.end);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("td", {
    className:
      slots == null
        ? void 0
        : slots.cell({ class: classNames == null ? void 0 : classNames.cell }),
    "data-slot": "cell",
    ...cellProps,
    children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", {
      ...
      "data-disabled": (0, import_shared_utils3.dataAttr)(
        isDisabled && !isInvalid,
      ),
      "data-focus-visible": (0, import_shared_utils3.dataAttr)(
        isFocused && isFocusVisible,
      ),
      "data-hover": (0, import_shared_utils3.dataAttr)(isHovered),
      "data-invalid": (0, import_shared_utils3.dataAttr)(isInvalid),
      "data-outside-month": (0, import_shared_utils3.dataAttr)(
        !(0, import_date3.isSameMonth)(props.date, currentMonth),
      ),
      "data-pressed": (0, import_shared_utils3.dataAttr)(
        isPressed && !state.isReadOnly,
      ),
      "data-range-end": (0, import_shared_utils3.dataAttr)(isRangeEnd),
      "data-range-selection": (0, import_shared_utils3.dataAttr)(
        isSelected && "highlightedRange" in state,
      ),
      ...
      "data-selection-start": (0, import_shared_utils3.dataAttr)(
        isSelectionStart,
      ),
      "data-today": (0, import_shared_utils3.dataAttr)(
        (0, import_date3.isToday)(props.date, state.timeZone),
      ),
...
function CalendarMonth(props) {
  ...
  const { gridProps, headerProps, weekDays } = (0,
  import_calendar4.useCalendarGrid)(
    {
      ...props,
      weekdayStyle,
  ...
  const bodyContent = [...new Array(weeksInMonth).keys()].map((weekIndex) =>
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      "tr",
      {
        ...
        children: state.getDatesInWeek(weekIndex, startDate).map((date, i) =>
          date
            ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                CalendarCell,
                {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("table", {
    ...
    className:
      slots == null
        ? void 0
        : slots.grid({ class: classNames == null ? void 0 : classNames.grid }),
    "data-slot": "grid",
    tabIndex: -1,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("thead", {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("tr", {
          ...
          children: weekDays.map((day, index2) =>
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              "th",
              {
                className:
...
function CalendarHeader(props) {
  ...
  const monthDateContent = monthAndYearDateFormatter.format(
    date.toDate(state.timeZone),
  );
  const headerTitle = /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
  ...
  return showMonthAndYearPickers
    ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_button.Button, {
        ...headerProps,
        disableAnimation,
        endContent: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          ChevronDownIcon,
...
var CalendarPickerItem = (0, import_react29.forwardRef)(
  ({ children, autoFocus, isDisabled, onKeyDown, ...otherProps }, ref) => {
    const domRef = (0, import_react_utils4.useDOMRef)(ref);
    const { buttonProps: ariaButtonProps, isPressed } = (0,
    import_use_aria_button.useAriaButton)(
      {
        elementType: "button",
        isDisabled,
        onKeyDown,
    ...
    const { isFocusVisible, isFocused, focusProps } = (0,
    import_focus3.useFocusRing)({
      autoFocus,
    });
...
var import_scroll_into_view_if_needed = __toESM(
...
function useCalendarPicker(props) {
  ...
  const highlightRef = (0, import_react30.useRef)(null);
  const yearsListRef = (0, import_react30.useRef)(null);
  const monthsListRef = (0, import_react30.useRef)(null);
  const monthsItemsRef = (0, import_react30.useRef)();
  const yearsItemsRef = (0, import_react30.useRef)();
  ...
  const years =
    (_a = getYearRange(state.minValue, state.maxValue)) == null
      ? void 0
      : _a.map((y) => ({
          value: y.year,
  ...
  const handleListScroll = (0, import_react30.useCallback)(
    (e, highlightEl, list) => {
      ...
      const item = items.find((itemEl) => {
        ...
        const rect2 =
          highlightEl == null ? void 0 : highlightEl.getBoundingClientRect();
        if (!rect2) {
          return false;
        }
      ...
      const itemValue = Number(
        item == null ? void 0 : item.getAttribute("data-value"),
      );
      if (!itemValue) return;
      let date2 = state.focusedDate.set(
  ...
  (0, import_react30.useEffect)(() => {
    ...
    return () => {
      if (debouncedHandleMonthsScroll) {
        monthsList == null
          ? void 0
          : monthsList.removeEventListener(
              "scroll",
              debouncedHandleMonthsScroll,
            );
      }
  ...
  const onPickerItemPressed = (0, import_react30.useCallback)(
    (e, list) => {
  ...
  const onPickerItemKeyDown = (0, import_react30.useCallback)(
    (e, value, list) => {
      var _a2;
      const map = getItemsRefMap(
        list === "months" ? monthsItemsRef : yearsItemsRef,
      ...
      switch (e.key) {
        ...
        case " ":
          setIsHeaderExpanded == null ? void 0 : setIsHeaderExpanded(false);
          (_a2 = headerRef == null ? void 0 : headerRef.current) == null
            ? void 0
            : _a2.focus();
          return;
      }
...
function CalendarPicker(props) {
  ...
  const EmptyItem = (0, import_react31.useCallback)(
    (props2) =>
  ...
  const PickerItemWrapper = (0, import_react31.useCallback)(
    ({ children }) =>
        ...
        import_jsx_runtime8.Fragment,
        {
          children: [
            Array.from({ length: EMPTY_ITEMS_OFFSET }, (_, i) =>
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(EmptyItem, {}, i),
            ),
            children,
            Array.from({ length: EMPTY_ITEMS_OFFSET }, (_, i) =>
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(EmptyItem, {}, i),
            ...
            children: months.map((month) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                CalendarPickerItem,
                {
                  ...
                  tabIndex:
                    !isHeaderExpanded ||
                    ((_a = state.focusedDate) == null ? void 0 : _a.month) !==
                      month.value
                      ? -1
                      : 0,
                  onKeyDown: (e) =>
                    onPickerItemKeyDown(e, month.value, "months"),
            ...
            children: years.map((year) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                CalendarPickerItem,
                {
                  ...
                  tabIndex:
                    !isHeaderExpanded ||
                    ((_a = state.focusedDate) == null ? void 0 : _a.year) !==
                      year.value
                      ? -1
                      : 0,
...
function CalendarBase(props) {
  ...
  const [direction, setDirection] = (0, import_react33.useState)(0);
  ...
  for (let i = 0; i < visibleMonths; i++) {
          ...
          children: [
            i === 0 &&
              /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
                ...
                {
                  ...prevButtonProps,
                  onPress: (0, import_utils18.chain)(
    ...
    const calendarMonthContent = /* @__PURE__ */ (0,
    import_react34.createElement)(CalendarMonth, {
      ...props,
    ...
    calendars.push(
      showMonthAndYearPickers
        ? /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
            ...
            `calendar-month-with-pickers-${i}`,
          )
        : calendarMonthContent,
    );
  }
  const calendarContent = /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
    import_jsx_runtime9.Fragment,
    {
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          "div",
          {
            className:
              slots == null
                ...
                : slots.headerWrapper({
                    class:
                      classNames == null ? void 0 : classNames.headerWrapper,
                  }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(Component2, {
    ...(0, import_utils18.mergeProps)(calendarProps, otherProps),
    ref,
    children: [
      topContent,
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
                    ...
                    import_jsx_runtime9.Fragment,
                    {
                      children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
                        MotionConfig,
                        {
                          transition,
                          children: /* @__PURE__ */ (0,
                          import_jsx_runtime9.jsx)(LazyMotion, {
...
var calendar_default = (0, import_system2.forwardRef)(Calendar2);
...
function useRangeCalendar({ className, ...originalProps }) {
  ...
  const {
    ...
    nextButtonProps,
    errorMessageProps,
  } = (0, import_calendar5.useRangeCalendar)(originalProps, state, domRef);
  const baseStyles = (0, import_shared_utils6.clsx)(
    classNames == null ? void 0 : classNames.base,
    className,
  );
  const getBaseCalendarProps = (props = {}) => {
