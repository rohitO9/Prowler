...
function createRenderBatcher(scheduleNextBatch, allowKeepAlive) {
  ...
  const cancel = (process) =>
    stepsOrder.forEach((key) => steps2[key].cancel(process));
...
function CalendarMonth(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("table", {
    ...gridProps,
    ...
    tabIndex: -1,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("thead", {
        ...headerProps,
        className:
          slots == null
            ? void 0
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("tr", {
          className:
            slots == null
              ? void 0
              : slots.gridHeaderRow({
