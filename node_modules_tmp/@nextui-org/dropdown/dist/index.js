...
var [DropdownProvider, useDropdownContext] = (0,
...
function useDropdown(props) {
  ...
  const getPopoverProps = (props2 = {}) => {
    ...
    return {
      ...
      classNames: {
        ...classNamesProp,
        ...props2.classNames,
        content: (0, import_shared_utils.clsx)(
          classNames,
          classNamesProp == null ? void 0 : classNamesProp.content,
          props2.className,
        ),
      },
  ...
  const getMenuTriggerProps = (originalProps = {}, _ref = null) => {
    const { onPress, onPressStart, ...otherMenuTriggerProps } =
      menuTriggerProps;
    return {
...
var Dropdown = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownProvider, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      ...
      { ...context.getPopoverProps(), children: [menuTrigger, menu] },
    ),
  });
};
...
var DropdownTrigger = (0, import_system2.forwardRef)((props, _) => {
  const { getMenuTriggerProps } = useDropdownContext();
  const { children, ...otherProps } = props;
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    import_popover2.PopoverTrigger,
    { ...getMenuTriggerProps(otherProps), children },
  );
});
...
var dropdown_menu_default = (0, import_system3.forwardRef)(DropdownMenu);
