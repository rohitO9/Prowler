...
declare const DropdownProvider: react.Provider<{
  ...
  >;
  getMenuProps: <T extends object>(
    props?: Partial<_nextui_org_menu.MenuProps<T>> | undefined,
    _ref?: react.Ref<any> | undefined,
  ) => _nextui_org_menu.MenuProps<object>;
  getMenuTriggerProps: _nextui_org_system.PropGetter<
    Record<string, unknown>,
    _nextui_org_system.DOMAttributes<_nextui_org_system.DOMElement>
  >;
}>;
