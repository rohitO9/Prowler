...
function useSwitch(originalProps = {}) {
  ...
  const [props, variantProps] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.toggle.variantKeys,
  );
  const {
    ref,
    as,
  ...
  import_focus.useFocusRing)({ autoFocus: inputProps.autoFocus });
...
var Switch = (0, import_system2.forwardRef)((props, ref) => {
  ...
  const clonedThumbIcon =
    typeof thumbIcon === "function"
      ...
      : thumbIcon &&
        (0, import_react3.cloneElement)(thumbIcon, getThumbIconProps());
  const clonedStartContent =
    startContent &&
    (0, import_react3.cloneElement)(startContent, getStartContentProps());
  const clonedEndContent =
    endContent &&
    (0, import_react3.cloneElement)(endContent, getEndContentProps());
