"use client";
import { useSwitch } from "./chunk-JYO7OWIA.mjs";
...
var Switch = forwardRef((props, ref) => {
  ...
  const clonedStartContent =
    startContent && cloneElement(startContent, getStartContentProps());
  const clonedEndContent =
    endContent && cloneElement(endContent, getEndContentProps());
