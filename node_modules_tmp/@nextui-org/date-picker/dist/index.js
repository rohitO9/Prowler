...
function useForceUpdate() {
  ...
  const [forcedRenderCount, setForcedRenderCount] = (0, import_react7.useState)(
    0,
  );
  const forceRender = (0, import_react7.useCallback)(() => {
    isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  const deferredForceRender = (0, import_react7.useCallback)(
...
function onlyElements(children) {
  ...
  import_react11.Children.forEach(children, (child) => {
    if ((0, import_react11.isValidElement)(child)) filtered.push(child);
  });
  return filtered;
}
var AnimatePresence = ({
  ...
  const forceRender =
    (0, import_react11.useContext)(LayoutGroupContext).forceRender ||
    useForceUpdate()[0];
  const isMounted = useIsMounted();
  const filteredChildren = onlyElements(children);
  let childrenToRender = filteredChildren;
  const exitingChildren = (0, import_react11.useRef)(
    /* @__PURE__ */ new Map(),
  ).current;
  const presentChildren = (0, import_react11.useRef)(childrenToRender);
  const allChildren = (0, import_react11.useRef)(
    /* @__PURE__ */ new Map(),
  ).current;
  ...
  exitingChildren.forEach((component, key) => {
    ...
    if (!exitingComponent) {
      ...
      exitingComponent = (0, import_jsx_runtime3.jsx)(
        PresenceChild,
        {
          isPresent: false,
  ...
  childrenToRender = childrenToRender.map((child) => {
    ...
    return exitingChildren.has(key)
      ...
      : (0, import_jsx_runtime3.jsx)(
          PresenceChild,
          { isPresent: true, presenceAffectsLayout, mode, children: child },
          getChildKey(child),
        );
  });
  if (
...
function useDatePickerBase(originalProps) {
  ...
  const [props, variantProps] = (0, import_system.mapPropsVariants)(
    originalProps,
    import_theme.dateInput.variantKeys,
  );
  const {
    as,
    ref,
  ...
  const handleHeaderExpandedChange = (0, import_react12.useCallback)(
    (isExpanded) => {
      onHeaderExpandedChange == null
        ? void 0
        : onHeaderExpandedChange(isExpanded || false);
    },
    [onHeaderExpandedChange],
  );
  const [isCalendarHeaderExpanded, setIsCalendarHeaderExpanded] = (0,
  import_utils2.useControlledState)(
    isHeaderExpanded,
  ...
  const disableAnimation =
    (_b =
      (_a = originalProps.disableAnimation) != null
        ? _a
        : globalContext == null
          ? void 0
      ...
      ? _b
      : false;
  let stringFormatter = (0, import_i18n.useLocalizedStringFormatter)(
    messages_default,
  );
  ...
  const placeholder =
    originalProps == null ? void 0 : originalProps.placeholderValue;
  const timePlaceholder =
    placeholder && "hour" in placeholder ? placeholder : null;
  const timeMinValue =
    originalProps.minValue && "hour" in originalProps.minValue
      ? originalProps.minValue
      : null;
  const timeMaxValue =
    originalProps.maxValue && "hour" in originalProps.maxValue
      ? originalProps.maxValue
      : null;
  const slotsProps = {
  ...
  const dateInputProps = {
    ...
    errorMessage,
    validationBehavior,
    "data-invalid": (0, import_shared_utils.dataAttr)(
      originalProps == null ? void 0 : originalProps.isInvalid,
    ),
  };
  const timeInputProps = {
    ...
    label:
      (userTimeInputProps == null ? void 0 : userTimeInputProps.label) ||
      stringFormatter.format("time"),
  ...
  const popoverProps = {
    ...
    children:
      (_d = (_c = slotsProps.popoverProps) == null ? void 0 : _c.children) !=
      null
        ? _d
        : [],
    triggerRef: domRef,
...
function useDatePicker({ className, classNames, ...originalProps }) {
  ...
  const validationBehavior =
    (_b =
      (_a = originalProps.validationBehavior) != null
        ? _a
        : globalContext == null
          ? void 0
          : globalContext.validationBehavior) != null
      ? _b
      : "aria";
  const {
    domRef,
      ...
      classNames: {
        base: slots.timeInput({
          class: (0, import_shared_utils2.clsx)(
            classNames == null ? void 0 : classNames.timeInput,
            (_a2 =
              userTimeInputProps == null
                ? void 0
                : userTimeInputProps.classNames) == null
              ? void 0
              : _a2.base,
          ),
        }),
        label: slots.timeInputLabel({
          class: (0, import_shared_utils2.clsx)(
            classNames == null ? void 0 : classNames.timeInputLabel,
            (_b2 =
              userTimeInputProps == null
                ? void 0
                : userTimeInputProps.classNames) == null
  ...
  const getPopoverProps = (props = {}) => {
    ...
    return {
      ...
      classNames: {
        content: slots.popoverContent({
          class: (0, import_shared_utils2.clsx)(
            ...
            (_b2 =
              (_a2 = slotsProps.popoverProps) == null
                ? void 0
                : _a2.classNames) == null
              ? void 0
              : _b2["content"],
      ...
      shouldCloseOnInteractOutside: (
        ...
        ? popoverProps.shouldCloseOnInteractOutside
        : (element) =>
            (0, import_aria_utils.ariaShouldCloseOnInteractOutside)(
              element,
              popoverTriggerRef,
              state,
            ),
...
function DatePicker(props, ref) {
  ...
  const selectorContent = (0, import_react15.isValidElement)(selectorIcon)
    ? (0, import_react15.cloneElement)(selectorIcon, getSelectorIconProps())
    : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        import_shared_icons.CalendarBoldIcon,
        { ...getSelectorIconProps() },
      );
  ...
  const popoverContent = state.isOpen
    ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        import_popover.FreeSoloPopover,
        {
          ...getPopoverProps(),
    ...
    import_jsx_runtime4.Fragment,
    {
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          ...
          {
            ...getDateInputProps(),
            endContent: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        ...
        disableAnimation
          ? popoverContent
          : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(AnimatePresence, {
...
function DateRangePickerField(props, ref) {
  ...
  } = (0, import_datepicker3.useDateField)(
    { ...otherProps, inputRef },
    state,
    domRef,
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Component2, {
...
var date_range_picker_field_default = (0, import_react16.forwardRef)(
...
function useDateRangePicker({
  ...
  } = (0, import_datepicker6.useDateRangePicker)(
    { ...originalProps, validationBehavior },
    state,
    domRef,
  );
    ...
    return {
      ...
      classNames: {
        ...
        shouldCloseOnInteractOutside: (
          ...
          ? popoverProps.shouldCloseOnInteractOutside
          : (element) =>
              (0, import_aria_utils2.ariaShouldCloseOnInteractOutside)(
                element,
                popoverTriggerRef,
                state,
              ),
  ...
  const getCalendarProps = () => {
    ...
    return {
      ...
      classNames: {
        ...
        base: slots.calendar({
          class: (0, import_theme3.cn)(
            (_a2 = calendarProps == null ? void 0 : calendarProps.classNames) ==
              null
              ? void 0
              : _a2.base,
            classNames == null ? void 0 : classNames.calendar,
          ),
        }),
        content: slots.calendarContent({
          class: (0, import_theme3.cn)(
            (_b2 = calendarProps == null ? void 0 : calendarProps.classNames) ==
              null
              ? void 0
              : _b2.content,
            classNames == null ? void 0 : classNames.calendarContent,
          ),
        }),
      },
    };
  ...
  const baseStyles = (0, import_shared_utils3.clsx)(
    classNames == null ? void 0 : classNames.base,
    className,
  );
  ...
  const getDateInputGroupProps = () => {
    return {
      ...
      "data-slot": "base",
      "data-required": (0, import_shared_utils3.dataAttr)(
        originalProps.isRequired,
      ),
      "data-disabled": (0, import_shared_utils3.dataAttr)(
        originalProps.isDisabled,
      ),
      "data-readonly": (0, import_shared_utils3.dataAttr)(
        originalProps.isReadOnly,
      ),
      "data-invalid": (0, import_shared_utils3.dataAttr)(isInvalid),
      "data-has-start-content": (0, import_shared_utils3.dataAttr)(
        !!startContent,
      ),
      "data-has-multiple-months": (0, import_shared_utils3.dataAttr)(
        hasMultipleMonths,
      ),
...
function DateRangePicker(props, ref) {
  ...
  const selectorContent = (0, import_react19.isValidElement)(selectorIcon)
    ? (0, import_react19.cloneElement)(selectorIcon, getSelectorIconProps())
    : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        import_shared_icons2.CalendarBoldIcon,
        { ...getSelectorIconProps() },
      );
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", {
              className:
                slots == null
                  ? void 0
                  : slots.timeInputWrapper({
                      class:
                        classNames == null
                          ? void 0
                          : classNames.timeInputWrapper,
                    }),
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                  import_date_input3.TimeInput,
                  { ...getStartTimeInputProps() },
                ),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                  import_date_input3.TimeInput,
  ...
  const popoverContent = state.isOpen
    ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        import_popover2.FreeSoloPopover,
        {
          ...getPopoverProps(),
          offset: 20,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
    import_jsx_runtime6.Fragment,
    {
      children: [
        ...
        disableAnimation
          ? popoverContent
          : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(AnimatePresence, {
              children: popoverContent,
            }),
      ],
    },
