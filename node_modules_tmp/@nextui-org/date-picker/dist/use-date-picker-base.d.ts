...
type Variants =
  ...
  | "labelPlacement"
  | "fullWidth";
type UseDatePickerBaseProps<T extends DateValue> = Props<T> &
...
declare function useDatePickerBase<T extends DateValue>(
  originalProps: UseDatePickerBaseProps<T>,
): {
  ...
  createCalendar:
    | ((
        calendar: _nextui_org_system.SupportedCalendars,
      ) => _internationalized_date.Calendar | null)
    | undefined;
  stringFormatter: any;
  ...
  timeMinValue:
    | _internationalized_date.CalendarDateTime
    | _internationalized_date.ZonedDateTime
    | null;
  timeMaxValue:
    | _internationalized_date.CalendarDateTime
    | _internationalized_date.ZonedDateTime
