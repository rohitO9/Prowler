...
function useCard(originalProps) {
  ...
  const disableRipple =
    (_d =
      (_c = originalProps.disableRipple) != null
        ? _c
        : globalContext == null
          ? void 0
          : globalContext.disableRipple) != null
      ? _d
      : false;
      ...
      return {
        ...
        ...(0, import_utils.mergeProps)(
          originalProps.isPressable
            ? { ...buttonProps, ...focusProps, role: "button" }
            : {},
...
var CardHeader = (0, import_system3.forwardRef)((props, ref) => {
  ...
  const headerStyles = (0, import_shared_utils2.clsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Component, {
    ref: domRef,
    className:
      (_a = slots.header) == null
        ? void 0
        : _a.call(slots, { class: headerStyles }),
    ...otherProps,
    children,
  });
});
...
var CardBody = (0, import_system4.forwardRef)((props, ref) => {
  ...
  const { slots, classNames } = useCardContext();
  const bodyStyles = (0, import_shared_utils3.clsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Component, {
    ...
    className:
      (_a = slots.body) == null
        ? void 0
        : _a.call(slots, { class: bodyStyles }),
    ...otherProps,
    children,
  });
});
...
var CardFooter = (0, import_system5.forwardRef)((props, ref) => {
  ...
  const { slots, classNames } = useCardContext();
  const footerStyles = (0, import_shared_utils4.clsx)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, {
    ref: domRef,
    className:
      (_a = slots.footer) == null
        ? void 0
        : _a.call(slots, { class: footerStyles }),
    ...otherProps,
    children,
  });
});
