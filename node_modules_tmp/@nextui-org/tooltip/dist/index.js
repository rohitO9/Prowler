...
function useTooltip(originalProps) {
  ...
  const { triggerProps, tooltipProps: triggerTooltipProps } = (0,
  import_tooltip2.useTooltipTrigger)(
    {
      isDisabled,
      trigger: triggerAction,
    },
  ...
  const slots = (0, import_react2.useMemo)(() => {
    ...
    return (0, import_theme.popover)({
      ...
      disableAnimation,
      radius:
        (_a2 = originalProps == null ? void 0 : originalProps.radius) != null
          ? _a2
          : "md",
      size:
        (_b2 = originalProps == null ? void 0 : originalProps.size) != null
          ? _b2
          : "md",
      shadow:
        (_c = originalProps == null ? void 0 : originalProps.shadow) != null
          ? _c
          : "sm",
    });
  }, [
  ...
  const getTooltipProps = (0, import_react2.useCallback)(
    () => ({
      ...
      "data-placement": (0, import_aria_utils.getArrowPlacement)(
        placement,
        placementProp,
      ),
...
var Tooltip = (0, import_system2.forwardRef)((props, ref) => {
  ...
  try {
    ...
    if (!(0, import_react3.isValidElement)(children)) {
      trigger = /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
        ...getTriggerProps(),
        children,
      });
    } else {
      const child = children;
      trigger = (0, import_react3.cloneElement)(
        child,
  ...
  const animatedContent = /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    ref: tooltipRef,
    id,
    style,
      ...
      children: [
        ...
        disableAnimation && isOpen
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              import_overlays2.OverlayContainer,
              {
                portalContainer,
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    Component,
                    { ...getTooltipContentProps(), children: content },
                  ),
                }),
              },
            )
