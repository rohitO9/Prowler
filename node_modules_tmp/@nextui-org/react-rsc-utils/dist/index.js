...
function getValidChildren(children) {
  return import_react.Children.toArray(children).filter((child) =>
...
var pickChildren = (children, targetChild) => {
  var _a;
  let target = [];
  const withoutTargetChildren =
    (_a = import_react.Children.map(children, (item) => {
...
function filterDOMProps(props, opts = {}) {
  ...
  for (const prop in props) {
    ...
    if (
      (omitEventNames == null ? void 0 : omitEventNames.has(prop)) &&
      funcRe.test(prop)
    ) {
      continue;
    }
    ...
    if (
      (Object.prototype.hasOwnProperty.call(props, prop) &&
        (DOMPropNames.has(prop) ||
          ...
          (propNames == null ? void 0 : propNames.has(prop)) ||
          propRe.test(prop))) ||
      funcRe.test(prop)
    ) {
