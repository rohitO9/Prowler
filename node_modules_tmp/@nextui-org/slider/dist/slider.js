...
function useSliderThumb(props) {
  ...
  const getTooltipProps = () => {
    const value = numberFormatter
      ? numberFormatter.format(state.values[index != null ? index : 0])
      : state.values[index != null ? index : 0];
    return {
      ...tooltipProps,
      placement: (tooltipProps == null ? void 0 : tooltipProps.placement)
        ? tooltipProps == null
          ? void 0
      ...
      isOpen:
        (tooltipProps == null ? void 0 : tooltipProps.isOpen) !== void 0
          ? tooltipProps == null
            ? void 0
            : tooltipProps.isOpen
...
var SliderThumb = (0, import_system.forwardRef)((props, ref) => {
  ...
  return showTooltip
    ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_tooltip.Tooltip, {
        ...getTooltipProps(),
        children: content,
      })
    : content;
...
function useSlider(originalProps) {
  ...
  const [props, variantProps] = (0, import_system2.mapPropsVariants)(
    originalProps,
    import_theme.slider.variantKeys,
  );
  const {
    ref,
    as,
  ...
  const state = (0, import_slider2.useSliderState)({
    ...
    isDisabled:
      (_c = originalProps == null ? void 0 : originalProps.isDisabled) != null
        ? _c
        : false,
    orientation,
    step,
  ...
  const tooltipProps = {
    ...
    color: (originalProps == null ? void 0 : originalProps.color)
      ? originalProps == null
        ? void 0
        : originalProps.color
      : (_d = import_theme.slider.defaultVariants) == null
        ? void 0
        : _d.color,
    isDisabled: originalProps.isDisabled,
    ...userTooltipProps,
  };
  const { groupProps, trackProps, labelProps, outputProps } = (0,
  import_slider3.useSlider)(originalProps, state, trackRef);
  ...
  const hasSingleThumb =
    fillOffset === void 0 ? state.values.length === 1 : false;
  ...
  const getTrackProps = (props2 = {}) => {
    return {
      ref: trackRef,
      "data-slot": "track",
      "data-thumb-hidden": !!(originalProps == null
        ? void 0
        : originalProps.hideThumb),
  ...
  const getFillerProps = (props2 = {}) => {
    return {
      ...
      style: {
        ...props2.style,
        [isVertical ? "bottom" : direction === "rtl" ? "right" : "left"]:
          `${startOffset * 100}%`,
        ...(isVertical
          ? {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", {
            ...
            children: [
              ...
              (marks == null ? void 0 : marks.length) > 0 &&
                marks.map((mark, index) =>
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                    "div",
                    { ...getMarkProps(mark), children: mark.label },
                    index,
                  ),
                ),
            ],
