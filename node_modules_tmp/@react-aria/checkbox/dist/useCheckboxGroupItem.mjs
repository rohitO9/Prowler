...
import {
  useFormValidationState as $6clEo$useFormValidationState,
  DEFAULT_VALIDATION_RESULT as $6clEo$DEFAULT_VALIDATION_RESULT,
  privateValidationStateProp as $6clEo$privateValidationStateProp,
...
function $fba3e38d5ca8983f$export$353b32fc6898d37d(props, state, inputRef) {
  ...
  validationBehavior =
    (_props_validationBehavior = props.validationBehavior) !== null &&
    _props_validationBehavior !== void 0
      ? _props_validationBehavior
      : validationBehavior;
  // Local validation for this checkbox.
  let { realtimeValidation: realtimeValidation } = (0,
  $6clEo$useFormValidationState)({
    ...props,
  ...
  let nativeValidation = (0, $6clEo$useRef)(
    (0, $6clEo$DEFAULT_VALIDATION_RESULT),
  );
  ...
  let res = (0, $406796ff087fe49b$export$e375f10ce42261c5)(
    {
      ...
      isRequired:
        (_props_isRequired = props.isRequired) !== null &&
        _props_isRequired !== void 0
          ? _props_isRequired
          : state.isRequired,
      validationBehavior: validationBehavior,
