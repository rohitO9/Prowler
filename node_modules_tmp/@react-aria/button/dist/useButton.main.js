...
$parcel$export(
  module.exports,
  "useButton",
  () => $988353faa005faf8$export$ea18c227d4417cc3,
);
/*
...
function $988353faa005faf8$export$ea18c227d4417cc3(props, ref) {
  ...
  $lIlxZ$reactariainteractions.usePress)({
    onPressStart: onPressStart,
    onPressEnd: onPressEnd,
    onPressChange: onPressChange,
    onPress: onPress,
  ...
  $lIlxZ$reactariafocus.useFocusable)(props, ref);
  if (allowFocusWhenDisabled)
    focusableProps.tabIndex = isDisabled ? -1 : focusableProps.tabIndex;
  let buttonProps = (0, $lIlxZ$reactariautils.mergeProps)(
    focusableProps,
    pressProps,
    (0, $lIlxZ$reactariautils.filterDOMProps)(props, {
      labelable: true,
    }),
  );
  return {
    isPressed: isPressed,
    buttonProps: (0, $lIlxZ$reactariautils.mergeProps)(
      additionalProps,
      buttonProps,
      {
