...
$parcel$export(
  module.exports,
  "useOption",
  () => $c164f9f79f4cef2d$export$497855f14858aa34,
);
/*
...
function $c164f9f79f4cef2d$export$497855f14858aa34(props, state, ref) {
  ...
  let isDisabled =
    (_props_isDisabled = props.isDisabled) !== null &&
    _props_isDisabled !== void 0
      ? _props_isDisabled
      : state.selectionManager.isDisabled(key);
  var _props_isSelected;
  let isSelected =
    (_props_isSelected = props.isSelected) !== null &&
    _props_isSelected !== void 0
      ? _props_isSelected
  ...
  let isVirtualized =
    (_props_isVirtualized = props.isVirtualized) !== null &&
    _props_isVirtualized !== void 0
  ...
  if (
    !(
      (0, $bOFHO$reactariautils.isMac)() &&
      (0, $bOFHO$reactariautils.isWebKit)()
    )
  ) {
  ...
  if (isVirtualized) {
    ...
    optionProps["aria-setsize"] = (0,
    $bOFHO$reactstatelycollections.getItemCount)(state.collection);
  }
  let onAction = (data === null || data === void 0 ? void 0 : data.onAction)
    ? () => {
        ...
        return data === null || data === void 0
          ? void 0
          : (_data_onAction = data.onAction) === null ||
              _data_onAction === void 0
            ? void 0
  ...
  } = (0, $bOFHO$reactariaselection.useSelectableItem)({
    ...
    onAction:
      ...
      (item === null || item === void 0
        ...
        : (_item_props = item.props) === null || _item_props === void 0
          ? void 0
          : _item_props.onAction)
        ? (0, $bOFHO$reactariautils.chain)(
            item === null || item === void 0
              ? void 0
              : (_item_props1 = item.props) === null || _item_props1 === void 0
                ? void 0
                : _item_props1.onAction,
            onAction,
          )
        : undefined,
  ...
  let domProps = (0, $bOFHO$reactariautils.filterDOMProps)(
    item === null || item === void 0 ? void 0 : item.props,
  );
  delete domProps.id;
  let linkProps = (0, $bOFHO$reactariautils.useLinkProps)(
    item === null || item === void 0 ? void 0 : item.props,
  );
  return {
    optionProps: {
      ...optionProps,
      ...(0, $bOFHO$reactariautils.mergeProps)(
        domProps,
        itemProps,
        hoverProps,
        linkProps,
    ...
    isFocused: isFocused,
    isFocusVisible:
      isFocused && (0, $bOFHO$reactariainteractions.isFocusVisible)(),
