import {
  getItemId as $b1f0cad8af73213b$export$9145995848b05025,
  listData as $b1f0cad8af73213b$export$3585ede4d035bf14,
} from "./utils.mjs";
import {
  useSlotId as $fcwmx$useSlotId,
  isMac as $fcwmx$isMac,
  isWebKit as $fcwmx$isWebKit,
  chain as $fcwmx$chain,
  filterDOMProps as $fcwmx$filterDOMProps,
  useLinkProps as $fcwmx$useLinkProps,
  mergeProps as $fcwmx$mergeProps,
} from "@react-aria/utils";
import { getItemCount as $fcwmx$getItemCount } from "@react-stately/collections";
import {
  useHover as $fcwmx$useHover,
  isFocusVisible as $fcwmx$isFocusVisible,
...
function $293f70390ea03370$export$497855f14858aa34(props, state, ref) {
  ...
  let domProps = (0, $fcwmx$filterDOMProps)(
    item === null || item === void 0 ? void 0 : item.props,
  );
  delete domProps.id;
  let linkProps = (0, $fcwmx$useLinkProps)(
    item === null || item === void 0 ? void 0 : item.props,
  );
  return {
    optionProps: {
