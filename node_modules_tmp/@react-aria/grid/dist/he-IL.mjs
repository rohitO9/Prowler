...
$fe732cdb32124ea8$exports = {
  deselectedItem: (args) =>
    `${args.item} \u{5DC}\u{5D0} \u{5E0}\u{5D1}\u{5D7}\u{5E8}.`,
  ...
  selectedCount: (args, formatter) =>
    `${formatter.plural(args.count, {
      ...
      one: () =>
        `\u{5E4}\u{5E8}\u{5D9}\u{5D8} ${formatter.number(args.count)} \u{5E0}\u{5D1}\u{5D7}\u{5E8}`,
      other: () =>
        `${formatter.number(args.count)} \u{5E4}\u{5E8}\u{5D9}\u{5D8}\u{5D9}\u{5DD} \u{5E0}\u{5D1}\u{5D7}\u{5E8}\u{5D5}`,
    })}.`,
