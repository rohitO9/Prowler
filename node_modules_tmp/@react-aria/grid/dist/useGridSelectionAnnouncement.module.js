...
function $92599c3fd427b763$export$137e594ef3218a10(props, state) {
  ...
  let stringFormatter = (0, $4stjr$useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($4stjr$intlStringsmodulejs)),
    "@react-aria/grid",
  );
  ...
  (0, $4stjr$useUpdateEffect)(() => {
    ...
    let removedKeys = $92599c3fd427b763$var$diffSelection(
      lastSelection.current,
      selection,
    );
