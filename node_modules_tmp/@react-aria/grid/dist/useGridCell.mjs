...
import {
  getFocusableTreeWalker as $j4Qbl$getFocusableTreeWalker,
  focusSafely as $j4Qbl$focusSafely,
} from "@react-aria/focus";
import {
  scrollIntoViewport as $j4Qbl$scrollIntoViewport,
  getScrollParent as $j4Qbl$getScrollParent,
  mergeProps as $j4Qbl$mergeProps,
      ...
      if (focusMode === "child") {
        ...
        let focusable =
          state.selectionManager.childFocusStrategy === "last"
            ? $ab90dcbc1b5466d0$var$last(treeWalker)
        ...
        if (focusable) {
          ...
          if (focusMode === "cell" && direction === "rtl") {
            ...
            focusable =
              direction === "rtl"
                ? walker.firstChild()
                : $ab90dcbc1b5466d0$var$last(walker);
            if (focusable) {
              (0, $j4Qbl$focusSafely)(focusable);
              (0, $j4Qbl$scrollIntoViewport)(focusable, {
                containingElement: (0, $j4Qbl$getScrollParent)(ref.current),
