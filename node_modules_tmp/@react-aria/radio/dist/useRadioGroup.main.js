...
$parcel$export(
  module.exports,
  "useRadioGroup",
  () => $dfcade00a56a6317$export$62b9571f283ff5c2,
);
/*
...
function $dfcade00a56a6317$export$62b9571f283ff5c2(props, state) {
  ...
  } = (0, $bNSfM$reactarialabel.useField)({
    ...props,
  ...
  $bNSfM$reactariainteractions.useFocusWithin)({
    onBlurWithin(e) {
      var _props_onBlur;
  ...
  let onKeyDown = (e) => {
    ...
    e.preventDefault();
    let walker = (0, $bNSfM$reactariafocus.getFocusableTreeWalker)(
      e.currentTarget,
      {
        from: e.target,
      },
