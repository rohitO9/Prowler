...
$parcel$export(
  module.exports,
  "SSRProvider",
  () => $97d95f6660b1bb14$export$9f8ac96af4b1b2ae,
);
$parcel$export(
  module.exports,
  "useIsSSR",
  () => $97d95f6660b1bb14$export$535bd6ca7f90a273,
);
$parcel$export(
  module.exports,
  "useSSRSafeId",
  () => $97d95f6660b1bb14$export$619500959fc48b26,
);
/*
...
const $97d95f6660b1bb14$var$SSRContext = /*#__PURE__*/ (0,
$parcel$interopDefault($14Xyt$react)).createContext(
  $97d95f6660b1bb14$var$defaultContext,
);
const $97d95f6660b1bb14$var$IsSSRContext = /*#__PURE__*/ (0,
$parcel$interopDefault($14Xyt$react)).createContext(false);
...
function $97d95f6660b1bb14$var$LegacySSRProvider(props) {
  ...
  let counter = $97d95f6660b1bb14$var$useCounter(
    cur === $97d95f6660b1bb14$var$defaultContext,
  );
  ...
  return /*#__PURE__*/ (0, $parcel$interopDefault($14Xyt$react)).createElement(
    $97d95f6660b1bb14$var$SSRContext.Provider,
    {
      value: value,
    },
    /*#__PURE__*/ (0, $parcel$interopDefault($14Xyt$react)).createElement(
      $97d95f6660b1bb14$var$IsSSRContext.Provider,
      {
        value: isSSR,
      },
      props.children,
...
function $97d95f6660b1bb14$export$9f8ac96af4b1b2ae(props) {
  if (
    typeof (0, $parcel$interopDefault($14Xyt$react))["useId"] === "function"
  ) {
    if (
      process.env.NODE_ENV !== "test" &&
      !$97d95f6660b1bb14$var$warnedAboutSSRProvider
    ) {
      console.warn(
    ...
    return /*#__PURE__*/ (0,
    $parcel$interopDefault($14Xyt$react)).createElement(
      (0, $parcel$interopDefault($14Xyt$react)).Fragment,
      null,
      props.children,
    );
  }
  return /*#__PURE__*/ (0, $parcel$interopDefault($14Xyt$react)).createElement(
    $97d95f6660b1bb14$var$LegacySSRProvider,
    props,
  );
}
let $97d95f6660b1bb14$var$canUseDOM = Boolean(
...
function $97d95f6660b1bb14$var$useCounter(isDisabled = false) {
  ...
  if (ref.current === null && !isDisabled) {
    ...
    let currentOwner =
      ...
      $parcel$interopDefault($14Xyt$react))
    ...
    if (currentOwner) {
      let prevComponentValue =
        $97d95f6660b1bb14$var$componentIds.get(currentOwner);
...
function $97d95f6660b1bb14$var$useLegacySSRSafeId(defaultId) {
  ...
  if (
    ctx === $97d95f6660b1bb14$var$defaultContext &&
    !$97d95f6660b1bb14$var$canUseDOM
  )
    console.warn(
...
function $97d95f6660b1bb14$var$useModernSSRSafeId(defaultId) {
  ...
  let [didSSR] = (0, $14Xyt$react.useState)(
    $97d95f6660b1bb14$export$535bd6ca7f90a273(),
  );
  let prefix =
    didSSR || process.env.NODE_ENV === "test"
      ? "react-aria"
      : `react-aria${$97d95f6660b1bb14$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
const $97d95f6660b1bb14$export$619500959fc48b26 =
  typeof (0, $parcel$interopDefault($14Xyt$react))["useId"] === "function"
    ? $97d95f6660b1bb14$var$useModernSSRSafeId
    : $97d95f6660b1bb14$var$useLegacySSRSafeId;
...
function $97d95f6660b1bb14$export$535bd6ca7f90a273() {
  ...
  if (
    typeof (0, $parcel$interopDefault($14Xyt$react))["useSyncExternalStore"] ===
    "function"
  )
    return (0, $parcel$interopDefault($14Xyt$react))["useSyncExternalStore"](
      $97d95f6660b1bb14$var$subscribe,
      $97d95f6660b1bb14$var$getSnapshot,
      $97d95f6660b1bb14$var$getServerSnapshot,
    );
  // eslint-disable-next-line react-hooks/rules-of-hooks
