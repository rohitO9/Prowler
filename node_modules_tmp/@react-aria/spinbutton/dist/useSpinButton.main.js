...
$parcel$export(
  module.exports,
  "useSpinButton",
  () => $37bbd4c129023f61$export$e908e06f4b8e3402,
);
/*
...
function $37bbd4c129023f61$export$e908e06f4b8e3402(props) {
  ...
  const stringFormatter = (0, $2pZbw$reactariai18n.useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($cb4b786159079747$exports)),
  ...
  const onIncrementPressStart = (0, $2pZbw$reactariautils.useEffectEvent)(
    (initialStepDelay) => {
      clearAsync();
  ...
  const onDecrementPressStart = (0, $2pZbw$reactariautils.useEffectEvent)(
    (initialStepDelay) => {
      clearAsync();
  ...
  } = (0, $2pZbw$reactariautils.useGlobalListeners)();
  return {
    spinButtonProps: {
      role: "spinbutton",
