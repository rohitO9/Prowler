...
$parcel$export(
  module.exports,
  "useDateSegment",
  () => $5c015c6316d1904d$export$1315d136e6f7581,
);
/*
...
function $5c015c6316d1904d$export$1315d136e6f7581(segment, state, ref) {
  ...
  } = (0, $4acc2f407c169e55$exports.hookData).get(state);
  let textValue = segment.isPlaceholder ? "" : segment.text;
  let options = (0, $5Tgzj$react.useMemo)(
  ...
  let { spinButtonProps: spinButtonProps } = (0,
  $5Tgzj$reactariaspinbutton.useSpinButton)({
  ...
  let parser = (0, $5Tgzj$react.useMemo)(
    () =>
      new (0, $5Tgzj$internationalizednumber.NumberParser)(locale, {
  ...
  let onKeyDown = (e) => {
    ...
    if (
      e.key === "a" &&
      ((0, $5Tgzj$reactariautils.isMac)() ? e.metaKey : e.ctrlKey)
    )
      e.preventDefault();
  ...
  let eras = (0, $5Tgzj$react.useMemo)(() => {
    ...
    let date = (0, $5Tgzj$internationalizeddate.toCalendar)(
      new (0, $5Tgzj$internationalizeddate.CalendarDate)(1, 1, 1),
      state.calendar,
    );
    ...
    let prefixLength = $5c015c6316d1904d$var$commonPrefixLength(
  ...
  let onFocus = () => {
    ...
    (0, $5Tgzj$reactariautils.scrollIntoViewport)(ref.current, {
      containingElement: (0, $5Tgzj$reactariautils.getScrollParent)(
        ref.current,
      ),
    });
  ...
  let touchPropOverrides =
    (0, $5Tgzj$reactariautils.isIOS)() || segment.type === "timeZoneName"
      ? {
          role: "textbox",
          "aria-valuemax": null,
          "aria-valuemin": null,
  ...
  let firstSegment = (0, $5Tgzj$react.useMemo)(
  ...
  return {
    segmentProps: (0, $5Tgzj$reactariautils.mergeProps)(
      spinButtonProps,
      labelProps,
      {
        id: id,
