...
$parcel$export(
  module.exports,
  "hookData",
  () => $4acc2f407c169e55$export$653eddfc964b0f8a,
);
$parcel$export(
  module.exports,
  "roleSymbol",
...
$parcel$export(
  module.exports,
  "focusManagerSymbol",
  () => $4acc2f407c169e55$export$7b3062cd49e80452,
);
$parcel$export(
  module.exports,
  "useDateField",
  () => $4acc2f407c169e55$export$5591b0b878c1a989,
);
$parcel$export(
  module.exports,
  "useTimeField",
  () => $4acc2f407c169e55$export$4c842f6a241dc825,
);
/*
...
function $4acc2f407c169e55$export$5591b0b878c1a989(props, state, ref) {
  ...
  } = (0, $lVMtq$reactarialabel.useField)({
    ...props,
  ...
  let { focusWithinProps: focusWithinProps } = (0,
  $lVMtq$reactariainteractions.useFocusWithin)({
    ...props,
    onFocusWithin(e) {
      var _props_onFocus;
      valueOnFocus.current = state.value;
      (_props_onFocus = props.onFocus) === null || _props_onFocus === void 0
        ? void 0
        : _props_onFocus.call(props, e);
    },
    onBlurWithin: (e) => {
      var _props_onBlur;
      state.confirmPlaceholder();
      if (state.value !== valueOnFocus.current) state.commitValidation();
      (_props_onBlur = props.onBlur) === null || _props_onBlur === void 0
        ? void 0
        : _props_onBlur.call(props, e);
    },
    onFocusWithinChange: props.onFocusChange,
  });
  let stringFormatter = (0, $lVMtq$reactariai18n.useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($c1905b78f6d2f5bf$exports)),
  ...
  let description = state.value
    ? stringFormatter.format(message, {
  ...
  let describedBy =
    props[$4acc2f407c169e55$export$300019f83c56d282] === "presentation"
  ...
  let focusManager = (0, $lVMtq$react.useMemo)(
    () =>
      propsFocusManager || (0, $lVMtq$reactariafocus.createFocusManager)(ref),
    [propsFocusManager, ref],
  );
  let groupProps = (0, $715562ad3b4cced4$exports.useDatePickerGroup)(
    state,
    ref,
    props[$4acc2f407c169e55$export$300019f83c56d282] === "presentation",
  );
  ...
  $4acc2f407c169e55$export$653eddfc964b0f8a.set(state, {
    ...
    ariaLabelledBy:
      [labelProps.id, props["aria-labelledby"]].filter(Boolean).join(" ") ||
      undefined,
  ...
  let fieldDOMProps;
  if (props[$4acc2f407c169e55$export$300019f83c56d282] === "presentation")
    fieldDOMProps = {
      role: "presentation",
    };
  else
    fieldDOMProps = (0, $lVMtq$reactariautils.mergeProps)(fieldProps, {
      role: "group",
  ...
  (0, $lVMtq$reactariautils.useFormReset)(
    props.inputRef,
    state.value,
    state.setValue,
  );
  ...
  let inputProps = {
    ...
    name: props.name,
    value:
      ((_state_value = state.value) === null || _state_value === void 0
        ? void 0
        : _state_value.toString()) || "",
  };
  ...
  return {
    ...
    fieldProps: (0, $lVMtq$reactariautils.mergeProps)(
      domProps,
      fieldDOMProps,
      groupProps,
      focusWithinProps,
...
function $4acc2f407c169e55$export$4c842f6a241dc825(props, state, ref) {
  ...
  res.inputProps.value =
    ((_state_timeValue = state.timeValue) === null ||
    _state_timeValue === void 0
      ? void 0
      : _state_timeValue.toString()) || "";
  return res;
}
