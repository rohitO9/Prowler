...
$parcel$export(
  module.exports,
  "useDateRangePicker",
  () => $20f695b1b69e6b9e$export$12fd5f0e9f4bb192,
);
/*
...
function $20f695b1b69e6b9e$export$12fd5f0e9f4bb192(props, state, ref) {
  ...
  let stringFormatter = (0, $Xt1Bd$reactariai18n.useLocalizedStringFormatter)(
  ...
  } = (0, $Xt1Bd$reactarialabel.useField)({
    ...props,
  ...
  let ariaDescribedBy =
    [descProps["aria-describedby"], fieldProps["aria-describedby"]]
      .filter(Boolean)
      .join(" ") || undefined;
  let focusManager = (0, $Xt1Bd$react.useMemo)(
    () =>
      (0, $Xt1Bd$reactariafocus.createFocusManager)(ref, {
  ...
  $Xt1Bd$reactariainteractions.useFocusWithin)({
    ...props,
  ...
  let startFieldValidation = (0, $Xt1Bd$react.useRef)(
    (0, $Xt1Bd$reactstatelyform.DEFAULT_VALIDATION_RESULT),
  );
  let endFieldValidation = (0, $Xt1Bd$react.useRef)(
    (0, $Xt1Bd$reactstatelyform.DEFAULT_VALIDATION_RESULT),
  );
  return {
    groupProps: (0, $Xt1Bd$reactariautils.mergeProps)(
      domProps,
      groupProps,
      fieldProps,
      descProps,
      ...
      [(0, $Xt1Bd$reactstatelyform.privateValidationStateProp)]: {
        ...
        updateValidation(e) {
          ...
          state.updateValidation(
            (0, $Xt1Bd$reactstatelyform.mergeValidation)(
              e,
              endFieldValidation.current,
            ),
          );
        },
