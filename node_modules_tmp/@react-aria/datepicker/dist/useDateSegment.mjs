...
import {
  toCalendar as $4d1jn$toCalendar,
  CalendarDate as $4d1jn$CalendarDate,
} from "@internationalized/date";
import {
  isMac as $4d1jn$isMac,
  scrollIntoViewport as $4d1jn$scrollIntoViewport,
  getScrollParent as $4d1jn$getScrollParent,
  useEvent as $4d1jn$useEvent,
  useLayoutEffect as $4d1jn$useLayoutEffect,
  isIOS as $4d1jn$isIOS,
  useId as $4d1jn$useId,
  useLabels as $4d1jn$useLabels,
  mergeProps as $4d1jn$mergeProps,
} from "@react-aria/utils";
import { NumberParser as $4d1jn$NumberParser } from "@internationalized/number";
import $4d1jn$react, {
  useRef as $4d1jn$useRef,
  useMemo as $4d1jn$useMemo,
} from "react";
import {
  useLocale as $4d1jn$useLocale,
  useDateFormatter as $4d1jn$useDateFormatter,
  useFilter as $4d1jn$useFilter,
...
function $32489daedd52963e$export$1315d136e6f7581(segment, state, ref) {
  ...
  if (segment.type === "month" && !segment.isPlaceholder) {
    ...
    textValue =
      monthTextValue !== textValue
        ? `${textValue} \u{2013} ${monthTextValue}`
        : monthTextValue;
  ...
  let parser = (0, $4d1jn$useMemo)(
    () =>
      new (0, $4d1jn$NumberParser)(locale, {
  ...
  let onKeyDown = (e) => {
    ...
    if (e.key === "a" && ((0, $4d1jn$isMac)() ? e.metaKey : e.ctrlKey))
      e.preventDefault();
  ...
  let eras = (0, $4d1jn$useMemo)(() => {
    ...
    let date = (0, $4d1jn$toCalendar)(
      new (0, $4d1jn$CalendarDate)(1, 1, 1),
      state.calendar,
    );
    ...
    let prefixLength = $32489daedd52963e$var$commonPrefixLength(
      eras.map((era) => era.formatted),
    );
    if (prefixLength)
      for (let era of eras) era.formatted = era.formatted.slice(prefixLength);
    return eras;
  ...
  let touchPropOverrides =
    (0, $4d1jn$isIOS)() || segment.type === "timeZoneName"
      ? {
          role: "textbox",
          "aria-valuemax": null,
          "aria-valuemin": null,
  ...
  let firstSegment = (0, $4d1jn$useMemo)(
