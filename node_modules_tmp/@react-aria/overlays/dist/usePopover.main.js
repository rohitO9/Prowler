...
$parcel$export(
  module.exports,
  "usePopover",
  () => $6c2dfcdee3e15e20$export$542a6fd13ac93354,
);
/*
...
function $6c2dfcdee3e15e20$export$542a6fd13ac93354(props, state) {
  ...
  let { overlayProps: overlayProps, underlayProps: underlayProps } = (0,
  ...
  let {
    ...
    placement: placement,
  } = (0, $cd94b4896dd97759$exports.useOverlayPosition)({
    ...otherProps,
  ...
  (0, $jkVOI$reactariautils.useLayoutEffect)(() => {
    if (state.isOpen && !isNonModal && popoverRef.current)
      return (0, $08ef1685902b6011$exports.ariaHideOutside)([
        popoverRef.current,
      ]);
  }, [isNonModal, state.isOpen, popoverRef]);
  return {
    popoverProps: (0, $jkVOI$reactariautils.mergeProps)(
      overlayProps,
      positionProps,
    ),
    arrowProps: arrowProps,
