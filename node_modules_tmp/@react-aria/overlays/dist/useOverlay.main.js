...
$parcel$export(
  module.exports,
  "useOverlay",
  () => $82711f9cb668ecdb$export$ea8f71083e90600f,
);
/*
...
function $82711f9cb668ecdb$export$ea8f71083e90600f(props, ref) {
  ...
  let onHide = () => {
    if (
      $82711f9cb668ecdb$var$visibleOverlays[
        $82711f9cb668ecdb$var$visibleOverlays.length - 1
      ] === ref &&
      onClose
    )
      onClose();
  ...
  let onInteractOutsideStart = (e) => {
    if (
      ...
      shouldCloseOnInteractOutside(e.target)
    ) {
      if (
        $82711f9cb668ecdb$var$visibleOverlays[
          $82711f9cb668ecdb$var$visibleOverlays.length - 1
  ...
  $eQbp7$reactariainteractions.useFocusWithin)({
    ...
    onBlurWithin: (e) => {
      ...
      if (
        !e.relatedTarget ||
        (0, $eQbp7$reactariafocus.isElementInChildOfActiveScope)(
          e.relatedTarget,
        )
      )
        return;
