 ...
 */
// @ts-ignore
const $5c2f5cd01815d369$var$visualViewport =
...
function $5c2f5cd01815d369$export$ee0f7cc6afcd1c18(options = {}) {
  ...
  (0, $59kHH$reactariautils.useLayoutEffect)(() => {
    ...
    if ($5c2f5cd01815d369$var$preventScrollCount === 1) {
      if ((0, $59kHH$reactariautils.isIOS)())
        $5c2f5cd01815d369$var$restore =
          $5c2f5cd01815d369$var$preventScrollMobileSafari();
      else
        $5c2f5cd01815d369$var$restore =
          $5c2f5cd01815d369$var$preventScrollStandard();
    }
    return () => {
      $5c2f5cd01815d369$var$preventScrollCount--;
...
function $5c2f5cd01815d369$var$preventScrollStandard() {
  return (0, $59kHH$reactariautils.chain)(
    $5c2f5cd01815d369$var$setStyle(
...
function $5c2f5cd01815d369$var$preventScrollMobileSafari() {
  ...
  let onTouchStart = (e) => {
    ...
    if (
      ...
      restoreScrollableStyles = $5c2f5cd01815d369$var$setStyle(
        scrollable,
        "overscrollBehavior",
        "contain",
      );
  ...
  let onTouchEnd = (e) => {
    ...
    if (
      $5c2f5cd01815d369$var$willOpenKeyboard(target) &&
  ...
  let setupStyles = () => {
    ...
    restoreStyles = (0, $59kHH$reactariautils.chain)(
      $5c2f5cd01815d369$var$addEvent(window, "scroll", onWindowScroll),
      $5c2f5cd01815d369$var$setStyle(
        document.documentElement,
        "paddingRight",
        `${window.innerWidth - document.documentElement.clientWidth}px`,
  ...
  let removeEvents = (0, $59kHH$reactariautils.chain)(
    $5c2f5cd01815d369$var$addEvent(document, "touchstart", onTouchStart, {
      passive: false,
      capture: true,
    }),
...
function $5c2f5cd01815d369$var$willOpenKeyboard(target) {
  return (
    (target instanceof HTMLInputElement &&
      !$5c2f5cd01815d369$var$nonTextInputTypes.has(target.type)) ||
