...
import {
  useInteractOutside as $jtpZv$useInteractOutside,
  useFocusWithin as $jtpZv$useFocusWithin,
...
function $a11501f3d1d39e6c$export$ea8f71083e90600f(props, ref) {
  ...
  let onHide = () => {
    if (
      $a11501f3d1d39e6c$var$visibleOverlays[
        $a11501f3d1d39e6c$var$visibleOverlays.length - 1
      ] === ref &&
      onClose
    )
      onClose();
  ...
  let { focusWithinProps: focusWithinProps } = (0, $jtpZv$useFocusWithin)({
    ...
    onBlurWithin: (e) => {
      ...
      if (
        !e.relatedTarget ||
        (0, $jtpZv$isElementInChildOfActiveScope)(e.relatedTarget)
      )
        return;
      if (
        !shouldCloseOnInteractOutside ||
