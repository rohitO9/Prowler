...
$parcel$export(
  module.exports,
  "useHover",
  () => $ffbc150311c75f01$export$ae780daf29e6d456,
);
/*
...
function $ffbc150311c75f01$var$setupGlobalTouchEvents() {
  ...
  if (typeof PointerEvent !== "undefined")
    document.addEventListener(
      "pointerup",
      $ffbc150311c75f01$var$handleGlobalPointerEvent,
    );
  else
    document.addEventListener(
      "touchend",
...
function $ffbc150311c75f01$export$ae780daf29e6d456(props) {
  ...
  let { hoverProps: hoverProps, triggerHoverEnd: triggerHoverEnd } = (0,
  $82z6W$react.useMemo)(() => {
    ...
    if (typeof PointerEvent !== "undefined") {
      hoverProps.onPointerEnter = (e) => {
        if (
          $ffbc150311c75f01$var$globalIgnoreEmulatedMouseEvents &&
          e.pointerType === "mouse"
        )
          return;
