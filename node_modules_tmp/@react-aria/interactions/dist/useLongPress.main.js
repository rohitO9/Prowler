...
$parcel$export(
  module.exports,
  "useLongPress",
  () => $3cd7b5d0eebf0ca9$export$c24ed0104d07eab9,
);
/*
...
function $3cd7b5d0eebf0ca9$export$c24ed0104d07eab9(props) {
  let {
    ...
    threshold: threshold = $3cd7b5d0eebf0ca9$var$DEFAULT_THRESHOLD,
  ...
  } = (0, $5sxTM$reactariautils.useGlobalListeners)();
  ...
  let descriptionProps = (0, $5sxTM$reactariautils.useDescription)(
    onLongPress && !isDisabled ? accessibilityDescription : undefined,
  );
  return {
    longPressProps: (0, $5sxTM$reactariautils.mergeProps)(
      pressProps,
      descriptionProps,
    ),
  };
