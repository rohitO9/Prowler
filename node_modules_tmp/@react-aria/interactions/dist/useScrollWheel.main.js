...
$parcel$export(
  module.exports,
  "useScrollWheel",
  () => $a3dbce0aed7087e2$export$2123ff2b87c81ca,
);
/*
...
function $a3dbce0aed7087e2$export$2123ff2b87c81ca(props, ref) {
  ...
  let onScrollHandler = (0, $jo4fw$react.useCallback)(
    (e) => {
  ...
  (0, $jo4fw$reactariautils.useEvent)(
    ref,
    "wheel",
    isDisabled ? undefined : onScrollHandler,
  );
}
