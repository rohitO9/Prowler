...
$parcel$export(
  module.exports,
  "PressResponder",
  () => $3596bae48579386f$export$3351871ee4b288b8,
);
$parcel$export(
  module.exports,
  "ClearPressResponder",
  () => $3596bae48579386f$export$cf75428e0b9ed1ea,
);
/*
...
const $3596bae48579386f$export$3351871ee4b288b8 = /*#__PURE__*/ (0,
$parcel$interopDefault($3maub$react)).forwardRef(
  ({ children: children, ...props }, ref) => {
    let isRegistered = (0, $3maub$react.useRef)(false);
    let prevContext = (0, $3maub$react.useContext)(
      (0, $01d3f539e91688c8$exports.PressResponderContext),
    );
    ref = (0, $3maub$reactariautils.useObjectRef)(
      ref ||
    ...
    return /*#__PURE__*/ (0,
    $parcel$interopDefault($3maub$react)).createElement(
      (0, $01d3f539e91688c8$exports.PressResponderContext).Provider,
      {
        value: context,
      },
      children,
...
function $3596bae48579386f$export$cf75428e0b9ed1ea({ children: children }) {
  ...
  return /*#__PURE__*/ (0, $parcel$interopDefault($3maub$react)).createElement(
    (0, $01d3f539e91688c8$exports.PressResponderContext).Provider,
    {
      value: context,
    },
