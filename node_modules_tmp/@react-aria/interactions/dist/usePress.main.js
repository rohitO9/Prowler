...
$parcel$export(
  module.exports,
  "usePress",
  () => $0294ea432cd92340$export$45712eceda6fad21,
);
/*
...
function $0294ea432cd92340$var$usePressResponderContext(props) {
  ...
  let context = (0, $bBqCQ$react.useContext)(
    (0, $01d3f539e91688c8$exports.PressResponderContext),
  );
  if (context) {
...
class $0294ea432cd92340$var$PressEvent {
  continuePropagation() {
    (0, $bBqCQ$swchelperscjs_class_private_field_setcjs._)(
      this,
      $0294ea432cd92340$var$_shouldStopPropagation,
      false,
    );
  }
  get shouldStopPropagation() {
    return (0, $bBqCQ$swchelperscjs_class_private_field_getcjs._)(
      this,
      $0294ea432cd92340$var$_shouldStopPropagation,
    );
  }
  constructor(type, pointerType, originalEvent, state) {
    (0, $bBqCQ$swchelperscjs_class_private_field_initcjs._)(
      this,
      $0294ea432cd92340$var$_shouldStopPropagation,
      {
        writable: true,
...
function $0294ea432cd92340$export$45712eceda6fad21(props) {
  ...
  } = (0, $bBqCQ$reactariautils.useGlobalListeners)();
  let triggerPressStart = (0, $bBqCQ$reactariautils.useEffectEvent)(
  ...
  let triggerPressEnd = (0, $bBqCQ$reactariautils.useEffectEvent)(
  ...
  let triggerPressUp = (0, $bBqCQ$reactariautils.useEffectEvent)(
    (originalEvent, pointerType) => {
      let state = ref.current;
  ...
  let cancel = (0, $bBqCQ$reactariautils.useEffectEvent)((e) => {
    ...
    if (state.isPressed && state.target) {
      if (state.isOverTarget && state.pointerType != null)
        triggerPressEnd(
          $0294ea432cd92340$var$createEvent(state.target, e),
          state.pointerType,
          false,
        );
  ...
  let pressProps = (0, $bBqCQ$react.useMemo)(() => {
    ...
    let pressProps = {
      onKeyDown(e) {
        if (
          $0294ea432cd92340$var$isValidKeyboardEvent(
            e.nativeEvent,
            e.currentTarget,
          ) &&
          ...
          if (
            $0294ea432cd92340$var$shouldPreventDefaultKeyboard(e.target, e.key)
          )
            e.preventDefault();
          ...
          if (!state.isPressed && !e.repeat) {
            ...
            let pressUp = (e) => {
              if (
                $0294ea432cd92340$var$isValidKeyboardEvent(e, originalTarget) &&
                !e.repeat &&
            ...
            addGlobalListener(
              (0, $bBqCQ$reactariautils.getOwnerDocument)(e.currentTarget),
              "keyup",
              (0, $bBqCQ$reactariautils.chain)(pressUp, onKeyUp),
              true,
            );
          }
      ...
      onClick(e) {
        ...
        if (
          ...
          !(0, $bBqCQ$reactariautils.openLink).isOpening
        ) {
          let shouldStopPropagation = true;
          ...
          if (
            ...
            (state.pointerType === "virtual" ||
              (0, $bBqCQ$reactariautils.isVirtualClick)(e.nativeEvent))
          ) {
    ...
    let onKeyUp = (e) => {
      ...
      if (
        state.isPressed &&
        state.target &&
        $0294ea432cd92340$var$isValidKeyboardEvent(e, state.target)
      ) {
        ...
        if (
          e.key !== "Enter" &&
          $0294ea432cd92340$var$isHTMLAnchorLink(state.target) &&
          state.target.contains(target) &&
          !e[$0294ea432cd92340$var$LINK_CLICKED]
        ) {
    ...
    if (typeof PointerEvent !== "undefined") {
      ...
      pressProps.onPointerUp = (e) => {
        ...
        if (
          e.button === 0 &&
          $0294ea432cd92340$var$isOverTarget(e, e.currentTarget)
        )
      ...
      let onPointerMove = (e) => {
        ...
        if (
          state.target &&
          $0294ea432cd92340$var$isOverTarget(e, state.target)
        ) {
          if (!state.isOverTarget && state.pointerType != null) {
            state.isOverTarget = true;
            triggerPressStart(
      ...
      pressProps.onMouseDown = (e) => {
        ...
        state.isOverTarget = true;
        state.target = e.currentTarget;
        state.pointerType = (0, $bBqCQ$reactariautils.isVirtualClick)(
          e.nativeEvent,
        )
          ? "virtual"
          : "mouse";
      ...
      pressProps.onTouchStart = (e) => {
        ...
        let shouldStopPropagation = triggerPressStart(
          $0294ea432cd92340$var$createTouchEvent(state.target, e),
          state.pointerType,
        );
        if (shouldStopPropagation) e.stopPropagation();
        addGlobalListener(
          (0, $bBqCQ$reactariautils.getOwnerWindow)(e.currentTarget),
          "scroll",
          onScroll,
          true,
        );
      ...
      pressProps.onTouchMove = (e) => {
        ...
        let touch = $0294ea432cd92340$var$getTouchById(
          e.nativeEvent,
        ...
        if (
          touch &&
          $0294ea432cd92340$var$isOverTarget(touch, e.currentTarget)
        ) {
          if (!state.isOverTarget && state.pointerType != null) {
            state.isOverTarget = true;
...
function $0294ea432cd92340$var$isValidKeyboardEvent(event, currentTarget) {
  ...
  return (
    ...
    !(
      (element instanceof
        (0, $bBqCQ$reactariautils.getOwnerWindow)(element).HTMLInputElement &&
        !$0294ea432cd92340$var$isValidInputKey(element, key)) ||
      element instanceof
        (0, $bBqCQ$reactariautils.getOwnerWindow)(element)
          .HTMLTextAreaElement ||
      element.isContentEditable
    ) && // Links should only trigger with Enter key
    !(
      (role === "link" ||
        (!role && $0294ea432cd92340$var$isHTMLAnchorLink(element))) &&
      key !== "Enter"
    )
  );
}
...
function $0294ea432cd92340$var$isValidInputKey(target, key) {
  ...
  return target.type === "checkbox" || target.type === "radio"
    ? key === " "
    : $0294ea432cd92340$var$nonTextInputTypes.has(target.type);
}
