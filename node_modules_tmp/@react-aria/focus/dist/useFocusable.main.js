...
$parcel$export(
  module.exports,
  "FocusableProvider",
  () => $fb504d83237fd6ac$export$13f3202a3e5ddd5,
);
$parcel$export(
  module.exports,
  "useFocusable",
  () => $fb504d83237fd6ac$export$4c014de7c8940b4c,
);
/*
...
let $fb504d83237fd6ac$var$FocusableContext = /*#__PURE__*/ (0,
$parcel$interopDefault($ggOO2$react)).createContext(null);
function $fb504d83237fd6ac$var$useFocusableContext(ref) {
  let context =
    (0, $ggOO2$react.useContext)($fb504d83237fd6ac$var$FocusableContext) || {};
 ...
 */ function $fb504d83237fd6ac$var$FocusableProvider(props, ref) {
  ...
  return /*#__PURE__*/ (0, $parcel$interopDefault($ggOO2$react)).createElement(
    $fb504d83237fd6ac$var$FocusableContext.Provider,
    {
      value: context,
    },
    children,
...
let $fb504d83237fd6ac$export$13f3202a3e5ddd5 = /*#__PURE__*/ (0,
$parcel$interopDefault($ggOO2$react)).forwardRef(
  $fb504d83237fd6ac$var$FocusableProvider,
);
function $fb504d83237fd6ac$export$4c014de7c8940b4c(props, domRef) {
  let { focusProps: focusProps } = (0, $ggOO2$reactariainteractions.useFocus)(
    props,
  );
  let { keyboardProps: keyboardProps } = (0,
  $ggOO2$reactariainteractions.useKeyboard)(props);
  let interactions = (0, $ggOO2$reactariautils.mergeProps)(
    focusProps,
    keyboardProps,
  );
