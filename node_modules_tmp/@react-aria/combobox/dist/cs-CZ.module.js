...
$87581c0202d106b8$exports = {
  ...
  countAnnouncement: (args, formatter) =>
    `K dispozici ${formatter.plural(args.optionCount, {
      ...
      other: () =>
        `jsou/je ${formatter.number(args.optionCount)} mo\u{17E}nosti/-\xed`,
    })}.`,
    ...
    `${formatter.select(
      {
        true: () =>
          `Zadan\xe1 skupina \u{201E}${args.groupTitle}\u{201C} ${formatter.plural(
            ...
            {
              one: () =>
                `s ${formatter.number(args.groupCount)} mo\u{17E}nost\xed`,
              other: () =>
                `se ${formatter.number(args.groupCount)} mo\u{17E}nostmi`,
            },
          )}. `,
        other: ``,
      },
