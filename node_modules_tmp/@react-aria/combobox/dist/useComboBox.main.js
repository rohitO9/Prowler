...
$parcel$export(
  module.exports,
  "useComboBox",
  () => $242452271d1e4c0e$export$8c18d1b4f7232bbf,
);
/*
...
function $242452271d1e4c0e$export$8c18d1b4f7232bbf(props, state) {
  ...
  let stringFormatter = (0, $BGXP4$reactariai18n.useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($8d1e5da058b86bb9$exports)),
    "@react-aria/combobox",
  );
  let { menuTriggerProps: menuTriggerProps, menuProps: menuProps } = (0,
  $BGXP4$reactariamenu.useMenuTrigger)(
    {
      type: "listbox",
  ...
  let delegate = (0, $BGXP4$react.useMemo)(
    () =>
      keyboardDelegate ||
      new (0, $BGXP4$reactariaselection.ListKeyboardDelegate)(
        state.collection,
        state.disabledKeys,
        listBoxRef,
      ),
  ...
  $BGXP4$reactariaselection.useSelectableCollection)({
  ...
  } = (0, $BGXP4$reactariatextfield.useTextField)(
    {
      ...props,
      onChange: state.setInputValue,
      onKeyDown: !isReadOnly
        ? (0, $BGXP4$reactariautils.chain)(
  ...
  (0, $BGXP4$react.useEffect)(() => {
    if (
      (0, $BGXP4$reactariautils.isAppleDevice)() &&
      focusedItem != null &&
      ...
      let announcement = stringFormatter.format("focusAnnouncement", {
        ...
        groupCount: section
          ? [
              ...(0, $BGXP4$reactstatelycollections.getChildNodes)(
                section,
                state.collection,
              ),
            ].length
  ...
  let optionCount = (0, $BGXP4$reactstatelycollections.getItemCount)(
    state.collection,
  );
  ...
  (0, $BGXP4$react.useEffect)(() => {
    if (state.isOpen)
      return (0, $BGXP4$reactariaoverlays.ariaHideOutside)([
        inputRef.current,
        popoverRef.current,
      ]);
  ...
  return {
    ...
    inputProps: (0, $BGXP4$reactariautils.mergeProps)(inputProps, {
      ...
      "aria-activedescendant": focusedItem
        ? (0, $BGXP4$reactarialistbox.getItemId)(state, focusedItem.key)
        : undefined,
    ...
    listBoxProps: (0, $BGXP4$reactariautils.mergeProps)(
      menuProps,
      listBoxProps,
      {
