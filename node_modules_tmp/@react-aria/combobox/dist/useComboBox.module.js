...
import {
  listData as $dShfP$listData,
  getItemId as $dShfP$getItemId,
} from "@react-aria/listbox";
import {
  useRouter as $dShfP$useRouter,
  chain as $dShfP$chain,
  useLabels as $dShfP$useLabels,
  isAppleDevice as $dShfP$isAppleDevice,
  mergeProps as $dShfP$mergeProps,
} from "@react-aria/utils";
import {
  useMemo as $dShfP$useMemo,
  useRef as $dShfP$useRef,
  useEffect as $dShfP$useEffect,
} from "react";
import {
  getChildNodes as $dShfP$getChildNodes,
  getItemCount as $dShfP$getItemCount,
} from "@react-stately/collections";
import {
  ListKeyboardDelegate as $dShfP$ListKeyboardDelegate,
  useSelectableCollection as $dShfP$useSelectableCollection,
...
function $c350ade66beef0af$export$8c18d1b4f7232bbf(props, state) {
  ...
  let stringFormatter = (0, $dShfP$useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($dShfP$intlStringsmodulejs)),
    "@react-aria/combobox",
  );
  let { menuTriggerProps: menuTriggerProps, menuProps: menuProps } = (0,
  $dShfP$useMenuTrigger)(
    {
      type: "listbox",
  ...
  let delegate = (0, $dShfP$useMemo)(
    () =>
      keyboardDelegate ||
      new (0, $dShfP$ListKeyboardDelegate)(
        state.collection,
        state.disabledKeys,
        listBoxRef,
      ),
  ...
  let { collectionProps: collectionProps } = (0,
  $dShfP$useSelectableCollection)({
        ...
        if (
          ...
          if (e.key === "Enter") {
            ...
            if (item instanceof HTMLAnchorElement) {
              let collectionItem = state.collection.getItem(
  ...
  let onBlur = (e) => {
    ...
    let blurFromButton =
      (buttonRef === null || buttonRef === void 0
        ? void 0
        : buttonRef.current) && buttonRef.current === e.relatedTarget;
    let blurIntoPopover =
      (_popoverRef_current = popoverRef.current) === null ||
      _popoverRef_current === void 0
        ? void 0
  ...
  let sectionKey =
    (_focusedItem_parentKey =
      focusedItem === null || focusedItem === void 0
        ? void 0
        : focusedItem.parentKey) !== null && _focusedItem_parentKey !== void 0
      ? _focusedItem_parentKey
      : null;
  var _state_selectionManager_focusedKey;
  let itemKey =
    (_state_selectionManager_focusedKey = state.selectionManager.focusedKey) !==
      null && _state_selectionManager_focusedKey !== void 0
    ...
    if (
      ...
      let sectionTitle =
        (section === null || section === void 0
          ? void 0
          : section["aria-label"]) ||
        (typeof (section === null || section === void 0
          ? void 0
          : section.rendered) === "string"
          ? section.rendered
          : "") ||
        "";
      let announcement = stringFormatter.format("focusAnnouncement", {
        ...
        groupCount: section
          ? [...(0, $dShfP$getChildNodes)(section, state.collection)].length
          : 0,
  ...
  (0, $dShfP$useEffect)(() => {
    if (
      ...
      let optionText =
        state.selectedItem["aria-label"] || state.selectedItem.textValue || "";
  ...
  (0, $dShfP$useEffect)(() => {
    if (state.isOpen)
      return (0, $dShfP$ariaHideOutside)([
        inputRef.current,
        popoverRef.current,
      ]);
  ...
  return {
    ...
    inputProps: (0, $dShfP$mergeProps)(inputProps, {
      ...
      "aria-activedescendant": focusedItem
        ? (0, $dShfP$getItemId)(state, focusedItem.key)
        : undefined,
