...
import {
  useRouter as $581M0$useRouter,
  openLink as $581M0$openLink,
  mergeProps as $581M0$mergeProps,
} from "@react-aria/utils";
import {
  usePress as $581M0$usePress,
  useLongPress as $581M0$useLongPress,
...
function $880e95eb8b93ba9a$export$ecf600387e221c37(options) {
  ...
  (0, $581M0$useEffect)(() => {
    ...
    if (isFocused && manager.isFocused && !shouldUseVirtualFocus) {
      if (focus) focus();
        ...
        (0, $581M0$focusSafely)(ref.current);
    }
    ...
    itemPressProps.onPressStart = (e) => {
      ...
      if (
        ...
        ((e.pointerType === "mouse" && !hasPrimaryAction) ||
          (e.pointerType === "keyboard" &&
            (!allowsActions || $880e95eb8b93ba9a$var$isSelectionKey())))
      )
        onSelect(e);
    };
    itemPressProps.onPress = (e) => {
  ...
  let { pressProps: pressProps, isPressed: isPressed } = (0, $581M0$usePress)(
    itemPressProps,
  );
  ...
  let onClick = manager.isLink(key)
    ? (e) => {
        if (!(0, $581M0$openLink).isOpening) e.preventDefault();
      }
    : undefined;
  return {
    itemProps: (0, $581M0$mergeProps)(
      itemProps,
