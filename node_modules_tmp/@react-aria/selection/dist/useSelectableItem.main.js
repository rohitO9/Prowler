...
$parcel$export(
  module.exports,
  "useSelectableItem",
  () => $433b1145b0781e10$export$ecf600387e221c37,
);
/*
...
function $433b1145b0781e10$export$ecf600387e221c37(options) {
  ...
  (0, $i4XHw$react.useEffect)(() => {
    ...
    if (isFocused && manager.isFocused && !shouldUseVirtualFocus) {
      if (focus) focus();
        ...
        (0, $i4XHw$reactariafocus.focusSafely)(ref.current);
    }
  ...
  if (shouldSelectOnPressUp) {
    itemPressProps.onPressStart = (e) => {
      ...
      if (
        e.pointerType === "keyboard" &&
        (!hasAction || $433b1145b0781e10$var$isSelectionKey())
      )
        onSelect(e);
    };
    ...
    if (!allowsDifferentPressOrigin)
      itemPressProps.onPress = (e) => {
        if (
          ...
          if (
            e.pointerType === "keyboard" &&
            !$433b1145b0781e10$var$isActionKey()
          )
            return;
          performAction(e);
    ...
    itemPressProps.onPressStart = (e) => {
      ...
      if (
        ...
        ((e.pointerType === "mouse" && !hasPrimaryAction) ||
          (e.pointerType === "keyboard" &&
            (!allowsActions || $433b1145b0781e10$var$isSelectionKey())))
      )
        onSelect(e);
    };
    itemPressProps.onPress = (e) => {
  ...
  $i4XHw$reactariainteractions.usePress)(itemPressProps);
  ...
  let { longPressProps: longPressProps } = (0,
  $i4XHw$reactariainteractions.useLongPress)({
  ...
  let onClick = manager.isLink(key)
    ...
    : undefined;
  return {
    itemProps: (0, $i4XHw$reactariautils.mergeProps)(
      itemProps,
