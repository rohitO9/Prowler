...
$parcel$export(
  module.exports,
  "useSlider",
  () => $481f97d830e3ede6$export$56b2c08e277f365,
);
/*
...
function $481f97d830e3ede6$export$56b2c08e277f365(props, state, trackRef) {
  let { labelProps: labelProps, fieldProps: fieldProps } = (0,
  $eVqG0$reactarialabel.useLabel)(props);
  ...
  } = (0, $eVqG0$reactariautils.useGlobalListeners)();
  ...
  const { moveProps: moveProps } = (0, $eVqG0$reactariainteractions.useMove)({
    ...
    onMove({ deltaX: deltaX, deltaY: deltaY }) {
      ...
      if (realTimeTrackDraggingIndex.current != null && trackRef.current) {
        const percent = (0, $eVqG0$reactariautils.clamp)(
  ...
  if ("htmlFor" in labelProps && labelProps.htmlFor) {
    ...
    labelProps.onClick = () => {
      ...
      (_document_getElementById = document.getElementById(
        (0, $28db8d634be2fa58$exports.getSliderThumbId)(state, 0),
  ...
  return {
    ...
    outputProps: {
      htmlFor: state.values
        .map((_, index) =>
          (0, $28db8d634be2fa58$exports.getSliderThumbId)(state, index),
        )
        .join(" "),
      "aria-live": "off",
    },
