import {
  getSliderThumbId as $aa519ee6cf463259$export$68e648cbec363a18,
  sliderData as $aa519ee6cf463259$export$d6c8d9636a3dc49c,
} from "./utils.mjs";
import {
  useGlobalListeners as $lSlq7$useGlobalListeners,
  focusWithoutScrolling as $lSlq7$focusWithoutScrolling,
  clamp as $lSlq7$clamp,
  mergeProps as $lSlq7$mergeProps,
  useFormReset as $lSlq7$useFormReset,
} from "@react-aria/utils";
import {
  useCallback as $lSlq7$useCallback,
  useEffect as $lSlq7$useEffect,
  useRef as $lSlq7$useRef,
} from "react";
import { useFocusable as $lSlq7$useFocusable } from "@react-aria/focus";
import {
  useKeyboard as $lSlq7$useKeyboard,
  useMove as $lSlq7$useMove,
...
function $47b897dc8cdb026b$export$8d15029008292ae(opts, state) {
  ...
  const { labelProps: labelProps, fieldProps: fieldProps } = (0,
  $lSlq7$useLabel)({
    ...opts,
    id: (0, $aa519ee6cf463259$export$68e648cbec363a18)(state, index),
    "aria-labelledby":
      `${data.id} ${(_opts_arialabelledby = opts["aria-labelledby"]) !== null && _opts_arialabelledby !== void 0 ? _opts_arialabelledby : ""}`.trim(),
  });
  ...
  let { moveProps: moveProps } = (0, $lSlq7$useMove)({
    ...
    onMove({
      ...
      if (pointerType === "keyboard") {
        ...
        setThumbPercent(
          index,
          (0, $lSlq7$clamp)(currentPosition.current / size, 0, 1),
        );
      }
    },
    onMoveEnd() {
  ...
  const { focusableProps: focusableProps } = (0, $lSlq7$useFocusable)(
    (0, $lSlq7$mergeProps)(opts, {
  ...
  let onUp = (e) => {
    ...
    var _e_pointerId;
    let id =
      (_e_pointerId = e.pointerId) !== null && _e_pointerId !== void 0
        ? _e_pointerId
        : (_e_changedTouches = e.changedTouches) === null ||
            _e_changedTouches === void 0
          ? void 0
          : _e_changedTouches[0].identifier;
  ...
  let interactions = !isDisabled
    ? (0, $lSlq7$mergeProps)(keyboardProps, moveProps, {
        onMouseDown: (e) => {
