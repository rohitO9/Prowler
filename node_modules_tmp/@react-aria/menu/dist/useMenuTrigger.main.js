...
$parcel$export(
  module.exports,
  "useMenuTrigger",
  () => $7211ab9328763fb9$export$dc9c12ed27dd1b49,
);
/*
...
function $7211ab9328763fb9$export$dc9c12ed27dd1b49(props, state, ref) {
  ...
  let { triggerProps: triggerProps, overlayProps: overlayProps } = (0,
  $jo7gW$reactariaoverlays.useOverlayTrigger)(
    {
      type: type,
    },
    state,
  ...
  let stringFormatter = (0, $jo7gW$reactariai18n.useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($d1742ec2644a0949$exports)),
    "@react-aria/menu",
  );
  let { longPressProps: longPressProps } = (0,
  $jo7gW$reactariainteractions.useLongPress)({
