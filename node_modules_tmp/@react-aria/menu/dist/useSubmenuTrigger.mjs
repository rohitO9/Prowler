...
import {
  useRef as $dXlYe$useRef,
  useCallback as $dXlYe$useCallback,
} from "react";
import {
  useId as $dXlYe$useId,
  useEffectEvent as $dXlYe$useEffectEvent,
  useLayoutEffect as $dXlYe$useLayoutEffect,
...
function $0065b146e7192841$export$7138b0d059a6e743(props, state, ref) {
      ...
      case "ArrowRight":
        if (!isDisabled) {
          if (direction === "ltr") {
            ...
            if (
              type === "menu" &&
              !!(submenuRef === null || submenuRef === void 0
                ? void 0
                : submenuRef.current) &&
  ...
  let onPressStart = (e) => {
    if (
      !isDisabled &&
      (e.pointerType === "virtual" || e.pointerType === "keyboard")
    )
