...
import {
  filterDOMProps as $ig234$filterDOMProps,
  useFormReset as $ig234$useFormReset,
  getOwnerWindow as $ig234$getOwnerWindow,
  mergeProps as $ig234$mergeProps,
...
function $2d73ec29415bd339$export$712718f7aec83d5(props, ref) {
  ...
  let [value, setValue] = (0, $ig234$useControlledState)(
    props.value,
    props.defaultValue || "",
    props.onChange,
  );
  ...
  (0, $ig234$useEffect)(() => {
    ...
    if (
      ...
      (0, $ig234$getOwnerWindow)(ref.current).HTMLTextAreaElement
    ) {
