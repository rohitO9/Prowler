...
$parcel$export(
  module.exports,
  "useFilter",
  () => $832d079b867c7223$export$3274cf84b703fff,
);
/*
...
function $832d079b867c7223$export$3274cf84b703fff(options) {
  ...
  let startsWith = (0, $c0oFg$react.useCallback)(
    (string, substring) => {
  ...
  let endsWith = (0, $c0oFg$react.useCallback)(
    (string, substring) => {
      if (substring.length === 0) return true;
      string = string.normalize("NFC");
      substring = substring.normalize("NFC");
  ...
  let contains = (0, $c0oFg$react.useCallback)(
    (string, substring) => {
      if (substring.length === 0) return true;
      string = string.normalize("NFC");
      substring = substring.normalize("NFC");
