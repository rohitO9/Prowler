...
$parcel$export(
  ...
  () => $fc53663969a3d00a$export$87b761675e8eaa10,
);
$parcel$export(
  module.exports,
  "useLocalizedStringFormatter",
  () => $fc53663969a3d00a$export$f12b703ca79dfbb1,
);
/*
...
function $fc53663969a3d00a$var$getCachedDictionary(strings) {
  ...
  if (!dictionary) {
    dictionary = new (0,
    $fbyBw$internationalizedstring.LocalizedStringDictionary)(strings);
...
function $fc53663969a3d00a$export$87b761675e8eaa10(strings, packageName) {
  return (
    (packageName &&
      (0,
      $fbyBw$internationalizedstring.LocalizedStringDictionary).getGlobalDictionaryForPackage(
        packageName,
      )) ||
...
function $fc53663969a3d00a$export$f12b703ca79dfbb1(strings, packageName) {
  ...
  let dictionary = $fc53663969a3d00a$export$87b761675e8eaa10(
    strings,
    packageName,
  );
  return (0, $fbyBw$react.useMemo)(
    () =>
      new (0, $fbyBw$internationalizedstring.LocalizedStringFormatter)(
        locale,
        dictionary,
      ),
    [locale, dictionary],
