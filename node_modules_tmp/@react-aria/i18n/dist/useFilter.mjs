...
import {
  useCallback as $21ck9$useCallback,
  useMemo as $21ck9$useMemo,
} from "react";
...
function $bb77f239b46e8c72$export$3274cf84b703fff(options) {
  ...
  let startsWith = (0, $21ck9$useCallback)(
    (string, substring) => {
  ...
  let endsWith = (0, $21ck9$useCallback)(
    (string, substring) => {
      if (substring.length === 0) return true;
      string = string.normalize("NFC");
      substring = substring.normalize("NFC");
  ...
  let contains = (0, $21ck9$useCallback)(
    (string, substring) => {
      if (substring.length === 0) return true;
      string = string.normalize("NFC");
      substring = substring.normalize("NFC");
