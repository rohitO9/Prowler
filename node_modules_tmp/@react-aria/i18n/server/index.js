...
$parcel$export(
  ...
  () => $417d44b6975b2ee7$export$9ec1fc026a5460ba,
);
$parcel$export(
  module.exports,
  "getPackageLocalizationScript",
  () => $417d44b6975b2ee7$export$fe9518edbbdc73da,
);
/*
...
function $417d44b6975b2ee7$export$9ec1fc026a5460ba(props) {
  if (typeof document !== "undefined") {
    console.log(
      "PackageLocalizationProvider should only be rendered on the server.",
    );
    return null;
  }
  let { locale: locale, strings: strings } = props;
  return /*#__PURE__*/ (0, $parcel$interopDefault($kg1kr$react)).createElement(
    "script",
    {
