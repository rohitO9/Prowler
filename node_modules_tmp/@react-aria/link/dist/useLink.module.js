import {
  filterDOMProps as $5Ot33$filterDOMProps,
  mergeProps as $5Ot33$mergeProps,
  useRouter as $5Ot33$useRouter,
  useLinkProps as $5Ot33$useLinkProps,
  shouldClientNavigate as $5Ot33$shouldClientNavigate,
    ...
    linkProps: (0, $5Ot33$mergeProps)(domProps, routerLinkProps, {
      ...
      onClick: (e) => {
        ...
        if (
          ...
          (0, $5Ot33$shouldClientNavigate)(e.currentTarget, e) &&
          props.href
        ) {
          e.preventDefault();
