...
function $2a795c53a101c542$export$16ea7f650bd7c1bb(props, state) {
  let { key: key } = props;
  const { checkboxProps: checkboxProps } = (0, $iIuaM$useGridSelectionCheckbox)(
    props,
    state,
  );
  return {
...
function $2a795c53a101c542$export$1003db6a7e384b99(state) {
  ...
  const stringFormatter = (0, $iIuaM$useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($iIuaM$intlStringsmodulejs)),
    "@react-aria/table",
  );
  return {
    checkboxProps: {
