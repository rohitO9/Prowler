...
import {
  isAndroid as $cjB6b$isAndroid,
  useDescription as $cjB6b$useDescription,
  mergeProps as $cjB6b$mergeProps,
...
function $f329116d8ad0aba0$export$9514819a8c81e960(props, state, ref) {
  ...
  if (node.props.allowsSorting && !(0, $cjB6b$isAndroid)())
    ariaSort = isSortedColumn ? sortDirection : "none";
  let stringFormatter = (0, $cjB6b$useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($cjB6b$intlStringsmodulejs)),
    "@react-aria/table",
  );
  let sortDescription;
  if (allowsSorting) {
    ...
    if (isSortedColumn && sortDirection && (0, $cjB6b$isAndroid)())
