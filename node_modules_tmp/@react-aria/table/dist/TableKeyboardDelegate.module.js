import {
  getFirstItem as $eIXPM$getFirstItem,
  getChildNodes as $eIXPM$getChildNodes,
  getNthItem as $eIXPM$getNthItem,
...
class $0ba3c81c7f1caedd$export$da43f8f5cb04028d extends (0,
$eIXPM$GridKeyboardDelegate) {
  isCell(node) {
    return (
      node.type === "cell" ||
      node.type === "rowheader" ||
  ...
  getKeyBelow(key) {
    ...
    if (startItem.type === "column") {
      let child = (0, $eIXPM$getFirstItem)(
        (0, $eIXPM$getChildNodes)(startItem, this.collection),
      );
      if (child) return child.key;
      let firstKey = this.getFirstKey();
      if (firstKey == null) return;
      let firstItem = this.collection.getItem(firstKey);
      return (0, $eIXPM$getNthItem)(
        (0, $eIXPM$getChildNodes)(firstItem, this.collection),
        startItem.index,
      ).key;
    }
