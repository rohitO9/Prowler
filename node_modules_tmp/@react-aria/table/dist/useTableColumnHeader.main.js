...
$parcel$export(
  ...
  () => $7669c34a63ef0113$export$9514819a8c81e960,
);
/*
...
function $7669c34a63ef0113$export$9514819a8c81e960(props, state, ref) {
  ...
  let { focusableProps: focusableProps } = (0,
  $33PgG$reactariafocus.useFocusable)({}, ref);
  let ariaSort = null;
  let isSortedColumn =
    ((_state_sortDescriptor = state.sortDescriptor) === null ||
    _state_sortDescriptor === void 0
      ? void 0
      : _state_sortDescriptor.column) === node.key;
  let sortDirection =
    (_state_sortDescriptor1 = state.sortDescriptor) === null ||
    _state_sortDescriptor1 === void 0
      ? void 0
      : _state_sortDescriptor1.direction;
  // aria-sort not supported in Android Talkback
  if (node.props.allowsSorting && !(0, $33PgG$reactariautils.isAndroid)())
    ariaSort = isSortedColumn ? sortDirection : "none";
  let stringFormatter = (0, $33PgG$reactariai18n.useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($7ff3f66df3873a5e$exports)),
    "@react-aria/table",
  );
  let sortDescription;
  if (allowsSorting) {
    ...
    if (
      isSortedColumn &&
      sortDirection &&
      (0, $33PgG$reactariautils.isAndroid)()
    )
      sortDescription = `${sortDescription}, ${stringFormatter.format(sortDirection)}`;
  }
  let descriptionProps = (0, $33PgG$reactariautils.useDescription)(
    sortDescription,
  );
  ...
  return {
    columnHeaderProps: {
      ...(0, $33PgG$reactariautils.mergeProps)(
        gridCellProps,
        pressProps,
        focusableProps,
        descriptionProps, // If the table is empty, make all column headers untabbable
        shouldDisableFocus && {
          tabIndex: -1,
        },
      ),
