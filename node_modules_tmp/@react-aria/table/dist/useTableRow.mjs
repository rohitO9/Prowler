...
import {
  getSyntheticLinkProps as $2K6sg$getSyntheticLinkProps,
  mergeProps as $2K6sg$mergeProps,
...
function $b2db214c022798eb$export$7f2f6ae19e707aa5(props, state, ref) {
  ...
  let { rowProps: rowProps, ...states } = (0, $2K6sg$useGridRow)(
    props,
    state,
    ref,
  );
  ...
  if (
    isVirtualized &&
    !((0, $2K6sg$tableNestedRows)() && "expandedKeys" in state)
  )
    ...
    if (treeNode != null) {
      ...
      treeGridRowProps = {
        onKeyDown: (e) => {
          if (
            e.key ===
              $b2db214c022798eb$var$EXPANSION_KEYS["expand"][direction] &&
            ...
            e.key ===
              $b2db214c022798eb$var$EXPANSION_KEYS["collapse"][direction] &&
            state.selectionManager.focusedKey === treeNode.key &&
            hasChildRows &&
            (state.expandedKeys === "all" ||
              state.expandedKeys.has(treeNode.key))
  ...
  let linkProps = states.hasAction
    ? (0, $2K6sg$getSyntheticLinkProps)(node.props)
    : {};
  return {
    rowProps: {
      ...(0, $2K6sg$mergeProps)(rowProps, treeGridRowProps, linkProps),
      "aria-labelledby": (0, $2140fb2337097f2d$export$85069b70317f543)(
        state,
        node.key,
      ),
    },
