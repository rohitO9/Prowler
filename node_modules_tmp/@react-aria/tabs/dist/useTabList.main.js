...
$parcel$export(
  module.exports,
  "useTabList",
  () => $f2b4a4926440e901$export$773e389e644c5874,
);
/*
...
function $f2b4a4926440e901$export$773e389e644c5874(props, state, ref) {
  let {
    ...
    keyboardActivation: keyboardActivation = "automatic",
  } = props;
  let {
  ...
  let delegate = (0, $c5HcZ$react.useMemo)(
    () =>
      new (0, $283e5d8830177ead$exports.TabsKeyboardDelegate)(
        collection,
        direction,
        orientation,
        disabledKeys,
  ...
  $c5HcZ$reactariaselection.useSelectableCollection)({
    ref: ref,
    selectionManager: manager,
  ...
  return {
    tabListProps: {
      ...(0, $c5HcZ$reactariautils.mergeProps)(
        collectionProps,
        tabListLabelProps,
      ),
      role: "tablist",
