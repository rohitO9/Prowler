...
$parcel$export(
  module.exports,
  "useTabPanel",
  () => $8db1928b18472a1f$export$fae0121b5afe572d,
);
/*
...
function $8db1928b18472a1f$export$fae0121b5afe572d(props, state, ref) {
  ...
  // within the tabpanel.
  let tabIndex = (0, $8Zd8I$reactariafocus.useHasTabbableChild)(ref)
    ? undefined
    : 0;
  var _props_id;
  const id = (0, $a217ebca77471970$exports.generateId)(
    state,
    (_props_id = props.id) !== null && _props_id !== void 0
      ? _props_id
  ...
  const tabPanelProps = (0, $8Zd8I$reactariautils.useLabels)({
    ...props,
    id: id,
    "aria-labelledby": (0, $a217ebca77471970$exports.generateId)(
      state,
      state === null || state === void 0 ? void 0 : state.selectedKey,
      "tab",
    ),
  });
  return {
