import {
  getEraFormat as $a074e1e2d0f0a665$export$134cbb7fb09a9522,
  hookData as $a074e1e2d0f0a665$export$653eddfc964b0f8a,
} from "./utils.mjs";
import $dm6hl$intlStringsmodulejs from "./intlStrings.mjs";
import {
  isSameDay as $dm6hl$isSameDay,
  isEqualDay as $dm6hl$isEqualDay,
  isToday as $dm6hl$isToday,
} from "@internationalized/date";
import {
  useDeepMemo as $dm6hl$useDeepMemo,
  useDescription as $dm6hl$useDescription,
  focusWithoutScrolling as $dm6hl$focusWithoutScrolling,
  scrollIntoViewport as $dm6hl$scrollIntoViewport,
  getScrollParent as $dm6hl$getScrollParent,
  mergeProps as $dm6hl$mergeProps,
} from "@react-aria/utils";
import {
  usePress as $dm6hl$usePress,
  getInteractionModality as $dm6hl$getInteractionModality,
} from "@react-aria/interactions";
import {
  useMemo as $dm6hl$useMemo,
  useRef as $dm6hl$useRef,
  useEffect as $dm6hl$useEffect,
} from "react";
import {
  useLocalizedStringFormatter as $dm6hl$useLocalizedStringFormatter,
  useDateFormatter as $dm6hl$useDateFormatter,
...
function $36a0ac60f04457c5$export$136073280381448e(props, state, ref) {
  ...
  let stringFormatter = (0, $dm6hl$useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($dm6hl$intlStringsmodulejs)),
    "@react-aria/calendar",
  );
  ...
  let label = (0, $dm6hl$useMemo)(() => {
    ...
    if (
      ...
      state.value &&
      !state.anchorDate &&
      ((0, $dm6hl$isSameDay)(date, state.value.start) ||
        (0, $dm6hl$isSameDay)(date, state.value.end))
    )
    ...
    if (state.minValue && (0, $dm6hl$isSameDay)(date, state.minValue))
      label += ", " + stringFormatter.format("minimumDate");
    else if (state.maxValue && (0, $dm6hl$isSameDay)(date, state.maxValue))
  ...
  if ("anchorDate" in state && isFocused && !state.isReadOnly && isSelectable) {
    ...
    if (state.anchorDate)
      rangeSelectionPrompt = stringFormatter.format(
  ...
  let tabIndex = null;
  if (!isDisabled)
    tabIndex = (0, $dm6hl$isSameDay)(date, state.focusedDate) ? 0 : -1;
  ...
  (0, $dm6hl$useEffect)(() => {
    if (isFocused && ref.current) {
      ...
      if (
        (0, $dm6hl$getInteractionModality)() !== "pointer" &&
        document.activeElement === ref.current
      )
        (0, $dm6hl$scrollIntoViewport)(ref.current, {
  ...
  let formattedDate = (0, $dm6hl$useMemo)(
    () =>
      cellDateFormatter
