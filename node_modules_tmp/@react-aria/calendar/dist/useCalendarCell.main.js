...
$parcel$export(
  module.exports,
  "useCalendarCell",
  () => $4d833327a32c9193$export$136073280381448e,
);
/*
...
function $4d833327a32c9193$export$136073280381448e(props, state, ref) {
  ...
  } = (0, $df1d8e967e73ec8e$exports.hookData).get(state);
  let stringFormatter = (0, $cuS6T$reactariai18n.useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($bd6dc95a3c5ee5cd$exports)),
    "@react-aria/calendar",
  );
  ...
  let isInvalid =
    ...
    ("highlightedRange" in state
      ...
      : state.value &&
        (0, $cuS6T$internationalizeddate.isSameDay)(state.value, date));
  if (isInvalid) isSelected = true;
  // For performance, reuse the same date object as before if the new date prop is the same.
  // This allows subsequent useMemo results to be reused.
  date = (0, $cuS6T$reactariautils.useDeepMemo)(
    date,
    (0, $cuS6T$internationalizeddate.isEqualDay),
  );
  let nativeDate = (0, $cuS6T$react.useMemo)(
    () => date.toDate(state.timeZone),
    [date, state.timeZone],
  );
  // aria-label should be localize Day of week, Month, Day and Year without Time.
  let isDateToday = (0, $cuS6T$internationalizeddate.isToday)(
    date,
    state.timeZone,
  );
  let label = (0, $cuS6T$react.useMemo)(() => {
    ...
    if (
      ...
      state.value &&
      !state.anchorDate &&
      ((0, $cuS6T$internationalizeddate.isSameDay)(date, state.value.start) ||
        (0, $cuS6T$internationalizeddate.isSameDay)(date, state.value.end))
    )
    ...
    if (
      state.minValue &&
      (0, $cuS6T$internationalizeddate.isSameDay)(date, state.minValue)
    )
      label += ", " + stringFormatter.format("minimumDate");
    else if (
      state.maxValue &&
      (0, $cuS6T$internationalizeddate.isSameDay)(date, state.maxValue)
    )
  ...
  let descriptionProps = (0, $cuS6T$reactariautils.useDescription)(
  ...
  let { pressProps: pressProps, isPressed: isPressed } = (0,
  $cuS6T$reactariainteractions.usePress)({
    ...
    onPressStart(e) {
      ...
      if (
        ...
        if (state.highlightedRange && !isInvalid) {
          if (
            (0, $cuS6T$internationalizeddate.isSameDay)(
              date,
  ...
  let tabIndex = null;
  if (!isDisabled)
    tabIndex = (0, $cuS6T$internationalizeddate.isSameDay)(
      date,
      state.focusedDate,
    )
      ? 0
  ...
  (0, $cuS6T$react.useEffect)(() => {
    if (isFocused && ref.current) {
      ...
      if (
        (0, $cuS6T$reactariainteractions.getInteractionModality)() !==
          "pointer" &&
        document.activeElement === ref.current
      )
        (0, $cuS6T$reactariautils.scrollIntoViewport)(ref.current, {
          containingElement: (0, $cuS6T$reactariautils.getScrollParent)(
            ref.current,
          ),
        });
    }
  ...
  let formattedDate = (0, $cuS6T$react.useMemo)(
    () =>
      cellDateFormatter
