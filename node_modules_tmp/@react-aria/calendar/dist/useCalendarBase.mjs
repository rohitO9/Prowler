import {
  ...
  useSelectedDateDescription as $a074e1e2d0f0a665$export$b6df97c887c38e1a,
  useVisibleRangeDescription as $a074e1e2d0f0a665$export$31afe65d91ef6e8,
} from "./utils.mjs";
import $g2t6q$intlStringsmodulejs from "./intlStrings.mjs";
import { announce as $g2t6q$announce } from "@react-aria/live-announcer";
import {
  filterDOMProps as $g2t6q$filterDOMProps,
  useUpdateEffect as $g2t6q$useUpdateEffect,
  useSlotId as $g2t6q$useSlotId,
  useLabels as $g2t6q$useLabels,
  mergeProps as $g2t6q$mergeProps,
...
function $c4acc1de3ab169cf$export$d652b3ea2d672d5b(props, state) {
  let stringFormatter = (0, $g2t6q$useLocalizedStringFormatter)(
    (0, $parcel$interopDefault($g2t6q$intlStringsmodulejs)),
    "@react-aria/calendar",
  );
  let domProps = (0, $g2t6q$filterDOMProps)(props);
  let title = (0, $a074e1e2d0f0a665$export$31afe65d91ef6e8)(
    state.visibleRange.start,
    state.visibleRange.end,
    state.timeZone,
    false,
  );
  let visibleRangeDescription = (0, $a074e1e2d0f0a665$export$31afe65d91ef6e8)(
    state.visibleRange.start,
    state.visibleRange.end,
    state.timeZone,
    true,
  ...
  let selectedDateDescription = (0, $a074e1e2d0f0a665$export$b6df97c887c38e1a)(
    state,
  );
  (0, $g2t6q$useUpdateEffect)(() => {
    if (selectedDateDescription)
      (0, $g2t6q$announce)(selectedDateDescription, "polite", 4000);
