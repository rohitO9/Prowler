...
declare namespace _ {
  ...
  type LodashAfter1x1<TFunc extends (...args: any[]) => any> = (
    n: number,
  ) => TFunc;
  type LodashAfter1x2 = <TFunc extends (...args: any[]) => any>(
    func: TFunc,
  ) => TFunc;
  interface LodashEvery {
    ...
    <T>(
      predicate: lodash.__,
      collection: lodash.List<T> | null | undefined,
    ): LodashEvery1x2<T>;
    <T>(
      predicate: lodash.ValueIterateeCustom<T, boolean>,
      collection: lodash.List<T> | null | undefined,
    ): boolean;
    <T extends object>(
      predicate: lodash.__,
    ...
    <T extends object>(
      predicate: lodash.ValueIterateeCustom<T[keyof T], boolean>,
      collection: T | null | undefined,
    ): boolean;
  }
  type LodashEvery1x1<T> = (
    collection: lodash.List<T> | object | null | undefined,
  ) => boolean;
  type LodashEvery1x2<T> = (
    predicate: lodash.ValueIterateeCustom<T, boolean>,
  ) => boolean;
  type LodashEvery2x2<T> = (
    predicate: lodash.ValueIterateeCustom<T[keyof T], boolean>,
  ) => boolean;
  type LodashOverEvery = <T>(
    predicates: lodash.Many<(...args: T[]) => boolean>,
  ) => (...args: T[]) => boolean;
  ...
  type LodashSome1x1<T> = (
    collection: lodash.List<T> | object | null | undefined,
  ) => boolean;
  type LodashSome1x2<T> = (
    predicate: lodash.ValueIterateeCustom<T, boolean>,
  ) => boolean;
  type LodashSome2x2<T> = (
    predicate: lodash.ValueIterateeCustom<T[keyof T], boolean>,
  ) => boolean;
  type LodashOverSome = <T>(
    predicates: lodash.Many<(...args: T[]) => boolean>,
  ) => (...args: T[]) => boolean;
  type LodashApply = <TResult>(
  ...
  type LodashAssign1x1<TObject> = <TSource>(
    source: TSource,
  ) => TObject & TSource;
  type LodashAssign1x2<TSource> = <TObject>(
    object: TObject,
  ) => TObject & TSource;
  interface LodashAssignAll {
    <TObject, TSource>(object: [TObject, TSource]): TObject & TSource;
    <TObject, TSource1, TSource2>(
      object: [TObject, TSource1, TSource2],
    ): TObject & TSource1 & TSource2;
    <TObject, TSource1, TSource2, TSource3>(
      object: [TObject, TSource1, TSource2, TSource3],
    ): TObject & TSource1 & TSource2 & TSource3;
    <TObject, TSource1, TSource2, TSource3, TSource4>(
      object: [TObject, TSource1, TSource2, TSource3, TSource4],
    ): TObject & TSource1 & TSource2 & TSource3 & TSource4;
  ...
  type LodashAssignIn1x1<TObject> = <TSource>(
    source: TSource,
  ) => TObject & TSource;
  type LodashAssignIn1x2<TSource> = <TObject>(
    object: TObject,
  ) => TObject & TSource;
  ...
  interface LodashAssignInWith {
    ...
    <TObject>(
      customizer: lodash.AssignCustomizer,
      object: TObject,
  ...
  type LodashAssignInWith1x3<TObject> = <TSource>(
    source: TSource,
  ) => TObject & TSource;
  ...
  type LodashAssignInWith1x5<TSource> = <TObject>(
    object: TObject,
  ) => TObject & TSource;
  type LodashAssignInWith1x6<TObject, TSource> = (
    customizer: lodash.AssignCustomizer,
  ) => TObject & TSource;
  ...
  type LodashAssignWith1x3<TObject> = <TSource>(
    source: TSource,
  ) => TObject & TSource;
  ...
  type LodashAssignWith1x5<TSource> = <TObject>(
    object: TObject,
  ) => TObject & TSource;
  type LodashAssignWith1x6<TObject, TSource> = (
    customizer: lodash.AssignCustomizer,
  ) => TObject & TSource;
  interface LodashSet {
  ...
  interface LodashAt {
    ...
    <T>(
      ...
      object:
        | lodash.Dictionary<T>
        | lodash.NumericDictionary<T>
        | null
        | undefined,
    ): LodashAt1x2<T>;
    <T>(
      props: lodash.PropertyPath,
      object:
        | lodash.Dictionary<T>
        | lodash.NumericDictionary<T>
        | null
  ...
  type LodashBefore1x1<TFunc extends (...args: any[]) => any> = (
    n: number,
  ) => TFunc;
  type LodashBefore1x2 = <TFunc extends (...args: any[]) => any>(
    func: TFunc,
  ) => TFunc;
  ...
  type LodashCapitalize = <T extends string>(
    string: T,
  ...
  interface LodashCloneDeepWith {
    <T>(
      customizer: lodash.CloneDeepWithCustomizer<T>,
  ...
  type LodashCloneDeepWith1x2<T> = (
    customizer: lodash.CloneDeepWithCustomizer<T>,
  ) => any;
  interface LodashCloneWith {
    <T, TResult extends object | string | number | boolean | null>(
      customizer: lodash.CloneWithCustomizer<T, TResult>,
    ...
    <T, TResult>(
      customizer: lodash.CloneWithCustomizer<T, TResult | undefined>,
  ...
  interface LodashCloneWith1x2<T> {
    <TResult extends object | string | number | boolean | null>(
      customizer: lodash.CloneWithCustomizer<T, TResult>,
    ): TResult;
    <TResult>(
      customizer: lodash.CloneWithCustomizer<T, TResult | undefined>,
  ...
  type LodashCompact = <T>(
    array: lodash.List<T> | null | undefined,
  ) => Array<Exclude<T, lodash.Falsey>>;
  type LodashNegate = <T extends any[]>(
    predicate: (...args: T) => any,
  ) => (...args: T) => boolean;
  ...
  type LodashConformsTo1x2<T> = (
    source: lodash.ConformsPredicateObject<T>,
  ) => boolean;
  ...
  interface LodashCountBy {
    ...
    <T>(
      iteratee: lodash.ValueIteratee<T>,
      collection: lodash.List<T> | null | undefined,
    ...
    <T extends object>(
      iteratee: lodash.ValueIteratee<T[keyof T]>,
      collection: T | null | undefined,
    ): lodash.Dictionary<number>;
  }
  type LodashCountBy1x1<T> = (
    collection: lodash.List<T> | object | null | undefined,
  ) => lodash.Dictionary<number>;
  type LodashCountBy1x2<T> = (
    iteratee: lodash.ValueIteratee<T>,
  ) => lodash.Dictionary<number>;
  type LodashCountBy2x2<T> = (
    iteratee: lodash.ValueIteratee<T[keyof T]>,
  ) => lodash.Dictionary<number>;
  type LodashCreate = <T extends object, U extends object>(
    prototype: T,
  ) => T & U;
  interface LodashCurry {
    ...
    <T1, T2, R>(
      func: (t1: T1, t2: T2) => R,
    ): lodash.CurriedFunction2<T1, T2, R>;
    <T1, T2, T3, R>(
      func: (t1: T1, t2: T2, t3: T3) => R,
    ): lodash.CurriedFunction3<T1, T2, T3, R>;
    <T1, T2, T3, T4, R>(
      func: (t1: T1, t2: T2, t3: T3, t4: T4) => R,
    ): lodash.CurriedFunction4<T1, T2, T3, T4, R>;
    <T1, T2, T3, T4, T5, R>(
      func: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5) => R,
    ): lodash.CurriedFunction5<T1, T2, T3, T4, T5, R>;
  ...
  type LodashCurryN1x2<T1, R> = (
    arity: number,
  ) => lodash.CurriedFunction1<T1, R>;
  type LodashCurryN2x2<T1, T2, R> = (
    arity: number,
  ) => lodash.CurriedFunction2<T1, T2, R>;
  type LodashCurryN3x2<T1, T2, T3, R> = (
    arity: number,
  ) => lodash.CurriedFunction3<T1, T2, T3, R>;
  type LodashCurryN4x2<T1, T2, T3, T4, R> = (
    arity: number,
  ) => lodash.CurriedFunction4<T1, T2, T3, T4, R>;
  type LodashCurryN5x2<T1, T2, T3, T4, T5, R> = (
    arity: number,
  ) => lodash.CurriedFunction5<T1, T2, T3, T4, T5, R>;
  ...
  interface LodashCurryRight {
    ...
    <T1, T2, R>(
      func: (t1: T1, t2: T2) => R,
    ): lodash.RightCurriedFunction2<T1, T2, R>;
    <T1, T2, T3, R>(
      func: (t1: T1, t2: T2, t3: T3) => R,
    ): lodash.RightCurriedFunction3<T1, T2, T3, R>;
    <T1, T2, T3, T4, R>(
      func: (t1: T1, t2: T2, t3: T3, t4: T4) => R,
    ): lodash.RightCurriedFunction4<T1, T2, T3, T4, R>;
    <T1, T2, T3, T4, T5, R>(
      func: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5) => R,
    ): lodash.RightCurriedFunction5<T1, T2, T3, T4, T5, R>;
    (func: (...args: any[]) => any): (...args: any[]) => any;
    placeholder: lodash.__;
  }
  interface LodashCurryRightN {
    ...
    <T1, R>(
      arity: number,
      func: (t1: T1) => R,
    ): lodash.RightCurriedFunction1<T1, R>;
    <T1, T2, R>(
      arity: lodash.__,
      func: (t1: T1, t2: T2) => R,
  ...
  type LodashCurryRightN1x2<T1, R> = (
    arity: number,
  ) => lodash.RightCurriedFunction1<T1, R>;
  type LodashCurryRightN2x2<T1, T2, R> = (
    arity: number,
  ) => lodash.RightCurriedFunction2<T1, T2, R>;
  type LodashCurryRightN3x2<T1, T2, T3, R> = (
    arity: number,
  ) => lodash.RightCurriedFunction3<T1, T2, T3, R>;
  type LodashCurryRightN4x2<T1, T2, T3, T4, R> = (
    arity: number,
  ) => lodash.RightCurriedFunction4<T1, T2, T3, T4, R>;
  type LodashCurryRightN5x2<T1, T2, T3, T4, T5, R> = (
    arity: number,
  ) => lodash.RightCurriedFunction5<T1, T2, T3, T4, T5, R>;
  ...
  type LodashDebounce1x1 = <T extends (...args: any) => any>(
    func: T,
  ) => lodash.DebouncedFunc<T>;
  type LodashDebounce1x2<T extends (...args: any) => any> = (
    wait: number,
  ) => lodash.DebouncedFunc<T>;
  ...
  type LodashDefaults1x1<TSource> = <TObject>(
    object: TObject,
  ) => TSource & TObject;
  type LodashDefaults1x2<TObject> = <TSource>(
    source: TSource,
  ) => TSource & TObject;
  ...
  type LodashDefaultTo2x1<TDefault> = <T>(
    value: T | null | undefined,
  ) => T | TDefault;
  ...
  type LodashDifference1x2<T> = (
    array: lodash.List<T> | null | undefined,
  ) => T[];
  interface LodashDifferenceBy {
    <T1, T2>(
      iteratee: lodash.ValueIteratee<T1 | T2>,
    ): LodashDifferenceBy1x1<T1, T2>;
    <T1>(
      iteratee: lodash.__,
      array: lodash.List<T1> | null | undefined,
  ...
  type LodashDifferenceBy1x5<T1> = (
    array: lodash.List<T1> | null | undefined,
  ) => T1[];
  type LodashDifferenceBy1x6<T1, T2> = (
    iteratee: lodash.ValueIteratee<T1 | T2>,
  ) => T1[];
  interface LodashDifferenceWith {
    <T1, T2>(
      comparator: lodash.Comparator2<T1, T2>,
    ): LodashDifferenceWith1x1<T1, T2>;
    <T1>(
      comparator: lodash.__,
      array: lodash.List<T1> | null | undefined,
  ...
  type LodashDifferenceWith1x5<T1> = (
    array: lodash.List<T1> | null | undefined,
  ) => T1[];
  type LodashDifferenceWith1x6<T1, T2> = (
    comparator: lodash.Comparator2<T1, T2>,
  ) => T1[];
  ...
  interface LodashDropRightWhile {
    ...
    <T>(
      predicate: lodash.ValueIteratee<T>,
      array: lodash.List<T> | null | undefined,
    ): T[];
  }
  type LodashDropRightWhile1x1<T> = (
    array: lodash.List<T> | null | undefined,
  ) => T[];
  ...
  interface LodashForEach {
    ...
    ): LodashForEach4x2<T, TArray>;
    <T, TArray extends T[] | null | undefined>(
      iteratee: (value: T) => any,
      collection: TArray & (T[] | null | undefined),
    ): TArray;
    <T, TList extends lodash.List<T> | null | undefined>(
      iteratee: lodash.__,
      collection: TList & (lodash.List<T> | null | undefined),
    ): LodashForEach5x2<T, TList>;
    <T, TList extends lodash.List<T> | null | undefined>(
      iteratee: (value: T) => any,
      collection: TList & (lodash.List<T> | null | undefined),
    ): TList;
  ...
  interface LodashForEach1x1<T> {
    ...
    <TList extends lodash.List<T> | null | undefined>(
      collection: TList & (lodash.List<T> | null | undefined),
    ): TList;
    <T1 extends object>(
      collection: T1 | null | undefined,
    ): T1 | null | undefined;
  }
  ...
  interface LodashForEachRight {
    ...
    <T, TArray extends T[] | null | undefined>(
      iteratee: lodash.__,
      collection: TArray & (T[] | null | undefined),
    ): LodashForEachRight4x2<T, TArray>;
    <T, TArray extends T[] | null | undefined>(
      iteratee: (value: T) => any,
      collection: TArray & (T[] | null | undefined),
    ): TArray;
  ...
  interface LodashToPairs {
    <T>(
      object: lodash.Dictionary<T> | lodash.NumericDictionary<T>,
    ): Array<[string, T]>;
  ...
  type LodashExtend1x1<TObject> = <TSource>(
    source: TSource,
  ) => TObject & TSource;
  type LodashExtend1x2<TSource> = <TObject>(
    object: TObject,
  ) => TObject & TSource;
  ...
  type LodashExtendWith1x3<TObject> = <TSource>(
    source: TSource,
  ) => TObject & TSource;
  ...
  type LodashExtendWith1x5<TSource> = <TObject>(
    object: TObject,
  ) => TObject & TSource;
  type LodashExtendWith1x6<TObject, TSource> = (
    customizer: lodash.AssignCustomizer,
  ) => TObject & TSource;
  ...
  interface LodashFill {
    ...
    <U>(
      ...
      value: lodash.__,
      array: lodash.List<U> | null | undefined,
    ): LodashFill2x8<U>;
    <U>(
      start: number,
      end: lodash.__,
  ...
  interface LodashFilter {
    <T, S extends T>(
      predicate: lodash.ValueIteratorTypeGuard<T, S>,
    ): LodashFilter1x1<T, S>;
    <T>(
      predicate: lodash.__,
      collection: lodash.List<T> | null | undefined,
    ...
    <T extends object, S extends T[keyof T]>(
      predicate: lodash.ValueIteratorTypeGuard<T[keyof T], S>,
    ): LodashFilter3x1<T, S>;
    <T extends object>(
      predicate: lodash.__,
      collection: T | null | undefined,
  ...
  type LodashFind2x1<T> = (
    collection: lodash.List<T> | object | null | undefined,
  ) => T | undefined;
  type LodashFind3x1<T, S> = (
    collection: T | null | undefined,
  ) => S | undefined;
  ...
  type LodashFindIndex1x1<T> = (
    array: lodash.List<T> | null | undefined,
  ) => number;
  type LodashFindIndex1x2<T> = (
    predicate: lodash.ValueIterateeCustom<T, boolean>,
  ) => number;
  ...
  interface LodashFindKey {
    ...
    <T>(
      predicate: lodash.ValueIteratee<T[keyof T]>,
      object: T | null | undefined,
    ): string | undefined;
  }
  type LodashFindKey1x1<T> = (
    object: object | null | undefined,
  ) => string | undefined;
  type LodashFindKey1x2<T> = (
    predicate: lodash.ValueIteratee<T[keyof T]>,
  ) => string | undefined;
  ...
  type LodashFindLast2x1<T> = (
    collection: lodash.List<T> | object | null | undefined,
  ) => T | undefined;
  type LodashFindLast3x1<T, S> = (
    collection: T | null | undefined,
  ) => S | undefined;
  ...
  type LodashFindLastFrom1x3<T, S> = (
    collection: lodash.List<T> | null | undefined,
  ) => S | undefined;
  ...
  type LodashFindLastFrom3x3<T, S> = (
    collection: T | null | undefined,
  ) => S | undefined;
  ...
  type LodashFindLastIndex1x1<T> = (
    array: lodash.List<T> | null | undefined,
  ) => number;
  type LodashFindLastIndex1x2<T> = (
    predicate: lodash.ValueIterateeCustom<T, boolean>,
  ) => number;
  ...
  type LodashFindLastIndexFrom1x3<T> = (
    array: lodash.List<T> | null | undefined,
  ) => number;
  ...
  type LodashFindLastIndexFrom1x6<T> = (
    predicate: lodash.ValueIterateeCustom<T, boolean>,
  ) => number;
  ...
  type LodashFindLastKey1x1<T> = (
    object: object | null | undefined,
  ) => string | undefined;
  type LodashFindLastKey1x2<T> = (
    predicate: lodash.ValueIteratee<T[keyof T]>,
  ) => string | undefined;
  type LodashHead = <T>(
    array: lodash.List<T> | null | undefined,
  ...
  interface LodashFlatMap {
    <T, TResult>(
      iteratee: (value: T) => lodash.Many<TResult>,
    ...
    <T extends object, TResult>(
      iteratee: (value: T[keyof T]) => lodash.Many<TResult>,
  ...
  type LodashFlatMap1x1<T, TResult> = (
    collection: lodash.List<T> | null | undefined,
  ) => TResult[];
  type LodashFlatMap1x2<T> = <TResult>(
    iteratee: (value: T) => lodash.Many<TResult>,
  ) => TResult[];
  type LodashFlatMap2x1<T, TResult> = (
    collection: T | null | undefined,
  ) => TResult[];
  type LodashFlatMap2x2<T> = <TResult>(
    iteratee: (value: T[keyof T]) => lodash.Many<TResult>,
  ) => TResult[];
  ...
  interface LodashFlatMapDeep {
    <T, TResult>(
      iteratee: (
        value: T,
      ) => lodash.ListOfRecursiveArraysOrValues<TResult> | TResult,
  ...
  type LodashFlatMapDeep1x1<T, TResult> = (
    collection: lodash.List<T> | null | undefined,
  ) => TResult[];
  type LodashFlatMapDeep1x2<T> = <TResult>(
    iteratee: (
      value: T,
    ) => lodash.ListOfRecursiveArraysOrValues<TResult> | TResult,
  ) => TResult[];
  type LodashFlatMapDeep2x1<T, TResult> = (
    collection: T | null | undefined,
  ) => TResult[];
  type LodashFlatMapDeep2x2<T> = <TResult>(
    iteratee: (
      value: T[keyof T],
    ) => lodash.ListOfRecursiveArraysOrValues<TResult> | TResult,
  ) => TResult[];
  ...
  type LodashFlatMapDepth1x3<T, TResult> = (
    collection: lodash.List<T> | null | undefined,
  ) => TResult[];
  ...
  type LodashFlatMapDepth1x6<T> = <TResult>(
    iteratee: (
      value: T,
    ) => lodash.ListOfRecursiveArraysOrValues<TResult> | TResult,
  ) => TResult[];
  ...
  type LodashFlatMapDepth2x3<T, TResult> = (
    collection: T | null | undefined,
  ) => TResult[];
  ...
  type LodashFlatMapDepth2x6<T> = <TResult>(
    iteratee: (
      value: T[keyof T],
    ) => lodash.ListOfRecursiveArraysOrValues<TResult> | TResult,
  ) => TResult[];
  ...
  type LodashFlatMapDepth4x3 = (
    collection: object | null | undefined,
  ) => boolean[];
  type LodashFlatMapDepth4x5 = (depth: number) => boolean[];
  type LodashFlatten = <T>(
    array: lodash.List<lodash.Many<T>> | null | undefined,
  ) => T[];
  type LodashFlattenDeep = <T>(
    array: lodash.ListOfRecursiveArraysOrValues<T> | null | undefined,
  ) => T[];
  ...
  type LodashForOwnRight2x2<T> = (
    iteratee: (value: T[keyof T]) => any,
  ) => T | null | undefined;
  interface LodashFromPairs {
    <T>(
      pairs: lodash.List<[lodash.PropertyName, T]> | null | undefined,
    ): lodash.Dictionary<T>;
  ...
  interface LodashGet {
    ...
    >(
      path: [TKey1, TKey2],
    ): LodashGet3x1<TObject, TKey1, TKey2>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    ): LodashGet5x1<TObject, TKey1, TKey2, TKey3>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    ): LodashGet7x1<TObject, TKey1, TKey2, TKey3, TKey4>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    <T>(
      path: lodash.__,
      object: lodash.NumericDictionary<T> | null | undefined,
    ): LodashGet10x2<T>;
    <T>(
      path: number,
      object: lodash.NumericDictionary<T> | null | undefined,
  ...
  interface LodashGetOr {
    ...
    <TObject extends object, TDefault>(
      defaultValue: TDefault,
      path: lodash.__,
      object: TObject | null | undefined,
    ...
    >(
      defaultValue: lodash.__,
      path: [TKey1, TKey2],
    ): LodashGetOr2x2<TObject, TKey1, TKey2>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: TDefault,
      path: [TKey1, TKey2],
    ): LodashGetOr2x3<TObject, TKey1, TKey2, TDefault>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    >(
      ...
      path: [TKey1, TKey2],
      object: TObject | null | undefined,
    ): LodashGetOr2x6<TObject, TKey1, TKey2>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: lodash.__,
      path: [TKey1, TKey2, TKey3],
    ): LodashGetOr3x2<TObject, TKey1, TKey2, TKey3>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: TDefault,
      path: [TKey1, TKey2, TKey3],
    ): LodashGetOr3x3<TObject, TKey1, TKey2, TKey3, TDefault>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      ...
      path: [TKey1, TKey2, TKey3],
      object: TObject | null | undefined,
    ): LodashGetOr3x6<TObject, TKey1, TKey2, TKey3>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: lodash.__,
      path: [TKey1, TKey2, TKey3, TKey4],
    ): LodashGetOr4x2<TObject, TKey1, TKey2, TKey3, TKey4>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: TDefault,
      path: [TKey1, TKey2, TKey3, TKey4],
    ): LodashGetOr4x3<TObject, TKey1, TKey2, TKey3, TKey4, TDefault>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      ...
      path: [TKey1, TKey2, TKey3, TKey4],
      object: TObject | null | undefined,
    ): LodashGetOr4x6<TObject, TKey1, TKey2, TKey3, TKey4>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
  ...
  type LodashGetOr1x3<TObject, TKey extends keyof TObject, TDefault> = (
    object: TObject | null | undefined,
  ) => Exclude<TObject[TKey], undefined> | TDefault;
  interface LodashGetOr1x4<TObject> {
    ...
    <TKey extends keyof TObject, TDefault>(
      defaultValue: TDefault,
      path: TKey | [TKey],
    ): Exclude<TObject[TKey], undefined> | TDefault;
    <TKey1 extends keyof TObject, TKey2 extends keyof TObject[TKey1]>(
    ...
    <TKey1 extends keyof TObject, TKey2 extends keyof TObject[TKey1], TDefault>(
      defaultValue: TDefault,
      path: [TKey1, TKey2],
    ): Exclude<TObject[TKey1][TKey2], undefined> | TDefault;
    <
  ...
  type LodashGetOr1x6<TObject, TKey extends keyof TObject> = <TDefault>(
    defaultValue: TDefault,
  ) => Exclude<TObject[TKey], undefined> | TDefault;
  ...
  type LodashGetOr5x3<TDefault> = <T>(
    object: lodash.NumericDictionary<T> | null | undefined,
  ) => T | TDefault;
  ...
  interface LodashGroupBy {
    ...
    <T extends object>(
      iteratee: lodash.ValueIteratee<T[keyof T]>,
      collection: T | null | undefined,
    ): lodash.Dictionary<Array<T[keyof T]>>;
  }
  type LodashGroupBy1x1<T> = (
    collection: lodash.List<T> | object | null | undefined,
  ) => lodash.Dictionary<T[]>;
  type LodashGroupBy1x2<T> = (
    iteratee: lodash.ValueIteratee<T>,
  ) => lodash.Dictionary<T[]>;
  type LodashGroupBy2x2<T> = (
    iteratee: lodash.ValueIteratee<T[keyof T]>,
  ) => lodash.Dictionary<Array<T[keyof T]>>;
  interface LodashGt {
  ...
  interface LodashKeyBy {
    <T>(
      iteratee: lodash.ValueIterateeCustom<T, lodash.PropertyName>,
    ): LodashKeyBy1x1<T>;
    <T>(
      iteratee: lodash.__,
      collection: lodash.List<T> | null | undefined,
    ...
    <T extends object>(
      iteratee: lodash.ValueIterateeCustom<T[keyof T], lodash.PropertyName>,
      collection: T | null | undefined,
    ): lodash.Dictionary<T[keyof T]>;
  }
  type LodashKeyBy1x1<T> = (
    collection: lodash.List<T> | object | null | undefined,
  ) => lodash.Dictionary<T>;
  type LodashKeyBy1x2<T> = (
    iteratee: lodash.ValueIterateeCustom<T, lodash.PropertyName>,
  ) => lodash.Dictionary<T>;
  type LodashKeyBy2x2<T> = (
    iteratee: lodash.ValueIterateeCustom<T[keyof T], lodash.PropertyName>,
  ) => lodash.Dictionary<T[keyof T]>;
  ...
  interface LodashIntersection {
    ...
    <T>(
      arrays2: lodash.__,
      arrays: lodash.List<T> | null | undefined,
    ): LodashIntersection1x2<T>;
    <T>(
      arrays2: lodash.List<T> | null | undefined,
      arrays: lodash.List<T> | null | undefined,
    ): T[];
  }
  type LodashIntersection1x1<T> = (
    arrays: lodash.List<T> | null | undefined,
  ) => T[];
  type LodashIntersection1x2<T> = (
    arrays2: lodash.List<T> | null | undefined,
  ) => T[];
  ...
  type LodashIntersectionBy1x6<T1, T2> = (
    iteratee: lodash.ValueIteratee<T1 | T2>,
  ) => T1[];
  ...
  type LodashIntersectionWith1x5<T1> = (
    array: lodash.List<T1> | null | undefined,
  ) => T1[];
  type LodashIntersectionWith1x6<T1, T2> = (
    comparator: lodash.Comparator2<T1, T2>,
  ) => T1[];
  ...
  interface LodashInvertBy {
    ...
    <T>(
      interatee: lodash.ValueIteratee<T>,
      object:
        | lodash.Dictionary<T>
        | lodash.NumericDictionary<T>
        | null
        | undefined,
    ): lodash.Dictionary<string[]>;
    <T extends object>(
      interatee: lodash.__,
      object: T | null | undefined,
    ): LodashInvertBy2x2<T>;
    <T extends object>(
      interatee: lodash.ValueIteratee<T[keyof T]>,
      object: T | null | undefined,
    ): lodash.Dictionary<string[]>;
  }
  type LodashInvertBy1x1<T> = (
    object:
      | lodash.Dictionary<T>
      | lodash.NumericDictionary<T>
      | object
  ...
  type LodashInvertBy1x2<T> = (
    interatee: lodash.ValueIteratee<T>,
  ) => lodash.Dictionary<string[]>;
  type LodashInvertBy2x2<T> = (
    interatee: lodash.ValueIteratee<T[keyof T]>,
  ) => lodash.Dictionary<string[]>;
  ...
  type LodashInvokeArgsMap2x3<TResult> = (
    collection: object | null | undefined,
  ) => TResult[];
  ...
  type LodashInvokeMap2x1<TResult> = (
    collection: object | null | undefined,
  ) => TResult[];
  ...
  interface LodashIsEmpty {
    ...
    (
      value: readonly any[] | null | undefined,
    ): value is Readonly<[]> | null | undefined;
    (
      value: Map<any, any> | Set<any> | lodash.List<any> | null | undefined,
    ): boolean;
    <T extends object>(
      value: T | null | undefined,
    ): value is lodash.EmptyObjectOf<T> | null | undefined;
    (value?: any): boolean;
  }
  interface LodashIsEqualWith {
    ...
    (
      customizer: lodash.IsEqualCustomizer,
      value: lodash.__,
      other: any,
  ...
  interface LodashIsMatchWith {
    ...
    (
      customizer: lodash.isMatchWithCustomizer,
      source: object,
  ...
  interface LodashJoin {
    ...
    (
      separator: lodash.__,
      array: lodash.List<any> | null | undefined,
    ): LodashJoin1x2;
  ...
  type LodashOver = <TResult>(
    iteratees: lodash.Many<(...args: any[]) => TResult>,
  ) => (...args: any[]) => TResult[];
  ...
  type LodashLastIndexOfFrom1x3<T> = (
    array: lodash.List<T> | null | undefined,
  ) => number;
  ...
  type LodashLowerFirst = <T extends string = string>(
    string: T,
  ) => Uncapitalize<T>;
  interface LodashLt {
  ...
  interface LodashMap {
    ...
    <T extends object, TResult>(
      iteratee: (value: T[keyof T]) => TResult,
  ...
  type LodashMap1x1<T, TResult> = (
    collection: T[] | lodash.List<T> | null | undefined,
  ) => TResult[];
  type LodashMap1x2<T> = <TResult>(
    iteratee: (value: T) => TResult,
  ) => TResult[];
  type LodashMap2x2<T> = <TResult>(
    iteratee: (value: T) => TResult,
  ) => TResult[];
  type LodashMap3x1<T, TResult> = (
    collection: T | null | undefined,
  ) => TResult[];
  type LodashMap3x2<T> = <TResult>(
    iteratee: (value: T[keyof T]) => TResult,
  ) => TResult[];
  type LodashMap4x1<T, K extends keyof T> = (
    collection:
      | lodash.Dictionary<T>
      | lodash.NumericDictionary<T>
      | null
  ...
  interface LodashMapKeys {
    ...
    <T>(
      iteratee: lodash.__,
      object: lodash.List<T> | null | undefined,
    ): LodashMapKeys1x2<T>;
    <T>(
      iteratee: lodash.ValueIteratee<number>,
      object: lodash.List<T> | null | undefined,
    ): lodash.Dictionary<T>;
    ...
    <T extends object>(
      iteratee: lodash.ValueIteratee<string>,
      object: T | null | undefined,
    ): lodash.Dictionary<T[keyof T]>;
  }
  type LodashMapKeys1x1 = <T>(
    object: lodash.List<T> | null | undefined,
  ) => lodash.Dictionary<T>;
  type LodashMapKeys1x2<T> = (
    iteratee: lodash.ValueIteratee<number>,
  ) => lodash.Dictionary<T>;
  type LodashMapKeys2x1 = <T extends object>(
    object: T | null | undefined,
  ) => lodash.Dictionary<T[keyof T]>;
  type LodashMapKeys2x2<T> = (
    iteratee: lodash.ValueIteratee<string>,
  ) => lodash.Dictionary<T[keyof T]>;
  interface LodashMapValues {
    <T, TResult>(
      callback: (value: T) => TResult,
    ): LodashMapValues1x1<T, TResult>;
    <T>(
      callbackOrIterateeOrIterateeOrIteratee: lodash.__,
      obj:
        | lodash.Dictionary<T>
        | lodash.NumericDictionary<T>
        | null
        | undefined,
    ): LodashMapValues1x2<T>;
    <T, TResult>(
      callback: (value: T) => TResult,
      obj:
        | lodash.Dictionary<T>
        ...
        | null
        | undefined,
    ): lodash.Dictionary<TResult>;
    <T extends object, TResult>(
      callback: (value: T[keyof T]) => TResult,
    ): LodashMapValues2x1<T, TResult>;
    <T extends object>(
      callbackOrIterateeOrIteratee: lodash.__,
    ...
    <T>(
      ...
      obj:
        ...
        | null
        | undefined,
    ): lodash.Dictionary<any>;
    <T extends object>(
      iteratee: string,
      obj: T | null | undefined,
    ): { [P in keyof T]: any };
  }
  type LodashMapValues1x1<T, TResult> = (
    obj: lodash.Dictionary<T> | lodash.NumericDictionary<T> | null | undefined,
  ) => lodash.Dictionary<TResult>;
  ...
  type LodashMapValues2x1<T, TResult> = (obj: T | null | undefined) => {
    [P in keyof T]: TResult;
  };
  interface LodashMapValues2x2<T> {
    <TResult>(callback: (value: T[keyof T]) => TResult): {
      [P in keyof T]: TResult;
    };
  ...
  type LodashMapValues5x1<T, TKey extends keyof T> = (
    obj: lodash.Dictionary<T> | lodash.NumericDictionary<T> | null | undefined,
  ) => lodash.Dictionary<T[TKey]>;
  ...
  type LodashMeanBy1x1<T> = (
    collection: lodash.List<T> | null | undefined,
  ) => number;
  type LodashMeanBy1x2<T> = (iteratee: lodash.ValueIteratee<T>) => number;
  type LodashMemoize = <T extends (...args: any) => any>(
    func: T,
  ) => T & lodash.MemoizedFunction;
  ...
  type LodashMerge1x1<TObject> = <TSource>(
    source: TSource,
  ) => TObject & TSource;
  type LodashMerge1x2<TSource> = <TObject>(
    object: TObject,
  ) => TObject & TSource;
  ...
  type LodashMergeWith1x3<TObject> = <TSource>(
    source: TSource,
  ) => TObject & TSource;
  ...
  type LodashMergeWith1x5<TSource> = <TObject>(
    object: TObject,
  ) => TObject & TSource;
  type LodashMergeWith1x6<TObject, TSource> = (
    customizer: lodash.MergeWithCustomizer,
  ) => TObject & TSource;
  ...
  interface LodashOmit {
    ...
    <T extends object>(
      paths: lodash.Many<lodash.PropertyName>,
      object: T | null | undefined,
    ): lodash.PartialObject<T>;
  }
  type LodashOmit1x1<T, K extends keyof T> = (
    object: T | null | undefined,
  ) => lodash.Omit<T, K>;
  ...
  type LodashOmit2x1 = <T extends object>(
    object: T | null | undefined,
  ) => lodash.PartialObject<T>;
  interface LodashOmitBy {
    ...
    <T>(
      predicate: lodash.__,
      object: lodash.Dictionary<T> | null | undefined,
    ): LodashOmitBy1x2<T>;
    <T>(
    ...
    <T extends object>(
      predicate: lodash.ValueKeyIteratee<T[keyof T]>,
      object: T | null | undefined,
    ): lodash.PartialObject<T>;
  }
  interface LodashOmitBy1x1<T> {
    ...
    <T1 extends object>(
      object: T1 | null | undefined,
    ): lodash.PartialObject<T1>;
  }
  type LodashOmitBy1x2<T> = (
    predicate: lodash.ValueKeyIteratee<T>,
  ) => lodash.Dictionary<T>;
  type LodashOmitBy2x2<T> = (
    predicate: lodash.ValueKeyIteratee<T>,
  ) => lodash.NumericDictionary<T>;
  type LodashOmitBy3x2<T> = (
    predicate: lodash.ValueKeyIteratee<T[keyof T]>,
  ) => lodash.PartialObject<T>;
  type LodashOnce = <T extends (...args: any) => any>(func: T) => T;
  interface LodashOrderBy {
    <T>(
      iteratees: lodash.Many<(value: T) => lodash.NotVoid>,
    ): LodashOrderBy1x1<T>;
    (
      iteratees: lodash.__,
      orders: lodash.Many<boolean | "asc" | "desc">,
    ): LodashOrderBy1x2;
    <T>(
      iteratees: lodash.Many<(value: T) => lodash.NotVoid>,
      orders: lodash.Many<boolean | "asc" | "desc">,
    ...
    <T>(
      iteratees:
        | lodash.Many<(value: T) => lodash.NotVoid>
        | lodash.Many<lodash.ValueIteratee<T>>,
      orders: lodash.Many<boolean | "asc" | "desc">,
      collection: lodash.List<T> | null | undefined,
    ): T[];
    <T>(iteratees: lodash.Many<lodash.ValueIteratee<T>>): LodashOrderBy2x1<T>;
    <T>(
      iteratees: lodash.Many<lodash.ValueIteratee<T>>,
      orders: lodash.Many<boolean | "asc" | "desc">,
    ): LodashOrderBy2x3<T>;
    <T>(
      iteratees: lodash.Many<lodash.ValueIteratee<T>>,
    ...
    <T extends object>(
      iteratees: lodash.Many<(value: T[keyof T]) => lodash.NotVoid>,
      orders: lodash.__,
      collection: T | null | undefined,
    ): LodashOrderBy3x5<T>;
    <T extends object>(
    ...
    <T extends object>(
      iteratees:
        | lodash.Many<(value: T[keyof T]) => lodash.NotVoid>
        | lodash.Many<lodash.ValueIteratee<T[keyof T]>>,
      orders: lodash.Many<boolean | "asc" | "desc">,
      collection: T | null | undefined,
    ): Array<T[keyof T]>;
    <T extends object>(
      iteratees: lodash.Many<lodash.ValueIteratee<T[keyof T]>>,
      orders: lodash.__,
      collection: T | null | undefined,
    ): LodashOrderBy4x5<T>;
  }
  ...
  type LodashOrderBy1x5<T> = (
    orders: lodash.Many<boolean | "asc" | "desc">,
  ) => T[];
  type LodashOrderBy1x6<T> = (
    iteratees:
      | lodash.Many<(value: T) => lodash.NotVoid>
      | lodash.Many<lodash.ValueIteratee<T>>,
  ) => T[];
  ...
  type LodashOrderBy3x5<T> = (
    orders: lodash.Many<boolean | "asc" | "desc">,
  ) => Array<T[keyof T]>;
  type LodashOrderBy3x6<T> = (
    iteratees:
      | lodash.Many<(value: T[keyof T]) => lodash.NotVoid>
      | lodash.Many<lodash.ValueIteratee<T[keyof T]>>,
  ) => Array<T[keyof T]>;
  type LodashOrderBy4x5<T> = (
    orders: lodash.Many<boolean | "asc" | "desc">,
  ) => Array<T[keyof T]>;
  interface LodashOverArgs {
    ...
    (
      func: lodash.__,
      transforms: lodash.Many<(...args: any[]) => any>,
    ): LodashOverArgs1x2;
    (
      func: (...args: any[]) => any,
      transforms: lodash.Many<(...args: any[]) => any>,
  ...
  type LodashOverArgs1x1 = (
    transforms: lodash.Many<(...args: any[]) => any>,
  ) => (...args: any[]) => any;
  type LodashOverArgs1x2 = (
    func: (...args: any[]) => any,
  ) => (...args: any[]) => any;
  interface LodashPad {
  ...
  interface LodashPartial {
    ...
    <T1, T2, R>(
      func: lodash.Function2<T1, T2, R>,
      plc1: [lodash.__, T2],
    ): lodash.Function1<T1, R>;
    <T1, T2, T3, R>(
      func: lodash.Function3<T1, T2, T3, R>,
    ): LodashPartial2x1<T1, T2, T3, R>;
    <T1, T2, T3, R>(
      func: lodash.Function3<T1, T2, T3, R>,
      plc1: [lodash.__, T2],
    ): lodash.Function2<T1, T3, R>;
    <T3>(
      func: lodash.__,
      plc1: [lodash.__, lodash.__, T3],
    ): LodashPartial3x2<T3>;
    <T1, T2, T3, R>(
      func: lodash.Function3<T1, T2, T3, R>,
      plc1: [lodash.__, lodash.__, T3],
    ): lodash.Function2<T1, T2, R>;
    <T1, T3>(
      func: lodash.__,
      arg1: [T1, lodash.__, T3],
    ): LodashPartial4x2<T1, T3>;
    <T1, T2, T3, R>(
      func: lodash.Function3<T1, T2, T3, R>,
      arg1: [T1, lodash.__, T3],
    ): lodash.Function1<T2, R>;
    <T2, T3>(
      func: lodash.__,
      plc1: [lodash.__, T2, T3],
    ): LodashPartial5x2<T2, T3>;
    <T1, T2, T3, R>(
      func: lodash.Function3<T1, T2, T3, R>,
      plc1: [lodash.__, T2, T3],
    ): lodash.Function1<T1, R>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
    ): LodashPartial6x1<T1, T2, T3, T4, R>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      plc1: [lodash.__, T2],
    ): lodash.Function3<T1, T3, T4, R>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      plc1: [lodash.__, lodash.__, T3],
    ): lodash.Function3<T1, T2, T4, R>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg1: [T1, lodash.__, T3],
    ): lodash.Function2<T2, T4, R>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      plc1: [lodash.__, T2, T3],
    ): lodash.Function2<T1, T4, R>;
    <T1, T2, T3>(
      func: lodash.__,
      arg1OrT1: [T1, T2, T3],
    ): LodashPartial10x2<T1, T2, T3>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg1: [T1, T2, T3],
    ): lodash.Function1<T4, R>;
    <T4>(
      func: lodash.__,
      plc1: [lodash.__, lodash.__, lodash.__, T4],
    ): LodashPartial11x2<T4>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      plc1: [lodash.__, lodash.__, lodash.__, T4],
    ): lodash.Function3<T1, T2, T3, R>;
    <T1, T4>(
      func: lodash.__,
      arg1: [T1, lodash.__, lodash.__, T4],
    ): LodashPartial12x2<T1, T4>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg1: [T1, lodash.__, lodash.__, T4],
    ): lodash.Function2<T2, T3, R>;
    <T2, T4>(
      func: lodash.__,
      plc1: [lodash.__, T2, lodash.__, T4],
    ): LodashPartial13x2<T2, T4>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      plc1: [lodash.__, T2, lodash.__, T4],
    ): lodash.Function2<T1, T3, R>;
    <T1, T2, T4>(
      func: lodash.__,
      arg1: [T1, T2, lodash.__, T4],
    ): LodashPartial14x2<T1, T2, T4>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg1: [T1, T2, lodash.__, T4],
    ): lodash.Function1<T3, R>;
    <T3, T4>(
      func: lodash.__,
      plc1: [lodash.__, lodash.__, T3, T4],
    ): LodashPartial15x2<T3, T4>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      plc1: [lodash.__, lodash.__, T3, T4],
    ): lodash.Function2<T1, T2, R>;
    <T1, T3, T4>(
      func: lodash.__,
      arg1: [T1, lodash.__, T3, T4],
    ): LodashPartial16x2<T1, T3, T4>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg1: [T1, lodash.__, T3, T4],
    ): lodash.Function1<T2, R>;
    <T2, T3, T4>(
      func: lodash.__,
      plc1: [lodash.__, T2, T3, T4],
    ): LodashPartial17x2<T2, T3, T4>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      plc1: [lodash.__, T2, T3, T4],
    ): lodash.Function1<T1, R>;
    ...
    ): LodashPartial20x1<TS, T1, T2, T3, R>;
    <TS extends any[], T1, T2, T3, R>(
      func: (t1: T1, t2: T2, t3: T3, ...ts: TS) => R,
      t1: [T1, T2, T3],
    ): (...ts: TS) => R;
    ...
    ): LodashPartial21x1<TS, T1, T2, T3, T4, R>;
    <T1, T2, T3, T4>(
      func: lodash.__,
      t1: [T1, T2, T3, T4],
    ): LodashPartial21x2<T1, T2, T3, T4>;
    <TS extends any[], T1, T2, T3, T4, R>(
      func: (t1: T1, t2: T2, t3: T3, t4: T4, ...ts: TS) => R,
      t1: [T1, T2, T3, T4],
    ): (...ts: TS) => R;
  ...
  type LodashPartial11x2<T4> = <T1, T2, T3, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function3<T1, T2, T3, R>;
  type LodashPartial12x2<T1, T4> = <T2, T3, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function2<T2, T3, R>;
  type LodashPartial13x2<T2, T4> = <T1, T3, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function2<T1, T3, R>;
  type LodashPartial14x2<T1, T2, T4> = <T3, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function1<T3, R>;
  type LodashPartial15x2<T3, T4> = <T1, T2, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function2<T1, T2, R>;
  type LodashPartial16x2<T1, T3, T4> = <T2, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function1<T2, R>;
  type LodashPartial17x2<T2, T3, T4> = <T1, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function1<T1, R>;
  type LodashPartial18x1<TS extends any[], T1, R> = (
    arg1: [T1],
  ) => (...ts: TS) => R;
  type LodashPartial18x2<T1> = <TS extends any[], R>(
    func: (t1: T1, ...ts: TS) => R,
  ) => (...ts: TS) => R;
  type LodashPartial19x1<TS extends any[], T1, T2, R> = (
    t1: [T1, T2],
  ) => (...ts: TS) => R;
  type LodashPartial19x2<T1, T2> = <TS extends any[], R>(
    func: (t1: T1, t2: T2, ...ts: TS) => R,
  ) => (...ts: TS) => R;
  type LodashPartial20x1<TS extends any[], T1, T2, T3, R> = (
    t1: [T1, T2, T3],
  ) => (...ts: TS) => R;
  type LodashPartial21x1<TS extends any[], T1, T2, T3, T4, R> = (
    t1: [T1, T2, T3, T4],
  ) => (...ts: TS) => R;
  type LodashPartial21x2<T1, T2, T3, T4> = <TS extends any[], R>(
    func: (t1: T1, t2: T2, t3: T3, t4: T4, ...ts: TS) => R,
  ) => (...ts: TS) => R;
  interface LodashPartialRight {
    ...
    <T1, T2, T3, R>(
      func: lodash.Function3<T1, T2, T3, R>,
    ): LodashPartialRight5x1<T1, T2, T3, R>;
    <T1>(
      func: lodash.__,
      arg1: [T1, lodash.__, lodash.__],
    ): LodashPartialRight5x2<T1>;
    <T1, T2, T3, R>(
      func: lodash.Function3<T1, T2, T3, R>,
      arg1: [T1, lodash.__, lodash.__],
    ): lodash.Function2<T2, T3, R>;
    ...
    <T1, T2>(
      func: lodash.__,
      arg1: [T1, T2, lodash.__],
    ): LodashPartialRight7x2<T1, T2>;
    <T1, T2, T3, R>(
      func: lodash.Function3<T1, T2, T3, R>,
      arg1: [T1, T2, lodash.__],
    ): lodash.Function1<T3, R>;
    ...
    <T1, T2, T3>(
      func: lodash.__,
      arg1: [T1, T2, T3],
    ): LodashPartialRight11x2<T1, T2, T3>;
    <T1, T2, T3, R>(
      func: lodash.Function3<T1, T2, T3, R>,
      arg1: [T1, T2, T3],
    ): lodash.Function0<R>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
    ): LodashPartialRight12x1<T1, T2, T3, T4, R>;
    <T1>(
      func: lodash.__,
      arg1: [T1, lodash.__, lodash.__, lodash.__],
    ): LodashPartialRight12x2<T1>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg1: [T1, lodash.__, lodash.__, lodash.__],
    ): lodash.Function3<T2, T3, T4, R>;
    <T2>(
      func: lodash.__,
      arg2: [T2, lodash.__, lodash.__],
    ): LodashPartialRight13x2<T2>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg2: [T2, lodash.__, lodash.__],
    ): lodash.Function3<T1, T3, T4, R>;
    <T1, T2>(
      func: lodash.__,
      arg1: [T1, T2, lodash.__, lodash.__],
    ): LodashPartialRight14x2<T1, T2>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg1: [T1, T2, lodash.__, lodash.__],
    ): lodash.Function2<T3, T4, R>;
    ...
    <T1, T3>(
      func: lodash.__,
      arg1: [T1, lodash.__, T3, lodash.__],
    ): LodashPartialRight16x2<T1, T3>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg1: [T1, lodash.__, T3, lodash.__],
    ): lodash.Function2<T2, T4, R>;
    <T2, T3>(
      func: lodash.__,
      arg2: [T2, T3, lodash.__],
    ): LodashPartialRight17x2<T2, T3>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg2: [T2, T3, lodash.__],
    ): lodash.Function2<T1, T4, R>;
    <T1, T2, T3>(
      func: lodash.__,
      arg1: [T1, T2, T3, lodash.__],
    ): LodashPartialRight18x2<T1, T2, T3>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg1: [T1, T2, T3, lodash.__],
    ): lodash.Function1<T4, R>;
    ...
    <T2, T4>(
      func: lodash.__,
      arg2: [T2, lodash.__, T4],
    ): LodashPartialRight21x2<T2, T4>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg2: [T2, lodash.__, T4],
    ): lodash.Function2<T1, T3, R>;
    <T1, T2, T4>(
      func: lodash.__,
      arg1: [T1, T2, lodash.__, T4],
    ): LodashPartialRight22x2<T1, T2, T4>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg1: [T1, T2, lodash.__, T4],
    ): lodash.Function1<T3, R>;
    ...
    <T1, T3, T4>(
      func: lodash.__,
      arg1: [T1, lodash.__, T3, T4],
    ): LodashPartialRight24x2<T1, T3, T4>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg1: [T1, lodash.__, T3, T4],
    ): lodash.Function1<T2, R>;
    <T2, T3, T4>(
      func: lodash.__,
      arg2: [T2, T3, T4],
    ): LodashPartialRight25x2<T2, T3, T4>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg2: [T2, T3, T4],
    ): lodash.Function1<T1, R>;
    <T1, T2, T3, T4>(
      func: lodash.__,
      arg1: [T1, T2, T3, T4],
    ): LodashPartialRight26x2<T1, T2, T3, T4>;
    <T1, T2, T3, T4, R>(
      func: lodash.Function4<T1, T2, T3, T4, R>,
      arg1: [T1, T2, T3, T4],
    ): lodash.Function0<R>;
  ...
  type LodashPartialRight1x2<T1> = <R>(
    func: lodash.Function1<T1, R>,
  ) => lodash.Function0<R>;
  ...
  type LodashPartialRight2x2<T1> = <T2, R>(
    func: lodash.Function2<T1, T2, R>,
  ) => lodash.Function1<T2, R>;
  type LodashPartialRight3x2<T2> = <T1, R>(
    func: lodash.Function2<T1, T2, R>,
  ) => lodash.Function1<T1, R>;
  type LodashPartialRight4x2<T1, T2> = <R>(
    func: lodash.Function2<T1, T2, R>,
  ) => lodash.Function0<R>;
  ...
  type LodashPartialRight5x2<T1> = <T2, T3, R>(
    func: lodash.Function3<T1, T2, T3, R>,
  ) => lodash.Function2<T2, T3, R>;
  type LodashPartialRight6x2<T2> = <T1, T3, R>(
    func: lodash.Function3<T1, T2, T3, R>,
  ) => lodash.Function2<T1, T3, R>;
  type LodashPartialRight7x2<T1, T2> = <T3, R>(
    func: lodash.Function3<T1, T2, T3, R>,
  ) => lodash.Function1<T3, R>;
  type LodashPartialRight8x2<T3> = <T1, T2, R>(
    func: lodash.Function3<T1, T2, T3, R>,
  ) => lodash.Function2<T1, T2, R>;
  type LodashPartialRight9x2<T1, T3> = <T2, R>(
    func: lodash.Function3<T1, T2, T3, R>,
  ) => lodash.Function1<T2, R>;
  type LodashPartialRight10x2<T2, T3> = <T1, R>(
    func: lodash.Function3<T1, T2, T3, R>,
  ) => lodash.Function1<T1, R>;
  type LodashPartialRight11x2<T1, T2, T3> = <R>(
    func: lodash.Function3<T1, T2, T3, R>,
  ) => lodash.Function0<R>;
  ...
  type LodashPartialRight12x2<T1> = <T2, T3, T4, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function3<T2, T3, T4, R>;
  type LodashPartialRight13x2<T2> = <T1, T3, T4, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function3<T1, T3, T4, R>;
  type LodashPartialRight14x2<T1, T2> = <T3, T4, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function2<T3, T4, R>;
  type LodashPartialRight15x2<T3> = <T1, T2, T4, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function3<T1, T2, T4, R>;
  type LodashPartialRight16x2<T1, T3> = <T2, T4, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function2<T2, T4, R>;
  type LodashPartialRight17x2<T2, T3> = <T1, T4, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function2<T1, T4, R>;
  type LodashPartialRight18x2<T1, T2, T3> = <T4, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function1<T4, R>;
  type LodashPartialRight19x2<T4> = <T1, T2, T3, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function3<T1, T2, T3, R>;
  type LodashPartialRight20x2<T1, T4> = <T2, T3, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function2<T2, T3, R>;
  type LodashPartialRight21x2<T2, T4> = <T1, T3, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function2<T1, T3, R>;
  type LodashPartialRight22x2<T1, T2, T4> = <T3, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function1<T3, R>;
  type LodashPartialRight23x2<T3, T4> = <T1, T2, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function2<T1, T2, R>;
  type LodashPartialRight24x2<T1, T3, T4> = <T2, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function1<T2, R>;
  type LodashPartialRight25x2<T2, T3, T4> = <T1, R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function1<T1, R>;
  type LodashPartialRight26x2<T1, T2, T3, T4> = <R>(
    func: lodash.Function4<T1, T2, T3, T4, R>,
  ) => lodash.Function0<R>;
  type LodashPartialRight27x1 = (
    args: readonly any[],
  ) => (...args: any[]) => any;
  type LodashPartialRight27x2 = (
    func: (...args: any[]) => any,
  ) => (...args: any[]) => any;
  interface LodashPartition {
    <T, U extends T>(
      callback: lodash.ValueIteratorTypeGuard<T, U>,
    ): LodashPartition1x1<T, U>;
    <T>(
      callback: lodash.__,
      collection: lodash.List<T> | null | undefined,
    ...
    <T>(
      callback: lodash.ValueIteratee<T>,
      collection: lodash.List<T> | null | undefined,
    ): [T[], T[]];
    <T extends object>(
      callback: lodash.__,
      collection: T | null | undefined,
    ): LodashPartition3x2<T>;
    <T extends object>(
      callback: lodash.ValueIteratee<T[keyof T]>,
      collection: T | null | undefined,
    ): [Array<T[keyof T]>, Array<T[keyof T]>];
  }
  type LodashPartition1x1<T, U> = (
    collection: lodash.List<T> | null | undefined,
  ) => [U[], Array<Exclude<T, U>>];
  ...
  type LodashPartition2x1<T> = (
    collection: lodash.List<T> | object | null | undefined,
  ) => [T[], T[]];
  type LodashPartition3x2<T> = (
    callback: lodash.ValueIteratee<T[keyof T]>,
  ) => [Array<T[keyof T]>, Array<T[keyof T]>];
  interface LodashPath {
    ...
    >(
      path: [TKey1, TKey2],
    ): LodashPath3x1<TObject, TKey1, TKey2>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      path: [TKey1, TKey2, TKey3],
    ): LodashPath5x1<TObject, TKey1, TKey2, TKey3>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      path: [TKey1, TKey2, TKey3, TKey4],
    ): LodashPath7x1<TObject, TKey1, TKey2, TKey3, TKey4>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
  ...
  interface LodashPathOr {
    ...
    >(
      defaultValue: lodash.__,
      path: [TKey1, TKey2],
    ): LodashPathOr2x2<TObject, TKey1, TKey2>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: TDefault,
      path: [TKey1, TKey2],
    ): LodashPathOr2x3<TObject, TKey1, TKey2, TDefault>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    >(
      ...
      path: [TKey1, TKey2],
      object: TObject | null | undefined,
    ): LodashPathOr2x6<TObject, TKey1, TKey2>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: lodash.__,
      path: [TKey1, TKey2, TKey3],
    ): LodashPathOr3x2<TObject, TKey1, TKey2, TKey3>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: TDefault,
      path: [TKey1, TKey2, TKey3],
    ): LodashPathOr3x3<TObject, TKey1, TKey2, TKey3, TDefault>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      ...
      path: [TKey1, TKey2, TKey3],
      object: TObject | null | undefined,
    ): LodashPathOr3x6<TObject, TKey1, TKey2, TKey3>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: lodash.__,
      path: [TKey1, TKey2, TKey3, TKey4],
    ): LodashPathOr4x2<TObject, TKey1, TKey2, TKey3, TKey4>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: TDefault,
      path: [TKey1, TKey2, TKey3, TKey4],
    ): LodashPathOr4x3<TObject, TKey1, TKey2, TKey3, TKey4, TDefault>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      ...
      path: [TKey1, TKey2, TKey3, TKey4],
      object: TObject | null | undefined,
    ): LodashPathOr4x6<TObject, TKey1, TKey2, TKey3, TKey4>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
  ...
  type LodashPathOr1x3<TObject, TKey extends keyof TObject, TDefault> = (
    object: TObject | null | undefined,
  ) => Exclude<TObject[TKey], undefined> | TDefault;
  ...
  type LodashPathOr1x6<TObject, TKey extends keyof TObject> = <TDefault>(
    defaultValue: TDefault,
  ) => Exclude<TObject[TKey], undefined> | TDefault;
  ...
  type LodashPathOr5x3<TDefault> = <T>(
    object: lodash.NumericDictionary<T> | null | undefined,
  ) => T | TDefault;
  ...
  type LodashPick1x2<T> = <U extends keyof T>(
    props: lodash.Many<U>,
  ) => Pick<T, U>;
  type LodashPick2x1 = <T>(
    object: T | null | undefined,
  ) => lodash.PartialObject<T>;
  type LodashPick2x2<T> = (
    props: lodash.PropertyPath,
  ) => lodash.PartialObject<T>;
  interface LodashPickBy {
    <T, S extends T>(
      predicate: lodash.ValueKeyIterateeTypeGuard<T, S>,
    ): LodashPickBy1x1<T, S>;
    <T>(
      predicate: lodash.__,
      object: lodash.Dictionary<T> | null | undefined,
  ...
  interface LodashProp {
    ...
    >(
      path: [TKey1, TKey2],
    ): LodashProp3x1<TObject, TKey1, TKey2>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      path: [TKey1, TKey2, TKey3],
    ): LodashProp5x1<TObject, TKey1, TKey2, TKey3>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      path: [TKey1, TKey2, TKey3, TKey4],
    ): LodashProp7x1<TObject, TKey1, TKey2, TKey3, TKey4>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
  ...
  interface LodashProperty {
    ...
    >(
      path: [TKey1, TKey2],
    ): LodashProperty3x1<TObject, TKey1, TKey2>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      path: [TKey1, TKey2, TKey3],
    ): LodashProperty5x1<TObject, TKey1, TKey2, TKey3>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      path: [TKey1, TKey2, TKey3, TKey4],
    ): LodashProperty7x1<TObject, TKey1, TKey2, TKey3, TKey4>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    <T>(
      path: lodash.__,
      object: lodash.NumericDictionary<T>,
    ): LodashProperty9x2<T>;
    <T>(path: number, object: lodash.NumericDictionary<T>): T;
    <T>(
      path: lodash.__,
      object: lodash.NumericDictionary<T> | null | undefined,
    ): LodashProperty10x2<T>;
    <T>(
      path: number,
      object: lodash.NumericDictionary<T> | null | undefined,
    ): T | undefined;
  ...
  interface LodashPropertyOf {
    ...
    >(
      path: [TKey1, TKey2],
    ): LodashPropertyOf3x1<TObject, TKey1, TKey2>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      path: [TKey1, TKey2, TKey3],
    ): LodashPropertyOf5x1<TObject, TKey1, TKey2, TKey3>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      path: [TKey1, TKey2, TKey3, TKey4],
    ): LodashPropertyOf7x1<TObject, TKey1, TKey2, TKey3, TKey4>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    <T>(
      path: lodash.__,
      object: lodash.NumericDictionary<T>,
    ): LodashPropertyOf9x2<T>;
    <T>(path: number, object: lodash.NumericDictionary<T>): T;
    <T>(
      path: lodash.__,
      object: lodash.NumericDictionary<T> | null | undefined,
    ): LodashPropertyOf10x2<T>;
    <T>(
      path: number,
      object: lodash.NumericDictionary<T> | null | undefined,
    ): T | undefined;
  ...
  interface LodashPropOr {
    ...
    >(
      defaultValue: lodash.__,
      path: [TKey1, TKey2],
    ): LodashPropOr2x2<TObject, TKey1, TKey2>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: TDefault,
      path: [TKey1, TKey2],
    ): LodashPropOr2x3<TObject, TKey1, TKey2, TDefault>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    >(
      ...
      path: [TKey1, TKey2],
      object: TObject | null | undefined,
    ): LodashPropOr2x6<TObject, TKey1, TKey2>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: lodash.__,
      path: [TKey1, TKey2, TKey3],
    ): LodashPropOr3x2<TObject, TKey1, TKey2, TKey3>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: TDefault,
      path: [TKey1, TKey2, TKey3],
    ): LodashPropOr3x3<TObject, TKey1, TKey2, TKey3, TDefault>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      ...
      path: [TKey1, TKey2, TKey3],
      object: TObject | null | undefined,
    ): LodashPropOr3x6<TObject, TKey1, TKey2, TKey3>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: lodash.__,
      path: [TKey1, TKey2, TKey3, TKey4],
    ): LodashPropOr4x2<TObject, TKey1, TKey2, TKey3, TKey4>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      defaultValue: TDefault,
      path: [TKey1, TKey2, TKey3, TKey4],
    ): LodashPropOr4x3<TObject, TKey1, TKey2, TKey3, TKey4, TDefault>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
    ...
    >(
      ...
      path: [TKey1, TKey2, TKey3, TKey4],
      object: TObject | null | undefined,
    ): LodashPropOr4x6<TObject, TKey1, TKey2, TKey3, TKey4>;
    <
      TObject extends object,
      TKey1 extends keyof TObject,
      TKey2 extends keyof TObject[TKey1],
  ...
  type LodashPropOr1x3<TObject, TKey extends keyof TObject, TDefault> = (
    object: TObject | null | undefined,
  ) => Exclude<TObject[TKey], undefined> | TDefault;
  ...
  type LodashPropOr1x6<TObject, TKey extends keyof TObject> = <TDefault>(
    defaultValue: TDefault,
  ) => Exclude<TObject[TKey], undefined> | TDefault;
  ...
  type LodashPropOr5x3<TDefault> = <T>(
    object: lodash.NumericDictionary<T> | null | undefined,
  ) => T | TDefault;
  ...
  type LodashPullAllBy4x5<T1, T2> = (
    values: lodash.List<T2>,
  ) => lodash.List<T1>;
  type LodashPullAllBy4x6<T1, T2> = (
    iteratee: lodash.ValueIteratee<T1 | T2>,
  ) => lodash.List<T1>;
  interface LodashPullAllWith {
    ...
    <T>(
      comparator: lodash.Comparator<T>,
      values: lodash.List<T>,
  ...
  type LodashPullAllWith3x6<T1, T2> = (
    comparator: lodash.Comparator2<T1, T2>,
  ) => T1[];
  ...
  type LodashPullAllWith4x5<T1, T2> = (
    values: lodash.List<T2>,
  ) => lodash.List<T1>;
  type LodashPullAllWith4x6<T1, T2> = (
    comparator: lodash.Comparator2<T1, T2>,
  ) => lodash.List<T1>;
  ...
  interface LodashReduce {
    <T, TResult>(
      callback: lodash.MemoIteratorCapped<T, TResult>,
    ...
    <T extends object, TResult>(
      callback: lodash.MemoIteratorCapped<T[keyof T], TResult>,
  ...
  type LodashReduce1x6<T, TResult> = (
    callback: lodash.MemoIteratorCapped<T, TResult>,
  ) => TResult;
  ...
  type LodashReduce2x6<T, TResult> = (
    callback: lodash.MemoIteratorCapped<T, TResult>,
  ) => TResult;
  ...
  type LodashReduce3x3<T, TResult> = (
    collection: T | null | undefined,
  ) => TResult;
  ...
  type LodashReduce3x6<T, TResult> = (
    callback: lodash.MemoIteratorCapped<T[keyof T], TResult>,
  ) => TResult;
  interface LodashReduceRight {
    <T, TResult>(
      callback: lodash.MemoIteratorCappedRight<T, TResult>,
    ...
    <T extends object, TResult>(
      callback: lodash.MemoIteratorCappedRight<T[keyof T], TResult>,
  ...
  type LodashReduceRight1x3<T, TResult> = (
    collection: T[] | lodash.List<T> | null | undefined,
  ) => TResult;
  ...
  type LodashReduceRight1x6<T, TResult> = (
    callback: lodash.MemoIteratorCappedRight<T, TResult>,
  ) => TResult;
  ...
  type LodashReduceRight2x6<T, TResult> = (
    callback: lodash.MemoIteratorCappedRight<T, TResult>,
  ) => TResult;
  ...
  type LodashReduceRight3x3<T, TResult> = (
    collection: T | null | undefined,
  ) => TResult;
  ...
  type LodashReduceRight3x6<T, TResult> = (
    callback: lodash.MemoIteratorCappedRight<T[keyof T], TResult>,
  ) => TResult;
  ...
  type LodashReject1x1<T> = (
    collection: lodash.List<T> | object | null | undefined,
  ) => T[];
  type LodashReject1x2<T> = (
    predicate: lodash.ValueIterateeCustom<T, boolean>,
  ) => T[];
  type LodashReject2x2<T> = (
    predicate: lodash.ValueIterateeCustom<T[keyof T], boolean>,
  ) => Array<T[keyof T]>;
  ...
  interface LodashReplace {
    ...
    (
      pattern: lodash.__,
      replacement: lodash.ReplaceFunction | string,
    ): LodashReplace1x2;
    (
  ...
  type LodashSortBy1x1<T> = (
    collection: lodash.List<T> | object | null | undefined,
  ) => T[];
  type LodashSortBy1x2<T> = (
    iteratees: lodash.Many<lodash.ValueIteratee<T>>,
  ) => T[];
  type LodashSortBy2x2<T> = (
    iteratees: lodash.Many<lodash.ValueIteratee<T[keyof T]>>,
  ) => Array<T[keyof T]>;
  ...
  type LodashSortedLastIndex1x1<T> = (
    array: lodash.List<T> | null | undefined,
  ) => number;
  ...
  type LodashSortedLastIndexBy1x3<T> = (
    array: lodash.List<T> | null | undefined,
  ) => number;
  ...
  type LodashSortedLastIndexBy1x6<T> = (
    iteratee: lodash.ValueIteratee<T>,
  ) => number;
  ...
  type LodashSortedLastIndexOf1x1<T> = (
    array: lodash.List<T> | null | undefined,
  ) => number;
  ...
  interface LodashSortedUniqBy {
    ...
    <T>(
      iteratee: lodash.__,
      array: lodash.List<T> | null | undefined,
    ): LodashSortedUniqBy1x2<T>;
    <T>(
      iteratee: lodash.ValueIteratee<T>,
      array: lodash.List<T> | null | undefined,
    ): T[];
  }
  type LodashSortedUniqBy1x1<T> = (
    array: lodash.List<T> | null | undefined,
  ) => T[];
  ...
  type LodashSpreadFrom1x1 = <TResult>(
    func: (...args: any[]) => TResult,
  ) => (...args: any[]) => TResult;
  type LodashSpreadFrom1x2<TResult> = (
    start: number,
  ) => (...args: any[]) => TResult;
  ...
  type LodashSumBy1x1<T> = (
    collection: lodash.List<T> | null | undefined,
  ) => number;
  type LodashSumBy1x2<T> = (
    iteratee: ((value: T) => number) | string,
  ) => number;
  interface LodashXor {
  ...
  type LodashTakeRightWhile1x1<T> = (
    array: lodash.List<T> | null | undefined,
  ) => T[];
  ...
  interface LodashThrottle {
    ...
    <T extends (...args: any) => any>(
      wait: number,
      func: T,
    ): lodash.DebouncedFuncLeading<T>;
  }
  type LodashThrottle1x1 = <T extends (...args: any) => any>(
    func: T,
  ) => lodash.DebouncedFuncLeading<T>;
  type LodashThrottle1x2<T extends (...args: any) => any> = (
    wait: number,
  ) => lodash.DebouncedFuncLeading<T>;
  ...
  interface LodashTransform {
    <T, TResult>(
      iteratee: lodash.MemoVoidIteratorCapped<T, TResult>,
    ...
    <T, TResult>(
      iteratee: lodash.MemoVoidIteratorCapped<T, TResult>,
      accumulator: TResult,
      object: readonly T[] | lodash.Dictionary<T>,
    ): TResult;
    <T>(
      iteratee: lodash.__,
      accumulator: lodash.__,
      object: lodash.Dictionary<T>,
    ): LodashTransform2x4<T>;
    <T, TResult>(
      iteratee: lodash.MemoVoidIteratorCapped<T, TResult>,
      accumulator: lodash.__,
      object: lodash.Dictionary<T>,
  ...
  type LodashTransform1x3<T, TResult> = (
    object: readonly T[] | lodash.Dictionary<T>,
  ) => TResult;
  ...
  type LodashTransform1x6<T, TResult> = (
    iteratee: lodash.MemoVoidIteratorCapped<T, TResult>,
  ) => TResult;
  ...
  type LodashTransform2x6<T, TResult> = (
    iteratee: lodash.MemoVoidIteratorCapped<T, TResult>,
  ) => TResult;
  ...
  interface LodashUnionBy {
    ...
    <T>(
      iteratee: lodash.__,
      arrays1: lodash.List<T> | null | undefined,
    ): LodashUnionBy1x2<T>;
    <T>(
      iteratee: lodash.ValueIteratee<T>,
      arrays1: lodash.List<T> | null | undefined,
  ...
  type LodashUnzip = <T>(
    array: T[][] | lodash.List<lodash.List<T>> | null | undefined,
  ) => T[][];
  interface LodashUnzipWith {
    ...
    <T>(
      iteratee: lodash.__,
      array: lodash.List<lodash.List<T>> | null | undefined,
  ...
  type LodashUnzipWith1x1<T, TResult> = (
    array: lodash.List<lodash.List<T>> | null | undefined,
  ) => TResult[];
  type LodashUnzipWith1x2<T> = <TResult>(
    iteratee: (...values: T[]) => TResult,
  ) => TResult[];
  ...
  type LodashUpperFirst = <T extends string = string>(
    string: T,
  ) => Capitalize<T>;
  ...
  type LodashWrap1x1<T, TArgs, TResult> = (
    value: T,
  ) => (...args: TArgs[]) => TResult;
  type LodashWrap1x2<T> = <TArgs, TResult>(
    wrapper: (value: T, ...args: TArgs[]) => TResult,
  ) => (...args: TArgs[]) => TResult;
  interface LodashZip {
    ...
    <T1, T2>(
      arrays1: lodash.List<T1>,
      arrays2: lodash.List<T2>,
    ): Array<[T1 | undefined, T2 | undefined]>;
  }
  type LodashZip1x1<T1> = <T2>(
    arrays2: lodash.List<T2>,
  ) => Array<[T1 | undefined, T2 | undefined]>;
  type LodashZip1x2<T2> = <T1>(
    arrays1: lodash.List<T1>,
  ) => Array<[T1 | undefined, T2 | undefined]>;
  interface LodashZipAll {
    <T1, T2>(
      arrays1: [lodash.List<T1>, lodash.List<T2>],
    ): Array<[T1 | undefined, T2 | undefined]>;
    <T1, T2, T3>(
      arrays1: [lodash.List<T1>, lodash.List<T2>, lodash.List<T3>],
    ...
    >;
    <T>(
      arrays: ReadonlyArray<lodash.List<T> | null | undefined>,
  ...
  type LodashZipObjectDeep1x2 = (
    paths: lodash.List<lodash.PropertyPath>,
  ) => object;
  ...
  type LodashZipWith1x6<T1, T2> = <TResult>(
    iteratee: (value1: T1, value2: T2) => TResult,
  ) => TResult[];
