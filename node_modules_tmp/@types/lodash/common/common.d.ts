...
declare module "../index" {
  ...
  interface String<T extends string = string>
    extends LoDashImplicitWrapper<T> {}
  ...
  interface StringChain<T extends string = string>
    extends LoDashExplicitWrapper<T> {}
  ...
  type TupleIterator<T extends readonly unknown[], TResult> = (
    value: T[number],
    index: StringToNumber<keyof T>,
    collection: T,
  ) => TResult;
