...
var _Converter_instances,
  _Converter_checkModifiers,
  _Converter_throwUnlessAllowInvalidAST,
  _Converter_withDeprecatedAliasGetter,
  _Converter_throwError,
  _Converter_checkForStatementDeclaration;
...
class Converter {
  ...
  convertParameters(parameters) {
    ...
    return parameters.map((param) => {
      ...
      convertedParam.decorators =
        (0, getModifiers_1.getDecorators)(param)?.map((el) =>
  ...
  convertChainExpression(node, tsNode) {
    ...
    const isChildUnwrappable = (0,
    node_utils_1.isChildUnwrappableOptionalChain)(tsNode, child);
  ...
  deeplyCopy(node) {
    ...
    if ("typeArguments" in node) {
      ...
      __classPrivateFieldGet(
        ...
        "m",
        _Converter_withDeprecatedAliasGetter,
      ).call(this, result, "typeParameters", "typeArguments");
    }
      ...
      case SyntaxKind.PropertyAccessExpression:
        if (node.name.kind === SyntaxKind.PrivateIdentifier) {
          ...
          __classPrivateFieldGet(
            ...
            "m",
            _Converter_throwError,
          ).call(this, node.name, "Non-private identifier expected.");
        }
  ...
  assertModuleSpecifier(node, allowNull) {
    if (!allowNull && node.moduleSpecifier == null) {
      __classPrivateFieldGet(
        ...
        "m",
        _Converter_throwUnlessAllowInvalidAST,
      ).call(this, node, "Module specifier must be a string literal.");
    }
    if (
  ...
  convertNode(node, parent) {
    switch (node.kind) {
      ...
      case SyntaxKind.ThrowStatement:
        if (node.expression.end === node.expression.pos) {
          __classPrivateFieldGet(
            ...
            "m",
            _Converter_throwUnlessAllowInvalidAST,
          ).call(this, node, "A throw statement must throw an expression.");
        }
        return this.createNode(node, {
      ...
      case SyntaxKind.FunctionDeclaration: {
        ...
        const isAsync = (0, node_utils_1.hasModifier)(
        ...
        for (const property of node.properties) {
          if (
            ...
            __classPrivateFieldGet(
              ...
              "m",
              _Converter_throwUnlessAllowInvalidAST,
            ).call(this, property.end - 1, "'{' expected.");
          }
      ...
      case SyntaxKind.PropertyDeclaration: {
        ...
        const isAccessor = (0, node_utils_1.hasModifier)(
        ...
        return this.createNode(node, {
          ...
          computed: (0, node_utils_1.isComputedProperty)(node.name),
          static: (0, node_utils_1.hasModifier)(SyntaxKind.StaticKeyword, node),
          readonly: (0, node_utils_1.hasModifier)(
            SyntaxKind.ReadonlyKeyword,
            node,
          ),
          decorators:
            (0, getModifiers_1.getDecorators)(node)?.map((el) =>
              this.convertChild(el),
            ) ?? [],
          declare: (0, node_utils_1.hasModifier)(
            SyntaxKind.DeclareKeyword,
          ...
          optional:
            (key.type === ts_estree_1.AST_NODE_TYPES.Literal ||
      ...
      case SyntaxKind.MethodDeclaration: {
        ...
        if (parent.kind === SyntaxKind.ObjectLiteralExpression) {
           ...
           */
          const methodDefinitionType = (0, node_utils_1.hasModifier)(
            SyntaxKind.AbstractKeyword,
            node,
          )
          ...
          if (token === SyntaxKind.ExtendsKeyword) {
            if (extendsClause) {
              __classPrivateFieldGet(
                ...
                "m",
                _Converter_throwUnlessAllowInvalidAST,
              ).call(this, heritageClause, "'extends' clause already seen.");
            }
            if (implementsClause) {
              __classPrivateFieldGet(
                this,
            ...
            if (types.length > 1) {
              __classPrivateFieldGet(
                ...
                "m",
                _Converter_throwUnlessAllowInvalidAST,
              ).call(this, types[1], "Classes can only extend a single class.");
            }
            ...
            if (implementsClause) {
              __classPrivateFieldGet(
                ...
                "m",
                _Converter_throwUnlessAllowInvalidAST,
              ).call(this, heritageClause, "'implements' clause already seen.");
            }
      ...
      case SyntaxKind.BinaryExpression: {
        ...
        const expressionType = (0, node_utils_1.getBinaryExpressionType)(
          node.operatorToken,
        );
        if (
          this.allowPattern &&
          expressionType.type ===
            ts_estree_1.AST_NODE_TYPES.AssignmentExpression
        ) {
          return this.createNode(node, {
            type: ts_estree_1.AST_NODE_TYPES.AssignmentPattern,
            decorators: [],
      ...
      case SyntaxKind.JsxSelfClosingElement: {
        return this.createNode(node, {
           ...
           */
          openingElement: this.createNode(
            node,
            __classPrivateFieldGet(
              this,
              _Converter_instances,
      ...
      case SyntaxKind.FunctionType: {
        ...
        if (modifiers) {
          __classPrivateFieldGet(
            ...
            "m",
            _Converter_throwError,
          ).call(this, modifiers[0], "A function type cannot have modifiers.");
        }
      }
      // intentional fallthrough
      ...
      case SyntaxKind.ImportType: {
        const range = (0, node_utils_1.getRange)(node, this.ast);
        if (node.isTypeOf) {
          const token = (0, node_utils_1.findNextToken)(
            node.getFirstToken(),
            node,
            this.ast,
          );
      ...
      case SyntaxKind.ModuleDeclaration: {
        let isDeclare = (0, node_utils_1.hasModifier)(
          SyntaxKind.DeclareKeyword,
          node,
        );
        const result = this.createNode(node, {
          ...
          ...(() => {
            ...
            if (node.flags & ts.NodeFlags.GlobalAugmentation) {
              ...
              if (
                ...
                __classPrivateFieldGet(
                  ...
                  "m",
                  _Converter_throwUnlessAllowInvalidAST,
                ).call(this, node.body ?? node, "Expected a valid module body");
              }
            ...
            if (node.body == null) {
              __classPrivateFieldGet(
                ...
                "m",
                _Converter_throwUnlessAllowInvalidAST,
              ).call(this, node, "Expected a module body");
            }
            ...
            while (
              ...
              node = node.body;
              isDeclare ||= (0, node_utils_1.hasModifier)(
                SyntaxKind.DeclareKeyword,
                node,
              );
      ...
      case SyntaxKind.ExternalModuleReference: {
        if (node.expression.kind !== SyntaxKind.StringLiteral) {
          __classPrivateFieldGet(
            ...
            "m",
            _Converter_throwError,
          ).call(this, node.expression, "String literal expected.");
        }
        return this.createNode(node, {
...
(_Converter_instances = new WeakSet()),
  (_Converter_checkModifiers = function _Converter_checkModifiers(node) {
    ...
    if ((0, node_utils_1.nodeHasIllegalDecorators)(node)) {
      __classPrivateFieldGet(
        ...
        "m",
        _Converter_throwError,
      ).call(this, node.illegalDecorators[0], "Decorators are not valid here.");
    }
    for (const decorator of (0, getModifiers_1.getDecorators)(
      ...
      if (!(0, node_utils_1.nodeCanBeDecorated)(node)) {
        if (
          ...
          !(0, node_utils_1.nodeIsPresent)(node.body)
        ) {
          __classPrivateFieldGet(
            this,
            _Converter_instances,
          ...
          __classPrivateFieldGet(
            ...
            "m",
            _Converter_throwError,
          ).call(this, decorator, "Decorators are not valid here.");
        }
      }
    }
    for (const modifier of (0, getModifiers_1.getModifiers)(
      ...
      if (modifier.kind !== SyntaxKind.ReadonlyKeyword) {
        if (
          ...
          __classPrivateFieldGet(
            ...
            this,
            modifier,
            `'${ts.tokenToString(modifier.kind)}' modifier cannot appear on a type member`,
          );
        }
        if (
      ...
      if (
        ...
        __classPrivateFieldGet(
          ...
          this,
          modifier,
          `'${ts.tokenToString(modifier.kind)}' modifier cannot appear on a type parameter`,
        );
      }
      if (
        (modifier.kind === SyntaxKind.InKeyword ||
      ...
      if (
        ...
        const declarationKind = (0, node_utils_1.getDeclarationKind)(
      ...
      if (
        ...
        __classPrivateFieldGet(
          ...
          "m",
          _Converter_throwError,
        ).call(this, modifier, "'async' modifier cannot be used here.");
      }
      // `checkGrammarModifiers` function in `typescript`
      if (
        node.kind === SyntaxKind.Parameter &&
        ...
        __classPrivateFieldGet(
          ...
          this,
          modifier,
          `'${ts.tokenToString(modifier.kind)}' modifier cannot appear on a parameter.`,
        );
      }
      // `checkGrammarModifiers` function in `typescript`
      if (
      ...
      if (
        ...
        if (
          !(
            ...
            (0, node_utils_1.nodeIsPresent)(func.body)
          )
        ) {
          __classPrivateFieldGet(
            this,
  ...
  (_Converter_throwUnlessAllowInvalidAST =
    function _Converter_throwUnlessAllowInvalidAST(node, message) {
      if (!this.options.allowInvalidAST) {
        __classPrivateFieldGet(
          this,
          _Converter_instances,
          "m",
          _Converter_throwError,
        ).call(this, node, message);
      }
    }),
  (_Converter_withDeprecatedAliasGetter =
    function _Converter_withDeprecatedAliasGetter(
      node,
      aliasKey,
      valueKey,
  ...
  (_Converter_checkForStatementDeclaration =
    function _Converter_checkForStatementDeclaration(initializer) {
