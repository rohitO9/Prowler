...
exports.default = (0, util_1.createRule)({
  ...
  create(context, [options]) {
    ...
    function isHigherPrecedenceThanUnary(node) {
      ...
      const nodePrecedence = (0, util_1.getOperatorPrecedence)(
        node.kind,
        operator,
      );
    ...
    function isUnhandledPromise(checker, node) {
      ...
      if (node.type === utils_1.AST_NODE_TYPES.CallExpression) {
        ...
        node.type === utils_1.AST_NODE_TYPES.TaggedTemplateExpression
      ) {
        return { isUnhandled: true };
    ...
    function isPromiseLike(node, type) {
      ...
      if (
        allowForKnownSafePromises.some((allowedType) =>
          (0, util_1.typeMatchesSpecifier)(type, allowedType, services.program),
        )
      ) {
        return false;
      }
