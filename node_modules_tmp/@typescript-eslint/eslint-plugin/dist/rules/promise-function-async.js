...
exports.default = (0, util_1.createRule)({
  ...
  create(
    ...
    function validateNode(node) {
      ...
      if (
        !(0, util_1.containsAllTypesByName)(
          returnType,
          // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
          allowAny,
      ...
      if (
        node.parent.type === utils_1.AST_NODE_TYPES.TSAbstractMethodDefinition
      ) {
      ...
      context.report({
        ...
        fix: (fixer) => {
          if (
            ...
            let keyToken = (0, util_1.nullThrows)(
              context.sourceCode.getFirstToken(method),
              util_1.NullThrowsReasons.MissingToken("key token", "method"),
            );
            // if there are decorators then skip past them
            if (
              method.type === utils_1.AST_NODE_TYPES.MethodDefinition &&
              method.decorators.length
            ) {
              const lastDecorator =
                method.decorators[method.decorators.length - 1];
              keyToken = (0, util_1.nullThrows)(
            ...
            while (
              keyToken.type === utils_1.AST_TOKEN_TYPES.Keyword &&
              keyToken.range[0] < method.key.range[0]
            ) {
              keyToken = (0, util_1.nullThrows)(
                context.sourceCode.getTokenAfter(keyToken),
                util_1.NullThrowsReasons.MissingToken("token", "keyword"),
              );
            }
