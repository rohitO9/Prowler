        ...
        fix:
          messageId === "as"
            ? (fixer) => {
                ...
                const asPrecedence = (0, util_1.getOperatorPrecedence)(
                  ts.SyntaxKind.AsExpression,
                  ts.SyntaxKind.Unknown,
                );
                const parentPrecedence = (0, util_1.getOperatorPrecedence)(
                  tsNode.parent.kind,
                ...
                const expressionPrecedence = (0,
                util_1.getOperatorPrecedenceForNode)(node.expression);
                const expressionCodeWrapped = (0,
                getWrappedCode_1.getWrappedCode)(
                  expressionCode,
                ...
                return fixer.replaceText(
                  ...
                  (0, util_1.isParenthesized)(node, context.sourceCode)
                    ? text
                    : (0, getWrappedCode_1.getWrappedCode)(
                        text,
                        asPrecedence,
                        parentPrecedence,
                      ),
        ...
        if (
          ...
          suggest.push({
            ...
            fix: (fixer) => [
              ...
              fixer.replaceText(
                node,
                (0, util_1.getTextWithParentheses)(
                  context.sourceCode,
                  node.expression,
                ),
              ),
