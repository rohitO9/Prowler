  ...
  create(context, [{ onlyInlineLambdas }]) {
    ...
    return {
      ...
      "ClassDeclaration, ClassExpression:exit"() {
        const finalizedClassScope = (0, util_1.nullThrows)(
          classScopeStack.pop(),
...
(function (TypeToClassRelation) {
  TypeToClassRelation[(TypeToClassRelation["ClassAndInstance"] = 0)] =
    "ClassAndInstance";
...
class ClassScope {
  ...
  getTypeToClassRelation(type) {
    ...
    if (
      !type.getSymbol() ||
      !(0, util_1.typeIsOrHasBaseType)(type, this.classType)
    ) {
