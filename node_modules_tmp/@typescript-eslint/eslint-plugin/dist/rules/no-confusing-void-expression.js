...
exports.default = (0, util_1.createRule)({
  ...
  create(context, [options]) {
          ...
          return context.report({
            ...
            fix(fixer) {
              ...
              if ((0, util_1.isParenthesized)(arrowBody, context.sourceCode)) {
                const bodyOpeningParen = (0, util_1.nullThrows)(
                ...
                const bodyClosingParen = (0, util_1.nullThrows)(
    ...
    function findInvalidAncestor(node) {
      const parent = (0, util_1.nullThrows)(
        node.parent,
    ...
    function isFinalReturn(node) {
      ...
      const block = (0, util_1.nullThrows)(
        node.parent,
        util_1.NullThrowsReasons.MissingParent,
      );
      ...
      const blockParent = (0, util_1.nullThrows)(
        block.parent,
        util_1.NullThrowsReasons.MissingParent,
      );
      if (
    ...
    function isPreventingASI(node) {
      const startToken = (0, util_1.nullThrows)(
        context.sourceCode.getFirstToken(node),
        util_1.NullThrowsReasons.MissingToken("first token", node.type),
      );
