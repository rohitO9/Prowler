    ...
    return {
      ConditionalExpression(node) {
        ...
        if (node.test.type === utils_1.AST_NODE_TYPES.BinaryExpression) {
          ...
          node.test.type === utils_1.AST_NODE_TYPES.LogicalExpression &&
            ...
            suggest: [
              {
                ...
                fix(fixer) {
                  ...
                  return fixer.replaceText(
                    node,
                    `${(0, util_1.getTextWithParentheses)(context.sourceCode, left)} ?? ${(0, util_1.getTextWithParentheses)(context.sourceCode, right)}`,
                  );
                },
              },
            ],
      ...
      'LogicalExpression[operator = "||"]'(node) {
        ...
        const barBarOperator = (0, util_1.nullThrows)(
        ...
        function* fix(fixer) {
          if ((0, util_1.isLogicalOrOperator)(node.parent)) {
            ...
            if (
              node.left.type === utils_1.AST_NODE_TYPES.LogicalExpression &&
