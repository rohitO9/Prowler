...
exports.default = (0, util_1.createRule)({
  ...
  create(context, [options]) {
    ...
    function isConstAssertion(node) {
      return (
        node.type === utils_1.AST_NODE_TYPES.TSTypeReference &&
    ...
    function isTypeUnchanged(uncast, cast) {
      ...
      if (
        (0, util_1.isTypeFlagSet)(uncast, ts.TypeFlags.Undefined) &&
        ...
        const uncastParts = tsutils
          ...
          .filter(
            (part) => !(0, util_1.isTypeFlagSet)(part, ts.TypeFlags.Undefined),
          );
    ...
    return {
      TSNonNullExpression(node) {
        ...
        const type = (0, util_1.getConstrainedTypeAtLocation)(
          services,
          node.expression,
        );
        if (
          !(0, util_1.isNullableType)(type) &&
          !(0, util_1.isTypeFlagSet)(type, ts.TypeFlags.Void)
        ) {
          if (
          ...
          const contextualType = (0, util_1.getContextualType)(
            checker,
            originalNode,
          );
          if (contextualType) {
            ...
            const contextualTypeIncludesUndefined = (0, util_1.isTypeFlagSet)(
              contextualType,
              ts.TypeFlags.Undefined,
            );
            const contextualTypeIncludesNull = (0, util_1.isTypeFlagSet)(
              contextualType,
              ts.TypeFlags.Null,
            );
            const contextualTypeIncludesVoid = (0, util_1.isTypeFlagSet)(
              contextualType,
              ts.TypeFlags.Void,
            );
          ...
          context.report({
            ...
            fix(fixer) {
              if (node.type === utils_1.AST_NODE_TYPES.TSTypeAssertion) {
                const openingAngleBracket = (0, util_1.nullThrows)(
                  ...
                  util_1.NullThrowsReasons.MissingToken("<", "type annotation"),
                );
                const closingAngleBracket = (0, util_1.nullThrows)(
              ...
              const asToken = (0, util_1.nullThrows)(
                context.sourceCode.getTokenAfter(
                  node.expression,
                  (token) =>
                    token.type === utils_1.AST_TOKEN_TYPES.Identifier &&
                    token.value === "as",
                ),
                util_1.NullThrowsReasons.MissingToken(">", "type annotation"),
              );
              const tokenBeforeAs = (0, util_1.nullThrows)(
