    ...
    function isStringArrayNode(node) {
      ...
      if (checker.isArrayType(type) || checker.isTupleType(type)) {
        ...
        return typeArgs.every(
          (arg) => (0, util_1.getTypeName)(checker, arg) === "string",
        );
      }
      return false;
    }
    function checkSortArgument(callee) {
      const calleeObjType = (0, util_1.getConstrainedTypeAtLocation)(
        services,
        callee.object,
      );
      ...
      if (
        (0, util_1.isTypeArrayTypeOrUnionOfArrayTypes)(calleeObjType, checker)
      ) {
