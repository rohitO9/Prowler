...
exports.default = (0, util_1.createRule)({
  ...
  create(context, [firstOption]) {
    ...
    function collectUnusedVariables() {
      ...
      const unusedVariablesOriginal = (0, util_1.collectUnusedVariables)(
        context,
      );
      ...
      for (const variable of unusedVariablesOriginal) {
        ...
        const refUsedInArrayPatterns = variable.references.some(
          (ref) =>
            ref.identifier.parent.type === utils_1.AST_NODE_TYPES.ArrayPattern,
        );
    ...
    return {
      ...
      [ambientDeclarationSelector(
        ...
        const moduleDecl = (0, util_1.nullThrows)(
          node.parent.parent,
        ...
        if (
          moduleDecl.id.type === utils_1.AST_NODE_TYPES.Literal &&
      ...
      "Program:exit"(programNode) {
        ...
        function getDefinedMessageData(unusedVar) {
          ...
          let pattern;
          if (
            defType === utils_1.TSESLint.Scope.DefinitionType.CatchClause &&
            options.caughtErrorsIgnorePattern
          ) {
            type = "args";
            pattern = options.caughtErrorsIgnorePattern.toString();
          } else if (
            defType === utils_1.TSESLint.Scope.DefinitionType.Parameter &&
        ...
        for (const unusedVar of unusedVars) {
          ...
          if (unusedVar.defs.length > 0) {
            ...
            context.report({
              node: programNode,
              loc: (0, util_1.getNameLocationInGlobalDirectiveComment)(
                context.sourceCode,
                directiveComment,
                unusedVar.name,
              ),
