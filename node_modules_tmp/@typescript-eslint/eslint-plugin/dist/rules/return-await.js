...
exports.default = (0, util_1.createRule)({
  ...
  create(context, [option]) {
    ...
    function isHigherPrecedenceThanAwait(node) {
      ...
      const nodePrecedence = (0, getOperatorPrecedence_1.getOperatorPrecedence)(
        node.kind,
        operator,
      );
      const awaitPrecedence = (0,
      getOperatorPrecedence_1.getOperatorPrecedence)(
