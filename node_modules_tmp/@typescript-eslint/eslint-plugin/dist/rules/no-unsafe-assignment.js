...
exports.default = (0, util_1.createRule)({
  ...
  create(context) {
    ...
    function checkArrayDestructure(receiverNode, senderType, senderNode) {
      ...
      for (
        ...
        if ((0, util_1.isTypeAnyType)(senderType)) {
          ...
          receiverElement.type === utils_1.AST_NODE_TYPES.ArrayPattern
        ) {
          ...
          receiverElement.type === utils_1.AST_NODE_TYPES.ObjectPattern
        ) {
    ...
    function checkObjectDestructure(receiverNode, senderType, senderNode) {
      ...
      for (const receiverProperty of receiverNode.properties) {
        ...
        if (!receiverProperty.computed) {
          ...
          receiverProperty.key.type === utils_1.AST_NODE_TYPES.Literal
        ) {
        ...
        if ((0, util_1.isTypeAnyType)(senderType)) {
          ...
          receiverProperty.value.type === utils_1.AST_NODE_TYPES.ArrayPattern
        ) {
          didReport = checkArrayDestructure(
          ...
          receiverProperty.value.type === utils_1.AST_NODE_TYPES.ObjectPattern
        ) {
          didReport = checkObjectDestructure(
            receiverProperty.value,
            senderType,
    ...
    function checkAssignment(
      ...
      const receiverType =
        comparisonType === 2 /* ComparisonType.Contextual */
      ...
      if ((0, util_1.isTypeAnyType)(senderType)) {
        ...
        if (!isNoImplicitThis) {
          ...
          if (
            thisExpression &&
            (0, util_1.isTypeAnyType)(
              (0, util_1.getConstrainedTypeAtLocation)(
                services,
                thisExpression,
              ),
            )
    ...
    return {
      "VariableDeclarator[init != null]"(node) {
        const init = (0, util_1.nullThrows)(
          node.init,
          util_1.NullThrowsReasons.MissingToken(node.type, "init"),
        );
      ...
      ":not(ObjectPattern) > Property"(node) {
        if (
          node.value.type === utils_1.AST_NODE_TYPES.AssignmentPattern ||
          node.value.type ===
        ...
        checkAssignment(
          ...
          node.value,
          node,
          2 /* ComparisonType.Contextual */,
        );
      },
      "ArrayExpression > SpreadElement"(node) {
        const restType = services.getTypeAtLocation(node.argument);
        if (
          (0, util_1.isTypeAnyType)(restType) ||
          (0, util_1.isTypeAnyArrayType)(restType, checker)
        ) {
          context.report({
            node: node,
      ...
      "JSXAttribute[value != null]"(node) {
        const value = (0, util_1.nullThrows)(
          node.value,
          util_1.NullThrowsReasons.MissingToken(node.type, "value"),
        );
        if (
