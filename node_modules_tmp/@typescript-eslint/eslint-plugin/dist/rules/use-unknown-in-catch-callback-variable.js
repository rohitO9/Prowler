...
exports.default = (0, util_1.createRule)({
  ...
  create(context) {
    ...
    function refineReportForNormalArgumentIfPossible(argument) {
      ...
      if (
        !(
          argument.type === utils_1.AST_NODE_TYPES.ArrowFunctionExpression ||
          argument.type === utils_1.AST_NODE_TYPES.FunctionExpression
        )
      ) {
        return undefined;
      }
      const catchVariableOuterWithIncorrectTypes = (0, util_1.nullThrows)(
      ...
      const catchVariableInner =
        catchVariableOuter.type === utils_1.AST_NODE_TYPES.AssignmentPattern
              ...
              suggest: [
                {
                  ...
                  fix: (fixer) => {
                    if (
                      ...
                      (0, util_1.isParenlessArrowFunction)(
                        argument,
                        context.sourceCode,
                      )
                    ) {
