  ...
  create(context, [mode]) {
    ...
    function getMethodParams(node) {
      ...
      if (node.params.length > 0) {
        const openingParen = (0, util_1.nullThrows)(
        ...
        const closingParen = (0, util_1.nullThrows)(
    ...
    function getDelimiter(node) {
      ...
      if (
        ...
        ((0, util_1.isSemicolonToken)(lastToken) ||
          (0, util_1.isCommaToken)(lastToken))
      ) {
    ...
    return {
      ...(mode === "property" && {
        TSMethodSignature(methodNode) {
          ...
          const members =
            parent.type === utils_1.AST_NODE_TYPES.TSInterfaceBody
              ? parent.body
              : parent.type === utils_1.AST_NODE_TYPES.TSTypeLiteral
                ? parent.members
                : [];
          const duplicatedKeyMethodNodes = members.filter(
            (element) =>
              element.type === utils_1.AST_NODE_TYPES.TSMethodSignature &&
              element !== methodNode &&
