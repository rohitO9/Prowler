...
const testTypeFlag = (flagsToCheck) => (type) =>
  (0, util_1.isTypeFlagSet)(type, flagsToCheck);
const optionTesters = [
  ["Any", util_1.isTypeAnyType],
  [
    "Array",
    (type, checker, recursivelyCheckType) =>
  ...
  [
    "Nullish",
    testTypeFlag(
      typescript_1.TypeFlags.Null | typescript_1.TypeFlags.Undefined,
    ),
  ],
  [
    "Number",
    testTypeFlag(
      typescript_1.TypeFlags.NumberLike | typescript_1.TypeFlags.BigIntLike,
    ),
  ],
  [
    "RegExp",
    ...
    return {
      TemplateLiteral(node) {
        ...
        for (const expression of node.expressions) {
          const expressionType = (0, util_1.getConstrainedTypeAtLocation)(
            services,
            expression,
          );
