...
exports.default = (0, util_1.createRule)({
  ...
  create(context, [options]) {
    ...
    function isThisParam(variable) {
      return (
        variable.defs[0].type === scope_manager_1.DefinitionType.Parameter &&
        variable.name === "this"
      );
    }
    function isTypeImport(definition) {
      return (
        definition?.type === scope_manager_1.DefinitionType.ImportBinding &&
    ...
    function isGenericOfClass(variable) {
      ...
      return (
        classDecl.type === utils_1.AST_NODE_TYPES.ClassDeclaration ||
    ...
    function isDuplicatedClassNameVariable(variable) {
      ...
      return (
        block.type === utils_1.AST_NODE_TYPES.ClassDeclaration &&
    ...
    function isDuplicatedEnumNameVariable(variable) {
      const block = variable.scope.block;
      return (
        block.type === utils_1.AST_NODE_TYPES.TSEnumDeclaration &&
        block.id === variable.identifiers[0]
      );
    }
    /**
    ...
    function isInitPatternNode(variable, shadowedVariable) {
      ...
      const callExpression = findSelfOrAncestor(
        parent,
        (node) => node.type === utils_1.AST_NODE_TYPES.CallExpression,
      );
      if (!callExpression) {
        return false;
      }
