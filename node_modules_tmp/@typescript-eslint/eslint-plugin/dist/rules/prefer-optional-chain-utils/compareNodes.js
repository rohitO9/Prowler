...
function compareNodesUncached(nodeA, nodeB) {
  if (nodeA.type !== nodeB.type) {
    ...
    //                ^^^^^^^^^^^ compare this
    if (
      nodeA.type === utils_1.AST_NODE_TYPES.CallExpression ||
      ...
      switch (nodeB.type) {
        case utils_1.AST_NODE_TYPES.MemberExpression:
          if (
            nodeB.property.type === utils_1.AST_NODE_TYPES.PrivateIdentifier
          ) {
          ...
          if (
            compareNodes(nodeA, nodeB.object) !==
        ...
        case utils_1.AST_NODE_TYPES.CallExpression:
          if (
            compareNodes(nodeA, nodeB.callee) !==
            "Invalid" /* NodeComparisonResult.Invalid */
          ) {
            return "Subset" /* NodeComparisonResult.Subset */;
          }
  ...
  switch (nodeA.type) {
    ...
    case utils_1.AST_NODE_TYPES.MemberExpression: {
      ...
      if (
        nodeBMember.property.type === utils_1.AST_NODE_TYPES.PrivateIdentifier
      ) {
        // Private identifiers in optional chaining is not currently allowed
        // TODO - handle this once TS supports it (https://github.com/microsoft/TypeScript/issues/42734)
        return "Invalid" /* NodeComparisonResult.Invalid */;
