...
exports.default = (0, util_1.createRule)({
  ...
  create(context, [{ allowBitwiseExpressions }]) {
    function isIdentifierWithName(node, name) {
      return (
        node.type === utils_1.AST_NODE_TYPES.Identifier && node.name === name
      );
    }
    ...
    return {
      TSEnumMember(node) {
        ...
        if (
          node.initializer.type === utils_1.AST_NODE_TYPES.TemplateLiteral &&
        ...
        if (
          node.initializer.type === utils_1.AST_NODE_TYPES.UnaryExpression &&
          node.initializer.argument.type === utils_1.AST_NODE_TYPES.Literal &&
          (["+", "-"].includes(node.initializer.operator) ||
