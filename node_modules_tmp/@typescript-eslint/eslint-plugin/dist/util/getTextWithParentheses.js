...
function getTextWithParentheses(sourceCode, node) {
  ...
  if ((0, _1.isParenthesized)(node, sourceCode)) {
    const bodyOpeningParen = (0, _1.nullThrows)(
      sourceCode.getTokenBefore(node, _1.isOpeningParenToken),
      _1.NullThrowsReasons.MissingToken("(", "node"),
    );
    const bodyClosingParen = (0, _1.nullThrows)(
      sourceCode.getTokenAfter(node, _1.isClosingParenToken),
      _1.NullThrowsReasons.MissingToken(")", "node"),
    );
