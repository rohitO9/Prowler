...
function typeDeclaredInFile(relativePath, declarationFiles, program) {
  if (relativePath === undefined) {
    const cwd = (0, typescript_estree_1.getCanonicalFileName)(
      program.getCurrentDirectory(),
    );
    return declarationFiles.some((declaration) =>
      (0, typescript_estree_1.getCanonicalFileName)(
        declaration.fileName,
      ).startsWith(cwd),
    );
  }
  const absolutePath = (0, typescript_estree_1.getCanonicalFileName)(
    path_1.default.join(program.getCurrentDirectory(), relativePath),
  );
  return declarationFiles.some(
    (declaration) =>
      (0, typescript_estree_1.getCanonicalFileName)(declaration.fileName) ===
      absolutePath,
  );
}
