 ...
 */
export declare function isTypeArrayTypeOrUnionOfArrayTypes(
  type: ts.Type,
...
export declare function isTypeReferenceType(
  type: ts.Type,
 ...
 * @returns true if the type is `any[]`
 */
export declare function isTypeAnyArrayType(
  type: ts.Type,
  checker: ts.TypeChecker,
): boolean;
/**
 * @returns true if the type is `unknown[]`
 */
export declare function isTypeUnknownArrayType(
  type: ts.Type,
  checker: ts.TypeChecker,
): boolean;
 ...
 */
export declare function isAnyOrAnyArrayTypeDiscriminated(
  node: ts.Node,
  checker: ts.TypeChecker,
): AnyType;
/**
 ...
 */
export declare function typeIsOrHasBaseType(
  type: ts.Type,
  parentType: ts.Type,
): boolean;
export declare function isTypeBigIntLiteralType(
  type: ts.Type,
): type is ts.BigIntLiteralType;
export declare function isTypeTemplateLiteralType(
  type: ts.Type,
