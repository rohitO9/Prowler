...
class ScopeManager {
  ...
  isGlobalReturn() {
    return (
      __classPrivateFieldGet(this, _ScopeManager_options, "f").globalReturn ===
      true
    );
  }
  isModule() {
    return (
      __classPrivateFieldGet(this, _ScopeManager_options, "f").sourceType ===
      "module"
    );
  }
  isImpliedStrict() {
    return (
      __classPrivateFieldGet(this, _ScopeManager_options, "f").impliedStrict ===
      true
    );
  }
  ...
  acquire(node, inner = false) {
    function predicate(testScope) {
      if (
        testScope.type === scope_1.ScopeType.function &&
  ...
  nestClassStaticBlockScope(node) {
    (0, assert_1.assert)(this.currentScope);
    return this.nestScope(
      new ClassStaticBlockScope_1.ClassStaticBlockScope(
        this,
        this.currentScope,
        node,
      ),
