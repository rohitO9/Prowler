...
class TypeVisitor extends Visitor_1.Visitor {
  ...
  visitFunctionType(node) {
    ...
    __classPrivateFieldGet(
      this,
      _TypeVisitor_referencer,
      "f",
    ).scopeManager.nestFunctionTypeScope(node);
  ...
  TSConditionalType(node) {
    ...
    __classPrivateFieldGet(
      ...
      _TypeVisitor_referencer,
      "f",
    ).scopeManager.nestConditionalTypeScope(node);
  ...
  TSInferType(node) {
    ...
    let scope = __classPrivateFieldGet(
      this,
      _TypeVisitor_referencer,
      "f",
    ).currentScope();
  ...
  TSInterfaceDeclaration(node) {
    ...
    if (node.typeParameters) {
      ...
      __classPrivateFieldGet(
        ...
        _TypeVisitor_referencer,
        "f",
      ).scopeManager.nestTypeScope(node);
      this.visit(node.typeParameters);
    }
  ...
  TSMappedType(node) {
    ...
    __classPrivateFieldGet(
      ...
      _TypeVisitor_referencer,
      "f",
    ).scopeManager.nestMappedTypeScope(node);
