...
var [createNavigationMenuContext, createNavigationMenuScope] = (0,
import_react_context.createContextScope)(NAVIGATION_MENU_NAME, [
  createCollectionScope,
  createFocusGroupCollectionScope,
]);
var [NavigationMenuProviderImpl, useNavigationMenuContext] =
  createNavigationMenuContext(NAVIGATION_MENU_NAME);
var [ViewportContentProvider, useViewportContentContext] =
  createNavigationMenuContext(NAVIGATION_MENU_NAME);
var NavigationMenu = React.forwardRef((props, forwardedRef) => {
  ...
  import_react_use_controllable_state.useControllableState)({
    prop: valueProp,
    onChange: (value2) => {
      const isOpen = value2 !== "";
...
var NavigationMenuProvider = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      onTriggerEnter: (0, import_react_use_callback_ref.useCallbackRef)(
        onTriggerEnter,
      ),
      onTriggerLeave: (0, import_react_use_callback_ref.useCallbackRef)(
        onTriggerLeave,
      ),
      onContentEnter: (0, import_react_use_callback_ref.useCallbackRef)(
        onContentEnter,
      ),
      onContentLeave: (0, import_react_use_callback_ref.useCallbackRef)(
        onContentLeave,
      ),
      onItemSelect: (0, import_react_use_callback_ref.useCallbackRef)(
        onItemSelect,
      ),
      onItemDismiss: (0, import_react_use_callback_ref.useCallbackRef)(
        onItemDismiss,
      ),
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        Collection.Provider,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            { scope, items: viewportContent, children },
          ),
        },
      ),
    },
...
var NavigationMenuList = React.forwardRef((props, forwardedRef) => {
  ...
  const list = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_react_primitive.Primitive.ul,
    {
    ...
    import_react_primitive.Primitive.div,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection.Slot, {
        ...
        children: context.isRootMenu
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FocusGroup, {
              asChild: true,
              children: list,
            })
          : list,
                  ...
                  VisuallyHiddenPrimitive.Root,
                  {
                    ...
                    onFocus: (event) => {
                      ...
                      const wasTriggerFocused =
                        prevFocusedElement === ref.current;
        ...
        onClick: (0, import_primitive.composeEventHandlers)(
          ...
          (event) => {
            ...
            target.addEventListener(
              LINK_SELECT,
              (event2) => onSelect?.(event2),
              { once: true },
            );
            (0, import_react_primitive.dispatchDiscreteCustomEvent)(
              target,
              linkSelectEvent,
            );
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          import_react_presence.Presence,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              ...
              { ...indicatorProps, ref: forwardedRef },
            ),
          },
        ),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FocusGroup, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_react_dismissable_layer.DismissableLayer,
      {
        ...
        onEscapeKeyDown: (0, import_primitive.composeEventHandlers)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_react_presence.Presence,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        { ...viewportProps, ref: forwardedRef },
      ),
    },
  );
});
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_react_presence.Presence,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                ...
                {
                  ...props2,
                  ref: (0, import_react_compose_refs.composeRefs)(
                    ref,
                    (node) => {
...
function useResizeObserver(element, onResize) {
  const handleResize = (0, import_react_use_callback_ref.useCallbackRef)(
    onResize,
  );
  (0, import_react_use_layout_effect.useLayoutEffect)(() => {
    let rAF = 0;
