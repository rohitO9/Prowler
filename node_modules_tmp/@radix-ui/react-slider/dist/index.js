...
import_react_collection.createCollection)(SLIDER_NAME);
var [createSliderContext, createSliderScope] = (0,
import_react_context.createContextScope)(SLIDER_NAME, [createCollectionScope]);
...
var Slider = React.forwardRef((props, forwardedRef) => {
  ...
  function handleSlideEnd() {
    const prevValue =
      valuesBeforeSlideStartRef.current[valueIndexToChangeRef.current];
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection.Slot, {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          SliderOrientation,
          {
            ...
            onHomeKeyDown: () =>
              !disabled && updateValues(min, 0, { commit: true }),
            onEndKeyDown: () =>
              !disabled &&
...
var SliderVertical = React.forwardRef((props, forwardedRef) => {
  ...
  const ref = (0, import_react_compose_refs.useComposedRefs)(
    forwardedRef,
    sliderRef,
  );
  const rectRef = React.useRef(void 0);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    SliderOrientationProvider,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SliderImpl, {
        ...
        onStepKeyDown: (event) => {
          const slideDirection = isSlidingFromBottom
            ? "from-bottom"
            : "from-top";
          const isBackKey = BACK_KEYS[slideDirection].includes(event.key);
          onStepKeyDown?.({ event, direction: isBackKey ? -1 : 1 });
