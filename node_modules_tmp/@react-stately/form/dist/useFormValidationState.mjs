import {
  createContext as $69F46$createContext,
  useMemo as $69F46$useMemo,
  useContext as $69F46$useContext,
  useState as $69F46$useState,
  useRef as $69F46$useRef,
  useEffect as $69F46$useEffect,
} from "react";
...
function $e5be200c675c3b3a$var$useFormValidationStateImpl(props) {
  ...
  let clientError = (0, $69F46$useMemo)(
    () =>
      $e5be200c675c3b3a$var$getValidationResult(
        $e5be200c675c3b3a$var$runValidate(validate, value),
      ),
    [validate, value],
  );
  if (
    builtinValidation === null || builtinValidation === void 0
      ? void 0
      : builtinValidation.validationDetails.valid
  )
    builtinValidation = null;
  // Get relevant server errors from the form.
  let serverErrors = (0, $69F46$useContext)(
  ...
  let serverErrorMessages = (0, $69F46$useMemo)(() => {
    if (name)
      return Array.isArray(name)
        ? name.flatMap((name) =>
            $e5be200c675c3b3a$var$asArray(serverErrors[name]),
          )
        : $e5be200c675c3b3a$var$asArray(serverErrors[name]);
    return [];
  }, [serverErrors, name]);
  // Show server errors when the form gets a new value, and clear when the user changes the value.
  let [lastServerErrors, setLastServerErrors] = (0, $69F46$useState)(
    serverErrors,
  );
  let [isServerErrorCleared, setServerErrorCleared] = (0, $69F46$useState)(
    false,
  );
  ...
  let serverError = (0, $69F46$useMemo)(
    () =>
      $e5be200c675c3b3a$var$getValidationResult(
  ...
  let nextValidation = (0, $69F46$useRef)(
    $e5be200c675c3b3a$export$dad6ae84456c676a,
  );
  let [currentValidity, setCurrentValidity] = (0, $69F46$useState)(
    $e5be200c675c3b3a$export$dad6ae84456c676a,
  );
  ...
  return {
    ...
    updateValidation(value) {
      ...
      if (
        ...
        !$e5be200c675c3b3a$var$isEqualValidation(currentValidity, value)
      )
...
function $e5be200c675c3b3a$export$75ee7c75d68f5b0e(...results) {
  ...
  for (let v of results) {
    ...
    for (let key in validationDetails)
      (_validationDetails = validationDetails)[(_key = key)] ||
        (_validationDetails[_key] = v.validationDetails[key]);
  }
...
export {
  $e5be200c675c3b3a$export$aca958c65c314e6c as VALID_VALIDITY_STATE,
  $e5be200c675c3b3a$export$dad6ae84456c676a as DEFAULT_VALIDATION_RESULT,
  ...
  $e5be200c675c3b3a$export$fc1a364ae1f3ff10 as useFormValidationState,
