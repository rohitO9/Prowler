...
$parcel$export(
  ...
  () => $5d10129a174740d4$export$dad6ae84456c676a,
);
$parcel$export(
  module.exports,
  "FormValidationContext",
  () => $5d10129a174740d4$export$571b5131b7e65c11,
);
$parcel$export(
  module.exports,
  "privateValidationStateProp",
  () => $5d10129a174740d4$export$a763b9476acd3eb,
);
$parcel$export(
  module.exports,
  "useFormValidationState",
  () => $5d10129a174740d4$export$fc1a364ae1f3ff10,
);
$parcel$export(
  module.exports,
  "mergeValidation",
  () => $5d10129a174740d4$export$75ee7c75d68f5b0e,
);
/*
...
const $5d10129a174740d4$export$571b5131b7e65c11 = (0,
$kFCAu$react.createContext)({});
...
function $5d10129a174740d4$export$fc1a364ae1f3ff10(props) {
  ...
  if (props[$5d10129a174740d4$export$a763b9476acd3eb]) {
    ...
    } = props[$5d10129a174740d4$export$a763b9476acd3eb];
    return {
      realtimeValidation: realtimeValidation,
      displayValidation: displayValidation,
      updateValidation: updateValidation,
...
function $5d10129a174740d4$var$useFormValidationStateImpl(props) {
  ...
  let clientError = (0, $kFCAu$react.useMemo)(
    () =>
      $5d10129a174740d4$var$getValidationResult(
        $5d10129a174740d4$var$runValidate(validate, value),
      ),
    [validate, value],
  );
  if (
  ...
  let serverErrors = (0, $kFCAu$react.useContext)(
    $5d10129a174740d4$export$571b5131b7e65c11,
  );
  ...
  let [lastServerErrors, setLastServerErrors] = (0, $kFCAu$react.useState)(
    serverErrors,
  );
  let [isServerErrorCleared, setServerErrorCleared] = (0,
  $kFCAu$react.useState)(false);
  if (serverErrors !== lastServerErrors) {
    setLastServerErrors(serverErrors);
    setServerErrorCleared(false);
  }
  let serverError = (0, $kFCAu$react.useMemo)(
    () =>
      $5d10129a174740d4$var$getValidationResult(
  ...
  let nextValidation = (0, $kFCAu$react.useRef)(
    $5d10129a174740d4$export$dad6ae84456c676a,
  );
  let [currentValidity, setCurrentValidity] = (0, $kFCAu$react.useState)(
    $5d10129a174740d4$export$dad6ae84456c676a,
  );
  let lastError = (0, $kFCAu$react.useRef)(
    $5d10129a174740d4$export$dad6ae84456c676a,
  );
  ...
  return {
    ...
    updateValidation(value) {
      ...
      if (
        ...
        !$5d10129a174740d4$var$isEqualValidation(currentValidity, value)
      )
