...
import {
  useMultipleSelectionState as $75HV2$useMultipleSelectionState,
  SelectionManager as $75HV2$SelectionManager,
} from "@react-stately/selection";
import {
  useMemo as $75HV2$useMemo,
  useCallback as $75HV2$useCallback,
  useEffect as $75HV2$useEffect,
} from "react";
...
function $875d6693e12af071$export$728d6ba534403756(props) {
  ...
  let [expandedKeys, setExpandedKeys] = (0, $75HV2$useControlledState)(
    props.expandedKeys ? new Set(props.expandedKeys) : undefined,
    props.defaultExpandedKeys ? new Set(props.defaultExpandedKeys) : new Set(),
    onExpandedChange,
  );
  let selectionState = (0, $75HV2$useMultipleSelectionState)(props);
  let disabledKeys = (0, $75HV2$useMemo)(
    () => (props.disabledKeys ? new Set(props.disabledKeys) : new Set()),
    [props.disabledKeys],
  );
  let tree = (0, $75HV2$useCollection)(
    props,
    (0, $75HV2$useCallback)(
      (nodes) =>
        new (0, $05ca4cd7c4a5a999$export$863faf230ee2118a)(nodes, {
