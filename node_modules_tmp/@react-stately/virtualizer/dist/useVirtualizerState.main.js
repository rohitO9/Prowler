...
$parcel$export(
  module.exports,
  "useVirtualizerState",
  () => $f02ef43b5e8eee9b$export$1505db82fe357e65,
);
/*
...
function $f02ef43b5e8eee9b$export$1505db82fe357e65(opts) {
  ...
  let [contentSize, setContentSize] = (0, $amfZP$react.useState)(
    new (0, $064492b79924894c$exports.Size)(),
  );
  let [isAnimating, setAnimating] = (0, $amfZP$react.useState)(false);
  let [isScrolling, setScrolling] = (0, $amfZP$react.useState)(false);
  let virtualizer = (0, $amfZP$react.useMemo)(
    () => new (0, $e1bc15d49d21df0e$exports.Virtualizer)(),
    [],
  );
  ...
  let setVisibleRect = (0, $amfZP$react.useCallback)(
    (rect) => {
      virtualizer.visibleRect = rect;
    },
    [virtualizer],
