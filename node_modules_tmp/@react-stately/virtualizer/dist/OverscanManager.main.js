...
$parcel$export(
  module.exports,
  "OverscanManager",
  () => $191a033606d4fda1$export$4455ee6afb38dcbb,
);
/*
...
class $191a033606d4fda1$export$4455ee6afb38dcbb {
  ...
  getOverscannedRect() {
    ...
    let overscanY =
      Math.round(
        Math.min(this.visibleRect.height * 2, this.overscanY.value) / 100,
      ) * 100;
    ...
    let overscanX =
      Math.round(
        Math.min(this.visibleRect.width * 2, this.overscanX.value) / 100,
      ) * 100;
