import {
  easeOut as $3eb131dcf37ad5f8$export$57636bb43b1ccbb0,
  tween as $3eb131dcf37ad5f8$export$dc0b63720788090c,
} from "./tween.module.js";
import {
  concatIterators as $fc36f9a046a9ce79$export$cfc14088dfefce5f,
  difference as $fc36f9a046a9ce79$export$acaf96a27438246b,
  isSetEqual as $fc36f9a046a9ce79$export$a8d0d0c8d1c5df64,
...
class $38b9490c1cca8fc4$export$89be5a243e59c4b2 {
  ...
  _setContentOffset(offset) {
    let rect = new (0, $60423f92c7f9ad87$export$c79fc6492f3af13d)(
      offset.x,
      offset.y,
  ...
  _setVisibleRect(rect, forceUpdate = false) {
    ...
    let shouldInvalidate =
      this.layout && this.layout.shouldInvalidate(rect, this._visibleRect);
  ...
  /** The set of persisted keys are always present in the DOM, even if not currently in view. */ set persistedKeys(
    persistedKeys,
  ) {
    if (
      !(0, $fc36f9a046a9ce79$export$a8d0d0c8d1c5df64)(
        persistedKeys,
        this._persistedKeys,
      )
    ) {
  ...
  /** Returns whether the given key, or an ancestor, is persisted. */ isPersistedKey(
    key,
  ) {
  ...
  getReusableView(layoutInfo) {
    ...
    let view =
      reusable.length > 0
        ? reusable.pop()
        : new (0, $ad1d98aa8f0c31b4$export$1a5223887c560441)(this);
    ...
    if (contentOffsetX !== visibleRect.x || contentOffsetY !== visibleRect.y) {
      ...
      if (context.animated || !this._animatedContentOffset.isOrigin()) {
        ...
        this._setContentOffset(
          new (0, $3041db3296945e6e$export$baf26146a414f24a)(
            contentOffsetX,
            contentOffsetY,
          ),
        );
    ...
    if (context.animated && hasLayoutUpdates) {
      ...
      let done = () => {
        ...
        if (!this._animatedContentOffset.isOrigin()) {
          ...
          this._resetAnimatedContentOffset();
          this._setContentOffset(
            new (0, $3041db3296945e6e$export$baf26146a414f24a)(x, y),
          );
        }
  ...
  _restoreScrollAnchor(scrollAnchor, context) {
    ...
    if (scrollAnchor) {
      ...
      let finalAnchor = (
        (_context_transaction = context.transaction) === null ||
        _context_transaction === void 0
          ? void 0
          : _context_transaction.animated
      )
  ...
  getVisibleRect() {
    ...
    return new (0, $60423f92c7f9ad87$export$c79fc6492f3af13d)(
      x,
      y,
      v.width,
      v.height,
  ...
  updateSubviews(forceUpdate = false) {
    ...
    if (forceUpdate) {
      ...
      ({
        ...
        toRemove: toRemove,
        toUpdate: toUpdate,
      } = (0, $fc36f9a046a9ce79$export$acaf96a27438246b)(
        currentlyVisible,
        visibleLayoutInfos,
      ));
      for (let key of toUpdate) {
        ...
        if (view.content === item) toUpdate.delete(key);
          ...
          let { reuseType: reuseType } = this._getReuseType(
            view.layoutInfo,
            item,
          );
  ...
  _flushVisibleViews() {
    ...
    for (let view of this._children) {
      var _view_layoutInfo,
        _viewsByParentKey_get,
        _view_layoutInfo1,
        _view_layoutInfo2,
        _view_layoutInfo3;
      if (
        ((_view_layoutInfo = view.layoutInfo) === null ||
        _view_layoutInfo === void 0
          ? void 0
          : _view_layoutInfo.parentKey) != null &&
        !viewsByParentKey.has(view.layoutInfo.parentKey)
      )
        viewsByParentKey.set(view.layoutInfo.parentKey, []);
      (_viewsByParentKey_get = viewsByParentKey.get(
        (_view_layoutInfo1 = view.layoutInfo) === null ||
          _view_layoutInfo1 === void 0
          ? void 0
          : _view_layoutInfo1.parentKey,
      )) === null || _viewsByParentKey_get === void 0
        ? void 0
        : _viewsByParentKey_get.push(view);
      if (
        !viewsByParentKey.has(
          (_view_layoutInfo2 = view.layoutInfo) === null ||
            _view_layoutInfo2 === void 0
            ? void 0
            : _view_layoutInfo2.key,
        )
      )
        viewsByParentKey.set(
          (_view_layoutInfo3 = view.layoutInfo) === null ||
            _view_layoutInfo3 === void 0
            ? void 0
            : _view_layoutInfo3.key,
          [],
        );
    }
  ...
  _resetAnimatedContentOffset() {
    ...
    if (!this._animatedContentOffset.isOrigin()) {
      this._animatedContentOffset = new (0,
      $3041db3296945e6e$export$baf26146a414f24a)(0, 0);
   ...
   */ scrollToItem(key, options) {
    ...
    let {
      ...
      shouldScrollX: shouldScrollX = true,
      shouldScrollY: shouldScrollY = true,
      offsetX: offsetX = 0,
      offsetY: offsetY = 0,
    } = options;
   ...
   */ scrollTo(offset, duration = 300) {
    ...
    this.startScrolling();
    this._scrollAnimation = (0, $3eb131dcf37ad5f8$export$dc0b63720788090c)(
      this.visibleRect,
      offset,
      duration,
      (0, $3eb131dcf37ad5f8$export$57636bb43b1ccbb0),
      (offset) => {
        this._setContentOffset(offset);
      },
    );
  ...
  _startTransaction() {
    if (!this._nextTransaction)
      this._nextTransaction = new (0,
      $8e135e531d8dcb66$export$febc5573c75cefb0)();
    ...
    this.relayoutNow({
      ...
      afterAnimation: () => {
        ...
        if (transaction.toRemove.size > 0 || transaction.removed.size > 0)
          for (let view of (0, $fc36f9a046a9ce79$export$cfc14088dfefce5f)(
  ...
  _setupTransactionAnimations(transaction) {
    ...
    for (let [key, layoutInfo] of initialMap)
      ...
      else transaction.finalLayoutInfo.set(layoutInfo.key, layoutInfo);
  ...
  constructor(options = {}) {
    ...
    this._invalidationContext = null;
    this._overscanManager = new (0,
    $364191b3decf3697$export$4455ee6afb38dcbb)();
    ...
    this.transitionDuration =
      (_options_transitionDuration = options.transitionDuration) !== null &&
      _options_transitionDuration !== void 0
        ? _options_transitionDuration
        : 500;
