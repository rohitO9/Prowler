...
$parcel$export(
  module.exports,
  "Virtualizer",
  () => $e1bc15d49d21df0e$export$89be5a243e59c4b2,
);
/*
...
class $e1bc15d49d21df0e$export$89be5a243e59c4b2 {
  ...
  _setContentOffset(offset) {
    let rect = new (0, $41b7691783731623$exports.Rect)(
      offset.x,
      offset.y,
  ...
  /** The set of persisted keys are always present in the DOM, even if not currently in view. */ set persistedKeys(
    ...
    if (
      !(0, $abed55ea619a7a17$exports.isSetEqual)(
        persistedKeys,
        this._persistedKeys,
      )
    ) {
  ...
  getReusableView(layoutInfo) {
    ...
    let view =
      reusable.length > 0
        ? reusable.pop()
        : new (0, $197a1781bd47f5b9$exports.ReusableView)(this);
    ...
    if (contentOffsetX !== visibleRect.x || contentOffsetY !== visibleRect.y) {
      ...
      if (context.animated || !this._animatedContentOffset.isOrigin()) {
        ...
        this._setContentOffset(
          new (0, $f89f15d7f52bce29$exports.Point)(
            contentOffsetX,
            contentOffsetY,
          ),
        );
    ...
    if (context.animated && hasLayoutUpdates) {
      ...
      let done = () => {
        ...
        if (!this._animatedContentOffset.isOrigin()) {
          ...
          this._resetAnimatedContentOffset();
          this._setContentOffset(
            new (0, $f89f15d7f52bce29$exports.Point)(x, y),
          );
        }
  ...
  updateSubviews(forceUpdate = false) {
    ...
    if (forceUpdate) {
      ...
      ({
        ...
        toRemove: toRemove,
        toUpdate: toUpdate,
      } = (0, $abed55ea619a7a17$exports.difference)(
        currentlyVisible,
        visibleLayoutInfos,
      ));
  ...
  _resetAnimatedContentOffset() {
    ...
    if (!this._animatedContentOffset.isOrigin()) {
      this._animatedContentOffset = new (0, $f89f15d7f52bce29$exports.Point)(
        0,
        0,
      );
   ...
   */ scrollTo(offset, duration = 300) {
    ...
    this.startScrolling();
    this._scrollAnimation = (0, $57c5d36217e1f286$exports.tween)(
      this.visibleRect,
      offset,
      duration,
      (0, $57c5d36217e1f286$exports.easeOut),
      (offset) => {
        this._setContentOffset(offset);
      },
    );
  ...
  _startTransaction() {
    if (!this._nextTransaction)
      this._nextTransaction = new (0, $d288159e8347722a$exports.Transaction)();
  ...
  _getContentRect() {
    return new (0, $41b7691783731623$exports.Rect)(
      0,
      0,
    ...
    this.relayoutNow({
      ...
      afterAnimation: () => {
        ...
        if (transaction.toRemove.size > 0 || transaction.removed.size > 0)
          for (let view of (0, $abed55ea619a7a17$exports.concatIterators)(
  ...
  constructor(options = {}) {
    ...
    $191a033606d4fda1$exports.OverscanManager)();
