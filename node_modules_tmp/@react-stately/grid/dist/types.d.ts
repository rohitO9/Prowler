import {
  GridCollection as _GridCollection1,
  GridNode,
  GridRow,
} from "@react-types/grid";
...
export interface GridStateOptions<T, C extends _GridCollection1<T>>
 ...
 */
export function useGridState<T extends object, C extends _GridCollection1<T>>(
