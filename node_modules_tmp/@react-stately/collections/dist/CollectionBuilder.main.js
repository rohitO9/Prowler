...
$parcel$export(
  module.exports,
  "CollectionBuilder",
  () => $51588fd411aace25$export$bf788dd355e3a401,
);
/*
...
class $51588fd411aace25$export$bf788dd355e3a401 {
  ...
  *iterateCollection(props) {
    ...
    if (typeof children === "function") {
      ...
      let items = [];
      (0, $parcel$interopDefault($ioO2y$react)).Children.forEach(
        children,
        (child) => {
          items.push(child);
        },
      ...
      while (!result.done && result.value) {
        ...
        let nodes = this.getFullNode(
          {
            ...
            key: nodeKey,
            index: index,
            wrapper: $51588fd411aace25$var$compose(
              partialNode.wrapper,
              childNode.wrapper,
            ),
          },
        ...
        for (let node of children) {
          ...
          if (partialNode.type && node.type !== partialNode.type)
            throw new Error(
              `Unsupported type <${$51588fd411aace25$var$capitalize(node.type)}> in <${$51588fd411aace25$var$capitalize(parentNode.type)}>. Only <${$51588fd411aace25$var$capitalize(partialNode.type)}> is supported.`,
            );
          index++;
          yield node;
        }
