...
$parcel$export(
  module.exports,
  "Section",
  () => $350f13aa4d8b327c$export$6e2c8f0811a474ce,
);
/*
...
$350f13aa4d8b327c$var$Section.getCollectionNode = function* getCollectionNode(
  props,
) {
  ...
  yield {
    ...
    *childNodes() {
      if (typeof children === "function") {
        ...
        let items = [];
        (0, $parcel$interopDefault($98hxh$react)).Children.forEach(
          children,
          (child) => {
            items.push({
              type: "item",
