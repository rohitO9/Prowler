...
$parcel$export(
  module.exports,
  "Item",
  () => $c870f3b549c61b6b$export$6d08773d2e66f8f2,
);
/*
...
$c870f3b549c61b6b$var$Item.getCollectionNode = function* getCollectionNode(
  props,
  context,
) {
  ...
  yield {
    ...
    *childNodes() {
      if (childItems)
        ...
        let items = [];
        (0, $parcel$interopDefault($5Zch8$react)).Children.forEach(
          children,
          (child) => {
            items.push({
              type: "item",
...
function $c870f3b549c61b6b$var$hasChildItems(props) {
  ...
  if (
    props.title &&
    (0, $parcel$interopDefault($5Zch8$react)).Children.count(props.children) > 0
  )
    return true;
  return false;
}
