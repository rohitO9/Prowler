...
$parcel$export(
  module.exports,
  "useComboBoxState",
  () => $e563f9c9469ad14c$export$b453a3bfd4a5fa9e,
);
/*
...
function $e563f9c9469ad14c$export$b453a3bfd4a5fa9e(props) {
  ...
  } = (0, $2KOLe$reactstatelylist.useSingleSelectListState)({
    ...props,
  ...
  $2KOLe$reactstatelyutils.useControlledState)(
    props.inputValue,
    (_ref =
  ...
  let filteredCollection = (0, $2KOLe$react.useMemo)(
    () =>
      // No default filter if items are controlled.
      props.items != null || !defaultFilter
        ? collection
        : $e563f9c9469ad14c$var$filterCollection(
            collection,
            inputValue,
            defaultFilter,
          ),
  ...
  let [lastCollection, setLastCollection] = (0, $2KOLe$react.useState)(
    filteredCollection,
  );
  ...
  let toggleMenu = (0, $2KOLe$react.useCallback)(
    (focusStrategy = null) => {
...
function $e563f9c9469ad14c$var$filterCollection(
  collection,
  inputValue,
  filter,
) {
  return new (0, $2KOLe$reactstatelylist.ListCollection)(
    $e563f9c9469ad14c$var$filterNodes(
      collection,
      collection,
      inputValue,
      filter,
...
function $e563f9c9469ad14c$var$filterNodes(
  collection,
  nodes,
  inputValue,
  filter,
  ...
  for (let node of nodes) {
    if (node.type === "section" && node.hasChildNodes) {
      let filtered = $e563f9c9469ad14c$var$filterNodes(
        collection,
        (0, $2KOLe$reactstatelycollections.getChildNodes)(node, collection),
        inputValue,
        filter,
      );
