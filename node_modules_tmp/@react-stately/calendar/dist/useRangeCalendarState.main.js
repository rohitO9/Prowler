...
$parcel$export(
  ...
  () => $e49f7b861e5e8049$export$9a987164d97ecc90,
);
/*
...
function $e49f7b861e5e8049$export$9a987164d97ecc90(props) {
  ...
  let [value, setValue] = (0, $e7F0I$reactstatelyutils.useControlledState)(
    valueProp,
    defaultValue || null,
    onChange,
  );
  ...
  if (value && value.start && value.end) {
    let start = (0, $4301262d71f567b9$exports.alignCenter)(
      (0, $e7F0I$internationalizeddate.toCalendarDate)(value.start),
      visibleDuration,
      locale,
      minValue,
      maxValue,
  ...
  let min = (0, $e7F0I$react.useMemo)(
    () =>
      (0, $e7F0I$internationalizeddate.maxDate)(
        minValue,
  ...
  let max = (0, $e7F0I$react.useMemo)(
    () =>
      (0, $e7F0I$internationalizeddate.minDate)(
        maxValue,
        availableRange === null || availableRange === void 0
          ? void 0
          : availableRange.end,
  ...
  let [lastVisibleRange, setLastVisibleRange] = (0, $e7F0I$react.useState)(
    calendar.visibleRange,
  );
  if (
    !(0, $e7F0I$internationalizeddate.isEqualDay)(
      calendar.visibleRange.start,
      lastVisibleRange.start,
    ) ||
    !(0, $e7F0I$internationalizeddate.isEqualDay)(
      calendar.visibleRange.end,
  ...
  let highlightedRange = anchorDate
    ? $e49f7b861e5e8049$var$makeRange(anchorDate, calendar.focusedDate)
    : value && $e49f7b861e5e8049$var$makeRange(value.start, value.end);
  let selectDate = (date) => {
    if (props.isReadOnly) return;
    date = (0, $4301262d71f567b9$exports.constrainValue)(date, min, max);
    date = (0, $4301262d71f567b9$exports.previousAvailableDate)(
      date,
      calendar.visibleRange.start,
    ...
    if (!anchorDate) setAnchorDate(date);
      ...
      setValue({
        start: $e49f7b861e5e8049$var$convertValue(
          range.start,
          value === null || value === void 0 ? void 0 : value.start,
        ),
        end: $e49f7b861e5e8049$var$convertValue(
          range.end,
  ...
  let isInvalidSelection = (0, $e7F0I$react.useMemo)(() => {
    ...
    if (
      ...
      return true;
    return (
      (0, $4301262d71f567b9$exports.isInvalid)(
        value.start,
        minValue,
        maxValue,
      ) ||
      (0, $4301262d71f567b9$exports.isInvalid)(value.end, minValue, maxValue)
    );
...
function $e49f7b861e5e8049$var$convertValue(newValue, oldValue) {
  ...
  newValue = (0, $e7F0I$internationalizeddate.toCalendar)(
    newValue,
    (oldValue === null || oldValue === void 0 ? void 0 : oldValue.calendar) ||
      new (0, $e7F0I$internationalizeddate.GregorianCalendar)(),
  );
