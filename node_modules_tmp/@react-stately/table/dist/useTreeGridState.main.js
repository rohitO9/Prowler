...
$parcel$export(
  ...
  () => $ed4e0b68b470dcfd$export$34dfa8a1622185a4,
);
/*
...
function $ed4e0b68b470dcfd$export$34dfa8a1622185a4(props) {
  ...
  if (!(0, $5Qo8l$reactstatelyflags.tableNestedRows)())
    throw new Error(
      "Feature flag for table nested rows must be enabled to use useTreeGridState.",
    );
  let [expandedKeys, setExpandedKeys] = (0,
  $5Qo8l$reactstatelyutils.useControlledState)(
    propExpandedKeys
      ? $ed4e0b68b470dcfd$var$convertExpanded(propExpandedKeys)
      : undefined,
    propDefaultExpandedKeys
      ? $ed4e0b68b470dcfd$var$convertExpanded(propDefaultExpandedKeys)
      : new Set(),
  ...
  let builder = (0, $5Qo8l$react.useMemo)(
    () => new (0, $5Qo8l$reactstatelycollections.CollectionBuilder)(),
    [],
  );
  let nodes = (0, $5Qo8l$react.useMemo)(
    () =>
      builder.build(
        {
          children: children,
  ...
  let onToggle = (key) => {
    setExpandedKeys(
      $ed4e0b68b470dcfd$var$toggleKey(expandedKeys, key, treeGridCollection),
    );
  };
  let collection = (0, $5Qo8l$react.useMemo)(() => {
    return new (0, $7f5a58334d8866a5$exports.TableCollection)(
  ...
  if (currentExpandedKeys === "all") {
    updatedExpandedKeys = new Set(
      collection.flattenedRows
        .filter(
          (row) =>
            row.props.UNSTABLE_childItems ||
            row.props.children.length > collection.userColumnCount,
        )
        .map((row) => row.key),
    );
