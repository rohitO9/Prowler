...
import {
  useState as $cPT3l$useState,
  useMemo as $cPT3l$useMemo,
  useCallback as $cPT3l$useCallback,
} from "react";
...
function $292bc4e09cd0eb62$export$cb895dcf85db1319(props, state) {
  ...
  let columnLayout = (0, $cPT3l$useMemo)(
    () =>
      new (0, $a9e7ae544a4e41dd$export$7ff77a162970b30e)({
        getDefaultWidth: getDefaultWidth,
        getDefaultMinWidth: getDefaultMinWidth,
      }),
    [getDefaultWidth, getDefaultMinWidth],
  );
  let [controlledColumns, uncontrolledColumns] = (0, $cPT3l$useMemo)(
    () =>
  ...
  let startResize = (0, $cPT3l$useCallback)(
    (key) => {
      setResizingColumn(key);
    },
    [setResizingColumn],
  );
  let updateResizedColumns = (0, $cPT3l$useCallback)(
    (key, width) => {
