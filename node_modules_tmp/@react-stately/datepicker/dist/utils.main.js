...
$parcel$export(
  module.exports,
  "getValidationResult",
  () => $50d5d6a623389320$export$f18627323ab57ac0,
);
$parcel$export(
  module.exports,
  "getFormatOptions",
  () => $50d5d6a623389320$export$7e319ea407e63bc0,
);
$parcel$export(
  module.exports,
  "getRangeValidationResult",
  () => $50d5d6a623389320$export$80ff8fc0ae339c13,
);
$parcel$export(
  module.exports,
  "getPlaceholderTime",
  () => $50d5d6a623389320$export$c5221a78ef73c5e9,
);
$parcel$export(
  module.exports,
  "convertValue",
  () => $50d5d6a623389320$export$61a490a80c552550,
);
$parcel$export(
  module.exports,
  "createPlaceholderDate",
  () => $50d5d6a623389320$export$66aa2b09de4b1ea5,
);
$parcel$export(
  module.exports,
  "useDefaultProps",
  () => $50d5d6a623389320$export$2440da353cedad43,
);
/*
...
const $50d5d6a623389320$var$dictionary = new (0,
$68Tdx$internationalizedstring.LocalizedStringDictionary)(
  (0, $parcel$interopDefault($5294278fb5cc815e$exports)),
);
...
function $50d5d6a623389320$export$f18627323ab57ac0(
  value,
  minValue,
  maxValue,
  isDateUnavailable,
  ...
  if (isInvalid) {
    ...
    let strings =
      (0,
      $68Tdx$internationalizedstring.LocalizedStringDictionary).getGlobalDictionaryForPackage(
        "@react-stately/datepicker",
      ) || $50d5d6a623389320$var$dictionary;
    let formatter = new (0,
    $68Tdx$internationalizedstring.LocalizedStringFormatter)(locale, strings);
    let dateFormatter = new (0, $68Tdx$internationalizeddate.DateFormatter)(
      locale,
      $50d5d6a623389320$export$7e319ea407e63bc0({}, options),
    );
...
function $50d5d6a623389320$export$80ff8fc0ae339c13(
  value,
  minValue,
  maxValue,
  isDateUnavailable,
  ...
  let startValidation = $50d5d6a623389320$export$f18627323ab57ac0(
  ...
  let endValidation = $50d5d6a623389320$export$f18627323ab57ac0(
  ...
  let result = (0, $68Tdx$reactstatelyform.mergeValidation)(
    startValidation,
    endValidation,
  );
  if (
    ...
    result = (0, $68Tdx$reactstatelyform.mergeValidation)(result, {
      ...
      validationErrors: [
        strings.getStringForLocale(
          "rangeReversed",
          $50d5d6a623389320$var$getLocale(),
        ),
      ],
      validationDetails: {
...
function $50d5d6a623389320$export$7e319ea407e63bc0(fieldOptions, options) {
  let defaultFieldOptions = options.shouldForceLeadingZeros
    ? $50d5d6a623389320$var$TWO_DIGIT_FIELD_OPTIONS
...
function $50d5d6a623389320$export$66aa2b09de4b1ea5(
  placeholderValue,
  granularity,
  calendar,
  timeZone,
  ...
  if (placeholderValue)
    return $50d5d6a623389320$export$61a490a80c552550(
      placeholderValue,
      calendar,
    );
  let date = (0, $68Tdx$internationalizeddate.toCalendar)(
    (0, $68Tdx$internationalizeddate.now)(timeZone).set({
      hour: 0,
      minute: 0,
      second: 0,
      millisecond: 0,
  ...
  if (
    ...
    return (0, $68Tdx$internationalizeddate.toCalendarDate)(date);
  if (!timeZone)
    return (0, $68Tdx$internationalizeddate.toCalendarDateTime)(date);
  return date;
}
