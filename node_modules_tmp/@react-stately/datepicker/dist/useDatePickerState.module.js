...
import {
  toCalendarDate as $goopS$toCalendarDate,
  toCalendarDateTime as $goopS$toCalendarDateTime,
  DateFormatter as $goopS$DateFormatter,
...
function $ab5bf3f618090389$export$87194bb378cc3ac2(props) {
  ...
  let [value, setValue] = (0, $goopS$useControlledState)(
    props.value,
  ...
  let dateValue =
    value != null
      ? value.toDate(
          defaultTimeZone !== null && defaultTimeZone !== void 0
            ? defaultTimeZone
            : "UTC",
        )
      : null;
  ...
  let builtinValidation = (0, $goopS$useMemo)(
    () =>
  ...
  let commitValue = (date, time) => {
    setValue(
      "timeZone" in time
        ? time.set((0, $goopS$toCalendarDate)(date))
        : (0, $goopS$toCalendarDateTime)(date, time),
    );
