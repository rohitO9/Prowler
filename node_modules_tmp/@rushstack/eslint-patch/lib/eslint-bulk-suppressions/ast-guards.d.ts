...
export declare function isClassExpression(
  node: TSESTree.Node,
): node is TSESTree.ClassExpression;
...
export declare function isTSModuleDeclaration(
  node: TSESTree.Node,
): node is TSESTree.TSModuleDeclaration;
...
export declare function isClassDeclarationWithName(
  node: TSESTree.Node,
): node is TSESTree.ClassDeclarationWithName;
export declare function isClassPropertyNameNonComputed(
  node: TSESTree.Node,
): node is TSESTree.ClassPropertyNameNonComputed;
export declare function isFunctionDeclarationWithName(
  node: TSESTree.Node,
): node is TSESTree.FunctionDeclarationWithName;
export declare function isNumberLiteral(
  node: TSESTree.Node,
): node is TSESTree.NumberLiteral;
export declare function isPropertyNameNonComputed(
  node: TSESTree.Node,
): node is TSESTree.PropertyNameNonComputed;
...
export declare function isClassExpressionWithName(
  node: TSESTree.Node,
): node is IClassExpressionWithName;
export interface IFunctionExpressionWithName
  extends TSESTree.FunctionExpression {
  id: TSESTree.Identifier;
}
export declare function isFunctionExpressionWithName(
  node: TSESTree.Node,
): node is IFunctionExpressionWithName;
export type NormalAnonymousExpression =
  | TSESTree.ArrowFunctionExpression
  | TSESTree.ClassExpression
  | TSESTree.FunctionExpression
  | TSESTree.ObjectExpression;
export declare function isNormalAnonymousExpression(
  node: TSESTree.Node,
): node is NormalAnonymousExpression;
export interface INormalAssignmentPattern extends TSESTree.AssignmentPattern {
  left: TSESTree.Identifier;
}
export declare function isNormalAssignmentPattern(
  node: TSESTree.Node,
): node is INormalAssignmentPattern;
export interface INormalClassPropertyDefinition
  extends TSESTree.PropertyDefinitionNonComputedName {
  key: TSESTree.PrivateIdentifier | TSESTree.Identifier;
  value: TSESTree.Expression;
}
export declare function isNormalClassPropertyDefinition(
  node: TSESTree.Node,
): node is INormalClassPropertyDefinition;
export interface INormalMethodDefinition
  extends TSESTree.MethodDefinitionNonComputedName {
  key: TSESTree.PrivateIdentifier | TSESTree.Identifier;
}
export declare function isNormalMethodDefinition(
  node: TSESTree.Node,
): node is INormalMethodDefinition;
export interface INormalObjectProperty
  extends TSESTree.PropertyNonComputedName {
  key: TSESTree.Identifier;
}
export declare function isNormalObjectProperty(
  node: TSESTree.Node,
): node is INormalObjectProperty;
export interface INormalVariableDeclarator extends TSESTree.VariableDeclarator {
  id: TSESTree.Identifier;
  init: TSESTree.Expression;
}
export declare function isNormalVariableDeclarator(
  node: TSESTree.Node,
): node is INormalVariableDeclarator;
export interface INormalAssignmentPatternWithAnonymousExpressionAssigned
  extends INormalAssignmentPattern {
  right: NormalAnonymousExpression;
}
export declare function isNormalAssignmentPatternWithAnonymousExpressionAssigned(
  node: TSESTree.Node,
): node is INormalAssignmentPatternWithAnonymousExpressionAssigned;
export interface INormalVariableDeclaratorWithAnonymousExpressionAssigned
  extends INormalVariableDeclarator {
  init: NormalAnonymousExpression;
}
export declare function isNormalVariableDeclaratorWithAnonymousExpressionAssigned(
  node: TSESTree.Node,
): node is INormalVariableDeclaratorWithAnonymousExpressionAssigned;
export interface INormalObjectPropertyWithAnonymousExpressionAssigned
  extends INormalObjectProperty {
  value: NormalAnonymousExpression;
}
export declare function isNormalObjectPropertyWithAnonymousExpressionAssigned(
  node: TSESTree.Node,
...
export declare function isNormalClassPropertyDefinitionWithAnonymousExpressionAssigned(
  node: TSESTree.Node,
...
export declare function isNodeWithName(
  node: TSESTree.Node,
): node is NodeWithName;
