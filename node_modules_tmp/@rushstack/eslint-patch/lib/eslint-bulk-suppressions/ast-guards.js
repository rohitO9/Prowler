...
exports.isNodeWithName =
  exports.isNormalClassPropertyDefinitionWithAnonymousExpressionAssigned =
  exports.isNormalObjectPropertyWithAnonymousExpressionAssigned =
  exports.isNormalVariableDeclaratorWithAnonymousExpressionAssigned =
  exports.isNormalAssignmentPatternWithAnonymousExpressionAssigned =
  exports.isNormalVariableDeclarator =
  exports.isNormalObjectProperty =
  exports.isNormalMethodDefinition =
  exports.isNormalClassPropertyDefinition =
  exports.isNormalAssignmentPattern =
  exports.isNormalAnonymousExpression =
  exports.isFunctionExpressionWithName =
  exports.isClassExpressionWithName =
  exports.isStringLiteral =
  exports.isPropertyNameNonComputed =
  exports.isNumberLiteral =
  exports.isFunctionDeclarationWithName =
  exports.isClassPropertyNameNonComputed =
  exports.isClassDeclarationWithName =
  exports.isVariableDeclarator =
  exports.isTSTypeAliasDeclaration =
  exports.isTSQualifiedName =
  exports.isTSModuleDeclaration =
  exports.isTSInterfaceDeclaration =
  exports.isTSEnumDeclaration =
  exports.isPropertyDefinition =
  exports.isProperty =
  exports.isPrivateIdentifier =
  exports.isObjectExpression =
  exports.isMethodDefinition =
  exports.isLiteral =
  exports.isIdentifier =
  exports.isFunctionExpression =
  exports.isFunctionDeclaration =
  exports.isExpression =
  exports.isExportDefaultDeclaration =
  exports.isClassExpression =
  exports.isClassDeclaration =
  exports.isAssignmentPattern =
  exports.isArrowFunctionExpression =
...
function isNormalVariableDeclarator(node) {
  return (
    isVariableDeclarator(node) && isIdentifier(node.id) && node.init !== null
  );
}
...
function isNormalAssignmentPatternWithAnonymousExpressionAssigned(node) {
  return (
    isNormalAssignmentPattern(node) && isNormalAnonymousExpression(node.right)
  );
}
exports.isNormalAssignmentPatternWithAnonymousExpressionAssigned =
  isNormalAssignmentPatternWithAnonymousExpressionAssigned;
function isNormalVariableDeclaratorWithAnonymousExpressionAssigned(node) {
  return (
    isNormalVariableDeclarator(node) && isNormalAnonymousExpression(node.init)
  );
}
exports.isNormalVariableDeclaratorWithAnonymousExpressionAssigned =
...
function isNormalObjectPropertyWithAnonymousExpressionAssigned(node) {
  return (
    isNormalObjectProperty(node) && isNormalAnonymousExpression(node.value)
  );
}
exports.isNormalObjectPropertyWithAnonymousExpressionAssigned =
...
function isNormalClassPropertyDefinitionWithAnonymousExpressionAssigned(node) {
  return (
    isNormalClassPropertyDefinition(node) &&
    isNormalAnonymousExpression(node.value)
  );
}
exports.isNormalClassPropertyDefinitionWithAnonymousExpressionAssigned =
