...
if (!_patch_base_1.configArrayFactory.__loadExtendedShareableConfigPatched) {
  ...
  const originalLoadExtendedShareableConfig =
    _patch_base_1.configArrayFactory.prototype._loadExtendedShareableConfig;
        ...
        _patch_base_1.ModuleResolver.resolve = function (
          ...
          try {
            ...
            if (
              ...
              moduleName ===
                _patch_base_1.Naming.normalizePackageName(
                  extendName,
                  "eslint-config",
                )
            ) {
