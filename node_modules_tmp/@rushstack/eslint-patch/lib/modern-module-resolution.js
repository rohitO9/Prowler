...
const isInvalidImporterPath = (ex) =>
  (ex === null || ex === void 0 ? void 0 : ex.code) === "ERR_INVALID_ARG_VALUE";
if (!_patch_base_1.configArrayFactory.__loadPluginPatched) {
  ...
  const originalLoadPlugin =
    _patch_base_1.configArrayFactory.prototype._loadPlugin;
  if (_patch_base_1.ESLINT_MAJOR_VERSION === 6) {
    ...
    _patch_base_1.configArrayFactory.prototype._loadPlugin = function (
      name,
      importerPath,
      importerName,
    ) {
      ...
      try {
        _patch_base_1.ModuleResolver.resolve = function (
          moduleName,
          relativeToPath,
        ) {
          try {
            ...
            if (
              (0, _patch_base_1.isModuleResolutionError)(e) ||
              isInvalidImporterPath(e)
            ) {
