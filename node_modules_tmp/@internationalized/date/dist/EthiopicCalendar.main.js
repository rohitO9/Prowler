...
$parcel$export(
  module.exports,
  "EthiopicCalendar",
  () => $4db04d1051af0f2f$export$26ba6eab5e20cd7d,
);
$parcel$export(
  module.exports,
  "EthiopicAmeteAlemCalendar",
  () => $4db04d1051af0f2f$export$d72e0c37005a4914,
);
$parcel$export(
  module.exports,
  "CopticCalendar",
  () => $4db04d1051af0f2f$export$fe6243cbe1a4b7c1,
);
/*
...
function $4db04d1051af0f2f$var$ceToJulianDay(epoch, year, month, day) {
  return (
    ...
    30 *
      (month - 1) + // number of days from months (1 based)
    day -
...
function $4db04d1051af0f2f$var$julianDayToCE(epoch, jd) {
  ...
  let month =
    1 +
    Math.floor(
      (jd - $4db04d1051af0f2f$var$ceToJulianDay(epoch, year, 1, 1)) / 30,
    );
...
function $4db04d1051af0f2f$var$getDaysInMonth(year, month) {
  ...
  else return $4db04d1051af0f2f$var$getLeapDay(year) + 5;
}
class $4db04d1051af0f2f$export$26ba6eab5e20cd7d {
  fromJulianDay(jd) {
    let [year, month, day] = $4db04d1051af0f2f$var$julianDayToCE(
      $4db04d1051af0f2f$var$ETHIOPIC_EPOCH,
      jd,
    );
    let era = "AM";
    if (year <= 0) {
  ...
  toJulianDay(date) {
    ...
    return $4db04d1051af0f2f$var$ceToJulianDay(
      $4db04d1051af0f2f$var$ETHIOPIC_EPOCH,
      year,
      date.month,
      date.day,
...
class $4db04d1051af0f2f$export$fe6243cbe1a4b7c1 extends $4db04d1051af0f2f$export$26ba6eab5e20cd7d {
  fromJulianDay(jd) {
    let [year, month, day] = $4db04d1051af0f2f$var$julianDayToCE(
      $4db04d1051af0f2f$var$COPTIC_EPOCH,
      jd,
    );
    let era = "CE";
    if (year <= 0) {
