...
$parcel$export(
  ...
  () => $ecb2c4cc8c9aae25$export$2066795aadd37bfc,
);
$parcel$export(
  module.exports,
  "IslamicTabularCalendar",
  () => $ecb2c4cc8c9aae25$export$37f0887f2f9d22f7,
);
$parcel$export(
  module.exports,
...
function $ecb2c4cc8c9aae25$var$julianDayToIslamic(calendar, epoch, jd) {
  ...
  let month = Math.min(
    ...
    Math.ceil(
      (jd -
        (29 + $ecb2c4cc8c9aae25$var$islamicToJulianDay(epoch, year, 1, 1))) /
        29.5,
    ) + 1,
  );
  let day =
    jd - $ecb2c4cc8c9aae25$var$islamicToJulianDay(epoch, year, month, 1) + 1;
...
class $ecb2c4cc8c9aae25$export$2066795aadd37bfc {
  fromJulianDay(jd) {
    return $ecb2c4cc8c9aae25$var$julianDayToIslamic(
      this,
      $ecb2c4cc8c9aae25$var$CIVIL_EPOC,
      jd,
    );
  }
  toJulianDay(date) {
    return $ecb2c4cc8c9aae25$var$islamicToJulianDay(
      $ecb2c4cc8c9aae25$var$CIVIL_EPOC,
      date.year,
      date.month,
      date.day,
...
class $ecb2c4cc8c9aae25$export$37f0887f2f9d22f7 extends $ecb2c4cc8c9aae25$export$2066795aadd37bfc {
  fromJulianDay(jd) {
    return $ecb2c4cc8c9aae25$var$julianDayToIslamic(
      this,
      $ecb2c4cc8c9aae25$var$ASTRONOMICAL_EPOC,
      jd,
    );
  }
  toJulianDay(date) {
...
function $ecb2c4cc8c9aae25$var$umalquraYearStart(year) {
  return (
    $ecb2c4cc8c9aae25$var$UMALQURA_START_DAYS +
    $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_START_TABLE[
      year - $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_START
    ]
  );
}
...
function $ecb2c4cc8c9aae25$var$umalquraYearLength(year) {
  return (
    $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_START_TABLE[
      year + 1 - $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_START
    ] -
    $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_START_TABLE[
      year - $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_START
    ]
...
class $ecb2c4cc8c9aae25$export$5baab4758c231076 extends $ecb2c4cc8c9aae25$export$2066795aadd37bfc {
  fromJulianDay(jd) {
    ...
    let startDays = $ecb2c4cc8c9aae25$var$umalquraYearStart(
      $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_START,
    );
    let endDays = $ecb2c4cc8c9aae25$var$umalquraYearStart(
      $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_END,
    );
    if (days < startDays || days > endDays) return super.fromJulianDay(jd);
      ...
      return new (0, $625ad1e1f4c43bc1$exports.CalendarDate)(
        ...
        y,
        m,
        days - $ecb2c4cc8c9aae25$var$umalquraMonthStart(y, m) + 1,
      );
    }
  }
  toJulianDay(date) {
    if (
      date.year < $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_START ||
      date.year > $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_END
    )
      return super.toJulianDay(date);
    return (
      $ecb2c4cc8c9aae25$var$CIVIL_EPOC +
      $ecb2c4cc8c9aae25$var$umalquraMonthStart(date.year, date.month) +
      (date.day - 1)
    );
  }
  getDaysInMonth(date) {
  ...
  constructor() {
    ...
    if (!$ecb2c4cc8c9aae25$var$UMALQURA_MONTHLENGTH)
      $ecb2c4cc8c9aae25$var$UMALQURA_MONTHLENGTH = new Uint16Array(
        Uint8Array.from(atob($ecb2c4cc8c9aae25$var$UMALQURA_DATA), (c) =>
          c.charCodeAt(0),
        ).buffer,
      );
    if (!$ecb2c4cc8c9aae25$var$UMALQURA_YEAR_START_TABLE) {
      $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_START_TABLE = new Uint32Array(
        $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_END -
          $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_START +
          1,
      );
      let yearStart = 0;
      for (
        let year = $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_START;
        year <= $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_END;
        year++
      ) {
        $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_START_TABLE[
          year - $ecb2c4cc8c9aae25$var$UMALQURA_YEAR_START
