...
$parcel$export(
  module.exports,
  "PersianCalendar",
  () => $3c060181fc7249ae$export$37fccdbfd14c5939,
);
/*
...
class $3c060181fc7249ae$export$37fccdbfd14c5939 {
  ...
  toJulianDay(date) {
    let jd =
      $3c060181fc7249ae$var$PERSIAN_EPOCH -
      1 +
      365 * (date.year - 1) +
      Math.floor((8 * date.year + 21) / 33);
  ...
  getDaysInMonth(date) {
    ...
    let isLeapYear =
      (0, $a5090d6430502238$exports.mod)(25 * date.year + 11, 33) < 8;
