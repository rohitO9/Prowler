...
$parcel$export(
  module.exports,
  "IndianCalendar",
  () => $5f1dfa5c67609fe6$export$39f31c639fa15726,
);
/*
...
class $5f1dfa5c67609fe6$export$39f31c639fa15726 extends (0,
$af14c9812fdceb33$exports.GregorianCalendar) {
  fromJulianDay(jd) {
    ...
    let yDay =
      jd -
      (0, $af14c9812fdceb33$exports.gregorianToJulianDay)(
        date.era,
        date.year,
        1,
        1,
    ...
    if (yDay < $5f1dfa5c67609fe6$var$INDIAN_YEAR_START) {
      ...
      leapMonth = (0, $af14c9812fdceb33$exports.isLeapYear)(date.year - 1)
        ? 31
        : 30;
      yDay += leapMonth + 155 + 90 + 10;
    } else {
      // Days in leapMonth this year
      leapMonth = (0, $af14c9812fdceb33$exports.isLeapYear)(date.year)
        ? 31
        : 30;
  ...
  toJulianDay(date) {
    ...
    let [era, year] = (0, $af14c9812fdceb33$exports.fromExtendedYear)(
      extendedYear,
    );
    let leapMonth;
    let jd;
    if ((0, $af14c9812fdceb33$exports.isLeapYear)(year)) {
      leapMonth = 31;
      jd = (0, $af14c9812fdceb33$exports.gregorianToJulianDay)(
        era,
        year,
        3,
        21,
  ...
  getDaysInMonth(date) {
    if (
      date.month === 1 &&
      (0, $af14c9812fdceb33$exports.isLeapYear)(
        date.year + $5f1dfa5c67609fe6$var$INDIAN_ERA_START,
      )
    )
      return 31;
