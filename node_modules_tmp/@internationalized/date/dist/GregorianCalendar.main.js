...
$parcel$export(
  ...
  () => $af14c9812fdceb33$export$f297eb839006d339,
);
$parcel$export(
  module.exports,
  "getExtendedYear",
  () => $af14c9812fdceb33$export$c36e0ecb2d4fa69d,
);
$parcel$export(
  module.exports,
  "isLeapYear",
  () => $af14c9812fdceb33$export$553d7fa8e3805fc0,
);
$parcel$export(
  module.exports,
  "fromExtendedYear",
  () => $af14c9812fdceb33$export$4475b7e617eb123c,
);
$parcel$export(
  module.exports,
  "GregorianCalendar",
  () => $af14c9812fdceb33$export$80ee6245ec4f29ec,
);
/*
...
class $af14c9812fdceb33$export$80ee6245ec4f29ec {
  fromJulianDay(jd) {
    ...
    let yearDay =
      jd0 - $af14c9812fdceb33$export$f297eb839006d339(era, year, 1, 1);
    let leapAdj = 2;
    ...
    let day =
      jd0 - $af14c9812fdceb33$export$f297eb839006d339(era, year, month, 1) + 1;
  ...
  toJulianDay(date) {
    return $af14c9812fdceb33$export$f297eb839006d339(
      date.era,
      date.year,
      date.month,
      date.day,
  ...
  getDaysInMonth(date) {
    return $af14c9812fdceb33$var$daysInMonth[
      $af14c9812fdceb33$export$553d7fa8e3805fc0(date.year)
        ? "leapyear"
        : "standard"
    ][date.month - 1];
  }
