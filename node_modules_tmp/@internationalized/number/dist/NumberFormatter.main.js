...
$parcel$export(
  module.exports,
  "NumberFormatter",
  () => $0c1d5654b62fc485$export$cc77c4ff7e8673c5,
);
/*
...
try {
  $0c1d5654b62fc485$var$supportsSignDisplay =
...
try {
  $0c1d5654b62fc485$var$supportsUnit =
    new Intl.NumberFormat("de-DE", {
      style: "unit",
      unit: "degree",
...
class $0c1d5654b62fc485$export$cc77c4ff7e8673c5 {
  /** Formats a number value as a string, according to the locale and options provided to the constructor. */ format(
    ...
    if (
      ...
      res = $0c1d5654b62fc485$export$711b50b3c525e0f2(
    ...
    if (this.options.style === "unit" && !$0c1d5654b62fc485$var$supportsUnit) {
      ...
      if (!unit) return res;
      let values =
        (_UNITS_unit = $0c1d5654b62fc485$var$UNITS[unit]) === null ||
        _UNITS_unit === void 0
          ? void 0
  ...
  constructor(locale, options = {}) {
    this.numberFormatter = $0c1d5654b62fc485$var$getCachedNumberFormatter(
      locale,
      options,
    );
...
function $0c1d5654b62fc485$export$711b50b3c525e0f2(
  numberFormat,
  signDisplay,
  num,
) {
