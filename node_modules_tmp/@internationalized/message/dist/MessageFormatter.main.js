...
$parcel$export(
  module.exports,
  "MessageFormatter",
  () => $7a31ee9993c13f0b$export$526ebc05ff964723,
);
/*
...
class $7a31ee9993c13f0b$export$526ebc05ff964723 {
  format(key, variables) {
    ...
    if (!message) {
      ...
      if (!msg)
        throw new Error(
          `Could not find intl message ${key} in ${this.locale} locale`,
        );
      message = new (0, $parcel$interopDefault($f4V3v$intlmessageformat))(
        msg,
        this.locale,
      );
