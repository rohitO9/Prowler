...
$parcel$export(
  ...
  () => $f80be5fd4d03dda9$export$c17fa47878dc55b6,
);
/*
 ...
 */ const $f80be5fd4d03dda9$var$localeSymbol = Symbol.for(
  "react-aria.i18n.locale",
);
const $f80be5fd4d03dda9$var$stringsSymbol = Symbol.for(
  "react-aria.i18n.strings",
);
let $f80be5fd4d03dda9$var$cachedGlobalStrings = undefined;
class $f80be5fd4d03dda9$export$c17fa47878dc55b6 {
  /** Returns a localized string for the given key and locale. */ getStringForLocale(
    key,
    locale,
  ) {
  ...
  /** Returns all localized strings for the given locale. */ getStringsForLocale(
    locale,
  ) {
    let strings = this.strings[locale];
    if (!strings) {
      strings = $f80be5fd4d03dda9$var$getStringsForLocale(
        locale,
        this.strings,
        this.defaultLocale,
      );
  ...
  static getGlobalDictionaryForPackage(packageName) {
    ...
    if ($f80be5fd4d03dda9$var$cachedGlobalStrings === undefined) {
      ...
      for (let pkg in globalStrings)
        $f80be5fd4d03dda9$var$cachedGlobalStrings[pkg] =
          new $f80be5fd4d03dda9$export$c17fa47878dc55b6(
            {
    ...
    let dictionary =
      $f80be5fd4d03dda9$var$cachedGlobalStrings === null ||
      $f80be5fd4d03dda9$var$cachedGlobalStrings === void 0
        ? void 0
        : $f80be5fd4d03dda9$var$cachedGlobalStrings[packageName];
    if (!dictionary)
      throw new Error(
...
function $f80be5fd4d03dda9$var$getStringsForLocale(
  locale,
  strings,
  defaultLocale = "en-US",
) {
