 ...
 */
export declare function addAPIProvider(
  provider: string,
 ...
 * Add icon set
 */
export declare function addCollection(
  data: IconifyJSON,
  provider?: string,
): boolean;
 ...
 * Add one icon
 */
export declare function addIcon(
  name: string,
 ...
 */
export declare function buildIcon(
  icon: IconifyIcon,
  customisations?: IconifyIconCustomisations_2,
 ...
 */
export declare type GetAPIConfig = (
  provider: string,
) => IconifyAPIConfig | undefined;

/**
 * Get full icon
 */
export declare function getIcon(
  name: string,
 ...
 */
export declare type IconifyAPIPrepareIconsQuery = (
  provider: string,
  prefix: string,
  icons: string[],
) => IconifyAPIIconsQueryParams[];

export declare type IconifyAPIQueryParams =
  | IconifyAPIIconsQueryParams
  | IconifyAPICustomQueryParams;

export declare type IconifyAPISendQuery = (
  host: string,
 ...
 */
export declare type IconifyCustomIconLoader = (
  name: string,
  prefix: string,
  provider: string,
 ...
 * Custom icons loader
 */
export declare type IconifyCustomIconsLoader = (
  icons: string[],
  prefix: string,
  provider: string,
 ...
 */
export declare type IconifyIconLoaderCallback = (
 ...
 */
declare type QueryDoneCallback = (
  data?: QueryModuleResponseData,
  error?: QueryModuleResponseData,
) => void;

declare type QueryModuleResponse = (
 ...
 */
export declare function replaceIDs(
  body: string,
 ...
 * Set custom loader for one icon
 */
export declare function setCustomIconLoader(
 ...
 */
export declare function setCustomIconsLoader(
