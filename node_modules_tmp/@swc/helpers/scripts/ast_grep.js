      ...
      .forEach((match) => {
        ...
        tree
          ...
          .forEach((match) => {
            ...
            source.update(range.start.index, range.end.index, `${ref_name}._`);
          });
      });
  ...
  errors.push(
    [
      ...
      [
        ...
        chalk.red(
          "^".repeat(binding_range.end.column - binding_range.start.column),
        ),
        " ".repeat(source_range.start.column - binding_range.end.column),
        chalk.blue(
          "-".repeat(source_range.end.column - source_range.start.column),
        ),
      ].join(""),
      `${chalk.bold(
        "note:",
